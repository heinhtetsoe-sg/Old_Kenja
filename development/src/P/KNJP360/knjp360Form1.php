...
class knjp360Form1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjp360Form1", "POST", "knjp360index.php", "", "knjp360Form1");
    ...
    $result = $db->query(knjp360Query::GetReduc_rare_case_cd());
    ...
    $result = $db->query(knjp360Query::GetClasscd($model));
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)){
    ...
    View::toHTML($model, "knjp360Form1.html", $arg); 
    }
}
?>
