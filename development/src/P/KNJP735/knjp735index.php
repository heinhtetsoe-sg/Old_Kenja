...
require_once('knjp735Model.inc');
require_once('knjp735Query.inc');

class knjp735Controller extends Controller
{
    public $ModelClassName = "knjp735Model";
    public $ProgramID      = "KNJP735";
        ...
        while (true) {
            switch (trim($sessionInstance->cmd)) {
                ...
                case "":
                    ...
                    $args["left_src"] .= "&PATH=" .urlencode("/P/KNJP735/knjp735index.php?cmd=edit");

                    $args["right_src"] = "knjp735index.php?cmd=cmdStart";;
...
$KNJP735Ctl = new knjp735Controller;
//var_dump($_REQUEST);
