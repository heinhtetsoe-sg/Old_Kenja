...
class knjp962Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjp962Form1", "POST", "knjp962index.php", "", "knjp962Form1");
        ...
        //学期リスト
        $query = knjp962Query::getSemester($model);
        $extra = "onChange=\"return btn_submit('knjp962');\"";
        makeCmb($objForm, $arg, $db, $query, "SEMESTER", $model->field["SEMESTER"], $extra, 1, "");

        //学年コンボボックス
        $query = knjp962Query::getGrade();
        $extra = "onChange=\"return btn_submit('knjp962');\"";
        makeCmb($objForm, $arg, $db, $query, "GRADE", $model->field["GRADE"], $extra, 1, "");

        //クラス一覧リスト作成する
        $query = knjp962Query::getAuth($model);
        ...
        //収入伺日
        $query = knjp962Query::getMonth($model);
        $extra = "";
        ...
        //収入決定日
        $extra = "";
        $model->field["INCOME_YMONTH"] = $model->field["INCOME_YMONTH"] ? $model->field["INCOME_YMONTH"] : $month;
        makeCmb($objForm, $arg, $db, $query, "INCOME_YMONTH", $model->field["INCOME_YMONTH"], $extra, 1, "");
        ...
        View::toHTML($model, "knjp962Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJP962");
