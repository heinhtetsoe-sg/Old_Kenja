...
class knjp827Form1 {
    function main(&$model) {
        ...
        //今年度・今学期名及びタイトルの表示
        $arg["data"]["YEAR_SEMESTER"] = CTRL_YEAR."年度<br>入金一括登録・Web出願入金情報ＣＳＶ取込";
...
//        $opt_shori[]    = array("label" => "削除","value" => "2");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJP827");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjp827index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjp827Form1.html", $arg);
    }
}
?>
