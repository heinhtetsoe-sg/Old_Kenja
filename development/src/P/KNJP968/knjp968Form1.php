...
class knjp968Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjp968Form1", "POST", "knjp968index.php", "", "knjp968Form1");
        ...
        View::toHTML($model, "knjp968Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJP968");
