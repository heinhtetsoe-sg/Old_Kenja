...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].DOCUMENTCD.value == "") {
        alert("{rval MSG310}" + "\n(出力文面)");
        return;
    }
    ...
    var documentCd = document.forms[0].DOCUMENTCD.value;
    if (documentCd != "") {
        var documentSize = document.forms[0]["documentMstSize_" + documentCd].value;
        var mojiGyou = documentSize.split("*");
        document.forms[0].TEXT_MOJI.value = Number(mojiGyou[0]);
        document.forms[0].TEXT_GYOU.value = Number(mojiGyou[1]);
    }
