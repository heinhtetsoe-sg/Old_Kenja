...
class knjp392qForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjp392qForm1", "POST", "knjp392qindex.php", "", "knjp392qForm1");
        ...
        $opt_grant = array();
        $db = Query::dbCheckOut();
        $result = $db->query(knjp392qQuery::getGrant());
        ...
        View::toHTML($model, "knjp392qForm1.html", $arg); 
    }
}
?>
