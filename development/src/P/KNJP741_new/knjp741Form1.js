...
var selectedColor = "";
function selectRow() {
alert(document.forms[0].btn_del);
    ...
    if (chk.length){
        parent.bottom_frame.location.href = "knjp741index.php?cmd=edit&CHECKED="+chk[selectedRow].value;
    }else if (chk){
        parent.bottom_frame.location.href = "knjp741index.php?cmd=edit&CHECKED="+chk.value;
    }
}
