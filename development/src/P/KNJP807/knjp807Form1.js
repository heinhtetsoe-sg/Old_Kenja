...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].COLLECT_M_CD.value == "") {
        alert('出力入金項目を指定して下さい。');
        return;
    }

    if (document.forms[0].NYUUKIN.checked) {
        if (document.forms[0].PAID_FDAY.value == "" || document.forms[0].PAID_TDAY.value == "" || document.forms[0].PRINT_DAY.value == "") {
            alert('生徒入金日期間/入金伝票日付を指定して下さい。');
            return;
        }
    }
