...
class knjp742aForm1 {
    function main(&$model) {
        ...
        $securityCnt = $db->getOne(knjp742aQuery::getSecurityHigh());
        //セキュリティーチェック
        ...
        if ($model->field["INPUT"] == "1") {
            $arg["HIKIOTOSHI"] = "1";
            $query = knjp742aQuery::getPaidMonth($model);
            $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJP742A");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjp742aindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjp742aForm1.html", $arg);
    }
}
