...
class knjp963Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjp963Form1", "POST", "knjp963index.php", "", "knjp963Form1");
        ...
        //支出伺日F
        $query = knjp963Query::getMonth($model);
        $extra = "";
        ...
        View::toHTML($model, "knjp963Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJP963");
