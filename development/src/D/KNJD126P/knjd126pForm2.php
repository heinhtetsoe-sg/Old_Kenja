...
class knjd126pForm2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("form2", "POST", "knjd126pindex.php", "", "form2");
        ...
        /* Edit by Kaung for PC-Talker 2020-01-20 start */
        $extra = "aria-label=\"学期\" id = \"SEMESTER\" onchange=\"current_cursor('SEMESTER');return btn_submit('form2', '')\"";
        /* Edit by Kaung for PC-Talker 2020-01-31 end */
        ...
        /* Edit by Kaung for PC-Talker 2020-01-20 start */
        $extra = "aria-label=\"年組\" id = \"GRADE_HR_CLASS\" onchange=\"current_cursor('GRADE_HR_CLASS');return btn_submit('form2', '')\"";
        /* Edit by Kaung for PC-Talker 2020-01-31 end */
        ...
        /* Edit by Kaung for PC-Talker 2020-01-20 start */
        $extra = "aria-label=\"科目\" id = \"SUBCLASSCD\" onchange=\"current_cursor('SUBCLASSCD');return btn_submit('form2', '')\"";
        /* Edit by Kaung for PC-Talker 2020-01-31 end */
        ...
        /* Edit by Kaung for PC-Talker 2020-01-31 start */
            ...
            foreach ($view_key as $code => $col) {
                ...
                if (in_array($model->field["SEMESTER"], $admin_key) && DEF_UPDATE_RESTRICT <= AUTHORITY) {
                    ...
                    if ($model->Properties["displayHyoutei"] != "1") {
                        /* Edit by Kaung for PC-Talker 2020-01-20 start */
                        if ($code != 9) {
                            $read_text = "aria-label=\"".$inputname."の観点別学習状況の".$code."\"";
                        } else {
                            $read_text = "aria-label=\"".$inputname."の評価の\"";
                        }
                        $extra = "$read_text STYLE=\"text-align: center\" onChange=\"this.style.background='#ccffcc';document.forms[0].elements['STATUS9-{$counter}'].value='';\" onblur=\"calc(this, '".$electdiv["ELECTDIV"]."');\" onPaste=\"return showPaste(this);\" id=\"STATUS{$code}-{$counter}\"";
                        /* Edit by Kaung for PC-Talker 2020-01-31 end */
                        if ($model->maxValue == '0' && $code == "9") {
                            $extra .= " disabled";
                        }
                        ...
                        if ($code != "9") {
                            /* Edit by Kaung for PC-Talker 2020-01-20 start */
                            $extra = "aria-label=\"".$inputname."の観点別学習状況の".$code."\" STYLE=\"text-align: center\" onChange=\"this.style.background='#ccffcc'\" onblur=\"calc(this, '".$electdiv["ELECTDIV"]."');\" onPaste=\"return showPaste(this);\" id=\"STATUS{$code}-{$counter}\"";
                            /* Edit by Kaung for PC-Talker 2020-01-31 end */
        ...
        //変換表取込ボタン
        $extra = "aria-label = \"変換表取込\" id = \"btn_conversion\" onclick=\"current_cursor('btn_conversion');return btn_submit('form2_conversion', '');\"".$disable;
        ...
        View::toHTML($model, "knjd126pForm2.html", $arg);
    }
}
//コンボ作成
