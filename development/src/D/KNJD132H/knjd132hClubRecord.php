...
class knjd132hClubRecord {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("clubrecord", "POST", "knjd132hindex.php", "", "clubrecord");
        ...
        //記録備考リスト
        $counter = 0;
        $query = knjd132hQuery::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knjd132hClubRecord.html", $arg);
    }
}
?>
