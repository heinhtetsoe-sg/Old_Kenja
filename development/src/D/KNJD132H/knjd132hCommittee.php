...
class knjd132hCommittee {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("committee", "POST", "knjd132hindex.php", "", "committee");
        ...
        //委員会リスト
        $counter = 0;
        $query = knjd132hQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd132hCommittee.html", $arg);
    }
}
?>
