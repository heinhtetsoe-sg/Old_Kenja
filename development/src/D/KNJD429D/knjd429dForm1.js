window.onload = function () {
    if (sessionStorage.getItem("KNJD429DForm1_CurrentCursor") != null) {
        document.title = '';
        document.getElementById(sessionStorage.getItem("KNJD429DForm1_CurrentCursor")).focus();
    }
};

function current_cursor(para) {
    sessionStorage.setItem("KNJD429DForm1_CurrentCursor", para);
}

function btn_submit(cmd) {
    if (sessionStorage.getItem("KNJD429DForm1_CurrentCursor") != null) {
        document.title = '';
        document.getElementById(sessionStorage.getItem("KNJD429DForm1_CurrentCursor")).blur();
    }
