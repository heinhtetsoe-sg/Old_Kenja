...
function move(side)
{
    ...
    {
        attribute1 = document.forms[0].L_SUBCLASSCD;
        attribute2 = document.forms[0].R_SUBCLASSCD;
    }
    else
    {
        attribute1 = document.forms[0].R_SUBCLASSCD;
        attribute2 = document.forms[0].L_SUBCLASSCD;
    }
...
function checktest() {
 ...
 document.all('TESTKINDCD').style.backgroundColor = "#cccccc";
 document.forms[0].TESTITEMCD.disabled = true;
 document.all('TESTITEMCD').style.backgroundColor = "#cccccc";
}
