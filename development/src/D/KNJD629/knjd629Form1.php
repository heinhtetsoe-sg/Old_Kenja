...
class knjd629Form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjd629Form1", "POST", "knjd629index.php", "", "knjd629Form1");
        ...
        View::toHTML($model, "knjd629Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJD629");
