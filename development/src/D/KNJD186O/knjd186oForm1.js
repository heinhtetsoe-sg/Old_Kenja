...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].SEMESTER.value != '9') {
        if (document.forms[0].EDATE.value < document.forms[0].SEME_SDATE.value || document.forms[0].EDATE.value > document.forms[0].SEME_EDATE.value)
        {
            alert("日付が学期範囲外です。");
            return;
        }
