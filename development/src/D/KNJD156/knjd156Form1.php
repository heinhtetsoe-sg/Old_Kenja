...
class knjd156Form1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("list", "POST", "knjd156index.php", "", "edit");
        $db = Query::dbCheckOut();
        ...
        $arg["reload"]  = "parent.right_frame.location.href='knjd156index.php?cmd=edit';";

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjd156Form1.html", $arg);
    }
}
