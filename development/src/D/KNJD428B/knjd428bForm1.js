...
setTimeout(function () {
  window.onload = new function () {
    if (sessionStorage.getItem("KNJD428BForm1_CurrentCursor") == "sortDes") { 
    ...
    } else if (sessionStorage.getItem("KNJD428BForm1_CurrentCursor") == "sortAsc") {
      document.getElementById("table").focus();
      setTimeout(function () {
      ...
      if (sessionStorage.getItem("KNJD428BForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD428BForm1_CurrentCursor")).focus();
...
function current_cursor(para) {
    sessionStorage.setItem("KNJD428BForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJD428BForm1_CurrentCursor") != null) {
         document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD428BForm1_CurrentCursor")).blur();
    }
