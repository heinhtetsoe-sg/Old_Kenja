function btn_submit(cmd) {
    var i;
    var sel = document.forms[0].select;
    sel.value = "";
    var selLabel = document.forms[0].selectLabel;
    selLabel.value = "";
    sep = "";
    for (i = 0; i < document.forms[0].category_selected.length; i++) {
        sel.value = sel.value + sep + document.forms[0].category_selected.options[i].value;
        selLabel.value = selLabel.value + sep + document.forms[0].category_selected.options[i].text;
        sep = ",";
    }
