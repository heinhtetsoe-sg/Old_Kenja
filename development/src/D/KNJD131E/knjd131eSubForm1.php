...
class knjd131eSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjd131eindex.php", "", "subform1");
        ...
        $query = knjd131eQuery::getClub($model);
        ...
        View::toHTML($model, "knjd131eSubForm1.html", $arg);
    }
}
?>
