...
class knjd131eSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131eindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131eQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131eSubForm2.html", $arg);
    }
}
?>
