# kanji=漢字
# $Id: readme.txt 64843 2019-01-18 05:49:42Z matsushima $
...
2013/08/19  1.前回の修正漏れ

2013/12/18  1.出欠累積データの同月別学期のデータがある場合の不具合を修正

2015/02/20  1.成績優良者に「欠席、遅刻、早退日数」も出力するチェックボックスを追加
            -- ※京都西山からの要望

2015/03/20  1.学校マスタの「欠課に含める」勤怠もカウントする
            2.修正

2015/07/21  1.皆勤者に授業早退の指定を追加

2016/04/12  1.異動日付のチェック不具合を修正

2017/01/16  1.皆勤者CSV出力の遅刻、早退、欠席の集計を変更
