...
class knjd232yForm1 {
    function main(&$model) {
        ...
        //成績優良者（欠席、遅刻、早退日数出力）
        $extra  = ($model->field["SEISEKI_YURYO_ATTEND"] == "1") ? "checked" : "";
        $extra .= " id=\"SEISEKI_YURYO_ATTEND\"";
        $arg["data"]["SEISEKI_YURYO_ATTEND"] = knjCreateCheckBox($objForm, "SEISEKI_YURYO_ATTEND", "1", $extra, "");
        ...
        //皆勤者/授業早退
        $extra = "style=\"text-align: right\" onblur=\"this.value=toInteger(this.value)\"";
        $value = $model->field["KAIKIN_KAIKIN_JUGYO_SOUTAI"];
        $arg["data"]["KAIKIN_KAIKIN_JUGYO_SOUTAI"] = knjCreateTextBox($objForm, $value, "KAIKIN_KAIKIN_JUGYO_SOUTAI", 3, 3, $extra);
        ...
        //精勤者/授業早退
        $extra = "style=\"text-align: right\" onblur=\"this.value=toInteger(this.value)\"";
        $value = $model->field["KAIKIN_SEIKIN_JUGYO_SOUTAI"];
        $arg["data"]["KAIKIN_SEIKIN_JUGYO_SOUTAI"] = knjCreateTextBox($objForm, $value, "KAIKIN_SEIKIN_JUGYO_SOUTAI", 3, 3, $extra);
        //精勤者/SHR・遅刻
        $extra = "style=\"text-align: right\" onblur=\"this.value=toInteger(this.value)\"";
