...
//印刷
function newwin(SERVLET_URL,output){
    ...
    //コールする帳票プログラムＩＤをセット
	var testkind = document.forms[0].TESTKINDCD;
    var i = testkind.selectedIndex;
    var tmp = testkind.options[i].value;
    if (tmp == 90 || tmp == 91 || tmp == 92)
	{
        document.forms[0].PRGID.value = "KNJD324_2";
	} else {
        document.forms[0].PRGID.value = "KNJD324";
	}
