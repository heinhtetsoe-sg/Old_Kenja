...
class knjd137fSubForm2 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knjd137findex.php", "", "subform2");
        ...
        //委員会一覧
        $query = knjd137fQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd137fSubForm2.html", $arg);
    }
}
?>
