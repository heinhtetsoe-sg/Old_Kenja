<?php
class knjd131jSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131jindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131jQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131jSubForm2.html", $arg);
    }
}
?>
