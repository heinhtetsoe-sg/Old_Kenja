<?php
class knjd131jSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjd131jindex.php", "", "subform1");
        ...
        $query = knjd131jQuery::getClub($model);
        ...
        View::toHTML($model, "knjd131jSubForm1.html", $arg);
    }
}
?>
