...
function btn_submit(cmd) {
    ...
    if (cmd == "setupdate") {
        ...
        attribute3.value = "";
        sep = "";
        if (document.forms[0].CATEGORY_SELECTED.length==0 || (document.forms[0].CATEGORY_SELECTED.length==0 && document.forms[0].CATEGORY_NAME.length==0)) {
            alert('{rval MSG916}');
            return false;
        }
        ...
        if (!confirm('{rval MSG102}'+'\n今年度の部活動・委員会活動を取込、特別活動の記録を更新します。')) {
            return false;
        }
