...
class knjd131fForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjd131fForm1", "POST", "knjd131findex.php", "", "knjd131fForm1");
        ...
        //学期数取得
        $model->semsterCount = "";
        $model->semsterCount = $db->getOne(knjd131fQuery::getSemester());
        ...
        //フォーマット設定
        $arg["setA"] = '1';
        $arg["FORMAT"] = $arg["3gakki"] === '1' ? "100%" : "82%";
        
        //クラス
        $query = knjd131fQuery::getHrClassList();
        ...
        $model->data["SCHREGNO"] = "";
        $query = knjd131fQuery::getMainQuery($model, $model->semsterCount);
        ...
        View::toHTML($model, "knjd131fForm1.html", $arg);
    }
}
...
function makeBtn(&$objForm, &$arg, $model, $Row) {
    ...
    //csv
    $extra = " onClick=\" wopen('".REQUESTROOT."/X/KNJX154/knjx154index.php?','SUBWIN2',0,0,screen.availWidth,screen.availHeight);\"";
