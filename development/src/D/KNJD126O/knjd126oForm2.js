...
window.onload = function() {
    if(sessionStorage.getItem("KNJD126O_CurrentCursor") != null){
        if(sessionStorage.getItem("KNJD126O_CurrentCursor_temp") != null && sessionStorage.getItem("KNJD126O_CurrentCursor_temp") == "SELECT1" && sessionStorage.getItem("KNJD126O_CurrentCursor") == "SELECT2"){
            setTimeout(function(){
                document.getElementById(sessionStorage.getItem("KNJD126O_CurrentCursor")).focus();
            },3000);
            sessionStorage.setItem("KNJD126O_CurrentCursor_temp",null);
        } else {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJD126O_CurrentCursor")).focus();
        }
...
function current_cursor(para){
    if(para == "SELECT1"){
      sessionStorage.setItem("KNJD126O_CurrentCursor_temp","SELECT2");
    }
    sessionStorage.setItem("KNJD126O_CurrentCursor",para);
}
...
function btn_submit(cmd, electdiv) {
    ...
    document.title = "";
    if(sessionStorage.getItem("KNJD126O_CurrentCursor") != null){
        document.getElementById(sessionStorage.getItem("KNJD126O_CurrentCursor")).blur();
    }
    /* Add by Kaung for PC-Talker 2020-01-17 end */
    if (cmd == 'form2_reset'){
