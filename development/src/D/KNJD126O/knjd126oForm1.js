...
function init() {       //ウィンドウを開いたら呼ばれる関数
    ...
    if(sessionStorage.getItem("KNJD126O_CurrentCursor") != null){
        if(sessionStorage.getItem("KNJD126O_CurrentCursor_temp") != null && sessionStorage.getItem("KNJD126O_CurrentCursor_temp") == "SELECT2" && sessionStorage.getItem("KNJD126O_CurrentCursor") == "SELECT1"){
            setTimeout(function(){
...
function current_cursor(para){
    if(para == "SELECT2"){
      sessionStorage.setItem("KNJD126O_CurrentCursor_temp","SELECT1");
    }
