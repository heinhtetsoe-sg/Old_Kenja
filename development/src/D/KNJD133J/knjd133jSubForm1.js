function btn_submit(cmd) {
    if (cmd == 'teikei' || cmd == 'teikei2' || cmd == 'teikei3') {
        ...
        loadwindow('knjd133jindex.php?cmd='+cmd+'&REPLACE_FLG=1&CHR='+chr+'&SEMESTER='+sendSemester, event.clientX + function () {var scrollX = document.documentElement.scrollLeft || document.body.scrollLeft;return scrollX;}(), event.clientY + function () {var scrollY = document.documentElement.scrollTop || document.body.scrollTop;return scrollY;}(), 650, 450);
        return true;
    }
