function btn_submit(cmd) {
    ...
    document.forms[0].CHECKS.value = getchecks();
...
function kubun()
{
    var kubun1 = document.forms[0].PRINT_SIDE1;
    var kubun2 = document.forms[0].PRINT_SIDE2;
    var kubun3 = document.forms[0].PRINT_SIDE3;
    var kubun4 = document.forms[0].PRINT_SIDE4;

    if ((kubun1.checked == false) && 
        (kubun2.checked == false) && 
        (kubun3.checked == false) && 
    ...
    //存在するときだけ処理(表示しないパターンあり)
    if (document.forms[0].NOTOUTPUT_EDUTARGET) {
        var kubun5 = document.forms[0].NOTOUTPUT_EDUTARGET;
        if (kubun1.checked == false) {
            document.forms[0].NOTOUTPUT_EDUTARGET.disabled = true;
        } else {
            document.forms[0].NOTOUTPUT_EDUTARGET.disabled = false;
        }
    }
}
