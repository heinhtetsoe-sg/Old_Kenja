window.onload = function () {
    if (sessionStorage.getItem("KNJD126W_CurrentCursor") != null) {
        if (
            ...
            sessionStorage.getItem("KNJD126W_CurrentCursor_temp") == "SELECT1" &&
            sessionStorage.getItem("KNJD126W_CurrentCursor") == "SELECT2"
        ) {
            setTimeout(function () {
...
function current_cursor(para) {
    if (para == "SELECT1") {
        sessionStorage.setItem("KNJD126W_CurrentCursor_temp", "SELECT2");
    }
...
function showPaste(obj) {
    ...
    //テキストボックスの名前の配列を作る
    if (kantenHyouji_5 == 1) {
        var nameArray = new Array("STATUS1", "STATUS2", "STATUS3", "STATUS4", "STATUS5", "STATUS8", "STATUS9");
    } else {
        var nameArray = new Array("STATUS1", "STATUS2", "STATUS3", "STATUS4", "STATUS5", "STATUS6", "STATUS8", "STATUS9");
    }
