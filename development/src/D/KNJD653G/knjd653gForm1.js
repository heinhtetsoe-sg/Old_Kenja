...
function newwin(SERVLET_URL) {
    ...
    var c = 0;
    if (document.forms[0].OUTPUT_RANK1.checked == true) c += 1;
    if (document.forms[0].OUTPUT_RANK2.checked == true) c += 1;
    if (document.forms[0].OUTPUT_RANK3.checked == true) c += 1;
    if (document.forms[0].usePerfectCourseGroup.value == "1" && document.forms[0].OUTPUT_RANK5.checked == true) c += 1;
    if( c > 2) {
        alert('{rval MSG915}\n（総合順位出力）');
        return false;
    }
