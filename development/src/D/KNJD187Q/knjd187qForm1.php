...
class knjd187qForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjd187qForm1", "POST", "knjd187qindex.php", "", "knjd187qForm1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJD187Q");
        ...
        View::toHTML($model, "knjd187qForm1.html", $arg);
    }
}
