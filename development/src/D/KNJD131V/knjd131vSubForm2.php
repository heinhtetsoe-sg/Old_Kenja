...
class knjd131vSubForm2
{
    public function main(&$model)
    {
        ...
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131vindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131vQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131vSubForm2.html", $arg);
    }
}
?>
