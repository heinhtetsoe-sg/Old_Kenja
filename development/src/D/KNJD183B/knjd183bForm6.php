...
class knjd183bForm6
{
    public function main(&$model)
    {
        ...
        $radioArray = knjCreateRadio($objForm, "FRM_PATERN", $model->frmPatern, $extra, $opt, get_count($opt), $optVal);
        foreach ($radioArray as $key => $val) {
            $arg["data"][$key] = $val;
        }
        ...
        //身体の記録
        $query = knjd183bQuery::getMedexamDerMonthDat();
        $extra = "";
        ...
        View::toHTML($model, "knjd183bForm6.html", $arg);
    }
}
