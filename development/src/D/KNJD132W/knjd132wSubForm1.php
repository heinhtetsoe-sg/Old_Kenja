...
class knjd132wSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjd132windex.php", "", "subform1");
        ...
        $query = knjd132wQuery::getClub($model);
        ...
        View::toHTML($model, "knjd132wSubForm1.html", $arg);
    }
}
?>
