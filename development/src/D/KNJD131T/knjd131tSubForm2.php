...
class knjd131tSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131tindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131tQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131tSubForm2.html", $arg);
    }
}
?>
