...
class knjd131tSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjd131tindex.php", "", "subform1");
        ...
        $query = knjd131tQuery::getClub($model);
        ...
        View::toHTML($model, "knjd131tSubForm1.html", $arg);
    }
}
?>
