...
function doSubmit() {
    //チェック
    if (document.forms[0].SUBCLASS_REMARK0.checked == false
        && (!document.forms[0].SUBCLASS_REMARK1 || document.forms[0].SUBCLASS_REMARK1.checked == false)
        && (!document.forms[0].SUBCLASS_REMARK2 || document.forms[0].SUBCLASS_REMARK2.checked == false)
        && (!document.forms[0].SUBCLASS_REMARK3 || document.forms[0].SUBCLASS_REMARK3.checked == false)
        ) {
        alert('処理対象科目を選択して下さい。');
        return false;
    }
