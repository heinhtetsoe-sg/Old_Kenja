...
window.addEventListener("load",function(event) {
    if (sessionStorage.getItem("KNJD129V_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD129V_CurrentCursor")).focus();
    }
    setTimeout(function () {
...
function current_cursor(para){
    document.title = "";
    sessionStorage.setItem("KNJD129V_CurrentCursor",para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJD129V_CurrentCursor") != null) {
        ...
        document.getElementById(sessionStorage.getItem("KNJD129V_CurrentCursor")).blur();
    }
    setTimeout(function () {
            parent.top_frame.document.title = "佐賀県教務支援システム Ver0.01";
    }, 1000);
