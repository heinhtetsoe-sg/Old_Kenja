    ...
    if (cmd == 'reset'){
        ...
        for (var i = 0; i < document.forms[0].elements.length; i++ ) {
            ...
            if (e.type == 'text' && e.value != '') {
                ...
                } else if (nam.match(/.SCORE1./) || nam.match(/.SCORE2./)) {
//                    if (score < 0 || score > 50) {
//                        alert('{rval MSG914}'+'0点～50点以内で入力してください。値：' + e.value);
//                        return false;
//                    }
                } else {
                    //満点チェック
        ...
        score_msg[0] = "（前期１学期期末共通）";
        score_msg[1] = "（前期２学期期末共通）";
        score_msg[2] = "（後期３学期期末共通）";
        score_msg[3] = "（後期４学期期末共通）";
        var info_msg = "";
        var info_msg2 = "";
        var info_msg3 = "";
        for (var i = 0; i < 4; i++ ) {
...
//        if (score < 0 || score > 50) {
//            alert('{rval MSG914}'+'0点～50点以内で入力してください。');
//            obj.value = obj.defaultValue;
//            return;
//        }
    } else {
        ...
        for (k = 0; k < objectNameArray.length; k++) { //テキストボックス名でまわす
            ...
            if (startFlg) {
                if (clipTextArray[j][i] != undefined) {
                    ...
                    if (objectNameArray[k].match(/SCORE3/)) {
                        if (valScore < 0 || valScore > 10) {
                            alert('{rval MSG914}'+'0点～10点以内で入力してください。');
                            return false;
                        }
                    } else if (objectNameArray[k].match(/SCORE[12]/)) {
                    } else {
                        //満点チェック
