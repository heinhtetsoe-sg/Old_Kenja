// kanji=漢字
// $Id: readme.txt 76260 2020-08-27 08:52:57Z arakaki $
...
2007/06/19 nakamoto
★ 入力項目「共通・レッスン」の値(範囲)チェックをしないようにした。
-- 0点～50点
-- 修正依頼メール2007/06/19
...
2009/06/25  1.以下の修正をした。
            ...
            -- レッスン・総合の「成績入力完了チェックボックス」追加(RECORD_CHKFIN_DATを更新)
            2.チェックボックスを表示する処理修正
...
2009/09/30  1.レッスンの「成績入力完了チェックボックス」削除。
