// kanji=漢字
// $Id: readme.txt 76388 2020-09-03 08:16:18Z arakaki $
...
2016/09/26  1.KNJD129V(1.43)を元に新規作成
            -- プロパティーshowHeikinran=1の時、「表示順リンク」の表示。
            -- プロパティーshowHeikinran=1の時、「平均点欄」の表示。'9990008'固定
            -- プロパティーshowBunpuHyou=1の時、「集団ラジオ」の表示。
            -- プロパティーshowBunpuHyou=1の時、「分布表」の表示。
            -- プロパティーshowBunpuHyou=1の時、「追指導リンク」の無効化
...
2017/02/22  1.合併先科目の母集団がない場合、合併元科目を平均して算出する
...
2017/10/23  1.速度改善時の不具合修正

2017/12/14  1.ACCESS_LOG_DETAIL出力カット
