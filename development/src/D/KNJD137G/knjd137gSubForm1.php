...
class knjd137gSubForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform1", "POST", "knjd137gindex.php", "", "subform1");
        ...
        //部活動一覧
        $query = knjd137gQuery::getClub($model);
        ...
        View::toHTML($model, "knjd137gSubForm1.html", $arg);
    }
}
?>
