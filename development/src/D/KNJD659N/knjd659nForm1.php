...
class knjd659nForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjd659nForm1", "POST", "knjd659nindex.php", "", "knjd659nForm1");
        ...
        //学期コンボ作成
        $query = knjd659nQuery::getSemester($model);
        ...
        View::toHTML($model, "knjd659nForm1.html", $arg); 
    }
}

function makeStudentList(&$objForm, &$arg, $db, $model) {
    //対象クラスリストを作成する
    $query = knjd659nQuery::getGradeHrClass($model->field["SEMESTER"], $model);
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJD659N");
    ...
    knjCreateHidden($objForm, "useJviewHyouka_DankaichiSansyou", $model->Properties["useJviewHyouka_DankaichiSansyou"]);
    knjCreateHidden($objForm, "useJview_SemesKeiHyouji", $model->Properties["useJview_SemesKeiHyouji"]);
