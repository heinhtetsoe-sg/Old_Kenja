...
function checkPrint(obj) {
    if (obj == document.forms[0].PRINT_SIGN && obj.checked) {
        document.forms[0].PRINT_VERIFICATION.checked = false;
    } else if (obj == document.forms[0].PRINT_VERIFICATION && obj.checked) {
        document.forms[0].PRINT_SIGN.checked = false;
    }
}
