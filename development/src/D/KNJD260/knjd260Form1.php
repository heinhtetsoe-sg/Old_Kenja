...
//フォーム作成//////////////////////////////////////////////////////////////////////////////////////////
$arg["start"]   = $objForm->get_start("knjd260Form1", "POST", "knjd260index.php", "", "knjd260Form1");
...
//クラス選択コンボボックスを作成する///////////////////////////////////////////////////////////////////////////////
$db = Query::dbCheckOut();
$query = knjd260Query::getAuth($model->control["年度"],$model->control["学期"]);
/*
...
$objForm->ae( array("type"       => "select",
					...
					"extrahtml"  => "onchange=\"return btn_submit('knjd260');\"",
                    "options"    => $row1));
...
View::toHTML($model, "knjd260Form1.html", $arg); 
}
}
?>
