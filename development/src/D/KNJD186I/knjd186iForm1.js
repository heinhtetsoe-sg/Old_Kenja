...
function newwin(SERVLET_URL, cmd) {
    ...
    for (var i = 0; i < document.forms[0].CATEGORY_SELECTED.length; i++) {
        taihi[i] = document.forms[0].CATEGORY_SELECTED.options[i].value;
        schno = document.forms[0].CATEGORY_SELECTED.options[i].value.split("-");
        document.forms[0].CATEGORY_SELECTED.options[i].value = schno[1];
...
//    document.forms[0].action = "http://" + url +"/cgi-bin/printenv.pl";
    ...
    for (var i = 0; i < document.forms[0].CATEGORY_SELECTED.length; i++) {
        document.forms[0].CATEGORY_SELECTED.options[i].value = taihi[i];
    }
}
