...
function show(obj) {
    ...
    //テキストボックスの名前の配列を作る
    var nameArray = new Array('SEM1_INTR_SCORE', 'SEM1_INTR_VALUE', 'SEM1_TERM_SCORE', 'SEM1_TERM_VALUE', 'SEM1_VALUE', 'SEM2_INTR_SCORE', 'SEM2_INTR_VALUE', 'SEM2_TERM_SCORE', 'SEM2_TERM_VALUE', 'SEM2_VALUE', 'SEM3_TERM_SCORE', 'SEM3_VALUE', 'GRAD_SCORE', 'GRAD_VALUE', 'COMP_CREDIT', 'GET_CREDIT');
