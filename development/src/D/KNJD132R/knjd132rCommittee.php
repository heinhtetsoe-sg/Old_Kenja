...
class knjd132rCommittee {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("committee", "POST", "knjd132rindex.php", "", "committee");
		...
		//委員会リスト
        $counter = 0;
        $query = knjd132rQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd132rCommittee.html", $arg);
    }
}
?>
