...
class knjd645Form1
{
    function main(&$model) {
        ...
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjd645Form1", "POST", "knjd645index.php", "", "knjd645Form1");
        ...
        View::toHTML($model, "knjd645Form1.html", $arg); 
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    //クラス一覧
    $row1 = array();
    $result = $db->query(knjd645Query::getBuKa($model));
    ...
    //学部学科一覧作成
    $extra = "multiple style=\"width=270px\" ondblclick=\"move1('left')\"";
    $arg["data"]["CATEGORY_NAME"] = createCombo($objForm, "CATEGORY_NAME", "", $row1, $extra, 20);

    //学部学科選択作成
    $extra = "multiple style=\"width=270px\" ondblclick=\"move1('right')\"";
...
function makeHidden(&$objForm, $model, $seme, $semeflg)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJD645"));
