...
function btn_submit(cmd){
    if (document.forms[0].SCHREGNO.value == ""){
        ...
        loadwindow('knjd132iindex.php?cmd=subform2',0,0,650,250);
        return true;
    }
    else if (cmd == 'subform3'){
        loadwindow('knjd132iindex.php?cmd=subform3',0,0,700,300);
        return true;
    } else if (cmd == 'subform6'){
        loadwindow('knjd132iindex.php?cmd=subform6',0,0,750,300);
        return true;
    } else if (cmd == 'subform5'){      //検定選択
        loadwindow('knjd132iindex.php?cmd=subform5',0,0,670,550);
        return true;
    }
