...
//ビュー作成用クラス
class knjd132iSubForm3 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knjd132iindex.php", "", "subform3");
        ...
        //委員会リスト
        $db = Query::dbCheckOut();
        $query = knjd132iQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd132iSubForm3.html", $arg);
    }
}
?>
