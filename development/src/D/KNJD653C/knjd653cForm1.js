...
function newwin(SERVLET_URL) {
    if (document.forms[0].SELECT_DIV[0].checked || document.forms[0].SELECT_DIV[1].checked) {
    ...
    if(document.forms[0].OUTPUT_RANK1.checked == true && document.forms[0].OUTPUT_RANK2.checked == true && document.forms[0].OUTPUT_RANK3.checked == true) {
        alert('{rval MSG915}\n（総合順位出力）');
        return false;
    }
