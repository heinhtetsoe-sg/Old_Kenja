...
class knjd659aForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjd659aForm1", "POST", "knjd659aindex.php", "", "knjd659aForm1");
        ...
        //学期コンボ作成
        $query = knjd659aQuery::getSemester();
        ...
        View::toHTML($model, "knjd659aForm1.html", $arg); 
    }
}

function makeStudentList(&$objForm, &$arg, $db, $model) {
    //対象クラスリストを作成する
    $query = knjd659aQuery::getGradeHrClass($model->field["SEMESTER"], $model);
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJD659A");
