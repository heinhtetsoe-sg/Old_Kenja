...
function checkPrint(obj) {
    if (obj == document.forms[0].PRINT_ZENKI && obj.checked) {
        document.forms[0].PRINT_KOUKI.checked = false;
    } else if (obj == document.forms[0].PRINT_KOUKI && obj.checked) {
        document.forms[0].PRINT_ZENKI.checked = false;
    }
}
