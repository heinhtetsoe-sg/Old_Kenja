...
class knjd185nForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjd185nForm1", "POST", "knjd185nindex.php", "", "knjd185nForm1");
        ...
        //学期コンボ作成
        $query = knjd185nQuery::getSemester();
        $extra = "onchange=\"return btn_submit('knjd185n'), AllClearList();\"";
        ...
        //クラスコンボ作成
        $query = knjd185nQuery::getHrClass(CTRL_YEAR, $seme);
        $extra = "onchange=\"return btn_submit('knjd185n'), AllClearList();\"";
        makeCmb($objForm, $arg, $db, $query, "GRADE_HR_CLASS", $model->field["GRADE_HR_CLASS"], $extra, 1);

        //テスト種別コンボ作成
        $query = knjd185nQuery::getTestKindCd($model);
        $extra = "";
        ...
        //異動対象日付（テキスト）
        $disabled = "";
        $extra = "onblur=\"isDate(this); tmp_list('knjd185n')\"".$disabled;
        ...
        View::toHTML($model, "knjd185nForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model, $seme) {
    //対象外の生徒取得
    $query = knjd185nQuery::getSchnoIdou($model, $seme);
    ...
    //対象者リストを作成する
    $query = knjd185nQuery::getStudent($model, $seme);
    $result = $db->query($query);
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJD185N");
