...
window.onload = function () {
    if (sessionStorage.getItem("KNJD426MForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD426MForm1_CurrentCursor")).focus();
    }
};

function current_cursor(para) {
    sessionStorage.setItem("KNJD426MForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJD426MForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD426MForm1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
