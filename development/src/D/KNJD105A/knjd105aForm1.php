...
class knjd105aForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("list", "POST", "knjd105aindex.php", "", "edit");
        ...
        if ($model->cmd == "coursename"){
            $arg["reload"] = "window.open('knjd105aindex.php?cmd=edit','right_frame');";
        }

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。 
        View::toHTML($model, "knjd105aForm1.html", $arg);
    }
}
