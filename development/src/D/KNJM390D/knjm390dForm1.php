...
class knjm390dForm1 {
    function main(&$model) {
        ...
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            //出席回数
            $extra = "style=\"text-align:right\" onblur=\"this.value=toInteger(this.value);\" onkeydown=\"changeEnterToTab(this)\"";
            $row["SCHOOLIN_CNT"] = knjCreateTextBox($objForm, $row["SCHOOLIN_CNT"], "SCHOOLIN_CNT-".$row["SCHREGNO"], 2, 2, $extra);
