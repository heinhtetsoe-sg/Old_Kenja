...
class knjd126jForm1
{
    public function main(&$model)
    {
        ...
        $arg["start"]    = $objForm->get_start("form1", "POST", "knjd126jindex.php", "", "form1");
        $arg["YEAR"]     = CTRL_YEAR;
                ...
                if (in_array($model->field["SEMESTER"], $admin_key) && DEF_UPDATE_RESTRICT <= AUTHORITY) {
                    ...
                    if ($code == "9") {
                        ...
                        if ($model->Properties["displayHyoutei"] != "1" && $model->Properties["displayHyoutei"] != "2") {
                            $extra = "STYLE=\"text-align: center\" onChange=\"this.style.background='#ccffcc'\" onblur=\"calc(this, '".$electdiv."', '".$row["GRADE"]."');\"";
                        ...
                        $extra = "STYLE=\"text-align: center\" readonly=\"readonly\" onClick=\"kirikae(this, 'STATUS".$code."-".$counter."','".$counter."');\" oncontextmenu=\"kirikae2(this, 'STATUS".$code."-".$counter."')\"; ";
        ...
        //変換表取込ボタン
        $extra = "onclick=\"return btn_submit('conversion');\"".$disable;
        ...
        View::toHTML($model, "knjd126jForm1.html", $arg);
    }
}
//コンボ作成
