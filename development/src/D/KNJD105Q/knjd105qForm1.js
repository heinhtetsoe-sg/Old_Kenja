...
function newwin(SERVLET_URL, paramCmd){
    ...
    if (document.forms[0].SDATE.value == '') {
        document.forms[0].SDATE.value = document.forms[0].SDATE_DEFAULT.value;
    }
    if (document.forms[0].EDATE.value == '') {
        document.forms[0].EDATE.value = document.forms[0].EDATE_DEFAULT.value;
    }
    if (document.forms[0].SDATE.value < document.forms[0].YEAR_SDATE.value || document.forms[0].EDATE.value > document.forms[0].YEAR_EDATE.value) {
        alert('出欠集計日付が年度の範囲外です');
        return;
    }
    if (document.forms[0].EDATE.value < document.forms[0].SDATE.value) {
        alert('出欠集計日付の大小が不正です');
        return;
    }
