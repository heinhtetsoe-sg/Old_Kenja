...
class knjd132fClubHdetail {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("clubhdetail", "POST", "knjd132findex.php", "", "clubhdetail");
        ...
        //記録備考リスト
        $counter = 0;
        $query = knjd132fQuery::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knjd132fClubHdetail.html", $arg);
    }
}
?>
