function btn_submit(cmd) {
    ...
    if (cmd == 'reset') {
        ...
        for (var i = 0; i < document.forms[0].elements.length; i++ ) {
            ...
            if (e.type == 'text' && nam.match(/.SCORE./)) {
                ...
                if (nam.match(/SEM2_TERM2_SCORE./)) {
                    score_txt[5] = true;
                    if (e.value == '') score_cnt[5] = false;
                    else               score_not[5] = false;
                }
            }
            // 成績入力完了チェック
            if (e.type == 'checkbox' && nam.match(/CHK_COMP./)) {
                ...
                if (nam.match(/CHK_COMP6/)) score_chk[5] = e.checked;
            }
        }
        ...
        score_msg[5] = "（"+semename2+testname6+"素点）";
        var info_msg = "";
        var info_msg2 = "";
        var info_msg3 = "";
        for (var i = 0; i < 6; i++ ) {
        ...
        var testname7 = document.forms[0].TESTNAME20202.value;
        var testname8 = '';
        ...
        value_msg[7] = "（"+semename2+testname8+"評価）";
        value_msg[8] = "（学年評定）";
        for (var i = 0; i < 9; i++ ) {
            // ①の場合
