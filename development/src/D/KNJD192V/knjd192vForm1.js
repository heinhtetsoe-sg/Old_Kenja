...
function OptionUse(obj) {
    if (obj.checked == false) {
        document.forms[0].KEKKA_AS_INT.disabled = false;
        document.forms[0].KEKKA_AS_INT.checked = true;
    } else {
        document.forms[0].KEKKA_AS_INT.disabled = true;
        document.forms[0].KEKKA_AS_INT.checked = true;
    }
}
