...
class knjd139pSubForm2 {
    function main(&$model) {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd139pindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd139pQuery::getCommittee($model, "2");
        ...
        View::toHTML($model, "knjd139pSubForm2.html", $arg);
    }
}
?>
