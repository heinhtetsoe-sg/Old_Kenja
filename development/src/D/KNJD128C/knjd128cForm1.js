function btn_submit(cmd) {
    ...
    if (cmd == 'reset') {
        ...
        var testname4 = document.forms[0].TESTNAME20102.value;
        ...
        score_msg[4] = "（"+semename2+testname5+"）";
        score_msg[5] = "（"+semename2+testname6+"）";
        var info_msg = "";
        var info_msg2 = "";
        var info_msg3 = "";
        for (var i = 0; i < 6; i++ ) {
