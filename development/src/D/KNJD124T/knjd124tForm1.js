function btn_submit(cmd) {
    ...
    if (cmd == 'reset') {
        ...
        score_msg[4] = "（"+semename3+testname5+"素点）";
        var info_msg = "";
        var info_msg2 = "";
        var info_msg3 = "";
        for (var i = 0; i < 5; i++ ) {
        ...
        for (var i = 0; i < document.forms[0].elements.length; i++ ) {
            ...
            if (e.type == 'text' && (nam.match(/VALUE/) || nam.match(/COMP_CREDIT./) || nam.match(/GET_CREDIT./))) {
                ...
                if (subclasscd_chk.substr(0, 2) == '90'){
                    ...
                    if (nam.match(/GRAD_VALUE./)) {
                        value_txt[8] = true;
                        if (e.value == '') value_cnt[8] = false;
                        else               value_not[8] = false;
                    }
                }
            }
            // 成績入力完了チェック
            if (e.type == 'checkbox' && nam.match(/CHK_COMP_VALUE./)) {
                ...
                if (nam.match(/CHK_COMP_VALUE9/)) {value_chk[8] = e.checked; value_dis[8] = e.disabled;}
            }
        }
        // 成績入力完了チェックの入れ忘れメッセージ
        ...
        var testname6 = '';
        var testname7 = document.forms[0].TESTNAME30201.value;
        var testname8 = '';
        var testname9 = '';
        ...
        value_msg[6] = "（"+semename3+testname7+"評価）";
        value_msg[7] = "（"+semename3+testname8+"評価）";
        value_msg[8] = "（学年評定）";
        if (subclasscd_chk.substr(0, 2) == '90'){
            value_msg[8] = value_msg[8] + "（履修単位・修得単位）";
        }
        for (var i = 0; i < 9; i++ ) {
            // ①の場合
