function btn_submit(cmd) {
    ...
    if (cmd == 'reset') {
        ...
        var testname5 = document.forms[0].TESTNAME30101.value;
        var testname6 = document.forms[0].TESTNAME30201.value;
        ...
        score_msg[5] = "（"+semename3+testname6+"）";
        var info_msg = "";
        var info_msg2 = "";
        var info_msg3 = "";
        for (var i = 0; i < 6; i++ ) {
