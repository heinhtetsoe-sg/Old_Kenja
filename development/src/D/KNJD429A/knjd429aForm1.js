...
window.onload = function () {
    if (sessionStorage.getItem("KNJD429AForm1_CurrentCursor") != null) {
        document.title = '';
        document.getElementById(sessionStorage.getItem("KNJD429AForm1_CurrentCursor")).focus();
    }
};

function current_cursor(para) {
    sessionStorage.setItem("KNJD429AForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJD429AForm1_CurrentCursor") != null) {
        document.title = '';
        document.getElementById(sessionStorage.getItem("KNJD429AForm1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
...
function chgCheck() {
    document.forms[0].HYOSI.checked = true;
}
