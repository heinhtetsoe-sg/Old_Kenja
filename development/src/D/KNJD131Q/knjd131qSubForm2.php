...
class knjd131qSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131qindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131qQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131qSubForm2.html", $arg);
    }
}
?>
