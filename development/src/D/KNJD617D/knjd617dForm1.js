function btn_submit(cmd) {
    ...
    console.log(document.forms[0].selectdata);
...
function newwin(SERVLET_URL, cmd) {
    ...
    if (
        new Date(eval(sdate[0]), eval(sdate[1]) - 1, eval(sdate[2])) > new Date(eval(day[0]), eval(day[1]) - 1, eval(day[2])) ||
