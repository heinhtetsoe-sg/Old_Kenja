...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].DATE.value < document.forms[0].SEME_FROM.value || document.forms[0].SEME_TO.value < document.forms[0].DATE.value) {
        alert('{rval MSG916}' + "出欠集計日付が指定学期期間外です。");
        return;
    }
    //
