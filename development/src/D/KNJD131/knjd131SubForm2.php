...
class knjd131SubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131index.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131Query::getCommittee($model);
        ...
        View::toHTML($model, "knjd131SubForm2.html", $arg);
    }
}
?>
