...
window.onload = function () {
        if (sessionStorage.getItem("KNJD429Form1_CurrentCursor") != null) {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJD429Form1_CurrentCursor")).focus();
        }
};

function current_cursor(para) {
    sessionStorage.setItem("KNJD429Form1_CurrentCursor", para);
}
...
/* Add by PP for CurrentCursor 2020-01-10 start */
    if (sessionStorage.getItem("KNJD429Form1_CurrentCursor") != null) {
                document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD429Form1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
