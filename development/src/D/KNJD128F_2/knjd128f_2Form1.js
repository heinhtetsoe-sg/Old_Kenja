function btn_submit(cmd) {
    ...
    if (cmd == 'reset') {
        ...
        var recordDiv = document.forms[0].RECORD_DIV.value; // 1:素点 2:評価
        ...
        var semename = recordDiv == '2' ? '' : document.forms[0].SEMENAME.value;
...
function calc(obj) {
    ...
    var recordDiv = document.forms[0].RECORD_DIV.value;
    var str = obj.value;
    var nam = obj.name;
    if (recordDiv == '2') {
        if ((str == '-') | (str == '=')) {
...
function showPaste(obj) {
    ...
    //テキストボックスの名前の配列を作る
    var nameArray = new Array('TST_SCORE', 'REMARK');
