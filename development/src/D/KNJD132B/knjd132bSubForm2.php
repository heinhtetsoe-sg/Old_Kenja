...
class knjd132bSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd132bindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd132bQuery::getCommittee($model);
        ...
        //更新先のテキストエリア
        knjCreateHidden($objForm, "COMMITTEE_REMARK", $model->committee_remark);
        ...
        View::toHTML($model, "knjd132bSubForm2.html", $arg);
    }
}
?>
