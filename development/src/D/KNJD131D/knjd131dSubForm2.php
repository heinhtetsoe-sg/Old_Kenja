...
//ビュー作成用クラス
class knjd131dSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $db = Query::dbCheckOut();
        $arg = array();
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjd131dindex.php", "", "subform2");
        ...
        //委員会リスト
        $query = knjd131dQuery::getCommittee($model);
        ...
        View::toHTML($model, "knjd131dSubForm2.html", $arg);
    }
}
?>
