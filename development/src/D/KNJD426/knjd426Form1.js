...
window.onload = function () {
    if (sessionStorage.getItem("KNJD426Form1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD426Form1_CurrentCursor")).focus();
    }
};

function current_cursor(para) {
    sessionStorage.setItem("KNJD426Form1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJD426Form1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJD426Form1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
...
function kubun(idx) {
    var Flg3 = true;
    for (var i = 1; i <= idx; i++) {
        var kubun = document.getElementById('CHK_PRINTBLOCK'+i);
        if (kubun.checked == true){
        	Flg3 = false;
        }
    }
    document.forms[0].btn_print.disabled = Flg3;
}