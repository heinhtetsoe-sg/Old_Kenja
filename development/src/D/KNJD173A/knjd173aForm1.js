...
function changeDisabled(obj) {
    if (obj.value == "1") {
        ...
        document.forms[0].OUTPUT5.disabled = false;
        document.forms[0].OUTPUT6.disabled = false;
    } else {
        document.forms[0].OUTPUT2.disabled = true;
        document.forms[0].OUTPUT3.disabled = true;
        document.forms[0].OUTPUT4.disabled = true;
        document.forms[0].OUTPUT5.disabled = true;
        document.forms[0].OUTPUT6.disabled = true;
    }
}
