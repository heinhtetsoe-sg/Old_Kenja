function btn_submit(cmd) {
    ...
    //出欠集計範囲の変更時は出力対象者一覧の生徒を保持
    if (cmd == 'changeDateDiv') {
        selectStudent = document.forms[0].selectStudent;
        selectStudent.value = "";

        sep = "";
        for (var i = 0; i < document.forms[0].CATEGORY_SELECTED.length; i++) {
            selectStudent.value = selectStudent.value + sep + document.forms[0].CATEGORY_SELECTED.options[i].value;
            sep = ",";
        }
    }
