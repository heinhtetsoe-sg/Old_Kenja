...
function newwin(SERVLET_URL){
	...
	else if ( (document.forms[0].STUD[1].checked == true) && (document.forms[0].NUMBER.value == "") )
	{
		alert('{rval MSG916}');
	}

	else if ( (document.forms[0].STUD[2].checked == true) && (document.forms[0].POINT.value == "") )
	{
		alert('{rval MSG916}');
	}
...
function ra_gakki(num1)
{
	...
	document.forms[0].GAKKI.disabled = flag1;
}
function ra_stud(num2)
{
	if(num2.value == 1)
	{
		flag2=true;
	...
	document.forms[0].NUMBER.disabled = flag2;
	document.forms[0].POINT.disabled = flag3;
}
