...
class knje020oSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knje020oindex.php", "", "subform1");
        ...
        //SQL文発行
        //年度（年次）取得
        $query = knje020oQuery::selectQueryAnnual($model);
        ...
        $query = knje020oQuery::selectQuerySubForm1($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje020oSubForm1.html", $arg);
    }
}
?>