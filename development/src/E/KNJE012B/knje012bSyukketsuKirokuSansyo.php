...
class knje012bSyukketsuKirokuSansyo
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform8", "POST", "knje012bindex.php", "", "subform8");
        ...
        if ($db->getOne(knje012bQuery::checkSchoolMst()) > 0) {
            $schoolcd    = sprintf("%012d", SCHOOLCD);
            $school_kind = $db->getOne(knje012bQuery::getSchoolKind2($model));
        }
        //学校マスタ情報
        ...
        //出欠の記録
        $sick = $late = $early = 0;
        $result = $db->query(knje012bQuery::getAttendSemesDat2($model, $knjSchoolMst));
        ...
        View::toHTML($model, "knje012bSyukketsuKirokuSansyo.html", $arg);
    }
}
