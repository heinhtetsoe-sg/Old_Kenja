...
class knje356Form1
{
    function main(&$model)
    {
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("list", "POST", "knje356index.php", "", "edit");
        ...
        View::toHTML($model, "knje356Form1.html", $arg);
    }
}
?>
