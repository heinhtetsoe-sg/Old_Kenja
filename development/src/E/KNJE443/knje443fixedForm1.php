...
class knje443fixedForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knje443fixedForm1", "POST", "knja110aindex.php", "", "knje443fixedForm1");
        ...
        View::toHTML($model, "knje443fixedForm1.html", $arg);
    }
}
