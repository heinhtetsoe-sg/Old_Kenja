...
//ビュー作成用クラス
class knje010eSubFormYorokuSanshou
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou", "POST", "knje010eindex.php", "", "formYorokuSanshou");
        ...
        if ($model->schoolName === 'bunkyo') {
            $query = knje010eQuery::selectQuery_Htrainremark_datTotal($model);
        ...
        View::toHTML($model, "knje010eSubFormYorokuSanshou.html", $arg);
    }
}