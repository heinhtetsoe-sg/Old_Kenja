...
class knje010eSubFormBikoTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("bikoTori", "POST", "knje010eindex.php", "", "bikoTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje010eQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje010eSubFormBikoTori.html", $arg);
    }
}
