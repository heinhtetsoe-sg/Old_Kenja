...
class knje010eSubFormSeiseki
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formSeiseki", "POST", "knje010eindex.php", "", "formSeiseki");
        ...
        $query = knje010eQuery::selectQueryForm3($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje010eSubFormSeiseki.html", $arg);
    }
}