...
class knje153Form1 {
    ...
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knje153Form1", "POST", "knje153index.php", "", "knje153Form1");
        ...
        //親画面なし
        $securityCnt = $db->getOne(knje153Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //学年コンボ
        $query = knje153Query::getGrade($model);
        $extra = "";
        ...
        //学校コード
        $model->schoolCd = $db->getOne(knje153Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE153");
        ...
        View::toHTML($model, "knje153Form1.html", $arg); 
    }
}
