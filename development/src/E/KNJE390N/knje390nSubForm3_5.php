...
class knje390nSubForm3_5
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform3_5", "POST", "knje390nindex.php", "", "subform3_5");
        ...
        if (isset($model->schregno) && !isset($model->warning)){
            $Row = $db->getRow(knje390nQuery::getSubQuery3CommunityGetData($model), DB_FETCHMODE_ASSOC);
        } else {
            $Row =& $model->field3;
        }
        ...
        View::toHTML($model, "knje390nSubForm3_5.html", $arg); 
    }
}
