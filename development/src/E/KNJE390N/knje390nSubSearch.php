...
class knje390nSubSearch
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subsearch", "POST", "knje390nindex.php", "", "subsearch");
        ...
        View::toHTML($model, "knje390nSubSearch.html", $arg); 
    }
}
...
function makeList(&$objForm, &$arg, $db, $model) {
    $i = 0;
    $query = knje390nQuery::getSearchWelfareService($model);
...
{
    //検索ボタン
    $extra = " onclick=\"return btn_submit('welfare_useservice_search')\"";
