...
class knje390nSubMaster
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("submaster", "POST", "knje390nindex.php", "", "submaster");
        ...
        View::toHTML($model, "knje390nSubMaster.html", $arg); 
    }
}
...
function makeList(&$objForm, &$arg, $db, $model) {
    $i = 0;
    $query = knje390nQuery::getMasterList($model);
