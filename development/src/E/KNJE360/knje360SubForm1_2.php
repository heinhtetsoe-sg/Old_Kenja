...
class knje360SubForm1_2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform1_2", "POST", "knje360index.php", "", "subform1_2");
        ...
        //学校情報
        $college1 = $db->getRow(knje360Query::getCollegeInfo($Row["SCHOOL_CD1"], $Row["FACULTYCD1"], $Row["DEPARTMENTCD1"]), DB_FETCHMODE_ASSOC);
        ...
        //学校情報
        $college2 = $db->getRow(knje360Query::getCollegeInfo($Row["SCHOOL_CD2"], $Row["FACULTYCD2"], $Row["DEPARTMENTCD2"]), DB_FETCHMODE_ASSOC);
        ...
        View::toHTML($model, "knje360SubForm1_2.html", $arg);
    }
}
...
function makeStudentList(&$objForm, &$arg, $db, $model)
{
    ...
    //対象者一覧取得
    $opt_left = array();
    $result = $db->query(knje360Query::getStudent($model, "left", $array));
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
