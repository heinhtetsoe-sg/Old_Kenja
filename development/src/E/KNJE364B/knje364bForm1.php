...
class knje364bForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knje364bindex.php", "", "main");
        ...
        $securityCnt = $db->getOne(knje364bQuery::getSecurityHigh());
        //セキュリティーチェック
        ...
        //進路種別
        $opt_course = $coursekind = array();
        $coursekind[1] = '1：進学';
        // $coursekind[2] = '2：就職';
        // $coursekind[3] = '3：その他（家事手伝い等）';
        // $coursekind[4] = '4：未定';
        foreach($coursekind as $value => $label){
            $opt_course[] = array('label' => $label, 'value' => $value);
        }
        $extra = "";
        ...
        //年度一覧コンボ
        $query = knje364bquery::getYearSeme();
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE364B");
        ...
        View::toHTML($model, "knje364bForm1.html", $arg);
    }
}
