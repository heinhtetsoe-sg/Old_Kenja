...
function btn_check_submit(datacnt) {
    ...
    if (parent.document.forms[0].WELFARE_SERVICE_CENTER_TEXT.value) {
        parent.document.forms[0].WELFARE_SERVICE_CENTER_TEXT.value += comma;
    }
    parent.document.forms[0].WELFARE_SERVICE_CENTER_TEXT.value += setText;
    parent.closeit();
}
