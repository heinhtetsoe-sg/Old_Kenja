...
class knje390mSubSearchAdviceCenter
{
    public function main(&$model)
    {
        ...
        //内容表示
        if ($model->cmd == "welfare_advice_center_search" && ($model->searchfield["AREACD"] != "" || $model->searchfield["NAME"] != "" || $model->searchfield["ADDR1"] != "" || $model->searchfield["ADDR2"] != "")) {
        ...
        View::toHTML($model, "knje390mSubSearchAdviceCenter.html", $arg);
    }
}
...
{
    $i = 0;
    $query = knje390mQuery::getSearchWelfareAdviceCenter($model);
...
{
    //検索ボタン
    $extra = " onclick=\"return btn_submit('welfare_advice_center_search')\"";
