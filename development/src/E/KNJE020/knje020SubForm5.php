...
class knje020SubForm5
{
    public function main(&$model)
    {
        ...
        $counter = 0;
        if ($model->schregno) {
            $result = $db->query(knje020Query::getAward($model));
        ...
        if (VARS::get("cmd") == "right_list") {
            $arg["reload"] = "parent.edit_frame.location.href='knje020index.php?cmd=edit'";
        }

        View::toHTML($model, "knje020SubForm5.html", $arg);
    }
}
