...
class knje020SubForm3
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform3", "POST", "knje020index.php", "", "subform3");
        ...
        //委員会リスト
        $counter = 0;
        $query = knje020Query::getCommittee($model);
        ...
        View::toHTML($model, "knje020SubForm3.html", $arg);
    }
}
