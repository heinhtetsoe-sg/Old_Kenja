...
class knje020SubForm2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knje020index.php", "", "subform2");
        ...
        //部活動リスト
        $counter = 0;
        $query = knje020Query::getClub($model);
        ...
        View::toHTML($model, "knje020SubForm2.html", $arg);
    }
}
