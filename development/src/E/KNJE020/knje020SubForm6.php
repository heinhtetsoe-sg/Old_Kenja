...
class knje020SubForm6
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform6", "POST", "knje020index.php", "", "subform6");
        ...
        //記録備考リスト
        $counter = 0;
        $query = knje020Query::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knje020SubForm6.html", $arg);
    }
}
