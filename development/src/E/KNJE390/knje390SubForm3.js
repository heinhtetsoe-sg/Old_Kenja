...
setTimeout(function () {
    window.onload = new function () {
       if (sessionStorage.getItem("KNJE390SubForm3_CurrentCursor") != null) {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJE390SubForm3_CurrentCursor")).focus();
            // remove item
            sessionStorage.removeItem('KNJE390SubForm3_CurrentCursor');
        } else {
            // start loading focus
...
function current_cursor(para) {
    sessionStorage.setItem("KNJE390SubForm3_CurrentCursor",para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJE390SubForm3_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJE390SubForm3_CurrentCursor")).blur();
    }
