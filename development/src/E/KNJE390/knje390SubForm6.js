...
window.onload = function () {
    if (sessionStorage.getItem("KNJE390SubForm6_CurrentCursor915") != null) {
        // textbox 915 error
        document.getElementsByName(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor915"))[0].focus();
        var value = document.getElementsByName(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor915"))[0].value;
        document.getElementsByName(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor915"))[0].value = "";
        document.getElementsByName(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor915"))[0].value = value;
        sessionStorage.removeItem("KNJE390SubForm6_CurrentCursor915");
    } else {
        sessionStorage.removeItem("KNJE390SubForm6_CurrentCursor915");
        if (sessionStorage.getItem("KNJE390SubForm6_CurrentCursor") != null) {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor")).focus();
            // remove item
...
function current_cursor(para) {
    sessionStorage.setItem("KNJE390SubForm6_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJE390SubForm6_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJE390SubForm6_CurrentCursor")).blur();
    }
