...
//ビュー作成用クラス
class knje011dSubFormBikouTori {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formBikouTori", "POST", "knje011dindex.php", "", "formBikouTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje011dQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje011dSubFormBikouTori.html", $arg);
    }
}
?>
