...
class knje011dSubFormTransfer
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formTransfer", "POST", "knje011dindex.php", "", "formTransfer");
        ...
        //異動情報リスト
        $counter = 0;
        $query = knje011dQuery::getSchregTransferDat($model);
        ...
        View::toHTML($model, "knje011dSubFormTransfer.html", $arg);
    }
}
