function btn_submit(cmd, arg) {
    ...
    var h_size;
    if (cmd == 'reload'){ //成績参照
        reloadIframe("knje011dindex.php?cmd=reload");
        ...
        if (document.forms[0].tyousasyo_shokenTable_Seq.value == "1") {
            var select_pattern = document.forms[0].HID_SELECT_PATTERN ? document.forms[0].HID_SELECT_PATTERN.value : "";
            loadwindow('knje011dindex.php?cmd=form2_first&SELECT_PATTERN='+select_pattern,0,document.documentElement.scrollTop || document.body.scrollTop,w_size,h_size);
        } else {
            loadwindow('knje011dindex.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,w_size,h_size);
        }
        return true;
    }else if (cmd == 'formSeiseki_first'){ //成績参照
        loadwindow('knje011dindex.php?cmd=formSeiseki_first',0,document.documentElement.scrollTop || document.body.scrollTop,600,540);
        return true;
    }else if (cmd == 'formYorokuSanshou_first'){ //指導要録参照
        loadwindow('knje011dindex.php?cmd=formYorokuSanshou_first',0,document.documentElement.scrollTop || document.body.scrollTop,710,290);
        return true;
    }else if (cmd == 'formYorokuSanshou2_first'){ //指導要録参照
        loadwindow('knje011dindex.php?cmd=formYorokuSanshou2_first',0,document.documentElement.scrollTop || document.body.scrollTop,730,430);
        return true;
    } else if (cmd == 'formYourokuIkkatsuTorikomi_first'){ //指導要録所見一括取込
        loadwindow('knje011dindex.php?cmd=formYourokuIkkatsuTorikomi_first',0,document.documentElement.scrollTop || document.body.scrollTop,900,500);
        return true;
