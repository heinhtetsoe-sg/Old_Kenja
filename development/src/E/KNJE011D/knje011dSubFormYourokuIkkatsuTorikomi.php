...
//ビュー作成用クラス
class knje011dSubFormYourokuIkkatsuTorikomi
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYourokuIkkatsuTorikomi", "POST", "knje011dindex.php", "", "formYourokuIkkatsuTorikomi");
        ...
        //対象学年
        $query = knje011dQuery::getGradeComb($model);
        ...
        View::toHTML($model, "knje011dSubFormYourokuIkkatsuTorikomi.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    ...
    $query = knje011dQuery::getSchList($model);
