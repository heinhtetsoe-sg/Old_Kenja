...
class knje075bForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knje075bForm1", "POST", "knje075bindex.php", "", "knje075bForm1");
        ...
        if ($model->select_data["selectdata"][0]) {
            for ($i = 0; $i < get_count($model->select_data["selectdata"]); $i++) {
                $query = knje075bQuery::getList2($model->select_data["selectdata"][$i], $model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE075B");
        ...
        View::toHTML($model, "knje075bForm1.html", $arg);
    }
}
