...
class knje391nForm1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knje391nForm1", "POST", "knje391nindex.php", "", "knje391nForm1");
        ...
        if ($model->Properties["useFi_Hrclass"] == "1" || $model->Properties["useSpecial_Support_Hrclass"] == "1") {
            ...
            if ($model->Properties["useFi_Hrclass"] == "1") {
                ...
                //$extra .= " onclick=\"return btn_submit('knje391n');\" id=\"GAKUNEN_KONGOU\"";
        ...
        $query = knje391nQuery::getAuth($model);
        $row1 = array();
        ...
        // Add by PP for current cursor 2020-01-10 start
        $extra = "id=\"GRADE_HR_CLASS\" onchange=\"current_cursor('GRADE_HR_CLASS'); return btn_submit('knje391n'),AllClearList();\"";
        // Add by PP for current cursor 2020-01-17 end
        ...
        View::toHTML($model, "knje391nForm1.html", $arg); 
    }
}
//生徒リストToリスト作成
function makeStudentList(&$objForm, &$arg, $db, $model) {
    $query = knje391nQuery::getStudentSql($model);
    $result = $db->query($query);
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJE391N");
    ...
    knjCreateHidden($objForm, "useFormNameE390N_A_1", $model->Properties["useFormNameE390N_A_1"]);
    knjCreateHidden($objForm, "useFormNameE390N_A_2", $model->Properties["useFormNameE390N_A_2"]);
    knjCreateHidden($objForm, "useFormNameE390N_B_1", $model->Properties["useFormNameE390N_B_1"]);
    knjCreateHidden($objForm, "useFormNameE390N_D_1", $model->Properties["useFormNameE390N_D_1"]);}
