...
window.onload = new function () {
    setTimeout(function () {
        if (sessionStorage.getItem("KNJE391NForm1_CurrentCursor") != null) {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJE391NForm1_CurrentCursor")).focus();
        }
    }, 30);
};

function current_cursor(para) {
    sessionStorage.setItem("KNJE391NForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    /* Add by PP for CurrentCursor 2020-01-10 start */
    if (sessionStorage.getItem("KNJE391NForm1_CurrentCursor") != null) {
        document.getElementById(sessionStorage.getItem("KNJE391NForm1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
