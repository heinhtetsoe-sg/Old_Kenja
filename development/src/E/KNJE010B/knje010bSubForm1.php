...
//ビュー作成用クラス
class knje010bSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form3", "POST", "knje010bindex.php", "", "form3");
        ...
        $query = knje010bQuery::selectQueryForm3($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje010bSubForm1.html", $arg);
    }
}
?>