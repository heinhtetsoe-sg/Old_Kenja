...
class knje010bHyosyoForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("HyosyoForm1", "POST", "knje010bindex.php", "", "HyosyoForm1");
        ...
        if ($model->schregno) {
            ...
            $result = $db->query(knje010bQuery::getHyosyo($model, $detail_div, $namecd1));
        ...
        //取込ボタン
        $target = VARS::get("target").'-'.VARS::get("YEAR");
        ...
        View::toHTML($model, "knje010bHyosyoForm1.html", $arg);
    }
}
?>
