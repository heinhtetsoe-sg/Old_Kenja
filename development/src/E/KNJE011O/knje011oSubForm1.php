...
//ビュー作成用クラス
class knje011oSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form3", "POST", "knje011oindex.php", "", "form3");
        ...
        $query = knje011oQuery::selectQueryForm3($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje011oSubForm1.html", $arg);
    }
}
?>