...
class knje434fixedForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knje434fixedForm1", "POST", "knja110aindex.php", "", "knje434fixedForm1");
        ...
        View::toHTML($model, "knje434fixedForm1.html", $arg);
    }
}
