...
class knje441Form1 {
    function main(&$model) {
        ...
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("edit", "POST", "knje441index.php", "", "edit");
        ...
        $query = knje441Query::getHdat($model);
        ...
        //A023
        $model->a023 = array();
        $query = knje441Query::getA023($model);
        ...
        //報告済み日付
        $query = knje441Query::getReport($model);
        $setExeDate = "";
        $result = $db->query($query);
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
        ...
        $arg["data"]["TR_DATE"] = View::popUpCalendarAlp($objForm, "TR_DATE", $Row["IDOU_DATE"], "", "");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE441");
        ...
        View::toHTML($model, "knje441Form1.html", $arg); 
    }
}
