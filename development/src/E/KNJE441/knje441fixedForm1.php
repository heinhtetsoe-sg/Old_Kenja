...
class knje441fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knje441fixedForm1", "POST", "knja110aindex.php", "", "knje441fixedForm1");
        ...
        View::toHTML($model, "knje441fixedForm1.html", $arg);
    }
}
