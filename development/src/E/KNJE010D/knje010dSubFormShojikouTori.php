...
//ビュー作成用クラス
class knje010dSubFormShojikouTori {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formShojikouTori", "POST", "knje010dindex.php", "", "formShojikouTori");
        ...
        foreach ($item as $target => $row) {
            ...
            $name = "REMARK".$n;
            $query = knje010dQuery::getHexamEntremarkTrainrefDat($model, $model->targetYear, $item[$target]["TRAIN_SEQ"]);
        ...
        View::toHTML($model, "knje010dSubFormShojikouTori.html", $arg);
    }
}
?>
