...
class knje010dSubFormBikoTori {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("bikoTori", "POST", "knje010dindex.php", "", "bikoTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje010dQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje010dSubFormBikoTori.html", $arg);
    }
}
?>
