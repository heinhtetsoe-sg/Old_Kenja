...
//ビュー作成用クラス
class knje010dSubFormYorokuSanshou {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou", "POST", "knje010dindex.php", "", "formYorokuSanshou");
        ...
        if ($model->schoolName === 'bunkyo') {
            $query = knje010dQuery::selectQuery_Htrainremark_datTotal($model);
        ...
        View::toHTML($model, "knje010dSubFormYorokuSanshou.html", $arg);
    }
}
?>