...
class knje010SubForm3
{
    function main(&$model)
    {
        $objForm        = new form;
        $arg["start"]   = $objForm->get_start("sel", "POST", "knje010index.php", "", "sel");
        $arg["jscript"] = "";
        $db = Query::dbCheckOut();
        ...
        $result = $db->query(knje010Query::GetStudent($model));
        ...
        //年組名
        $hr_name = $db->getOne(knje010Query::getHR_Name($model));
        ...
        //戻るボタン
        $link = REQUESTROOT."/E/KNJE010/knje010index.php?cmd=back&ini2=1";
        $objForm->ae( array("type"        => "button",
                            "name"        => "btn_back",
                            "value"       => "戻 る",
        ...
        View::toHTML($model, "knje010SubForm3.html", $arg);
    }
}
?>
