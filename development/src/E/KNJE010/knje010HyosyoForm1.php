...
class knje010HyosyoForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("HyosyoForm1", "POST", "knje010index.php", "", "HyosyoForm1");
        ...
        if ($model->schregno) {
            ...
            $result = $db->query(knje010Query::getHyosyo($model, $detail_div, $namecd1));
        ...
        View::toHTML($model, "knje010HyosyoForm1.html", $arg);
    }
}
?>
