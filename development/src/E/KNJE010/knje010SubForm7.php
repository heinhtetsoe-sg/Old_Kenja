...
class knje010SubForm7 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform7", "POST", "knje010index.php", "", "subform7");
        ...
        //記録備考リスト
        $query = knje010Query::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knje010SubForm7.html", $arg);
    }
}
?>
