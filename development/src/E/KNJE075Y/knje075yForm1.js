...
function move1(side){
    ...
    for (var i = 0; i < attribute2.length; i++) {
        ...
        tempaa[y] = String(attribute2.options[i].text).substr(temp1[y].length+1,8)+","+y;
    }
    ...
    for (var i = 0; i < attribute1.length; i++) {
        if ( attribute1.options[i].selected ) {
            ...
            tempaa[y] = String(attribute1.options[i].text).substr(temp1[y].length+1,8)+","+y;
        } else {
            y=current2++
...
function moves(sides){
    ...
    for (var i = 0; i < attribute6.length; i++) {
        ...
        tempaa[z] = String(attribute6.options[i].text).substr(temp5[z].length+1,8)+","+z;
    }
    ...
    for (var i = 0; i < attribute5.length; i++) {
        ...
        tempaa[z] = String(attribute5.options[i].text).substr(temp5[z].length+1,8)+","+z;
    }
