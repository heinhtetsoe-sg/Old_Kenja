...
//ビュー作成用クラス
class knje011SubForm2 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form4", "POST", "knje011index.php", "", "form4");
        ...
        $query = knje011Query::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje011SubForm2.html", $arg);
    }
}
?>