...
class knje011SubForm3
{
    function main(&$model)
    {
        $objForm        = new form;
        $arg["start"]   = $objForm->get_start("sel", "POST", "knje011index.php", "", "sel");
        $arg["jscript"] = "";
        $db = Query::dbCheckOut();
        ...
        $result = $db->query(knje011Query::GetStudent($model));
        ...
        //年組名
        $hr_name = $db->getOne(knje011Query::getHR_Name($model));
        ...
        //戻るボタン
        $link = REQUESTROOT."/E/KNJE011/knje011index.php?cmd=back&ini2=1";
        $objForm->ae( array("type"        => "button",
                            "name"        => "btn_back",
                            "value"       => "戻 る",
        ...
        View::toHTML($model, "knje011SubForm3.html", $arg);
    }
}
?>
