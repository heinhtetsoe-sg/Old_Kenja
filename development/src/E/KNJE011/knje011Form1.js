function btn_submit(cmd) {
    ...
    if (cmd == 'reload'){ //成績参照
        reloadIframe("knje011index.php?cmd=reload");
        ...
        if (document.forms[0].useSyojikou3.value == "1") {
            ...
            h_size = (h > 680) ? 680 : h;
            loadwindow('knje011index.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,w_size,h_size);
        } else if (document.forms[0].tyousasyoTokuBetuFieldSize.value == "1") {
            loadwindow('knje011index.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,780,650);
        } else {
            loadwindow('knje011index.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,670,500);
        }
        return true;
    }else if (cmd == 'form3_first'){ //成績参照
        loadwindow('knje011index.php?cmd=form3_first',0,document.documentElement.scrollTop || document.body.scrollTop,600,540);
        return true;
    }else if (cmd == 'form4_first'){ //指導要録参照
        loadwindow('knje011index.php?cmd=form4_first',0,document.documentElement.scrollTop || document.body.scrollTop,710,290);
        return true;
    }else if (cmd == 'form6_first'){ //指導要録参照
        loadwindow('knje011index.php?cmd=form6_first',0,document.documentElement.scrollTop || document.body.scrollTop,730,430);
        return true;
