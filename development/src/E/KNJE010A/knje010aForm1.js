function btn_submit(cmd) {
    ...
    if (cmd == 'reload'){ //成績参照
        reloadIframe("knje010aindex.php?cmd=reload");
        ...
        loadwindow('knje010aindex.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,w_size,h_size);
        return true;
    }else if (cmd == 'form3_first'){ //成績参照
        loadwindow('knje010aindex.php?cmd=form3_first',0,document.documentElement.scrollTop || document.body.scrollTop,600,540);
        return true;
    }else if (cmd == 'form4_first'){ //指導要録参照
        loadwindow('knje010aindex.php?cmd=form4_first',0,document.documentElement.scrollTop || document.body.scrollTop,710,290);
        return true;
    } else if (cmd == 'form6_first'){ //指導要録参照
        loadwindow('knje010aindex.php?cmd=form6_first',0,document.documentElement.scrollTop || document.body.scrollTop,730,430);
        return true;
