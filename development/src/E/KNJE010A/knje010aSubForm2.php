...
//ビュー作成用クラス
class knje010aSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form4", "POST", "knje010aindex.php", "", "form4");
        ...
        $query = knje010aQuery::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje010aSubForm2.html", $arg);
    }
}
?>