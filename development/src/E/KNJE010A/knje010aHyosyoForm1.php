...
class knje010aHyosyoForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("HyosyoForm1", "POST", "knje010aindex.php", "", "HyosyoForm1");
        ...
        if ($model->schregno) {
            //常盤木は活動の記録を出力
            if ($model->getSchoolName == "tokiwagi") {
                $detail_div = "4";
                $namecd1    = "H317";
            } else {
                $detail_div = "1";
            ...
            $result = $db->query(knje010aQuery::getHyosyo($model, $detail_div, $namecd1));
        ...
        View::toHTML($model, "knje010aHyosyoForm1.html", $arg);
    }
}
?>
