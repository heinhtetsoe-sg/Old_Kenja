...
class knje010aSubForm7 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform7", "POST", "knje010aindex.php", "", "subform7");
        ...
        //記録備考リスト
        $query = knje010aQuery::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knje010aSubForm7.html", $arg);
    }
}
?>
