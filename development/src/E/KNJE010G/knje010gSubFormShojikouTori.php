...
//ビュー作成用クラス
class knje010gSubFormShojikouTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formShojikouTori", "POST", "knje010gindex.php", "", "formShojikouTori");
        ...
        foreach ($item as $target => $row) {
            ...
            $name = "REMARK".$n;
            $query = knje010gQuery::getHexamEntremarkTrainrefDat($model, $model->targetYear, $item[$target]["TRAIN_SEQ"]);
        ...
        View::toHTML($model, "knje010gSubFormShojikouTori.html", $arg);
    }
}
