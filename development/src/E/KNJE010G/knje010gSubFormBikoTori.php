...
class knje010gSubFormBikoTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("bikoTori", "POST", "knje010gindex.php", "", "bikoTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje010gQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje010gSubFormBikoTori.html", $arg);
    }
}
