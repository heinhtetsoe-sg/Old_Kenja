...
//ビュー作成用クラス
class knje010gSubFormYorokuSanshou2
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou2", "POST", "knje010gindex.php", "", "formYorokuSanshou2");
        ...
        $opt = array();
        $disabled = "disabled";
        $query = knje010gQuery::selectQueryAnnual_HTRAINREMARK_DAT($model);
        ...
        //指導要録所見（総合的な学習の時間）取得
        $query = knje010gQuery::selectQuery_Htrainremark_dat2($model);
        ...
        View::toHTML($model, "knje010gSubFormYorokuSanshou2.html", $arg);
    }
}
