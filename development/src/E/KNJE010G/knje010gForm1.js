function btn_submit(cmd, arg) {
    ...
    if (cmd == 'reload'){               //成績参照
//        reloadIframe("knje010gindex.php?cmd=reload");
//        for (var i = 0; i < document.forms[0]["CHECK\[\]"].length; i++){
//            document.forms[0]["CHECK\[\]"][i].checked = false;
//        }
        return true;
    } else if (cmd == 'formSeiseki_first'){   //成績参照
        loadwindow('knje010gindex.php?cmd=formSeiseki_first',0,document.documentElement.scrollTop || document.body.scrollTop,600,540);
        return true;
    } else if (cmd == 'formYorokuSanshou_first'){   //指導要録参照
        loadwindow('knje010gindex.php?cmd=formYorokuSanshou_first',0,document.documentElement.scrollTop || document.body.scrollTop,710,290);
        return true;
    } else if (cmd == 'formYorokuSanshou2_first'){   //指導要録参照
        loadwindow('knje010gindex.php?cmd=formYorokuSanshou2_first',0,document.documentElement.scrollTop || document.body.scrollTop,730,430);
        return true;
