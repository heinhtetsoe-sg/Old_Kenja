...
class knje010gSubFormSeiseki
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formSeiseki", "POST", "knje010gindex.php", "", "formSeiseki");
        ...
        $query = knje010gQuery::selectQueryForm3($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje010gSubFormSeiseki.html", $arg);
    }
}