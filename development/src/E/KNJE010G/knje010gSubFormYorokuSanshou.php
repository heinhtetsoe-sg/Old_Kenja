...
//ビュー作成用クラス
class knje010gSubFormYorokuSanshou
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou", "POST", "knje010gindex.php", "", "formYorokuSanshou");
        ...
        if ($model->schoolName === 'bunkyo') {
            $query = knje010gQuery::selectQuery_Htrainremark_datTotal($model);
        ...
        View::toHTML($model, "knje010gSubFormYorokuSanshou.html", $arg);
    }
}