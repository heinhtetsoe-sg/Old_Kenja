...
class knje373Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knje373Form1", "POST", "knje373index.php", "", "knje373Form1");
        ...
        //クラス一覧リスト作成する
        $query = knje373Query::getAuth($model);
        ...
        View::toHTML($model, "knje373Form1.html", $arg); 
    }
}
/****************************************************** 以下関数 ************************************************************/
//コンボ作成
