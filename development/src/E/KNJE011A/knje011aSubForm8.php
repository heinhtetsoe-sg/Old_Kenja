...
class knje011aSubForm8 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("form8", "POST", "knje011aindex.php", "", "form8");
        ...
        //テキストボックス
        $years = array();
        $query = knje011aQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje011aSubForm8.html", $arg);
    }
}
?>
