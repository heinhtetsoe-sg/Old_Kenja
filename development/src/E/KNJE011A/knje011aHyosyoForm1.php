...
class knje011aHyosyoForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("HyosyoForm1", "POST", "knje011aindex.php", "", "HyosyoForm1");
        ...
        if ($model->schregno) {
            ...
            $result = $db->query(knje011aQuery::getHyosyo($model, $detail_div, $namecd1));
        ...
        View::toHTML($model, "knje011aHyosyoForm1.html", $arg);
    }
}
?>
