...
class knje011aSubForm7 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("form7", "POST", "knje011aindex.php", "", "form7");
        ...
        //テキストボックス
        $query = knje011aQuery::getHexamEntremarkTrainrefDat($model, $model->annual["YEAR"], $item[$model->target]["TRAIN_SEQ"]);
        ...
        View::toHTML($model, "knje011aSubForm7.html", $arg);
    }
}
?>
