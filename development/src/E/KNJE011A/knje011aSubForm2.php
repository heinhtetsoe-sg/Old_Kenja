...
//ビュー作成用クラス
class knje011aSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form4", "POST", "knje011aindex.php", "", "form4");
        ...
        $query = knje011aQuery::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje011aSubForm2.html", $arg);
    }
}
?>