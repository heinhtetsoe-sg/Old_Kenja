function btn_submit(cmd, arg) {
    ...
    var h_size;
    if (cmd == 'reload'){ //成績参照
        reloadIframe("knje011gindex.php?cmd=reload");
        ...
        loadwindow('knje011gindex.php?cmd=form2_first',0,document.documentElement.scrollTop || document.body.scrollTop,w_size,h_size);
        return true;
    }else if (cmd == 'formSeiseki_first'){ //成績参照
        loadwindow('knje011gindex.php?cmd=formSeiseki_first',0,document.documentElement.scrollTop || document.body.scrollTop,600,540);
        return true;
    }else if (cmd == 'formYorokuSanshou_first'){ //指導要録参照
        loadwindow('knje011gindex.php?cmd=formYorokuSanshou_first',0,document.documentElement.scrollTop || document.body.scrollTop,710,290);
        return true;
    }else if (cmd == 'formYorokuSanshou2_first'){ //指導要録参照
        loadwindow('knje011gindex.php?cmd=formYorokuSanshou2_first',0,document.documentElement.scrollTop || document.body.scrollTop,730,430);
        return true;
