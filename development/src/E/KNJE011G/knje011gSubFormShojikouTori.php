...
//ビュー作成用クラス
class knje011gSubFormShojikouTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formShojikouTori", "POST", "knje011gindex.php", "", "formShojikouTori");
        ...
        foreach ($item as $target => $row) {
            ...
            $name = "REMARK".$n;
            $query = knje011gQuery::getHexamEntremarkTrainrefDat($model, $model->annual["YEAR"], $item[$target]["TRAIN_SEQ"]);
        ...
        View::toHTML($model, "knje011gSubFormShojikouTori.html", $arg);
    }
}
