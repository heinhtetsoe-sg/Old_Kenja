...
class knje011gSubFormSeiseki
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formSeiseki", "POST", "knje011gindex.php", "", "formSeiseki");
        ...
        //中高一貫校
        $JH = (count($db->getOne(knje011gQuery::getSchoolName('JH'))) > 0) ? "1" : "";
        ...
        $query = knje011gQuery::selectQueryAnnual($model, $JH);
        ...
        $query = knje011gQuery::selectQueryForm3($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje011gSubFormSeiseki.html", $arg);
    }
}
