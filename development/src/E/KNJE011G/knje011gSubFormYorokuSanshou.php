...
//ビュー作成用クラス
class knje011gSubFormYorokuSanshou
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou", "POST", "knje011gindex.php", "", "formYorokuSanshou");
        ...
        $query = knje011gQuery::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje011gSubFormYorokuSanshou.html", $arg);
    }
}
