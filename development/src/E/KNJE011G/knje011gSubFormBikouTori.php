...
//ビュー作成用クラス
class knje011gSubFormBikouTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formBikouTori", "POST", "knje011gindex.php", "", "formBikouTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje011gQuery::getHexamEntremarkLearningDat($model);
        ...
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            $row['REMARK'] = KnjCreateTextArea($objForm, 'REMARK', ($gyou + 1), ($moji * 2 + 1), 'soft', $extra, $row["REMARK"]);
        ...
        View::toHTML($model, "knje011gSubFormBikouTori.html", $arg);
    }
}
