    ...
    function selectRow() {
        ...
        if (chk.length){
            parent.bottom_frame.location.href = "knje063pindex.php?cmd=edit&CHECKED="+chk[selectedRow].value;
        }else if (chk){
            parent.bottom_frame.location.href = "knje063pindex.php?cmd=edit&CHECKED="+chk.value;
        }
    }
