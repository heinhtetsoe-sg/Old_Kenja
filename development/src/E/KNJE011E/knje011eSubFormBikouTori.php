...
//ビュー作成用クラス
class knje011eSubFormBikouTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formBikouTori", "POST", "knje011eindex.php", "", "formBikouTori");
        ...
        //テキストボックス
        $years = array();
        $query = knje011eQuery::getHexamEntremarkLearningDat($model);
        ...
        View::toHTML($model, "knje011eSubFormBikouTori.html", $arg);
    }
}
