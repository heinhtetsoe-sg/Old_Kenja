...
//ビュー作成用クラス
class knje011eSubFormShojikouTori
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("formShojikouTori", "POST", "knje011eindex.php", "", "formShojikouTori");
        ...
        foreach ($item as $target => $row) {
            ...
            $name = "REMARK".$n;
            $query = knje011eQuery::getHexamEntremarkTrainrefDat($model, $model->annual["YEAR"], $item[$target]["TRAIN_SEQ"]);
        ...
        View::toHTML($model, "knje011eSubFormShojikouTori.html", $arg);
    }
}
