...
//ビュー作成用クラス
class knje011eSubFormYorokuSanshou
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formYorokuSanshou", "POST", "knje011eindex.php", "", "formYorokuSanshou");
        ...
        $query = knje011eQuery::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje011eSubFormYorokuSanshou.html", $arg);
    }
}
