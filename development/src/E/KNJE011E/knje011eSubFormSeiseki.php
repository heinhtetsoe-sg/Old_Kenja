...
class knje011eSubFormSeiseki
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("formSeiseki", "POST", "knje011eindex.php", "", "formSeiseki");
        ...
        //中高一貫校
        $JH = (count($db->getOne(knje011eQuery::getSchoolName('JH'))) > 0) ? "1" : "";
        ...
        $query = knje011eQuery::selectQueryAnnual($model, $JH);
        ...
        $query = knje011eQuery::selectQueryForm3($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje011eSubFormSeiseki.html", $arg);
    }
}
