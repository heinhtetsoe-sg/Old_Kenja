...
class knje360bSubForm6_2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform6_2", "POST", "knje360bindex.php", "", "subform6_2");
        ...
        View::toHTML($model, "knje360bSubForm6_2.html", $arg);
    }
}
