...
class knje360bSubForm1_2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform1_2", "POST", "knje360bindex.php", "", "subform1_2");
        ...
        //学校情報
        $college1 = $db->getRow(knje360bQuery::getCollegeInfo($Row["SCHOOL_CD1"], $Row["FACULTYCD1"], $Row["DEPARTMENTCD1"]), DB_FETCHMODE_ASSOC);

        //学校コード
        $arg["data"]["SCHOOL_CD1"]      = $college1["SCHOOL_CD"];
        ...
        //学科名
        $arg["data"]["DEPARTMENTNAME1"] = $college1["DEPARTMENTNAME"];
        ...
        //学校情報
        $college2 = $db->getRow(knje360bQuery::getCollegeInfo($Row["SCHOOL_CD2"], $Row["FACULTYCD2"], $Row["DEPARTMENTCD2"]), DB_FETCHMODE_ASSOC);

        //学校コード
        $arg["data"]["SCHOOL_CD2"]      = $college2["SCHOOL_CD"];
        ...
        //学科名
        $arg["data"]["DEPARTMENTNAME2"] = $college2["DEPARTMENTNAME"];
        ...
        View::toHTML($model, "knje360bSubForm1_2.html", $arg);
    }
}
...
function makeStudentList(&$objForm, &$arg, $db, $model)
{
    ...
    $extra = "onchange=\"return btn_submit('replace1B');\"";
