...
class knje364Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knje364index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knje364Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボ
        $query = knje364query::getYearSeme();
        ...
        //調査名
        $query = knje364query::getQuestionnaireList($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE364");
        ...
        View::toHTML($model, "knje364Form1.html", $arg);
    }
}
