...
//ビュー作成用クラス
class knje010cSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form3", "POST", "knje010cindex.php", "", "form3");
        ...
        //中高一貫校
        $JH = (get_count($db->getOne(knje010cQuery::getSchoolName('JH'))) > 0) ? "1" : "";
        ...
        $query = knje010cQuery::selectQueryAnnual($model, $JH);
        ...
        $query = knje010cQuery::selectQueryForm3($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knje010cSubForm1.html", $arg);
    }
}
?>