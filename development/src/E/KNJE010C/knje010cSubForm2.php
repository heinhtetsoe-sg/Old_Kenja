...
//ビュー作成用クラス
class knje010cSubForm2 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("form4", "POST", "knje010cindex.php", "", "form4");
        ...
        $query = knje010cQuery::selectQuery_Htrainremark_Hdat($model);
        ...
        View::toHTML($model, "knje010cSubForm2.html", $arg);
    }
}
?>