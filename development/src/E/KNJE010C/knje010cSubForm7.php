...
class knje010cSubForm7 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform7", "POST", "knje010cindex.php", "", "subform7");
        ...
        //記録備考リスト
        $query = knje010cQuery::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knje010cSubForm7.html", $arg);
    }
}
?>
