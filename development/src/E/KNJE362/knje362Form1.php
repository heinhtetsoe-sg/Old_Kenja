...
class knje362Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knje362index.php", "", "main");

        //権限チェック（更新可、更新可・制限付以外は画面を閉じる）
        ...
        $securityCnt = $db->getOne(knje362Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボ
        $query = knje362query::getYearSeme($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE362");
        ...
        View::toHTML($model, "knje362Form1.html", $arg);
    }
}
