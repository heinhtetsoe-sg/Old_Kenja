...
class knje372Form1
{
    function main(&$model){
        ...
        //対象ラジオ 1:合格 2:最終進路 3:進路調査（在籍者のみ）
        $model->field["OUT_DIV"] = $model->field["OUT_DIV"] ? $model->field["OUT_DIV"] : '1';
        $opt_outdiv = array(1, 2, 3);
        $extra = array("id=\"OUT_DIV1\" onclick =\" return btn_submit('knje372');\"", "id=\"OUT_DIV2\" onclick =\" return btn_submit('knje372');\"", "id=\"OUT_DIV3\" onclick =\" return btn_submit('knje372');\"");
