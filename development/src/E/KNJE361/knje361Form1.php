...
class knje361Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knje361index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knje361Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボ
        $query = knje361query::getYearSeme();
        ...
        knjCreateHidden($objForm, "PRGID", "KNJE361");
        ...
        View::toHTML($model, "knje361Form1.html", $arg);
    }
}
