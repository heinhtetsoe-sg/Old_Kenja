...
window.onload = new function () {
    if (sessionStorage.getItem("KNJE460ZirituForm1_CurrentCursor") != null) {
            document.title = "";
            document.getElementById(sessionStorage.getItem("KNJE460ZirituForm1_CurrentCursor")).focus();
            // remove item
            sessionStorage.removeItem('KNJE460ZirituForm1_CurrentCursor');  
        } else {
            // start loading focus
...
function current_cursor(para) {
    sessionStorage.setItem("KNJE460ZirituForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    if (sessionStorage.getItem("KNJE460ZirituForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJE460ZirituForm1_CurrentCursor")).blur();
    }
