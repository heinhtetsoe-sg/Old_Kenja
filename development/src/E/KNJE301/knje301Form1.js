...
function doSubmit() {
    ...
    for (var i = 0; i < document.forms[0].finschoolyear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].finschoolyear.options[i].value;
        sep = ",";
    }
...
function set_selectdata_del(){
    var sep = '';
    var ret = '';
    for(var i=0;i<document.forms[0].finschoolyear.options.length;i++){
        if(document.forms[0].finschoolyear.options[i].selected){
            ret += sep + document.forms[0].finschoolyear.options[i].value;
            sep = ',';
        }
    }
    document.forms[0].selectdata_del.value=ret;
}