...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].WRITE_DIV2.checked && document.forms[0].ENT_DATE.value == '') {
        alert('日付を入力して下さい。');
        return;
    }
...
/*
function keisenselect(num){
    if(num.value == 1)
    {
        document.forms[0].KEISEN.disabled = false;
    }
    else
    {
        document.forms[0].KEISEN.selectedIndex = 0;
        document.forms[0].KEISEN.disabled = true;
    }
}
*/
...
function kubun() {
    var ismajor;
    if (document.forms[0].MAJOR_ORDER) {
        ismajor = document.forms[0].CLASS_MAJOR[1].checked;
        document.forms[0].MAJOR_ORDER[0].disabled = !ismajor;
        document.forms[0].MAJOR_ORDER[1].disabled = !ismajor;
    }
}
