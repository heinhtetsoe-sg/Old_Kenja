...
function move1(side, div)
{
    ...
    var schGroup = document.forms[0].schItemList.value.split(',');
    ...
    for (var i = 0; i < attribute2.length; i++) {
        ...
        if (div == 'l') {
            ...
            if (side == "left" && div == "r") {
                ...
                flg = false;
                for (var j = 0; j < schGroup.length; j++) {
                    if (val[1] == schGroup[j]) {
                        flg = true;
                        break;
                    }
                ...
                if (flg == true) {
                    schArray.push(attribute2.options[i].value+","+y);
                } else {
                    recArray.push(attribute2.options[i].value+","+y);
                }
            } else {
        ...
        if ( attribute1.options[i].selected )
        {
            ...
            if (div == 'l') {
                ...
                if (side == "left" && div == "r") {
                    ...
                    if (flg == true) {
                        schArray.push(attribute1.options[i].value+","+y);
                    } else {
                        recArray.push(attribute1.options[i].value+","+y);
                    }
                } else {
    ...
    if (side == "left" && div == "r") {
        tempaa = schArray.concat(recArray);
    } else {
        tempaa.sort();
    }
    ...
    for (var i = 0; i < attribute6.length; i++) {
        ...
        if (div == 'l') {
            ...
            if (sides == "left" && div == "r") {
                ...
                if (flg == true) {
                    schArray.push(attribute6.options[i].value+","+z);
                } else {
                    recArray.push(attribute6.options[i].value+","+z);
                }
            } else {
    ...
    for (var i = 0; i < attribute5.length; i++) {
        ...
        if (div == 'l') {
            ...
            if (sides == "left" && div == "r") {
                ...
                if (flg == true) {
                    schArray.push(attribute5.options[i].value+","+z);
                } else {
                    recArray.push(attribute5.options[i].value+","+z);
                }
            } else {
