...
2018/07/03  1.プロパティーseitoSidoYorokuTotalStudyCombineHtrainremarkDat='1'の場合、総合的な学習の時間の活動内容と評価はHTRAINREMARK_DATから出力する

2018/09/11  1.学習記録データは仮評定設定分を出力対象から除く
