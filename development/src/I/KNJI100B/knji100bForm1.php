...
class knji100bForm1
{
    function main(&$model)
    {
        ...
        $arg["start"] = $objForm->get_start("edit", "POST", "knji100bindex.php", "", "edit");

        //DB接続
        $db = Query::dbCheckOut();

        $securityCnt = $db->getOne(knji100bQuery::getSecurityHigh());
        //セキュリティーチェック
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knji100bQuery::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJI100B");
        ...
        View::toHTML($model, "knji100bForm1.html", $arg);
    }
}
?>