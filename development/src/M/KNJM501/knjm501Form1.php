...
class knjm501Form1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm501Form1", "POST", "knjm501index.php", "", "knjm501Form1");
        ...
        //クラス選択コンボボックスを作成する
        $query = knjm501Query::getAuth(CTRL_YEAR, CTRL_SEMESTER);
        ...
        $query = knjm501Query::getSchreg($model);
        ...
        View::toHTML($model, "knjm501Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, &$arg, $model) {
    ...
    $arg["TOP"]["PRGID"] = knjCreateHidden($objForm, "PRGID", "KNJM501");
