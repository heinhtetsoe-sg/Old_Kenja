...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].CATEGORY_YEAR.length == 0 && document.forms[0].CATEGORY_MASTER.length == 0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].CATEGORY_YEAR.length; i++) {
        attribute3.value = attribute3.value + sep + document.forms[0].CATEGORY_YEAR.options[i].value;
        sep = ",";
    }
...
function temp_clear() {
    ClearList(document.forms[0].CATEGORY_YEAR,document.forms[0].CATEGORY_YEAR);
    ClearList(document.forms[0].CATEGORY_MASTER,document.forms[0].CATEGORY_MASTER);
}
