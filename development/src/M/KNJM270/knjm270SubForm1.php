...
class knjm270SubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm270SubForm1", "POST", "knjm270index.php", "", "knjm270SubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm270Query::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm270Query::getsubName());
        ...
        View::toHTML($model, "knjm270SubForm1.html", $arg);
    }
}
?>
