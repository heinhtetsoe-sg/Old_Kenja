...
class knjm273wSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm273wSubForm1", "POST", "knjm273windex.php", "", "knjm273wSubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm273wQuery::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm273wQuery::getsubName());
        ...
        View::toHTML($model, "knjm273wSubForm1.html", $arg);
    }
}
?>
