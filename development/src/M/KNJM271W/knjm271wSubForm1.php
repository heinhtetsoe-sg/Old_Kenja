...
class knjm271wSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm271wSubForm1", "POST", "knjm271windex.php", "", "knjm271wSubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm271wQuery::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm271wQuery::getsubName());
        ...
        View::toHTML($model, "knjm271wSubForm1.html", $arg);
    }
}
?>
