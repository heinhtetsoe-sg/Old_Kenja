...
class knjm390mSubForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjm390mSubForm1", "POST", "knjm390mindex.php", "", "knjm390mSubForm1");
        ...
        //データ取得
        $result = $db->query(knjm390mQuery::getsubremark($model));
        ...
        View::toHTML($model, "knjm390mSubForm1.html", $arg);
    }
}
?>
