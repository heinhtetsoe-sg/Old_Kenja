...
class knjm270sSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm270sSubForm1", "POST", "knjm270sindex.php", "", "knjm270sSubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm270sQuery::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm270sQuery::getsubName());
        ...
        View::toHTML($model, "knjm270sSubForm1.html", $arg);
    }
}
?>
