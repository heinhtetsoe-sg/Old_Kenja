...
class knjmp968Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjmp968Form1", "POST", "knjmp968index.php", "", "knjmp968Form1");
        ...
        View::toHTML($model, "knjmp968Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJMP968");
