...
class knjm437dForm1
{
    function main(&$model){
        ...
        //フォーム作成/////////////////////////////////////////////////////////////////////////////////////////////
        $arg["start"]   = $objForm->get_start("knjm437dForm1", "POST", "knjm437dindex.php", "", "knjm437dForm1");
        ...
        */
        ...
        //クラス選択コンボボックスを作成する///////////////////////////////////////////////////////////////////////////////
        $db = Query::dbCheckOut();
        $query = knjm437dQuery::getAuth($model->control["年度"],$ga);
        ...
        $objForm->ae( array("type"       => "select",
                            ...
                            "extrahtml"  => "onchange=\"return btn_submit('knjm437d'),AllClearList();\"",
        ...
        //異動対象日付（テキスト）
        $disabled = "";
        $extra = "onblur=\"isDate(this); tmp_list('knjm437d', 'on')\"".$disabled;
        ...
        //対象外の生徒取得
        $db = Query::dbCheckOut();
        $query = knjm437dQuery::getSchnoIdou($model,$ga);
        $result = $db->query($query);
        $opt_idou = array();
        while($row = $result->fetchRow(DB_FETCHMODE_ASSOC)){
        ...
        */
        ...
        View::toHTML($model, "knjm437dForm1.html", $arg); 
    }
}
?>
