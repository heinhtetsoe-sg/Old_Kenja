...
class knjm827Form1
{
    function main(&$model){
        ...
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("knjm827Form1", "POST", "knjm827index.php", "", "knjm827Form1");
        ...
        $extra = "onChange=\"return btn_submit('knjm827');\"";
        ...
        View::toHTML($model, "knjm827Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJM827"));
