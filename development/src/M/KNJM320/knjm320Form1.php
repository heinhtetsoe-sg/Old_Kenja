...
class knjm320Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm320Form1", "POST", "knjm320index.php", "", "knjm320Form1");
        ...
        //クラス選択コンボボックスを作成する
        $db = Query::dbCheckOut();
        $query = knjm320Query::getAuth($model->control["年度"],$model->control["学期"]);
        ...
        //対象者リストを作成する
        $db = Query::dbCheckOut();
        $query = knjm320Query::getSchreg($model);
        ...
        View::toHTML($model, "knjm320Form1.html", $arg); 
    }
}
?>
