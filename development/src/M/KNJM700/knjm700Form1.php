...
class knjm700Form1
{
    ...
    {
        $objForm        = new form;
        $arg["start"]   = $objForm->get_start("main", "POST", "knjm700index.php", "", "main");
        ...
        $query = knjm700Query::getNameMst("B001");
        $extra = "onChange=\"return btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["PERIODT"], "PERIODT", $extra, 1, "BLANK");

        //単位時間コンボ
        $query = knjm700Query::getNameMst("M010");
        $extra = "onChange=\"return btn_submit('main');\"";
        ...
        $query = knjm700Query::getSemesterMst($model);
        ...
        $query = knjm700Query::getSch($model, $setSem);
        ...
        View::toHTML($model, "knjm700Form1.html", $arg); 
    }
}
//makeCmb
