...
class knjm440eForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjm440eindex.php", "", "main");
        ...
        $query = knjm440eQuery::getSemesterMst();
        ...
        $chk_data = $db->getOne(knjm440eQuery::checkSubclassStdPassDat($model));
        ...
        View::toHTML($model, "knjm440eForm1.html", $arg);
    }
}
?>
