...
class knjmp965Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjmp965Form1", "POST", "knjmp965index.php", "", "knjmp965Form1");
        ...
        $model->month = array("04" => "４月", "05" => "５月", "06" => "６月", "07" => "７月", "08" => "８月", "09" => "９月",
                              "10" => "１０月", "11" => "１１月", "12" => "１２月", "01" => "１月", "02" => "２月", "03" => "３月");
        list($year, $month, $day) = preg_split("/-/", CTRL_DATE);
        //日付Fromコンボボックス
        $query = knjmp965Query::getMonth($model);
        $extra = "";
        ...
        View::toHTML($model, "knjmp965Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJMP965");
