...
class knjm390wSubForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjm390wSubForm1", "POST", "knjm390windex.php", "", "knjm390wSubForm1");
        ...
        //データ取得
        $result = $db->query(knjm390wQuery::getsubremark($model));
        ...
        View::toHTML($model, "knjm390wSubForm1.html", $arg);
    }
}
?>
