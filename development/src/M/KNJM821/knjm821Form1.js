...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].OUTPUTSDATE.value.length == 0 || document.forms[0].OUTPUTEDATE.value.length == 0)
    {
        alert('印刷範囲を指定してください');
        return;
    }
    if (document.forms[0].OUTPUTSDATE.value > document.forms[0].OUTPUTEDATE.value)
    {
        alert('{rval MSG916}');
        return;
    }
