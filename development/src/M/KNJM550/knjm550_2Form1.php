...
class knjm550_2Form1
{
    public function main(&$model)
    {
        $objForm = new form();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm550_2Form1", "POST", "knjm550index.php", "", "knjm550_2Form1");
        ...
        View::toHTML($model, "knjm550_2Form1.html", $arg);
    }
}
...
function makeBtn(&$objForm, &$arg)
{
    ...
    //印刷ボタン
    $extra = "onclick=\"return newwin('" . SERVLET_URL . "', 'KNJM510');\"";
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJM510");
