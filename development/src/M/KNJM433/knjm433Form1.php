...
class knjm433Form1
{
    function main(&$model) {
        ...
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm433Form1", "POST", "knjm433index.php", "", "knjm433Form1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJM433");
        knjCreateHidden($objForm, "cmd");
        knjCreateHidden($objForm, "useCurriculumcd", $model->Properties["useCurriculumcd"]);

        $arg["finish"]  = $objForm->get_finish();
        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。 
        View::toHTML($model, "knjm433Form1.html", $arg); 
    }
}
?>
