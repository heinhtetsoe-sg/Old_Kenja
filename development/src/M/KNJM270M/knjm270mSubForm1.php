...
class knjm270mSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm270mSubForm1", "POST", "knjm270mindex.php", "", "knjm270mSubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm270mQuery::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm270mQuery::getsubName());
        ...
        View::toHTML($model, "knjm270mSubForm1.html", $arg);
    }
}
?>
