...
function btn_submit(cmd) {
    ...
    if (cmd == "search") {
        if (document.forms[0].SUBCLASS1.value == '' &&
            document.forms[0].SUBCLASS2.value == '' &&
            document.forms[0].SUBCLASS3.value == ''
        ) {
            alert('科目の指定がありません。');
            return false;
        }
        if (document.forms[0].SUBCLASS1.value != '' &&
            (document.forms[0].SUBCLASS1.value == document.forms[0].SUBCLASS2.value ||
             document.forms[0].SUBCLASS1.value == document.forms[0].SUBCLASS3.value)
        ) {
            alert('同一科目が複数回指定されています。');
            return false;
        }
        if (document.forms[0].SUBCLASS2.value != '' &&
            document.forms[0].SUBCLASS2.value == document.forms[0].SUBCLASS3.value
        ) {
            alert('同一科目が複数回指定されています。');
            return false;
        }
    ...
    cmd = cmd == "search" ? "knjm550m_2Search" : cmd;
...
function radioChange(obj) {
    if(document.forms[0].OUTPUT[4].checked == true) {
        document.forms[0].CHECK2.disabled = false;
        document.forms[0].CHECK1.disabled = true;
    }
    if(document.forms[0].OUTPUT[0].checked == true || document.forms[0].OUTPUT[1].checked == true ||
                    document.forms[0].OUTPUT[2].checked == true || document.forms[0].OUTPUT[3].checked == true) {
        document.forms[0].CHECK2.disabled = true;
...
{   
    ...
    {  
        ...
        tempaa[current2] = String(attribute2.options[i].text).substr(0,8)+","+current2;
        current2++;
    }
    ...
    {   
        ...
        {  
            ...
            tempaa[current2] = String(attribute1.options[i].text).substr(0,8)+","+current2;
            current2++;
        }
        else
        {  
