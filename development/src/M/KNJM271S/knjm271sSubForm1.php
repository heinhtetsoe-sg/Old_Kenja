...
class knjm271sSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm271sSubForm1", "POST", "knjm271sindex.php", "", "knjm271sSubForm1");
        ...
        //データ取得
        $db = Query::dbCheckOut();
        $result = $db->query(knjm271sQuery::getsubSch($model));
        ...
        $opt_grval = array();
        $result = $db->query(knjm271sQuery::getsubName());
        ...
        View::toHTML($model, "knjm271sSubForm1.html", $arg);
    }
}
?>
