...
class knjm550w_1Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm550w_1Form1", "POST", "knjm550windex.php", "", "knjm550w_1Form1");
        ...
        if (($model->cmd == "knjm550w_1Search" || $model->cmd == "read" || $model->cmd == "meibo") &&
        ...
        if ($model->cmd != 'clschange') {
            $query = knjm550wQuery::getComment();
        ...
        if (!isset($model->warning) && ($model->cmd == 'read' || $model->cmd == 'meibo')) {
            $setCmd = $model->cmd == 'read' ? "KNJM500M" : "KNJM550W";
            $model->cmd = 'knjm550w_1';
        ...
        View::toHTML($model, "knjm550w_1Form1.html", $arg);
    }
}
