...
class knjm550w_3Form1
{
    public function main(&$model)
    {
        $objForm = new form();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjm550w_3Form1", "POST", "knjm550windex.php", "", "knjm550w_3Form1");
        ...
        View::toHTML($model, "knjm550w_3Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJM550W");
