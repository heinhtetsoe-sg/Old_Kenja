...
//        $model->schregno = "20031935";
        $result = $db->query(knjm210m_3Query::getStudentName($model->schregno));
        $row = $result->fetchRow(DB_FETCHMODE_ASSOC);
        $arg["NAME"] = "　　　学籍番号：".$row["SCHREGNO"]."　　　氏名：".$row["NAME"];

        $result = $db->query(knjm210m_3Query::getList($model->schregno));
        ...
        View::toHTML($model, "knjm210m_3Form4.html", $arg);
    }
}
?>
