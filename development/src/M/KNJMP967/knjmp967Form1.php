...
class knjmp967Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjmp967Form1", "POST", "knjmp967index.php", "", "knjmp967Form1");
        ...
        View::toHTML($model, "knjmp967Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJMP967");
