...
class knjh400_hanteiForm2
{
    function main(&$model)
    {
        ...
        $model->gakunen = number_format($schregRow["GRADE_CD"]);
        ...
        $periodQuery = knjh400_hanteiQuery::getPeriod($ent_year);
        ...
        $query = knjh400_hanteiQuery::getCompanycd();
        ...
        View::toHTML($model, "knjh400_hanteiForm2.html", $arg); 
    }
}
//コンボ作成
