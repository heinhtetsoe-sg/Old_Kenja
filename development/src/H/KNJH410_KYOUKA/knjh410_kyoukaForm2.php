...
class knjh410_kyoukaForm2
{
    function main(&$model)
    {
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("edit", "POST", "knjh410_kyoukaindex.php", "", "edit");
        ...
        $MockNameQuery = knjh410_kyoukaQuery::getMockName($model->GAKUSEKI, $model->right_field["NENDO"], $model->right_field["GYOUSYA"]);
        ...
        if($model->right_field["MOCKCD"] != ""){
            ...
            //模試名称取得
            $mockQuery = knjh410_kyoukaQuery::getMock($model->right_field["MOCKCD"]);
            ...
            //教科名取得
            $kyoukaQuery = knjh410_kyoukaQuery::getKyouka($model->GAKUSEKI, $model->right_field["NENDO"], $model->right_field["MOCKCD"], $model->right_field["KATA"]);
        ...
        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML6($model, "knjh410_kyoukaForm2.html", $arg, $jsplugin, $cssplugin);
    }
} 
//ボタン作成
