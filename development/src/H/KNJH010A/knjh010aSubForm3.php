...
class knjh010aSubForm3
{
    public function main(&$model)
    {
        ...
        //通学方法名称取得
        $arg["data"]["TUGAKU_NAME"] = $db->getOne(knjh010aQuery::getHowToCommutecdName());
        ...
        //バスコースコンボ
        $query = knjh010aQuery::getBusCourse();
        ...
        /********************/
        //バスコース名--テキスト
        list($rosen_cd, $rosen_mei) = $db->getRow(knjh010aQuery::getBusCourse($row["ROSEN_2"]));
        ...
        View::toHTML($model, "knjh010aSubForm3.html", $arg);
    }
}
/********************************************** 以下関数 **********************************************************/
//コンボ作成
