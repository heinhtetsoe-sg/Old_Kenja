...
class knjh113aForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjh113aForm1", "POST", "knjh113aindex.php", "", "knjh113aForm1");
        ...
        View::toHTML($model, "knjh113aForm1.html", $arg);
    }
}
/*********************************************** 以下関数 *******************************************************/
/******************/
...
function makeListToList(&$objForm, &$arg, $db) {
    //資格一覧
    $row1 = array();
    $result = $db->query(knjh113aQuery::getQualifiedList());
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID",         "KNJH113A");
