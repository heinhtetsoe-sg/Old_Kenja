function btn_submit(cmd) {
    ...
    if (cmd == "change") {
        ...
        selectdataText = document.forms[0].selectdataText;
        selectdata.value = "";
        selectdataText.value = "";
        sep = "";
        ...
        for (var i = 0; i < document.forms[0].CATEGORY_SELECTED.length; i++) {
            ...
            selectdataText.value = selectdataText.value + sep + document.forms[0].CATEGORY_SELECTED.options[i].text;
            sep = ",";
        }
    } else {
        selectdata = document.forms[0].selectdata;
