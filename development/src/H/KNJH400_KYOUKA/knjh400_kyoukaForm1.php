...
class knjh400_kyoukaForm1
{
    function main(&$model)
    {
        ...
        $MockNameQuery = knjh400_kyoukaQuery::getMockName($model->GAKUSEKI, $model->left_field["NENDO"], $model->left_field["GYOUSYA"]);
        ...
        if($model->left_field["MOCKCD"] != ""){
            ...
            //模試名称取得
            $mockQuery = knjh400_kyoukaQuery::getMock($model->left_field["MOCKCD"]);
            ...
            //教科名取得
            $kyoukaQuery = knjh400_kyoukaQuery::getKyouka($model->GAKUSEKI, $model->left_field["NENDO"], $model->left_field["MOCKCD"], $model->left_field["KATA"]);
        ...
        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML6($model, "knjh400_kyoukaForm1.html", $arg, $jsplugin, $cssplugin);
    }
} 
//ボタン作成
