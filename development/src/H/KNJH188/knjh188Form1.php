...
class knjh188Form1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjh188Form1", "POST", "knjh188index.php", "", "knjh188Form1");
        ...
        View::toHTML($model, "knjh188Form1.html", $arg);
    }
}
/******************************************* 以下関数 *****************************************************/
//ボタン作成
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJH188");
}
?>
