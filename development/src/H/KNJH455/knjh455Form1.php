...
class knjh455Form1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjh455index.php", "", "main");

        //DB接続
        $db = Query::dbCheckOut();

        //親画面なし
        $securityCnt = $db->getOne(knjh455Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        $query = knjh455Query::getMockRankRangeDat($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJh455");
        ...
        View::toHTML($model, "knjh455Form1.html", $arg);
    }
