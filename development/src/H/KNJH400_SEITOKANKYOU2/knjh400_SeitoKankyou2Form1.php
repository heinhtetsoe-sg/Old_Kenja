...
class knjh400_SeitoKankyou2Form1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("sel", "POST", "knjh400_SeitoKankyou2index.php", "", "sel");

        $row = knjh400_SeitoKankyou2Query::getSchregEnvirDat($model);
        ...
        //こづかい(コンボ)
        $query = knjh400_SeitoKankyou2Query::getVNameMst("H104", $model);
        $extra = '';
        ...
        //テレビの視聴時間(コンボ)
        $query = knjh400_SeitoKankyou2Query::getVNameMst("H105", $model);
        $extra = '';
        ...
        //戻るボタン
        $link = REQUESTROOT."/H/KNJH400_SEITOKANKYOU/knjh400_SeitoKankyouindex.php?cmd=back";
        $model->prg = "KNJH400_SEITOKANKYOU";
        ...
        View::toHTML($model, "knjh400_SeitoKankyou2Form1.html", $arg);
    }
}
/********************************************** 以下関数 **********************************************************/
//コンボ作成
