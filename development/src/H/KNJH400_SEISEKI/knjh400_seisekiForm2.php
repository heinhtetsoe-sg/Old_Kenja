...
class knjh400_seisekiForm2
{
    function main(&$model)
    {
        ...
        $arg["start"]   = $objForm->get_start("main", "POST", "knjh400_seisekiindex.php", "", "main");
        ...
        $schregQuery = knjh400_seisekiQuery::getSchreg($model->year, $model->GAKUSEKI);
        ...
        $periodQuery = knjh400_seisekiQuery::getPeriod($ent_year);
        ...
        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML6($model, "knjh400_seisekiForm2.html", $arg, $jsplugin, $cssplugin);
    }
}
//コンボ作成
