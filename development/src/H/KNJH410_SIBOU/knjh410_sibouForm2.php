...
class knjh410_sibouForm2
{
    function main(&$model)
    {
        ...
        $schregQuery = knjh410_sibouQuery::getSchreg($model->year, $model->GAKUSEKI);
        ...
        $periodQuery = knjh410_sibouQuery::getPeriod($ent_year);
        $period = $db->getOne($periodQuery);
        $arg["PERIOD"] = "(".$period."期)";*/

        //業者
        $extra = " style=\"font-size:110%;\" onchange=\"btn_submit('list');\"";
        $query = knjh410_sibouQuery::getCompanycd();
        ...
        View::toHTML($model, "knjh410_sibouForm2.html", $arg); 
    }
}
//コンボ作成
