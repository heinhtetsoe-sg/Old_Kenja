...
class knjh410_hanteiForm2
{
    function main(&$model)
    {
        ...
        $schregQuery = knjh410_hanteiQuery::getSchreg($model->year, $model->GAKUSEKI);
        $schregRow = $db->getRow($schregQuery, DB_FETCHMODE_ASSOC);
        
        $model->gakunen = mb_convert_kana(mb_substr($schregRow["GRADE_NAME"], 0, 1), "n");
        ...
        $periodQuery = knjh410_hanteiQuery::getPeriod($ent_year);
        ...
        $query = knjh410_hanteiQuery::getCompanycd();
        ...
        View::toHTML($model, "knjh410_hanteiForm2.html", $arg); 
    }
}
//コンボ作成
