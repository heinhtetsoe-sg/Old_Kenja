...
class knjh400SubForm1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjh400SubForm1", "POST", "knjh400index.php", "", "knjh400SubForm1");
        ...
        $arg["NAME"]     = $db->getOne(knjh400Query::getName($model->schregno));

        //データ取得
        $row = ($model->actiondate) ? $db->getRow(knjh400Query::getActionDucSub($model), DB_FETCHMODE_ASSOC) : array();
        ...
        View::toHTML($model, "knjh400SubForm1.html", $arg);
    }
}
