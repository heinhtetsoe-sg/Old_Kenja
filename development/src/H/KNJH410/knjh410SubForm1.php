...
class knjh410SubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjh410SubForm1", "POST", "knjh410index.php", "", "knjh410SubForm1");
        ...
        $arg["NAME"]     = $db->getOne(knjh410Query::getName($model->schregno));

		//データ取得
        $row = ($model->actiondate) ? $db->getRow(knjh410Query::getActionDucSub($model), DB_FETCHMODE_ASSOC) : array();
        ...
        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
   	    View::toHTML($model, "knjh410SubForm1.html", $arg);
    }
}
