...
//フォーム作成////////////////////////////////////////////////////////////////////////////////////////////////////
$arg["start"]   = $objForm->get_start("knjh080Form1", "POST", "knjh080index.php", "", "knjh080Form1");
...
//クラス選択コンボボックスを作成する///////////////////////////////////////////////////////////////////////////////
$db = Query::dbCheckOut();
$query = knjh080Query::getAuth($model, $model->control["年度"],$model->control["学期"]);
/*
...
$objForm->ae( array("type"       => "select",
                    ...
                    "extrahtml"  => "onchange=\"return btn_submit('knjh080');\"",
...
$objForm->ae( array("type"       => "select",
                    "name"       => "category_name",
					"extrahtml"  => "multiple style=\"height:230px; width:230px\" ondblclick=\"move1('left')\"",
                    "size"       => "20",
...
$objForm->ae( array("type"       => "select",
					...
					"extrahtml"  => "multiple style=\"height:230px; width:230px\" ondblclick=\"move1('right')\"",
                    "size"       => "20",
                    "options"    => array()));
...
View::toHTML($model, "knjh080Form1.html", $arg); 
}
}
?>
