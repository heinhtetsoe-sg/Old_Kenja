...
class knjh400_sibouForm1
{
    function main(&$model)
    {
        ...
        for($gaku=$model->gakunen;$gaku>0;$gaku--){
            ...
            $schregQuery2 = knjh400_sibouQuery::getSchreg($ctrlyear, $model->GAKUSEKI);
            ...
            $cntQuery = knjh400_sibouQuery::getMockCnt($model, $ctrlyear, $model->GAKUSEKI, $model->field["GYOUSYA"], "1", $grade, $hrClass, $attendno);  //カウント
            ...
            if($cnt > 0){
                ...
                //模試志望校数の最大値と模試回数取得
                $cntQuery = knjh400_sibouQuery::getMockCnt($model, $ctrlyear, $model->GAKUSEKI, $model->field["GYOUSYA"], "2", $grade, $hrClass, $attendno);
                ...
                //模試データ(CDとか取得)
                $mosiQuery = knjh400_sibouQuery::getMockCnt($model, $ctrlyear, $model->GAKUSEKI, $model->field["GYOUSYA"], "0", $grade, $hrClass, $attendno);
                ...
                while($mosiRow = $mosiResult->fetchRow(DB_FETCHMODE_ASSOC)){
                    ...
                    $hopeQuery = knjh400_sibouQuery::getHopeGaku($model, $mosiRow["MOCKCD"], $model->GAKUSEKI, $ctrlyear, $grade, $hrClass, $attendno);
        ...
        View::toHTML($model, "knjh400_sibouForm1.html", $arg); 
    }
}
//コンボ作成
