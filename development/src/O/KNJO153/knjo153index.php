<?php
require_once('knjo153Model.inc');
require_once('knjo153Query.inc');

class knjo153Controller extends Controller {
    var $ModelClassName = "knjo153Model";
    var $ProgramID      = "KNJO153";
        ...
        while ( true ) {
            switch (trim($sessionInstance->cmd)) {
                ...
                case "":
                    ...
                    $args["left_src"] .= "&PATH=" .urlencode("/O/KNJO153/knjo153index.php?cmd=edit");
                    
                    $args["right_src"] = "knjo153index.php?cmd=edit";
                    $args["cols"] = "25%,*";
                    View::frame($args);
                    exit;
                default:
...
$KNJo153Ctl = new knjo153Controller;
//var_dump($_REQUEST);
?>
