...
class knjo102Form1
{
    ...
    {
        $objForm = new form;
        $arg["start"] = $objForm->get_start("main", "POST", "knjo102index.php", "", "main");
        //DB接続
        $db = Query::dbCheckOut();
        
        //学籍番号
        $extra = "";
        $arg["SCHREGNO"] = str_replace("text", "tel", knjCreateTextBox($objForm, $model->SCHREGNO, "SCHREGNO", 10, 8, $extra));
        ...
        View::toHTML($model, "knjo102Form1.html", $arg);
    }
}
