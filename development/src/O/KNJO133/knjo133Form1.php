...
class knjo133Form1
{
    ...
    {
        $objForm = new form;
        $arg["start"] = $objForm->get_start("main", "POST", "knjo133index.php", "", "main");
        //DB接続
        $db = Query::dbCheckOut();
        ...
        //在学生検索ボタン
        $extra = "onclick=\"wopen('../../X/KNJXSEARCH2/index.php?PATH=/O/KNJO133/knjo133index.php&cmd=&target=KNJO133','search',0,0,700,500);\"";
        ...
        View::toHTML($model, "knjo133Form1.html", $arg);
    }
}
