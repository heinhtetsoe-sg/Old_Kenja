//jqury部
$(function(){
    $("input[name='SCHREGNO']").after("&nbsp;&nbsp;<input type='button' name='btn_zaigaku' value='在校生検索' onclick=wopen('../../X/KNJXSEARCH2/index.php?PATH=/O/KNJO131/knjo131index.php&amp;cmd=&amp;target=KNJO131','search',0,0,700,500);>");
    $("input[name='btn_read']").parent().addClass("btn");
    $("td.no_search").addClass("title");
