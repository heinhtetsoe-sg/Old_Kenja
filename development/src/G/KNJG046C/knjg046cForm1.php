...
class knjg046cForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjg046cForm1", "POST", "knjg046cindex.php", "", "knjg046cForm1");

        //DB接続
        $db = Query::dbCheckOut();

        //校種
        $query = knjg046cQuery::getSchoolKind($model);
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, $model->field["SCHOOL_KIND"], "SCHOOL_KIND", $extra, 1, "BLANK");
        ...
        View::toHTML($model, "knjg046cForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJG046C");
