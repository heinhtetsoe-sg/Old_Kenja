...
class knjg046aForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjg046aForm1", "POST", "knjg046aindex.php", "", "knjg046aForm1");

        //DB接続
        $db = Query::dbCheckOut();

        //校種
        $query = knjg046aQuery::getSchoolKind($model);
        $extra = "";
        ...
        View::toHTML($model, "knjg046aForm1.html", $arg);
    }
}
