...
class knjg049Form1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjg049Form1", "POST", "knjg049index.php", "", "knjg049Form1");
        ...
        View::toHTML($model, "knjg049Form1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJG049");
    knjCreateHidden($objForm, "hibiNyuuryokuNasi", $model->Properties["hibiNyuuryokuNasi"]);
    knjCreateHidden($objForm, "hibiNyuuryoku", $model->Properties["hibiNyuuryoku"]);
    knjCreateHidden($objForm, "SCHOOLCD", sprintf("%012d", SCHOOLCD));
    knjCreateHidden($objForm, "SCHOOLKIND", SCHOOLKIND);
    knjCreateHidden($objForm, "useSchool_KindField", $model->Properties["useSchool_KindField"]);
    knjCreateHidden($objForm, "useKNJG049_2", $model->Properties["useKNJG049_2"]);
