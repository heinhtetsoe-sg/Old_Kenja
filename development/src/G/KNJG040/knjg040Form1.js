...
{
    var str = 'knjg040index.php?cmd=edit&perm_div=' + that.value;
    btn_submit('list');
    window.open(str,'right_frame');
    return false;
}
...
//2004/04/27	function newwin(){
    ...
    //
//    for (var i = 0; i < document.forms[0].CITY_NAME.length; i++)
//    {  
//        document.forms[0].CITY_NAME.options[i].selected = 0;
//    }

//    for (var i = 0; i < document.forms[0].CITY_SELECTED.length; i++)
//    {  
//        document.lba400.CITY_SELECTED.options[i].selected = 1;
//    }
