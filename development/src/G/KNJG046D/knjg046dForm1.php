...
class knjg046dForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjg046dForm1", "POST", "knjg046dindex.php", "", "knjg046dForm1");
        ...
        View::toHTML($model, "knjg046dForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJG046D");
