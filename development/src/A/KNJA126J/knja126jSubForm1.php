...
class knja126jSubForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform1", "POST", "knja126jindex.php", "", "subform1");
        ...
        //通知表所見表示
        $query = knja126jQuery::getHreportRemarkDat($model);
        ...
        View::toHTML($model, "knja126jSubForm1.html", $arg);
    }
}
?>
