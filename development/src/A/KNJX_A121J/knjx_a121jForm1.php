...
class knjx_a121jForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx_a121jindex.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx_a121jQuery::getSecurityHigh($model));
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $result     = $db->query(knjx_a121jquery::getSelectFieldSQL());
        $opt_year   = array();
        ...
        //年組一覧コンボボックス
        $result      = $db->query(knjx_a121jquery::getSelectFieldSQL2($model));   
        $opt_gr_hr   = array();
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx_a121jQuery::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX_a121j");
        ...
        View::toHTML($model, "knjx_a121jForm1.html", $arg);
    }
}
?>
