function btn_submit(cmd) {
    if (cmd == 'update') {
        ...
        if (document.forms[0].CATEGORY_SELECTED.length == 0) {
            alert('{rval MSG916}');
            return;
        } else if ((document.forms[0].SEITO.checked == false) && (document.forms[0].KATSUDO.checked == false) && (document.forms[0].GAKUSHU.checked == false) && (document.forms[0].TANI.checked == false) && (document.forms[0].SHUKKETSU && document.forms[0].SHUKKETSU.checked == false)){
...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].CATEGORY_SELECTED.length == 0) {
        alert('{rval MSG916}');
        return;
    } else if ((document.forms[0].SEITO.checked == false) && (document.forms[0].KATSUDO.checked == false) && (document.forms[0].GAKUSHU.checked == false) && (document.forms[0].TANI.checked == false) && (document.forms[0].SHUKKETSU == null || document.forms[0].SHUKKETSU.checked == false)){
        alert('出力する帳票を選択してください。');
        return;
    } else {
        for (var i = 0; i < document.forms[0].CATEGORY_SELECTED.length; i++)
...
function OptionUse(obj) {
    var disabled = !document.forms[0].SEITO.checked;
    if (document.forms[0].SIMEI) {
        document.forms[0].SIMEI.disabled = disabled;
    }
    if (document.forms[0].SCHZIP) {
        document.forms[0].SCHZIP.disabled = disabled;
    }
    if (document.forms[0].SCHOOLZIP) {
        document.forms[0].SCHOOLZIP.disabled = disabled;
    }
}
