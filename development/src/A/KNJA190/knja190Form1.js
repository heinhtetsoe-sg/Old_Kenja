...
function dischange() {
    ...
    for (var i = 0; i < document.forms[0].OUTPUT.length; i++) {
        var o = document.forms[0].OUTPUT[i];
        if (o.id == 'OUTPUT2') {
            o2 = o;
            break;
        }
    ...
    if ((o2 && o2.checked) || (o4 && o4.checked)) {
        document.forms[0].CHECK3.disabled = false;
    } else {
        document.forms[0].CHECK3.disabled = true;
    }
}
    ...
    {   
        ...
        {  
            ...
            if (chdt == 1){
                ...
                tempaa[current2] = String(attribute1.options[i].value)+","+current2;
            }
            current2++;
        }
        else
