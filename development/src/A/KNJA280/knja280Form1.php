...
//フォーム作成////////////////////////////////////////////////////////////////////////
$arg["start"]   = $objForm->get_start("knja280Form1", "POST", "knja280index.php", "", "knja280Form1");
...
//学期リスト
$db = Query::dbCheckOut();
$query = knja280Query::getSemester($model);
...
$objForm->ae( array("type"       => "select",
					...
					"extrahtml"  => "onChange=\"return btn_submit('knja280');\"",
                    "options"    => $opt_seme));
...
//クラス一覧リスト作成する///////////////////////////////////////////////////////////////////////////////
$db = Query::dbCheckOut();
//$query = common::getHrClassAuth(CTRL_YEAR, $model->field["GAKKI"], AUTHORITY, STAFFCD);// 05/01/07 keep
$query = knja280Query::getAuth($model);
$result = $db->query($query);
while($row = $result->fetchRow(DB_FETCHMODE_ASSOC)){
...
View::toHTML($model, "knja280Form1.html", $arg); 
}
}
?>
