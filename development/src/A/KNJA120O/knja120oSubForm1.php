...
class knja120oSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knja120oindex.php", "", "subform1");
        ...
        //年度コンボ（通知表所見）
        $opt_year = array();
        $result = $db->query(knja120oQuery::selectQueryYear($model));
        ...
        $query = knja120oQuery::selectQueryGuide($model);
        ...
        View::toHTML($model, "knja120oSubForm1.html", $arg);
    }
}
?>
