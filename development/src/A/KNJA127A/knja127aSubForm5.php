...
class knja127aSubForm5 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja127aindex.php", "", "edit");
        ...
        //学籍資格データよりデータを取得
        if ($model->schregno) {
            $result = $db->query(knja127aQuery::getAward($model));
        ...
        if (VARS::get("cmd") == "right_list") { 
            $arg["reload"] = "parent.edit_frame.location.href='knja127aindex.php?cmd=edit'";
        }

        View::toHTML($model, "knja127aSubForm5.html", $arg);
    }
}
?>
