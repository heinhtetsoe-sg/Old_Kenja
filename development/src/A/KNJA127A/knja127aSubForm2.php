...
class knja127aSubForm2 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knja127aindex.php", "", "subform2");
        ...
        //部活一覧
        $query = knja127aQuery::getClub($model);
        ...
        View::toHTML($model, "knja127aSubForm2.html", $arg);
    }
}
?>
