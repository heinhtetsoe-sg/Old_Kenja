...
class tuutihyou {
    function main(&$model) {
        ...
        //年度コンボ
        $query = knja121bQuery::getYear($model->schregno);
        ...
        //通知票所見
        $query = knja121bQuery::getRemark($model->schregno, $model->year);
        ...
        while( $row = $result->fetchRow(DB_FETCHMODE_ASSOC))
        {
            ...
            $semester = $db->getone(knja121bQuery::getSemester($model->year, $row["SEMESTER"]));
        ...
        knjCreateHidden($objForm, "PRGID", "KNJA121B");
