...
class knja121bSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knja121bindex.php", "", "subform1");
        ...
        $opt_year = array();
		$year_flg = false;
        $result = $db->query(knja121bQuery::selectQueryYear($model));
        ...
        $query = knja121bQuery::selectQueryGuide($model);
        ...
        View::toHTML($model, "knja121bSubForm1.html", $arg);
    }
}
?>
