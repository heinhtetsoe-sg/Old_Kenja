...
class knja127hSubForm1
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform1", "POST", "knja127hindex.php", "", "subform1");
        ...
        if ($model->cmd === 'subform1') {
            $Row = $db->getRow(knja127hQuery::getChallengedProfile($model), DB_FETCHMODE_ASSOC);
        }
        ...
        View::toHTML($model, "knja127hSubForm1.html", $arg);
    }
}
