...
class knja127hSubForm2
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knja127hindex.php", "", "subform2");
        ...
        //部活一覧
        $query = knja127hQuery::getClub($model);
        ...
        View::toHTML($model, "knja127hSubForm2.html", $arg);
    }
}
