...
class knja127hSubForm5
{
    ...
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja127hindex.php", "", "edit");
        ...
        //学籍資格データよりデータを取得
        if ($model->schregno) {
            $result = $db->query(knja127hQuery::getAward($model));
        ...
        if (VARS::get("cmd") == "right_list") {
            $arg["reload"] = "parent.edit_frame.location.href='knja127hindex.php?cmd=edit'";
        }

        View::toHTML($model, "knja127hSubForm5.html", $arg);
    }
}
