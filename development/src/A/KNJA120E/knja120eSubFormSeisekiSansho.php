<?php
//ビュー作成用クラス
class knja120eSubformSeisekiSansho
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subformSeisekiSansho", "POST", "knja120eindex.php", "", "subformSeisekiSansho");
        ...
        //SQL文発行
        //年度（年次）取得
        $query = knja120eQuery::selectQueryAnnual($model);
        ...
        $objForm->ae(array("type"       => "select",
                            ...
                            "extrahtml"  => "onChange=\"return btn_submit('subformSeisekiSansho');\"",
                            "options"    => $opt));
        ...
        $query = knja120eQuery::selectQuerySubForm4($model);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knja120eSubFormSeisekiSansho.html", $arg);
    }
}
