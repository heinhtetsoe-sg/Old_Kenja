...
class knja120eSubMaster
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("submaster", "POST", "knja120eindex.php", "", "submaster");

        //DB接続
        $db = Query::dbCheckOut();

        //学年取得
        $getGradeName = $db->getOne(knja120eQuery::getGradeName($model));
        ...
        View::toHTML($model, "knja120eSubMaster.html", $arg);
    }
}
...
{
    $i = 0;
    $query = knja120eQuery::getHtrainRemarkTempDat($model);
