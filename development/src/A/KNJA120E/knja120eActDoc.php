...
class knja120eActDoc
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja120eindex.php", "", "edit");
        ...
        //行動の記録データ取得
        if ($model->schregno) {
            $result = $db->query(knja120eQuery::getActionDocumentDat($model));
        ...
        if (VARS::get("cmd") == "right_list") {
            $arg["reload"] = "parent.edit_frame.location.href='knja120eindex.php?cmd=edit'";
        }

        View::toHTML($model, "knja120eActDoc.html", $arg);
    }
}
