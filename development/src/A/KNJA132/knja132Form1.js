function btn_submit(cmd) {
    if (cmd == "csv") {
        ...
        if ((document.forms[0].seito.checked == false) &&
            (document.forms[0].kanten.checked == false) &&
            (document.forms[0].tani.checked == false) &&
            (document.forms[0].gakushu.checked == false) &&
            (document.forms[0].sogo.checked == false) &&
            (document.forms[0].katsudo.checked == false) &&
            (document.forms[0].kentei.checked == false) ) {
...
function newwin(SERVLET_URL) {
    if (document.forms[0].category_selected.length == 0) {
        alert('{rval MSG916}');
    } else if ((document.forms[0].seito.checked == false) &&
               (document.forms[0].kanten.checked == false) &&
               (document.forms[0].tani.checked == false) &&
               (document.forms[0].gakushu.checked == false) &&
               (document.forms[0].sogo.checked == false) &&
...
function kubun() {
    ...
    var kubun4 = document.forms[0].kanten;
    var kubun5 = document.forms[0].tani;
    var kubun6 = document.forms[0].gakushu;
    var kubun7 = document.forms[0].sogo;
    var kubun8 = document.forms[0].katsudo;
    var kubun9 = document.forms[0].kentei;

    if( (kubun1.checked == false) &&
        (kubun4.checked == false) &&
        (kubun5.checked == false) &&
        (kubun6.checked == false) &&
        (kubun7.checked == false) &&
        (kubun8.checked == false) &&
        (kubun9.checked == false) ) {
        flag3 = true;
    } else {
        flag3 = false;
    }
