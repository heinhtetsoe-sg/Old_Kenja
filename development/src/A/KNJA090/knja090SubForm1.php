...
class knja090SubForm1
{
    function main(&$model)
    {
        $db             = Query::dbCheckOut();
        $gakka_query = knja090Query::GetMajorCoursecd($model->control["new_year"],$db);
        $course1 = knja090Query::GetCourse($model->control["new_year"],$db);
        ...
        //フォーム作成
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("sel", "POST", "knja090index.php", "", "sel");
        ...
        //年組名
        $class_name = $db->getOne(knja090Query::getHR_Name($model));
        ...
        //戻るボタン
        $link = REQUESTROOT."/A/KNJA090/knja090index.php?cmd=list";
        $objForm->ae( array("type"           => "button",
                            "name"        => "btn_back",
                            "value"       => "戻 る",
        ...
        View::toHTML($model, "knja090SubForm1.html", $arg); 
    }
}
?>
