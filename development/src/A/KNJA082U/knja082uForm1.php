...
class knja082uForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knja082uForm1", "POST", "knja082uindex.php", "", "knja082uForm1");
        ...
        View::toHTML($model, "knja082uForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    //クラス一覧取得
    $opt = array();
    $result = $db->query(knja082uQuery::getHrClass($model));
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJA082U");
