...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].TERM_SDATE != null) {
...
//        tempaa[y] = String(attribute2.options[i].text).substring(0,cutpt+4)+","+y; // 2004/01/23
        tempaa[y] = attribute2.options[i].value+","+y; // 2004/01/23
    }
...
//            tempaa[y] = String(attribute1.options[i].text).substring(0,cutpt+4)+","+y; // 2004/01/23
            tempaa[y] = attribute1.options[i].value+","+y; // 2004/01/23
        }
        else
        {  
            y=current2++
...
//        tempaa[z] = String(attribute6.options[i].text).substring(0,cutpt+4)+","+z; // 2004/01/23
        tempaa[z] = attribute6.options[i].value+","+z; // 2004/01/23
    }
...
//        tempaa[z] = String(attribute5.options[i].text).substring(0,cutpt+4)+","+z; // 2004/01/23
        tempaa[z] = attribute5.options[i].value+","+z; // 2004/01/23
    }
