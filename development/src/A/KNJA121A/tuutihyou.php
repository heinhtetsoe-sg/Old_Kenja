...
class tuutihyou {
    function main(&$model) {
        $objForm = new form;
        $arg["start"] = $objForm->get_start("detail", "POST", "knja121aindex.php", "", "detail");
        ...
        //年度コンボ
        $query = knja121aQuery::getYear($model->schregno);
        ...
        //通知票所見
        $query = knja121aQuery::getRemark($model->schregno, $model->year);
        ...
        while( $row = $result->fetchRow(DB_FETCHMODE_ASSOC))
        {
            ...
            $semester = $db->getone(knja121aQuery::getSemester($model->year, $row["SEMESTER"]));
        ...
        knjCreateHidden($objForm, "PRGID", "KNJA121A");
