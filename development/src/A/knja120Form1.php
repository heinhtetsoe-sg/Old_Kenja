...
class knja120Form1
{
    function main(&$model)
    {
        ...
        if ($model->exp_year < 2018) {
            ...
            $isAny = false;
            $db = Query::dbCheckOut();
            $query = knja120Query::getTotalRemarkDisable($model);
        ...
        //署名機能使用の学校は対象外
        if ($model->Properties["useSeitoSidoYorokuShomeiKinou"] == '1' || $model->Properties["useSeitoSidoYorokuSougouShoken"] == '1') {
            $model->over2018 = "";
        }
        ...
        if ($model->Properties["seitoSidoYorokuSougouFieldSize"] == 1) {
            ...
            knjCreateHidden($objForm, "TOTALREMARK_KETA", 132);
            knjCreateHidden($objForm, "TOTALREMARK_GYO", 8);
            ...
            knjCreateHidden($objForm, "TOTALREMARK_KETA", 132);
            knjCreateHidden($objForm, "TOTALREMARK_GYO", 7);
            KnjCreateHidden($objForm, "TOTALREMARK_STAT", "statusarea6");
        } else {
            $objForm->ae( array("type"        => "textarea",
                                "name"        => "TOTALREMARK",
            ...
            knjCreateHidden($objForm, "TOTALREMARK_KETA", 88);
            knjCreateHidden($objForm, "TOTALREMARK_GYO", 6);
            KnjCreateHidden($objForm, "TOTALREMARK_STAT", "statusarea6");
        }
