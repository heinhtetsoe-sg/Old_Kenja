...
class knja120aSubForm6
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform6", "POST", "knja120aindex.php", "", "subform6");
        ...
        //記録備考リスト
        $query = knja120aQuery::getSchregClubHdetailDat($model);
        ...
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            if (strlen($row["DOCUMENT"]) > 0 && strlen($row["DETAIL_REMARK"]) > 0) {
                $row["KIROKU"] .= "／";
            }
        ...
        View::toHTML($model, "knja120aSubForm6.html", $arg);
    }
}
