...
{
    public $ModelClassName = "knja120aModel";
    public $ProgramID      = "KNJA120A";
        ...
        while (true) {
            switch (trim($sessionInstance->cmd)) {
                ...
                case "tyousasyoSelect":    //調査書内容選択
                    $this->callView("knja120aSubTyousasyoSelect");
                    break 2;
                case "update":
                ...
                case "":
                    //分割フレーム作成
                    $args["left_src"] = REQUESTROOT ."/X/KNJXEXP/index.php?PROGRAMID=" .$this->ProgramID ."&URL_SCHOOLKIND={$sessionInstance->urlSchoolKind}&TARGET=right_frame&PATH=" .urlencode("/A/KNJA120A/knja120aindex.php?cmd=edit") ."&button=1";
