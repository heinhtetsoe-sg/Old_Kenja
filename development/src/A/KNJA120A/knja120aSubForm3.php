...
class knja120aSubForm3
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knja120aindex.php", "", "subform3");
        ...
        //委員会リスト
        $db = Query::dbCheckOut();
        $query = knja120aQuery::getCommittee($model);
        ...
        View::toHTML($model, "knja120aSubForm3.html", $arg);
    }
}
