...
//フォーム作成////////////////////////////////////////////////////////////////////////
$arg["start"]   = $objForm->get_start("knja140Form1", "POST", "knja140index.php", "", "knja140Form1");
...
//クラス選択コンボボックスを作成する
$db = Query::dbCheckOut();
$query = knja140Query::getAuth($model);
/*
...
$objForm->ae( array("type"       => "select",
					...
					"extrahtml"  => "onchange=\"return btn_submit('knja140');\"",
                    "options"    => $row1));
...
View::toHTML($model, "knja140Form1.html", $arg); 
}
}
?>
