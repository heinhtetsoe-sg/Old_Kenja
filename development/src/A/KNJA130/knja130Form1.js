...
function kubun()
{
    ...
    var kubun7 = document.forms[0].shukketsu;

    //   生徒指導要録                 活動の記録                   学習の記録                   修得単位の記録
    if ((kubun1.checked == false) && (kubun4.checked == false) && (kubun5.checked == false) && (kubun6.checked == false) && (kubun7 == null || kubun7.checked == false)) {
        flag3 = true;
    } else {
        flag3 = false;
    }
