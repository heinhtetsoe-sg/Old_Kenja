...
class shokenlist {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("detail", "POST", "knja128jindex.php", "", "detail");
        ...
        //HTRAINREMARK_DAT 取得
        $model->data["YEAR"] = "";
        $result = $db->query(knja128jQuery::getTrainRow($model, "sanshou"));
        while ($Row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            //自立活動の記録
            $extra = "aria-label = \"\"";
            $Row["INDEPENDENT_REMARK"] = getTextOrArea($objForm, "INDEPENDENT_REMARK", $model->indep_remark_moji, $model->indep_remark_gyou, $Row["INDEPENDENT_REMARK"], $model, $extra);
            //道徳
            $extra = "aria-label = \"\"";
