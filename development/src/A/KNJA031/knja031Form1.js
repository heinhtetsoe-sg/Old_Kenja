    ...
    for (var i = 0; i < document.forms[0].elements.length; i++) {
        if (document.forms[0].elements[i].name == "CHECKED[]") {
            document.forms[0].elements[i].checked =
                document.forms[0]["CHECKALL"].checked;
...
function btn_read() {
    ...
    for (var i = 0; i < document.forms[0]["CHECKED[]"].length; i++) {
        ...
        if (document.forms[0].SCHOOLDIV.value == 0) {
            //学年制
            switch (parseInt(document.forms[0].TRANS.value)) {
                ...
                case 2: //卒業
                    ...
                    if (
                        parseInt(r_c[i]) <
                        parseInt(document.forms[0].GRADE_FEARVAL.value)
                    ) {
            ...
            //単位制
            if (
                parseInt(document.forms[0].TRANS.value) == 2 &&
                parseInt(g_c[i]) >=
                    parseInt(document.forms[0].GRAD_CREDITS.value)
            ) {
                document.forms[0]["CHECKED[]"][i].checked = true;
            } else {
                document.forms[0]["CHECKED[]"][i].checked = false;
