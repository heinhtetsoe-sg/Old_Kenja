...
class knja225Form1 {
    function main(&$model) {
        ...
        //フォーム作成////////////////////////////////////////////////////////////////////////
        $arg["start"]   = $objForm->get_start("knja225Form1", "POST", "knja225index.php", "", "knja225Form1");
        ...
        //学期リスト
        $db = Query::dbCheckOut();
        $query = knja225Query::getSemester($model);
        ...
        $objForm->ae( array("type"       => "select",
                            ...
                            "extrahtml"  => "onChange=\"return btn_submit('knja225');\"",
                            "options"    => $opt_seme));
        ...
        //クラス一覧リスト作成する///////////////////////////////////////////////////////////////////////////////
        $db = Query::dbCheckOut();
        $query = knja225Query::getAuth($model);
        $result = $db->query($query);
        while($row = $result->fetchRow(DB_FETCHMODE_ASSOC)){
        ...
        View::toHTML($model, "knja225Form1.html", $arg); 
    }
}
?>
