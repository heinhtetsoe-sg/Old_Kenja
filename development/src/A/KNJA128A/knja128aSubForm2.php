...
class knja128aSubForm2
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knja128aindex.php", "", "subform2");
        ...
        //部活一覧
        $query = knja128aQuery::getClub($model);
        ...
        View::toHTML($model, "knja128aSubForm2.html", $arg);
    }
}
