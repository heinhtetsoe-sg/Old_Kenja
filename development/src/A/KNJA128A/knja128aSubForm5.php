...
class knja128aSubForm5
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja128aindex.php", "", "edit");
        ...
        //学籍資格データよりデータを取得
        if ($model->schregno) {
            $result = $db->query(knja128aQuery::getAward($model));
        ...
        if (VARS::get("cmd") == "right_list") {
            $arg["reload"] = "parent.edit_frame.location.href='knja128aindex.php?cmd=edit'";
        }

        View::toHTML($model, "knja128aSubForm5.html", $arg);
    }
}
