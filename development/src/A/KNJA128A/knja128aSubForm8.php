...
class knja128aSubForm8
{
    public function main(&$model)
    {
        ...
        //学年の取得
        $row1 = $db->getRow(knja128aQuery::selectKinyuuyroku1($model, $data[0]['GRADE']), DB_FETCHMODE_ASSOC);
        $row2 = $db->getRow(knja128aQuery::selectKinyuuyroku1($model, $data[1]['GRADE']), DB_FETCHMODE_ASSOC);
        $extra = 'readonly = "readonly"';
        $arg['TOTALREMARK1'] = getTextOrArea($objForm, 'TOTALREMARK1', $model->totalremark_moji, $model->totalremark_gyou, $row1['TOTALREMARK'], $extra);
        $arg['TOTALREMARK2'] = getTextOrArea($objForm, 'TOTALREMARK2', $model->totalremark_moji, $model->totalremark_gyou, $row2['TOTALREMARK'], $extra);
        ...
        View::toHTML($model, "knja128aSubForm8.html", $arg);
    }
}
//テキストボックスorテキストエリア作成
