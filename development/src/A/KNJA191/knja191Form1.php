...
class knja191Form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knja191Form1", "POST", "knja191index.php", "", "knja191Form1");
        ...
        //学期コンボ
        $query = knja191Query::getSemester();
        $extra = "onchange=\"return btn_submit('knja191'), AllClearList();\"";
        makeCmb($objForm, $arg, $db, $query, "SEMESTER", $model->field["SEMESTER"], $extra, 1);

        //出力指定選択 (1:クラス指定 2:個人指定)
        $opt = array(1, 2);
        $model->field["CHOICE"] = ($model->field["CHOICE"] == "") ? "1" : $model->field["CHOICE"];
        $click = " onClick=\"return btn_submit('knja191');\"";
        ...
        if ($model->field["CHOICE"] == "2") {
            ...
            //年組コンボ作成
            $query = knja191Query::getHrClass($model);
            $extra = "onchange=\"return btn_submit('knja191'), AllClearList();\"";
        ...
        View::toHTML($model, "knja191Form1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    if ($model->field["CHOICE"] == "1") {
        ...
        $query = knja191Query::getStudent($model);
    }
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJA191");
