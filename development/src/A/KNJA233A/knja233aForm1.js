...
function newwin(SERVLET_URL) {
    document.forms[0].PRGID.value = "KNJA233A";
...
window.onload = function () {
    document.forms[0].DATE.attachEvent("onchange", function () {
        document.forms[0].submit();
    });
    document.forms[0].DATE.attachEvent("onkeydown", function (e) {
        if (e.keyCode == 13) {
            document.forms[0].submit();
        }
    });
...
function hurigana() {
    if (document.forms[0].PRINT_DIV[0].checked && document.forms[0].OUTPUT[2].checked) {
...
//サイズ指定なし
function sizeOff() {
    document.forms[0].OUTPUT1.checked = true;
    document.forms[0].OUTPUT3.disabled = true;
}
//サイズ指定あり
function sizeOn() {
    document.forms[0].OUTPUT3.disabled = false;
}

//エクセル出力
function newwin2(SERVLET_URL, schoolCd, fileDiv) {
    document.forms[0].encoding = "application/x-www-form-urlencoded";
    document.forms[0].PRGID.value = "KNJA233A_XLS";
