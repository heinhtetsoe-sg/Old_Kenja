...
window.onload = function () {
    if (sessionStorage.getItem("KNJA134hForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJA134hForm1_CurrentCursor")).focus();
    }
}

function current_cursor(para) {
    sessionStorage.setItem("KNJA134hForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    document.title = "";
    if (sessionStorage.getItem("KNJA134hForm1_CurrentCursor") != null) {
        document.getElementById(sessionStorage.getItem("KNJA134hForm1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
    ...
    if (cmd == 'update') {
        ...
        if (document.forms[0].category_selected.length == 0) {
            ...
            // Add by PP for CurrentCursor 2020-01-17 end
            return;
        } else if ((document.forms[0].seito.checked == false) && (document.forms[0].katsudo.checked == false) && (document.forms[0].gakushu.checked == false) && (document.forms[0].tani && document.forms[0].tani.checked == false)) {
