...
function newwin(SERVLET_URL) {
    document.forms[0].PRGID.value = "KNJA233M";
...
window.onload = function () {
    if (document.forms[0].DATE.attachEvent) {
        ...
        document.forms[0].DATE.addEventListener('change', function(){document.forms[0].submit();});
        document.forms[0].DATE.addEventListener('keydown', function(e){if (e.keyCode == 13) {document.forms[0].submit();}});
    }
};
...
function newwin2(SERVLET_URL, schoolCd, fileDiv) {
    ...
    document.forms[0].PRGID.value = "KNJA233M_XLS";
