...
class knja120SubForm4
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform4", "POST", "knja120index.php", "", "subform4");
        ...
        //中高一貫校
        $JH = (get_count($db->getOne(knja120Query::getJH())) > 0) ? "1" : "";

        //SQL文発行
        //年度（年次）取得
        $query = knja120Query::selectQueryAnnual($model, $JH);
        ...
        $query = knja120Query::selectQuerySubForm4($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knja120SubForm4.html", $arg);
    }
}
?>