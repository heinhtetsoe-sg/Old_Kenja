...
//フォーム作成////////////////////////////////////////////////////////////////////////
$arg["start"]   = $objForm->get_start("knja131jForm1", "POST", "knja131jindex.php", "", "knja131jForm1");
...
//クラス選択コンボボックスを作成する///////////////////////////////////////////////////////////////////////////////
$db = Query::dbCheckOut();
$query = knja131jQuery::getAuth($model);
...
$objForm->ae( array("type"       => "select",
                    ...
                    "value"      => $model->field["GRADE_HR_CLASS"],
                 	"extrahtml"  => "onchange=\"return btn_submit('knja131j');\"",
...
$objForm->ae( array("type"       => "checkbox",
                    ...
                    "checked"    => true,
					"extrahtml"  => "onclick=\"kubun();\"",
					"value"      => isset($model->field["inei"])?$model->field["inei"]:"1"));
...
View::toHTML($model, "knja131jForm1.html", $arg); 
}
}
?>
