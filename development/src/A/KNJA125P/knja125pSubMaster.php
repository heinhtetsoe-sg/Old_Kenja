...
class knja125pSubMaster
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("submaster", "POST", "knja125pindex.php", "", "submaster");

        //DB接続
        $db = Query::dbCheckOut();

        //学年取得
        $getGradeName = $db->getOne(knja125pQuery::getGradeName($model));
        ...
        View::toHTML($model, "knja125pSubMaster.html", $arg);
    }
}
...
{
    $i = 0;
    $query = knja125pQuery::getHtrainRemarkTempSemesDat($model);
