...
class knja125jClubForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("clubForm1", "POST", "knja125jindex.php", "", "clubForm1");
        ...
        //部活動一覧
        $query = knja125jQuery::getClub($model);
        ...
        View::toHTML($model, "knja125jClubForm1.html", $arg);
    }
}
?>
