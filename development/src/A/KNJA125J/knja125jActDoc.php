...
class knja125jActDoc
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja125jindex.php", "", "edit");
        ...
        //行動の記録データ取得
        if ($model->schregno) {
            $result = $db->query(knja125jQuery::getActionDocumentDat($model));
        ...
        if (VARS::get("cmd") == "right_list") {
            $arg["reload"] = "parent.edit_frame.location.href='knja125jindex.php?cmd=edit'";
        }

        View::toHTML($model, "knja125jActDoc.html", $arg);
    }
}
