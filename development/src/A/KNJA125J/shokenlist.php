...
class shokenlist
{
    ...
    {
        $objForm = new form();
        $arg["start"] = $objForm->get_start("detail", "POST", "knja125jindex.php", "", "detail");
        ...
        //HTRAINREMARK_DAT 取得
        $model->data["YEAR"] = "";
        $result = $db->query(knja125jQuery::getTrainRow($model, "sanshou"));
        while ($Row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            //道徳
            $extra = "style=\"height:35px;\"";
            $Row["REMARK1"] = knjCreateTextArea($objForm, "REMARK1", 3, 41, "soft", $extra, $Row["REMARK1"]);
