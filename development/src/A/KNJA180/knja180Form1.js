...
function newwin(SERVLET_URL, schoolCd, fileDiv, cmd) {
    ...
    if(document.forms[0].COURSE_MAJOR_NAME.length == 0 || document.forms[0].COURSECODE.length == 0) {
        alert('{rval MSG916}');
        return true;
    }
    ...
    if (cmd == "csv") {
        ...
        document.forms[0].PRGID.value = "KNJA180_XLS";
    } else {
        document.forms[0].PRGID.value = "KNJA180";
    }
