...
class knja110SubForm1
{
    function main(&$model)
    {
        $objForm        = new form;
        $arg["start"]   = $objForm->get_start("sel", "POST", "knja110index.php", "", "sel");
        $arg["jscript"] = "";
        ...
        //生徒情報
        $Row = knja110Query::getStudent_data($model, $array[0]);
        ...
        $result   = $db->query(knja110Query::GetStudent($model->GradeClass));
...
#                            "extrahtml"   => "style=width:\"100%\"",
        ...
        //年組名
        $hr_name = $db->getOne(knja110Query::getHR_Name($model));
        ...
        //戻るボタン
        $link = REQUESTROOT."/A/KNJA110/knja110index.php?cmd=back&ini2=1";
        $objForm->ae( array("type"        => "button",
                            "name"        => "btn_back",
                            "value"       => "戻 る",
        ...
        View::toHTML($model, "knja110SubForm1.html", $arg);
    }
}
?>
