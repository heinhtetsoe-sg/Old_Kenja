function btn_submit(cmd) {
    if (cmd == "csv") {
        ...
        if (document.forms[0].useFormNameA223B.value == "KNJA223B_6") {
...
function kubun() {
    if (document.forms[0].FORM_DIV2.checked) {
       document.forms[0].KANA.disabled = false; 
       document.forms[0].RYOMEN.disabled = false; 
    } else {
       document.forms[0].KANA.disabled = true; 
       document.forms[0].RYOMEN.disabled = true; 
    }
}
