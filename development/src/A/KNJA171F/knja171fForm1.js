...
function kubun() {
    if (document.forms[0].PRINT_RADIO[0].checked) {
        document.forms[0].NOT_PRINT_HOGOSHA_NAME.disabled = false;
    } else {
        document.forms[0].NOT_PRINT_HOGOSHA_NAME.disabled = true;
    }
}
