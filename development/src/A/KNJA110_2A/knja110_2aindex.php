    ...
    function main()
    {
        ...
        while ( true ) {
            switch (trim($sessionInstance->cmd)) {
                ...
                case "kakutei":
                case "clear":
                    if ($sessionInstance->Properties["useFamilyDat"] == '1' && $sessionInstance->infoDiv == "6") {
                        $this->callView("knja110_2aFamily");
                    } else {
                        $this->callView("knja110_2aForm2");
                    }
                    break 2;
                case "apply":
                    $sessionInstance->setAccessLogDetail("S", "KNJA110_2A");
                ...
                case "copyBros":
                    $this->checkAuth(DEF_UPDATE_RESTRICT);
                    $sessionInstance->getCopyToBrotherModel();
                    $sessionInstance->setCmd("edit");
                    break 1;
