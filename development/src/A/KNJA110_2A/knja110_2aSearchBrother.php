...
function apply_stucd(obj,cmd) {
    if(obj.selectedIndex >= 0) {
        ...
        if(cmd == 'reflect') {
            ...
            f.document.forms[0].RELA_NAME.value     = arr[3];
            f.document.forms[0].RELA_KANA.value     = arr[4];
            f.document.forms[0].RELA_SEX.value      = (arr[5]=="男") ? 1 : 2;
            f.document.forms[0].RELA_BIRTHDAY.value = arr[8];
            f.document.forms[0].RELA_SCHREGNO.value = arr[0];
            f.document.forms[0].REGD_GRD_FLG.value  = '1';
            var gdhr = arr[6].preg_split("/,/");
