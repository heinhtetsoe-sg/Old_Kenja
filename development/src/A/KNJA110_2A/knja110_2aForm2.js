function btn_submit(cmd) {
    ...
    if (pop_up_flg) {
        ...
        var load = '';
        load  = "loadwindow('" + requestroot + "/A/KNJA110_2A/knja110_2aindex.php?cmd=subForm1";
    ...
    if (cmd == 'copyBros') {
        ...
        //存在チェック
        var bros = document.forms[0].CHECK_BROS.value;
        if (document.forms[0].CHECK_BROS.value == 0) {
            alert('コピー対象の兄弟姉妹がいません。');
            return false;
        }
    }
    document.forms[0].cmd.value = cmd;
