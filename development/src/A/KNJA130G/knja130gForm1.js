    ...
    if (cmd == 'update') {
        ...
        if (document.forms[0].category_selected.length == 0) {
            ...
            return;
                   ...
                   (document.forms[0].zenki_katsudo.checked == false) &&
                   (document.forms[0].zenki_gakushu.checked == false) &&
                   (document.forms[0].kouki_katsudo.checked == false) &&
                   (document.forms[0].kouki_gakushu.checked == false) &&
...
function kubun()
{
    ...
    var kubun4 = document.forms[0].zenki_katsudo;
    var kubun5 = document.forms[0].zenki_gakushu;
    var kubun6 = document.forms[0].tani;
    var kubun7 = document.forms[0].kouki_katsudo;
    var kubun8 = document.forms[0].kouki_gakushu;

    if ((kubun1.checked == false) && (kubun4.checked == false) && (kubun5.checked == false) && (kubun6.checked == false) && (kubun7.checked == false) && (kubun8.checked == false)) {
        flag3 = true;
    } else {
        flag3 = false;
    }
