...
class knja120SubForm5 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("list", "POST", "knja120index.php", "", "edit");
        ...
        $counter = 0;
        if ($model->schregno) {
            $result = $db->query(knja120Query::getAward($model));
        ...
        if (VARS::get("cmd") == "right_list"){ 
            $arg["reload"] = "parent.edit_frame.location.href='knja120index.php?cmd=edit'";
        }

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knja120SubForm5.html", $arg);
    }
}
