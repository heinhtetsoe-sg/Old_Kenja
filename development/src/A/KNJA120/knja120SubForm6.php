...
class knja120SubForm6 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform6", "POST", "knja120index.php", "", "subform6");
        ...
        //記録備考リスト
        $counter = 0;
        $query = knja120Query::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knja120SubForm6.html", $arg);
    }
}
?>
