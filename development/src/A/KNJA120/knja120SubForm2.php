...
class knja120SubForm2 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform2", "POST", "knja120index.php", "", "subform2");
		...
		//部活動リスト
        $counter = 0;
        $query = knja120Query::getClub($model);
        ...
        View::toHTML($model, "knja120SubForm2.html", $arg);
    }
}
?>
