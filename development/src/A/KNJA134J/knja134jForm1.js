...
window.onload = function () {
    if (sessionStorage.getItem("KNJA134jForm1_CurrentCursor") != null) {
        document.title = "";
        document.getElementById(sessionStorage.getItem("KNJA134jForm1_CurrentCursor")).focus();
    }
}

function current_cursor(para) {
    sessionStorage.setItem("KNJA134jForm1_CurrentCursor", para);
}
...
function btn_submit(cmd) {
    ...
    document.title = "";
    if (sessionStorage.getItem("KNJA134jForm1_CurrentCursor") != null) {
        document.getElementById(sessionStorage.getItem("KNJA134jForm1_CurrentCursor")).blur();
    }
    /* Add by PP for CurrentCursor 2020-01-17 end */
    if (cmd == 'update') {
...
function kubun() {
    ...
    document.forms[0].simei.disabled = printdisabled;
    document.forms[0].schzip.disabled = printdisabled;
    document.forms[0].schoolzip.disabled = printdisabled;
    document.forms[0].color_print.disabled = printdisabled;
}
