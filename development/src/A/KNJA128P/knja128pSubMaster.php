...
class knja128pSubMaster
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("submaster", "POST", "knja128pindex.php", "", "submaster");

        //DB接続
        $db = Query::dbCheckOut();

        //学年取得
        $getGradeName = $db->getOne(knja128pQuery::getGradeName($model));
        ...
        View::toHTML($model, "knja128pSubMaster.html", $arg);
    }
}
...
{
    $i = 0;
    $query = knja128pQuery::getHtrainRemarkTempSemesDat($model);
