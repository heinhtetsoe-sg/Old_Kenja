function btn_submit(cmd) {   
    ...
    if (cmd == 'change_hr_class' || cmd == 'update') {
        ...
        with(document.forms[0]){
            document.getElementById("LEFT_NUM").innerHTML = LEFT_PART.options.length;
            document.getElementById("RIGHT_NUM").innerHTML = RIGHT_PART.options.length;
        }
    }
...
//子画面へ
function openCheck() {
    alert('授業クラスに一人も割り振られていません。\n割り振り後は更新ボタンを押してください。');
    return;
}

function openCheck2() {
    return confirm('{rval MSG108}');
}
