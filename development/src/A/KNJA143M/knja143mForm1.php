...
class knja143mForm1
{
    function main(&$model) {
        ...
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("knja143mForm1", "POST", "knja143mindex.php", "", "knja143mForm1");

        //DB接続
        $db = Query::dbCheckOut();

        //学期マスタ
        $query = knja143mQuery::getSemeMst(CTRL_YEAR, CTRL_SEMESTER);
        ...
        $query = knja143mQuery::getStaff($model, CTRL_YEAR, CTRL_SEMESTER);
        ...
        View::toHTML($model, "knja143mForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJA143M");
