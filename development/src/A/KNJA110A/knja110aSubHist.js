function btn_submit(cmd) {
    if (cmd == "histDel" && !confirm("{rval MSG103}")) {
        return true;
    }
...
function loadCheck(REQUESTROOT) {
    ...
    var check_handicap = "0";

    load =
        "loadwindow('" +
        REQUESTROOT +
        "/A/KNJA110A/knja110aindex.php?cmd=subReplaceForm2";
...
function doSubmit(cmd) {
    if (
        document.forms[0].RCHECK3.checked &&
    ...
    if (
        document.forms[0].RCHECK4.checked &&
