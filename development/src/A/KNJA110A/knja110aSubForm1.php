...
class knja110aSubForm1
{
    public function main(&$model)
    {
        ...
        if ($model->cmd == 'subReplace') {
            ...
            $Row = knja110aQuery::getStudentData($array[0], $model);
        }
        //生徒情報
        ...
        $result = $db->query(knja110aQuery::getStudent($model));
...
#                            "extrahtml" => "style=width:\"100%\"",
        ...
        //年組名
        $hr_name = $db->getOne(knja110aQuery::getHRName($model));
        ...
        $arg["info"] = array("TOP"        =>  sprintf(
            "%d年度  %s  対象クラス  %s",
            CTRL_YEAR,
            $model->control_data["学期名"][CTRL_SEMESTER],
            $hr_name
        ),
                             "LEFT_LIST"  => "対象者一覧",
                             "RIGHT_LIST" => "生徒一覧");
        ...
        View::toHTML($model, "knja110aSubForm1.html", $arg);
    }
}
