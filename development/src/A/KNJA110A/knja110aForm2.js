...
function loadCheck(REQUESTROOT) {
    ...
    var check_real_name_kana =
        parent_real_name_kana != this_real_name_kana ? "1" : "0";
    var check_handicap = parent_handicap != this_handicap ? "1" : "0";

    var check_nationality2 =
        document.forms[0].NATIONALITY2_FLG.value == "1" ? "1" : "0";
    var check_nationality_name =
        document.forms[0].NATIONALITY_NAME_FLG.value == "1" ? "1" : "0";
    var check_nationality_name_kana =
        document.forms[0].NATIONALITY_NAME_KANA_FLG.value == "1" ? "1" : "0";
    var check_nationality_name_eng =
        document.forms[0].NATIONALITY_NAME_ENG_FLG.value == "1" ? "1" : "0";
    var check_nationality_real_name =
        document.forms[0].NATIONALITY_REAL_NAME_FLG.value == "1" ? "1" : "0";
    var check_nationality_real_name_kana =
        document.forms[0].NATIONALITY_REAL_NAME_KANA_FLG.value == "1"
            ? "1"
            : "0";
    ...
    load =
        "loadwindow('" +
        REQUESTROOT +
        "/A/KNJA110A/knja110aindex.php?cmd=subForm2";
    ...
    load +=
        "&NATIONALITY_REAL_NAME_KANA_FLG=" + check_nationality_real_name_kana;
...
function Name_Clip(name_text) {
    ...
    if (document.forms[0].NAME_SHOW.value == "")
        document.forms[0].NAME_SHOW.value = Cliping_str;
