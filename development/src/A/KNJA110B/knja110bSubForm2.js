function btn_submit(cmd) {
    if (cmd == 'subUpdate' || cmd == 'subReplace_update') {
        var isCheck = false;
        if (document.forms[0].GRADE_FLG.checked ||
        ...
        parent.document.forms[0].GRADE_FLG.value = document.forms[0].GRADE_FLG.checked ? "1" : "0";
        parent.document.forms[0].HR_CLASS_FLG.value = document.forms[0].HR_CLASS_FLG.checked ? "1" : "0";
        parent.document.forms[0].ATTENDNO_FLG.value = document.forms[0].ATTENDNO_FLG.checked ? "1" : "0";
        parent.document.forms[0].ANNUAL_FLG.value = document.forms[0].ANNUAL_FLG.checked ? "1" : "0";
        parent.document.forms[0].COURSECD_FLG.value = document.forms[0].COURSECD_FLG.checked ? "1" : "0";
        parent.document.forms[0].MAJORCD_FLG.value = document.forms[0].MAJORCD_FLG.checked ? "1" : "0";
        parent.document.forms[0].COURSECODE_FLG.value = document.forms[0].COURSECODE_FLG.checked ? "1" : "0";
        parent.document.forms[0].NAME_FLG.value = document.forms[0].NAME_FLG.checked ? "1" : "0";
        parent.document.forms[0].NAME_SHOW_FLG.value = document.forms[0].NAME_SHOW_FLG.checked ? "1" : "0";
        parent.document.forms[0].NAME_KANA_FLG.value = document.forms[0].NAME_KANA_FLG.checked ? "1" : "0";
        parent.document.forms[0].NAME_ENG_FLG.value = document.forms[0].NAME_ENG_FLG.checked ? "1" : "0";
        parent.document.forms[0].cmd.value = cmd;
        parent.document.forms[0].REAL_NAME_FLG.value = document.forms[0].REAL_NAME_FLG.checked ? "1" : "0";
        parent.document.forms[0].REAL_NAME_KANA_FLG.value = document.forms[0].REAL_NAME_KANA_FLG.checked ? "1" : "0";
        parent.document.forms[0].HANDICAP_FLG.value = document.forms[0].HANDICAP_FLG.checked ? "1" : "0";
