...
class knja121Form1
{
    ...
    {
        $objForm = new form;
        $arg["start"] = $objForm->get_start("edit", "POST", "knja121index.php", "", "edit");
        //警告メッセージを表示しない場合
        if ((isset($model->schregno) && !isset($model->warning)) || !isset($model->schregno)){
            $row = knja121Query::getTrainRow($model->schregno);
            $arg["NOT_WARNING"] = 1;
...
//                            "wrap"        => "hard",
        ...
        $arg["data"]["SPECIALACTREMARK"] = $objForm->ge("SPECIALACTREMARK");//高校のみ
...
//                            "wrap"        => "hard",
        ...
        $cnt = knja121Query::getKindaiJudgment();
        if ($cnt > 0) {
        } else {
...
*/
        ...
        View::toHTML($model, "knja121Form1.html", $arg);
    }
}
?>
