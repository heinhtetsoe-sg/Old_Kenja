...
class knja120jsForm2
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("form2", "POST", "knja120jsindex.php", "", "form2");
        ...
        //記録の取得
        $Row = $row = array();
        $result = $db->query(knja120jsQuery::getBehavior($model));
        ...
        //特別活動の記録の観点取得
        $row = $db->getRow(knja120jsQuery::getTrainRow($model), DB_FETCHMODE_ASSOC);
        ...
        View::toHTML($model, "knja120jsForm2.html", $arg);
    }
}
?>