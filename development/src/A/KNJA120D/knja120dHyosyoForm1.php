...
class knja120dHyosyoForm1 {
    function main(&$model) {
        //オブジェクト作成
        $objForm = new form;

        //フォーム作成
        $arg["start"] = $objForm->get_start("HyosyoForm1", "POST", "knja120dindex.php", "", "HyosyoForm1");

        //学校判定用
        $getSchoolName = knja120dQuery::getSchoolHantei();
        ...
        if ($model->schregno) {
            ...
            $result = $db->query(knja120dQuery::getHyosyo($model, $detail_div, $namecd1));
        ...
        //取込ボタン
        $extra = "disabled style=\"color:#1E90FF;font:bold\" onclick=\"return dataPositionSet('TRAIN_REF2');\"";
        ...
        View::toHTML($model, "knja120dHyosyoForm1.html", $arg);
    }
}
?>
