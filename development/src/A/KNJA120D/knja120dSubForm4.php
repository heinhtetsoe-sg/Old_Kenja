...
class knja120dSubForm4
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform4", "POST", "knja120dindex.php", "", "subform4");
        ...
        //中高一貫校
        $JH = (get_count($db->getOne(knja120dQuery::getJH())) > 0) ? "1" : "";

        //SQL文発行
        //年度（年次）取得
        $query = knja120dQuery::selectQueryAnnual($model, $JH);
        ...
        $query = knja120dQuery::selectQuerySubForm4($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knja120dSubForm4.html", $arg);
    }
}
?>