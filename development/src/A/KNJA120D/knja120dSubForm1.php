...
class knja120dSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knja120dindex.php", "", "subform1");
        ...
        $query = knja120dQuery::selectQueryGuide($model);
        ...
        View::toHTML($model, "knja120dSubForm1.html", $arg);
    }
}
?>
