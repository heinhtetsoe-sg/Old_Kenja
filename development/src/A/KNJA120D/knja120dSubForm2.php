...
class knja120dSubForm2
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knja120dindex.php", "", "subform2");
        ...
        $query = knja120dQuery::getClub($model);
        ...
        View::toHTML($model, "knja120dSubForm2.html", $arg);
    }
}
?>
