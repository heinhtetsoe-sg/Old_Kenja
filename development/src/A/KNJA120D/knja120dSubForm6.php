...
class knja120dSubForm6 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform6", "POST", "knja120dindex.php", "", "subform6");
        ...
        //記録備考リスト
        $counter = 0;
        $query = knja120dQuery::getSchregClubHdetailDat($model);
        ...
        View::toHTML($model, "knja120dSubForm6.html", $arg);
    }
}
?>
