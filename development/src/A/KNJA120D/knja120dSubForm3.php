...
class knja120dSubForm3
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knja120dindex.php", "", "subform3");
		...
		//委員会リスト
        $db = Query::dbCheckOut();
        $query = knja120dQuery::getCommittee($model);
        ...
        View::toHTML($model, "knja120dSubForm3.html", $arg);
    }
}
?>
