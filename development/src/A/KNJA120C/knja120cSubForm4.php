...
class knja120cSubForm4
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform4", "POST", "knja120cindex.php", "", "subform4");
        ...
        //中高一貫校
        $JH = (get_count($db->getOne(knja120cQuery::getJH())) > 0) ? "1" : "";

        //SQL文発行
        //年度（年次）取得
        $query = knja120cQuery::selectQueryAnnual($model, $JH);
        ...
        $query = knja120cQuery::selectQuerySubForm4($model, $JH);
        $result = $db->query($query);
        ...
        View::toHTML($model, "knja120cSubForm4.html", $arg);
    }
}
?>