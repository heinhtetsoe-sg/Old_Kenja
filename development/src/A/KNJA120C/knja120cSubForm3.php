...
class knja120cSubForm3
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knja120cindex.php", "", "subform3");
		...
		//委員会リスト
        $db = Query::dbCheckOut();
        $query = knja120cQuery::getCommittee($model);
        ...
        View::toHTML($model, "knja120cSubForm3.html", $arg);
    }
}
?>
