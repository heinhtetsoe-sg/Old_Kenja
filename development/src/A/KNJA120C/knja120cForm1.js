function btn_submit(cmd){
    if (document.forms[0].SCHREGNO.value == ""){
        ...
        loadwindow('knja120cindex.php?cmd=subform1',0,0,750,450);
        return true;
    }
    else if (cmd == 'subform2'){
        loadwindow('knja120cindex.php?cmd=subform2',0,0,650,250);
        return true;
    }
    else if (cmd == 'subform3'){
        loadwindow('knja120cindex.php?cmd=subform3',0,0,700,300);
        return true;
    } else if (cmd == 'subform4'){
        loadwindow('knja120cindex.php?cmd=subform4',0,0,700,550);
        return true;
    } else if (cmd == 'subform5'){
        loadwindow('knja120cindex.php?cmd=subform5',0,0,700,550);
        return true;
    }
