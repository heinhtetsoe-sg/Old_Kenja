...
class knjf320Form2
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("edit", "POST", "knjf320index.php", "", "edit");
        ...
        if (!isset($model->warning)){
            ...
            $query = knjf320Query::getRow($model->staffcd, $date);
        ...
        $query = knjf320Query::getStaffMst($model);
        ...
        //その他チェック
        $extra = "id=\"REMARK5_000\" onclick=\"etc_check('000');\"";
        ...
        //その他テキスト
        $extra = "";
        $arg["data"]["REMARK6_000"] = knjCreateTextBox($objForm, $Row["REMARK6_000"], "REMARK6_000", 60, 30, $extra.$disabled_etc0);
        ...
        //(4)その他チェック
        $extra = "id=\"REMARK5_004\" onclick=\"etc_check('004');\"";
        if ($Row["REMARK5_004"] == "1") {
            $extra .= "checked='checked' ";
            $disabled_etc4 = "";
        } else {
            $extra .= "";
        ...
        $arg["data"]["REMARK5_004"] = knjCreateCheckBox($objForm, "REMARK5_004", "1", $extra.$disabled4);
        //(4)その他テキスト
        $extra = "";
        $arg["data"]["REMARK6_004"] = knjCreateTextBox($objForm, $Row["REMARK6_004"], "REMARK6_004", 60, 30, $extra.$disabled4.$disabled_etc4);
        ...
        //(3)その他テキスト
        $extra = "";
        $arg["data"]["REMARK5_006"] = knjCreateTextBox($objForm, $Row["REMARK5_006"], "REMARK5_006", 60, 30, $extra.$disabled6.$disabled_etc6);
        ...
        if (VARS::get("cmd") != "edit"){
            $arg["reload"]  = "parent.left_frame.location.href='knjf320index.php?cmd=list';";
        }

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。 
        View::toHTML($model, "knjf320Form2.html", $arg); 
    }
}
