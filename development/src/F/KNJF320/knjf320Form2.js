...
function etc_check(seq) {
    if (seq === '000') {
        if (document.forms[0].REMARK5_000.checked == true) {
            document.forms[0].REMARK6_000.disabled = "";
        } else {
            document.forms[0].REMARK6_000.disabled = "true";
        }
        return;
    }
    if (seq === '001') {
    ...
    if (seq === '004') {
        if (document.forms[0].REMARK1_004.checked == true) {
            ...
            document.forms[0].REMARK6_004.disabled = "";
            if (document.forms[0].REMARK5_004.checked == true) {
                document.forms[0].REMARK6_004.disabled = "";
            } else {
                document.forms[0].REMARK6_004.disabled = "true";
            }
        } else {
    ...
    if (seq === '006') {
        if (document.forms[0].REMARK1_006.checked == true) {
            ...
            if (document.forms[0].REMARK4_006.checked == true) {
                document.forms[0].REMARK5_006.disabled = "";
            } else {
