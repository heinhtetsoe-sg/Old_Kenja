...
class knjf331fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf331fixedForm1", "POST", "knja110aindex.php", "", "knjf331fixedForm1");
        ...
        View::toHTML($model, "knjf331fixedForm1.html", $arg);
    }
}
