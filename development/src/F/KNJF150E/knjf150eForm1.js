...
function btn_submit(cmd) {
    if (cmd == "exec") {
        ...
        attribute3.value = "";
        sep = "";
        for (var i = 0; i < document.forms[0].HR_SELECTED.length; i++) {
            attribute3.value = attribute3.value + sep + document.forms[0].HR_SELECTED.options[i].value;
            sep = ",";
        }
    }
