...
class knjf020jSubForm2
{
    public function main(&$model)
    {
        $objForm = new form();
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjf020jSubForm2", "POST", "knjf020jindex.php", "", "knjf020jSubForm2");

        //DB接続
        $db = Query::dbCheckOut();

        $arg["data"]["SCHREGNO"] = $model->schregno;
        $query   = knjf020jQuery::getSchregRegdDatData($model);
        ...
        /* 各歯列作成 */
        $query = knjf020jQuery::getToothData($model);
        ...
        View::toHTML($model, "knjf020jSubForm2.html", $arg);
    }
}
