...
function newwin(SERVLET_URL){
    ...
    if (document.forms[0].SCHOOLNAME.value == "risshisha") {
        if ( document.forms[0].CHECK3.checked==false &&
    ...
    if (document.forms[0].CHECK20.checked) {
        if (document.forms[0].NYOCHECK1.checked==false &&
            document.forms[0].NYOCHECK2.checked==false &&
            document.forms[0].NYOCHECK3.checked==false 
           ) {
            alert('{rval MSG916}' + '\n\n尿検査結果のお知らせの対象を選択してください');
            return;
        }
    }
    //提出日チェック
