...
class knjf150fForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjf150fForm1", "POST", "knjf150findex.php", "", "knjf150fForm1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJF150F");

        //フォーム終わり
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjf150fForm1.html", $arg);
    }
}
//makeCmb
