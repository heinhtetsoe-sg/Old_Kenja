function btn_submit(cmd) {
    ...
    if ((cmd == 'subform2_delete') && !confirm('{rval MSG103}')){
        return true;
    } else if (cmd == 'subform2_delete'){
    ...
    if ((cmd == 'subform2_update') && (document.forms[0].SEQ.value == "")){
            alert('{rval MSG308}');
            return true;
    }
    ...
    if ((cmd == 'subform2_insert') || (cmd == 'subform2_update')){
        if ((document.forms[0].DISEASE.value == "") && 
            ...
            (document.forms[0].HOSPITAL.value == "") && 
            (document.forms[0].DOCTOR.value == "") && 
            (document.forms[0].MEDICINE.value == "") && 
