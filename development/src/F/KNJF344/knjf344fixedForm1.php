...
class knjf344fixedForm1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjf344fixedForm1", "POST", "knjf344index.php", "", "knjf344fixedForm1");
        ...
        View::toHTML($model, "knjf344fixedForm1.html", $arg);
    }
}
