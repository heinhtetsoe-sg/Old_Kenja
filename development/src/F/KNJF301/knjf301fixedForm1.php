...
class knjf301fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf301fixedForm1", "POST", "knja110aindex.php", "", "knjf301fixedForm1");
        ...
        View::toHTML($model, "knjf301fixedForm1.html", $arg);
    }
}
