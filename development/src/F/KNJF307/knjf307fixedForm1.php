...
class knjf307fixedForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf307fixedForm1", "POST", "knja110aindex.php", "", "knjf307fixedForm1");
        ...
        View::toHTML($model, "knjf307fixedForm1.html", $arg);
    }
}
