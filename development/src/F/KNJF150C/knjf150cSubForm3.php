...
class knjf150cSubForm3
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform3", "POST", "knjf150cindex.php", "", "subform3");
        ...
        //来室理由コンボ作成
        $query = knjf150cQuery::getNameMst('F203');
        $extra = "";
        ...
        View::toHTML($model, "knjf150cSubForm3.html", $arg);
    }
}
...
function makeBtn(&$objForm, &$arg, $model)
{
    ...
    if($model->Properties["useKnjf150_2Button"] == 1) {
        $extra = "onclick=\"loadwindow('../KNJF150C_2/knjf150c_2index.php?CALL_INFO=KNJF150C_3&SCHREGNO={$model->schregno}',0,0,800,600);return;\"";
