...
class knjf345fixedForm1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjf345fixedForm1", "POST", "knjf345index.php", "", "knjf345fixedForm1");
        ...
        View::toHTML($model, "knjf345fixedForm1.html", $arg);
    }
}
