...
class knjf306fixedForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf306fixedForm1", "POST", "knja110aindex.php", "", "knjf306fixedForm1");
        ...
        View::toHTML($model, "knjf306fixedForm1.html", $arg);
    }
}
