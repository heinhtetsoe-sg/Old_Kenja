...
class knjf306Form1 {
    function main(&$model) {
        ...
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("edit", "POST", "knjf306index.php", "", "edit");
        ...
        //画面上データ取得
        $Row = $db->getRow(knjf306Query::getRow($model), DB_FETCHMODE_ASSOC);

        //年度
        $arg["YEAR"] = CTRL_YEAR;

        //タイトル
        $arg["TITLE"] = "肥満傾向および痩身傾向出現率";
        ...
        //報告済み日付
        $query = knjf306Query::getReport($model);
        $setExeDate = "";
        ...
        $Row["HIMAN"]  = ($Row["HIMAN"]) ? $Row["HIMAN"] : 30;
        $Row["SOSHIN"] = ($Row["SOSHIN"]) ? $Row["SOSHIN"] : 30;
        //肥満傾向
        $extra = "style=\"text-align:right\" onblur=\"this.value=toInteger(this.value);\"";
        $arg["data"]["HIMAN"] = knjCreateTextBox($objForm, $Row["HIMAN"], "HIMAN", 4, 3, $extra);

        //痩身傾向
        $extra = "style=\"text-align:right\" onblur=\"this.value=toInteger(this.value);\"";
        $arg["data"]["SOSHIN"] = knjCreateTextBox($objForm, $Row["SOSHIN"], "SOSHIN", 4, 3, $extra);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJF306");
        ...
        View::toHTML($model, "knjf306Form1.html", $arg); 
    }
}
