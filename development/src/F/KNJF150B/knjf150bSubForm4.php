...
class knjf150bSubForm4
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform4", "POST", "knjf150bindex.php", "", "subform4");
        ...
        View::toHTML($model, "knjf150bSubForm4.html", $arg);
    }
}
