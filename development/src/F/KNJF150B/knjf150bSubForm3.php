...
class knjf150bSubForm3
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform3", "POST", "knjf150bindex.php", "", "subform3");
        ...
        //来室理由１コンボ作成
        $query = knjf150bQuery::getNameMst('F203');
        ...
        //処置１コンボ作成
        $query = knjf150bQuery::getNameMst('F210');
        ...
        View::toHTML($model, "knjf150bSubForm3.html", $arg);
    }
}
...
function makeBtn(&$objForm, &$arg, $model)
{
    ...
    if($model->Properties["useKnjf150_2Button"] == 1) {
        $extra = "onclick=\"loadwindow('../KNJF150B_2/knjf150b_2index.php?CALL_INFO=KNJF150B_3&SCHREGNO={$model->schregno}',0,0,800,600);return;\"";
