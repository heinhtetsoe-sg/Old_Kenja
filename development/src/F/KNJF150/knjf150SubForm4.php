...
class knjf150SubForm4
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("subform4", "POST", "knjf150index.php", "", "subform4");
        ...
        //生徒との関係コンボ作成
        $query = knjf150Query::getNameMst('F214');
        //生徒との関係テキスト入力可コード格納
        if ($model->schoolName != "miyagiken") {
            $f214Text = array();
        ...
        View::toHTML($model, "knjf150SubForm4.html", $arg);
    }
}
