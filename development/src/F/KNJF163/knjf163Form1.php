...
class knjf163Form1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf163Form1", "POST", "knjf163index.php", "", "knjf163Form1");
        //DB接続
        $db = Query::dbCheckOut();
        //年度テキストボックスを作成する
        ...
        //学年コンボ
        $extra = "onChange=\"return btn_submit('knjf163');\"";
        $query = knjf163Query::getSelectGrade($model);
        ...
        View::toHTML($model, "knjf163Form1.html", $arg); 
    }
}
/**************************************** 以下関数 **************************************************/
//コンボ作成
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    //クラス一覧
    $row1 = array();
    $result = $db->query(knjf163Query::getAuth($model));
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
