...
class knjf310fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf310fixedForm1", "POST", "knja110aindex.php", "", "knjf310fixedForm1");
        ...
        View::toHTML($model, "knjf310fixedForm1.html", $arg);
    }
}
