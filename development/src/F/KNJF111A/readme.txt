# kanji=漢字
# $Id: readme.txt 64925 2019-01-18 06:46:35Z matsushima $

2009/11/06  1.新規作成

2009/11/09  1.CSVのファイル名、タイトルの修正「保健室利用人数集計表」⇒「症状別保健室利用人数集計表」

2010/03/03  1.MAX学期の学年を参照するよう修正した。

2010/06/01  1.年度コンボを追加

2010/06/04  1.CSV出力で「NAME_MST」のZ010の予備2を参照して中学・高校でわけるかの処理追加

2010/07/01  1.文言変更 健康相談活動 → 健康相談

2014/08/05  1.ログ取得機能追加

2016/07/05  1.年度コンボ内の"年度"表示をカット
            2.CSV出力の学年表示を学年名称に変更
