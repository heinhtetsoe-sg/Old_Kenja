...
class knjf341fixedForm1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjf341fixedForm1", "POST", "knjf341index.php", "", "knjf341fixedForm1");
        ...
        View::toHTML($model, "knjf341fixedForm1.html", $arg);
    }
}
