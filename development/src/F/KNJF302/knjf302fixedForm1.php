...
class knjf302fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf302fixedForm1", "POST", "knja110aindex.php", "", "knjf302fixedForm1");
        ...
        View::toHTML($model, "knjf302fixedForm1.html", $arg);
    }
}
