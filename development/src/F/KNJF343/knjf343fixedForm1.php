...
class knjf343fixedForm1
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjf343fixedForm1", "POST", "knjf343index.php", "", "knjf343fixedForm1");
        ...
        View::toHTML($model, "knjf343fixedForm1.html", $arg);
    }
}
