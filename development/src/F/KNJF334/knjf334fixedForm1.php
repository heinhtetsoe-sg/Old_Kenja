...
class knjf334fixedForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjf334fixedForm1", "POST", "knja110aindex.php", "", "knjf334fixedForm1");
        ...
        View::toHTML($model, "knjf334fixedForm1.html", $arg);
    }
}
