...
//カレンダーコントロール１//////////////////////////////////////////////
//$value = isset($model->field["DATE1"])?$model->field["DATE1"]:$model->control['学期開始日付'][9];		//cut 04/08/20 yamauchi
...
//$value2 = isset($model->field["DATE2"])?$model->field["DATE2"]:$model->control['学期終了日付'][9];	//cut 04/08/20 yamauchi
...
//クラス選択コンボボックスを作成する
$db = Query::dbCheckOut();
$query = knjc040Query::getAuth($model->control["年度"],$model->control["学期"]);
...
$objForm->ae( array("type"      => "hidden",
                    "name"      => "CHK_SDATE",
                    "value"     => $model->control['学期開始日付'][9]
                    ) );
//年度終了日
$objForm->ae( array("type"      => "hidden",
                    "name"      => "CHK_EDATE",
                    "value"     => $model->control['学期終了日付'][9]
                    ) );
