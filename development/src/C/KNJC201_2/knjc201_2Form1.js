...
function OptionUse(obj) {
    if (document.forms[0].CONTACTERDIV[2].checked == true) {
        document.forms[0].CONTACTER.disabled = false;
        document.forms[0].CONTACTER.style.backgroundColor = '#ffffff';
    } else {
        document.forms[0].CONTACTER.disabled = true;
        document.forms[0].CONTACTER.style.backgroundColor = '#D3D3D3';
    }
}
