...
//印刷
//sDate:学期開始日 eDate:学期終了日
function newwin(SERVLET_URL, sDate, eDate) {
    ...
    if (document.forms[0].SDATE.value < sDate) {
        alert("出力対象範囲の開始日が学期開始日以前に設定されています。\n出力対象範囲の開始日は学期開始日以降の日付を設定して下さい。");
        return;
    }
    if (document.forms[0].EDATE.value > eDate) {
        alert("出力対象範囲の終了日が学期終了日以降に設定されています。\n出力対象範囲の終了日は学期終了日までの日付を設定して下さい。");
        return;
    }
    
    if (document.forms[0].SDATE.value > document.forms[0].EDATE.value) {
        alert("出力対象範囲の終了日は、出力対象範囲の開始日以降を設定して下さい。");
        return;
    }
