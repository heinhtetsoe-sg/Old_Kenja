function btn_submit(cmd) {
    ...
    var old = document.forms[0].cmd.value;
    document.forms[0].cmd.value = cmd;
    document.forms[0].submit();
    document.forms[0].cmd.value = old;
    return false;
}
...
function newwin(SERVLET_URL, cmd) {
    ...
    var cmdbk = document.forms[0].cmd.value;
    if (cmd) {
        document.forms[0].cmd.value = cmd;
    }
...
function checkOutput() {
    if (document.forms[0].OUTPUT1.checked) {
        document.forms[0].KESSEKI_NISSU.disabled = false;
        document.forms[0].TYUI_TYOUKA1.disabled = true;
        document.forms[0].TYUI_TYOUKA2.disabled = true;
    } else if (document.forms[0].OUTPUT2.checked) {
        document.forms[0].KESSEKI_NISSU.disabled = true;
        document.forms[0].TYUI_TYOUKA1.disabled = false;
        document.forms[0].TYUI_TYOUKA2.disabled = false;
    }
}
