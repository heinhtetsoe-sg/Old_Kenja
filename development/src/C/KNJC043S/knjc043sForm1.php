...
class knjc043sForm1
{
    function main(&$model){
        ...
        $objForm = new form;
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjc043sForm1", "POST", "knjc043sindex.php", "", "knjc043sForm1");
        ...
        if (!$model->field["RADIO1"]) $model->field["RADIO1"] = 1;
        for ($i = 1; $i <= 2; $i++) {
            $name = "RADIO1_".$i;
        ...
        $query = knjc043sQuery::getAuth($model, $model->control["年度"],$model->control["学期"]);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJC043S");
        ...
        //TESTITEM_MST_COUNTFLG / TESTITEM_MST_COUNTFLG_NEW
        ...
        View::toHTML($model, "knjc043sForm1.html", $arg); 
