...
{   
	...
	{  
		...
		tempaa[y] = String(attribute2.options[i].text).substr(1,3)+","+y;
	}
	...
	{   
		...
		{  
			...
			tempaa[y] = String(attribute1.options[i].text).substr(1,3)+","+y;
		}
		else
		{  
			y=current2++
...
{   
	...
	{  
		...
		tempaa[z] = String(attribute6.options[i].text).substr(1,3)+","+z;
	}
	...
	{   
		...
		tempaa[z] = String(attribute5.options[i].text).substr(1,3)+","+z;
	}
