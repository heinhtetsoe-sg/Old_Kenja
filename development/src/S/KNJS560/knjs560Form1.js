function btn_submit(cmd) {
    ...
    if (cmd == 'exec'){
        if (document.forms[0].OUTPUT[0].checked == true || document.forms[0].OUTPUT[2].checked == true) {
            cmd = "csv";
        }
        if (document.forms[0].OUTPUT[1].checked == true && document.forms[0].SHORI_MEI.value == "2") {
            cmd = "henkan";
        }
    }
