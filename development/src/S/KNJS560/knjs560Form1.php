...
class knjs560Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjs560index.php", "", "main");
        ...
        $opt_shori[] = array("label" => "変換","value" => "2");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJS560");
        ...
        View::toHTML($model, "knjs560Form1.html", $arg);
    }
}
