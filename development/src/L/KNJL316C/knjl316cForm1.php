...
class knjl316cForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl316cForm1", "POST", "knjl316cindex.php", "", "knjl316cForm1");
        ...
        //extra
        $extra = " onChange=\"return btn_submit('knjl316c');\"";

        //入試制度コンボの設定
        $query = knjl316cQuery::getApctDiv("L003", $model->ObjYear);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボの設定
        $query = knjl316cQuery::getTestDiv("L004", $model->ObjYear);
        ...
        $query = knjl316cQuery::getSHDiv("L006", $model->ObjYear, $div);
        ...
        View::toHTML($model, "knjl316cForm1.html", $arg); 
	}
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL316C");
