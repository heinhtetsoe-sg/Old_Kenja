...
class knjl080qForm1 {
    ...
    function main(&$model) {
        ...
        $arg["start"] = $objForm->get_start("sel", "POST", "knjl080qindex.php", "", "sel");
        ...
        //入試制度
        $query = knjl080qQuery::getNameMst($model->ObjYear, "L003");
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        $nameCd2 = (SCHOOLKIND == "P") ? "LP24": "L024";

        //入試区分
        $query = knjl080qQuery::getNameMst($model->ObjYear, $nameCd2);
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "TESTDIV", $model->testdiv, $extra, 1);

        //リストタイトル用
        $arg["LEFT_TITLE"]  = "手続き対象者一覧";
        $arg["RIGHT_TITLE"] = "合格者一覧";

        //対象者・合格者一覧
        $opt_left = $opt_right = array();
        $query = knjl080qQuery::GetLeftList($model);
        ...
        //対象者一覧
        $extra = "multiple STYLE=\"WIDTH:100%\" ondblclick=\"move3('right','LEFT_PART','RIGHT_PART',1);\"";
        $arg["main_part"]["LEFT_PART"] = knjCreateCombo($objForm, "LEFT_PART", "left", $opt_left, $extra, 30);

        //合格者一覧
        $extra = "multiple STYLE=\"WIDTH:100%\" ondblclick=\"move3('left','LEFT_PART','RIGHT_PART',1);\"";
        ...
        View::toHTML($model, "knjl080qForm1.html", $arg); 
    }
}
