...
class knjl301rForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl301rForm1", "POST", "knjl301rindex.php", "", "knjl301rForm1");
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl301rQuery::getNameMst($model, $model->ObjYear, "L003"));
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl301rQuery::getNameMst($model, $model->ObjYear, "L004"));
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            $opt[] = array('label' => $row["LABEL"],
                           'value' => $row["VALUE"]);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL301R");
        ...
        View::toHTML($model, "knjl301rForm1.html", $arg); 
