...
class knjl080gForm1
{
    function main(&$model)
    {
        ...
        //入試制度
        $query = knjl080gQuery::GetName("L003", $model->ObjYear);
        ...
        $result = $db->query(knjl080gQuery::GetName("L004", $model->ObjYear));
        ...
        //専併区分コンボボックス
        $extra = "Onchange=\"btn_submit('main');\"";
        $query = knjl080gQuery::GetName("L006", $model->ObjYear);
        ...
        $query = knjl080gQuery::GetLeftList($model);
        ...
        $arg["start"]   = $objForm->get_start("sel", "POST", "knjl080gindex.php", "", "sel");

        $arg["finish"]  = $objForm->get_finish();

        View::toHTML($model, "knjl080gForm1.html", $arg); 
    }
}
