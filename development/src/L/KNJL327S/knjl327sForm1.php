...
class knjl327sForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl327sForm1", "POST", "knjl327sindex.php", "", "knjl327sForm1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL327S");
        ...
        View::toHTML($model, "knjl327sForm1.html", $arg);
    }
}
?>
