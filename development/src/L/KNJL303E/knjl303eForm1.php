...
class knjl303eForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl303eForm1", "POST", "knjl303eindex.php", "", "knjl303eForm1");
        ...
        //入試制度
        $query = knjl303eQuery::getNameMst($model->examyear, "L003");
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, $model->applicantdiv, "APPLICANTDIV", $extra, 1);

        //入試区分
        $query = knjl303eQuery::getNameMst($model->examyear, "L004");
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL303E");
        ...
        View::toHTML($model, "knjl303eForm1.html", $arg);
    }
}
