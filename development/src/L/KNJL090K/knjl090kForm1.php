...
class knjl090kForm1
{
    function main(&$model)
    {
        $db = Query::dbCheckOut();
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl090kindex.php", "", "main");
        ...
        //試験区分
        $opt = array();
        $result = $db->query(knjl090kQuery::GetName("L003", $model->examyear));
        ...
        View::toHTML($model, "knjl090kForm1.html", $arg);
    }
}
?>
