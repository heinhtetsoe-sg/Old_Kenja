    ...
    if (cmd == 'update'){
        ...
        for (var i = 0; i < document.forms[0].elements.length; i++){
            ...
            if (el.name == "SEX[]" && v != "" && typeof sex_name[v] == "undefined"){
                ...
                flg = true;
            }else if (el.name == "DESIREDIV[]" && v != "" && typeof examcourse_name[v] == "undefined"){
                document.forms[0].elements[i].style.background="red";
                flg = true;
...
function setName(obj, rowid, flg)
{
    ...
    if (obj.value == '') {
        if (flg == '0') {
            ...
            outputLAYER('EXAMCOURSE_NAME' + rowid, '');
        }else if (flg == '2') {
    ...
    if (flg == '0') {
        ...
        if (typeof examcourse_name[idx] != "undefined") {
            outputLAYER('EXAMCOURSE_NAME' + rowid, examcourse_name[idx]);
        } else {
            alert('{rval MSG901}');
            outputLAYER('EXAMCOURSE_NAME' + rowid, '');
            obj.value = '';
