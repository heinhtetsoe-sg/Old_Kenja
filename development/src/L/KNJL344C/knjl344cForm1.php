...
class knjl344cForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl344cForm1", "POST", "knjl344cindex.php", "", "knjl344cForm1");
        ...
        //入試制度コンボの設定
        $query = knjl344cQuery::getApctDiv("L003", $model->ObjYear);
        ...
        View::toHTML($model, "knjl344cForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL344C");
