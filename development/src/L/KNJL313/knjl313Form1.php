...
/* ･NO002：指定範囲の文言を変更                     山内 2005/01/13 */
/********************************************************************/
...
class knjl313Form1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl313Form1", "POST", "knjl313index.php", "", "knjl313Form1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl313Query::get_apct_div("L003",$model->ObjYear));	/* NO001 */
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl313');\"",
	...
	$defoult     = 1 ;
	$db = Query::dbCheckOut();
	$result = $db->query(knjl313Query::get_test_div($model->ObjYear));	/* NO001 */
	...
	View::toHTML($model, "knjl313Form1.html", $arg); 
	}
}
?>
