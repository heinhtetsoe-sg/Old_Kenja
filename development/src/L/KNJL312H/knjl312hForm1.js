...
{   
	...
	{  
		...
		tempaa[current2] = String(attribute2.options[i].value).substr(0,5)+","+current2;
		current2++;
	}
	...
	{   
		...
		{  
			...
			tempaa[current2] = String(attribute1.options[i].value).substr(0,5)+","+current2;
			current2++;
		}
		else
		{  
...
function newwin(SERVLET_URL){
	...
	if (document.forms[0].SUBCLASS_TYPE.value == ""){
		alert("受験科目を指定して下さい");
		return;
	}
