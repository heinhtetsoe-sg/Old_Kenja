...
class knjl310fForm1
{
    public function main(&$model)
    {
        ...
        /******************/
        //入試制度
        $query = knjl310fQuery::getNameMst($model->ObjYear, "L003");
        $extra = "onchange=\"return btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試種類
        if ($model->field["APPLICANTDIV"] == "1") {
            $query = knjl310fQuery::getTestLDiv($model->ObjYear, "L024");
            $extra = "onchange=\"return btn_submit('main');\"";
            makeCmb($objForm, $arg, $db, $query, "TEST_L_DIV", $model->field["TEST_L_DIV"], $extra, 1);
        }
        ...
        ****************/
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl310findex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl310fForm1.html", $arg);
    }
}
