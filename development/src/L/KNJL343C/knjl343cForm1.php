...
class knjl343cForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl343cForm1", "POST", "knjl343cindex.php", "", "knjl343cForm1");
        ...
        //入試制度コンボの設定
        $query = knjl343cQuery::getApctDiv("L003", $model->ObjYear);
        ...
        View::toHTML($model, "knjl343cForm1.html", $arg); 
	}
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL343C");
