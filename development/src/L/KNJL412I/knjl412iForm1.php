...
class knjl412iForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl412iindex.php", "", "main");
        ...
        $query = knjl412iQuery::getNameMst($model->examyear, "L003", $model->applicantdiv);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分コンボボックス
        $extra = "";
        $query = knjl412iQuery::getTestDiv($model);
        ...
        View::toHTML($model, "knjl412iForm1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJL412I");
