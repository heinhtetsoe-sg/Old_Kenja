...
class knjl344wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl344windex.php", "", "main");
        ...
        $radioArray = knjCreateRadio($objForm, "CSV_PRG", 4, $extra, $opt, get_count($opt));
        foreach($radioArray as $key => $val) $arg["data"][$key] = $val;

        //V_SCHOOL_MSTから学校コードを取得
        $model->schoolcd = $db->getOne(knjl344wQuery::getSchoolInfo($model));

        //報告表示
        $query = knjl344wQuery::getReport($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL344W");
        ...
        View::toHTML($model, "knjl344wForm1.html", $arg);
    }
}
?>
