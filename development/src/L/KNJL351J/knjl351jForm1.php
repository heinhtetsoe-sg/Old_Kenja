...
class knjl351jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl351jForm1", "POST", "knjl351jindex.php", "", "knjl351jForm1");
    ...
    //入学区分コンボ
    $query = knjl351jQuery::getTestdiv("L004",$model);
    makeCmb($objForm, $arg, $db, $query, "TESTDIV", $model->field["TESTDIV"], "", 1);

    Query::dbCheckIn($db);

    //出力順ラジオボタン 1:受験番号 2:塾名
    $opt_sort = array(1,2);
    ...
    View::toHTML($model, "knjl351jForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJL351J"));
