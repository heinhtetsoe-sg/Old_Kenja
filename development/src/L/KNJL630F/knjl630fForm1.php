...
class knjl630fForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl630fForm1", "POST", "knjl630findex.php", "", "knjl630fForm1");
        ...
        $query = knjl630fQuery::getNameMst($model->year, "L003");
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1);

        //入試区分コンボ
        $extra = "";
        $namecd1 = $model->applicantdiv == "1" ? "L024" : "L004";
        $query = knjl630fQuery::getNameMst($model->year, $namecd1, $model->testdiv);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL630F");
        ...
        View::toHTML($model, "knjl630fForm1.html", $arg);
    }
}
