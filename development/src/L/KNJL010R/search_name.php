...
class SearchNames
{
    ...
    function getNameList(){
        ...
        if (strlen($this->names) || strlen($this->name_kana) || strlen($this->receptno)){
            ...
            $query .= "    LEFT JOIN ENTEXAM_APPLICANTBASE_DETAIL_BUN_DAT BUN012 ON BUN012.SEQ = '012' ";
            $query .= "         AND BUN012.ENTEXAMYEAR = BASE.ENTEXAMYEAR ";
            ...
            if (strlen($this->receptno)){
                 $query .= " AND (BUN012.REMARK1 = '" .$this->receptno ."' OR BUN012.REMARK2 = '" .$this->receptno ."') ";
            }
