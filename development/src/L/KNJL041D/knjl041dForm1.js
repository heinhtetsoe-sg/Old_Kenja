...
function CheckOn(obj, flg) {
    ...
    var checkIntAb = document.getElementById("INTERVEW_ABSENCE-" + arrData[1]);
    ...
    if ((checkTesAb.checked == true && flg == "1") || (checkTesAb.checked == true && checkIntAb.checked == true)) {
        checkIntAb.checked = true;
        document.getElementById('ROWID' + arrData[1]).style.background = "red";
    }

    if ((checkTesAb.checked == false && checkIntAb.checked == true) || (checkTesAb.checked == true && checkIntAb.checked == false)) {
        document.getElementById('ROWID' + arrData[1]).style.background = "yellow";
    }

    if (checkTesAb.checked == false && checkIntAb.checked == false) {
