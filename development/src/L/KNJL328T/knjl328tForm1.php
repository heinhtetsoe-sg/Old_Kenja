...
class knjl328tForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl328tForm1", "POST", "knjl328tindex.php", "", "knjl328tForm1");
        ...
        //入試制度
        $query = knjl328tQuery::getApplicantdiv($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL328T");
        ...
        View::toHTML($model, "knjl328tForm1.html", $arg);
    }
}
//コンボ作成
