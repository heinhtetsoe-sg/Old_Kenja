...
class knjl280yForm1
{
    function main(&$model) {
        ...
        $query = knjl280yQuery::getNameMst("L003", $model->ObjYear);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分コンボボックス
        $model->field["TESTDIV"] = "";
        $query = knjl280yQuery::getNameMst("L004", $model->ObjYear);
        $extra = "onchange=\"return btn_submit('main');\"";
        ...
        $result = $db->query(knjl280yQuery::GetLeftList($model));
        ...
        //合格者一覧
        $opt_right = array();
        $result = $db->query(knjl280yQuery::GetRightList($model));
        ...
        $arg["start"]   = $objForm->get_start("sel", "POST", "knjl280yindex.php", "", "sel");

        $arg["finish"]  = $objForm->get_finish();

        View::toHTML($model, "knjl280yForm1.html", $arg);
    }
}
