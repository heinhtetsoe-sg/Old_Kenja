...
class knjl438iForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl438iindex.php", "", "main");
        ...
        $query = knjl438iQuery::getNameMst($model->examyear, "L003", $model->applicantdiv);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分コンボボックス
        $extra = "";
        $query = knjl438iQuery::getTestDiv($model);
        ...
        View::toHTML($model, "knjl438iForm1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJL438I");
