...
class knjl352nForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl352nForm1", "POST", "knjl352nindex.php", "", "knjl352nForm1");
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl352nQuery::getNameMst($model->ObjYear, "L003"));
        ...
        $extra = " onchange=\"return btn_submit('knjl352n');\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL352N");
        ...
        View::toHTML($model, "knjl352nForm1.html", $arg);
    }
}
//makeCmb
