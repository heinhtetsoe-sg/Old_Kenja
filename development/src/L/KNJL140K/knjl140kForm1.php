...
class knjl140kForm1
{
    ...
    {
        $objForm = new form();
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl140kindex.php", "", "main");
        ...
        $result = $db->query(knjl140kQuery::getExamCourse($model->examyear));
        ...
        View::toHTML($model, "knjl140kForm1.html", $arg);
    }
}
