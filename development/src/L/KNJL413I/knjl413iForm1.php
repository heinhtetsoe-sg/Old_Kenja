...
class knjl413iForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl413iForm1", "POST", "knjl413iindex.php", "", "knjl413iForm1");
        ...
        //入試制度コンボ
        $extra = " onchange=\"return btn_submit('knjl413i');\"";
        $query = knjl413iQuery::getNameMst($model, "L003");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL413I");
        ...
        View::toHTML($model, "knjl413iForm1.html", $arg); 
    }
}
