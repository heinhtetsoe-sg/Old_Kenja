...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].FORM_KIND.value == '1') {
        if (document.forms[0].TRANSFER_DATE1.value == '' || document.forms[0].TENNYUGAKU_DATE.value == '') {
            alert('{rval MSG301}\n( 日付 )');
            return;
        }
    }
    if (document.forms[0].FORM_KIND.value == '3') {
        if (document.forms[0].TRANSFER_DATE1.value == '' || document.forms[0].TENSEKI_DATE.value == '') {
            alert('{rval MSG301}\n( 日付 )');
            return;
        }
    }
    if (document.forms[0].FORM_KIND.value == '6') {
        if (document.forms[0].TENNYUGAKU_DATE.value == '') {
            alert('{rval MSG301}\n( 日付 )');
            return;
        }
    }

    // 6:生徒転入学について（合格者） or 9:生徒転籍について（合格者）
    if (document.forms[0].FORM_KIND.value == '6' || document.forms[0].FORM_KIND.value == '9') {
