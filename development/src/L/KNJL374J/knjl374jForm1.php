...
class knjl374jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl374jForm1", "POST", "knjl374jindex.php", "", "knjl374jForm1");
    ...
    View::toHTML($model, "knjl374jForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJL374J"));
