...
class knjl364wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl364windex.php", "", "main");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL364W");
        ...
        View::toHTML($model, "knjl364wForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjl364wQuery::getSchoolData($model);
