...
class knjl084qForm1 {
    ...
    function main(&$model) {
        ...
        $arg["start"] = $objForm->get_start("sel", "POST", "knjl084qindex.php", "", "sel");
        ...
        //入試制度
        $query = knjl084qQuery::getNameMst($model->ObjYear, "L003");
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分
        if (SCHOOLKIND == "J") {
            $query = knjl084qQuery::getNameMst($model->ObjYear, "L024");
        } else {
            $query = knjl084qQuery::getNameMst($model->ObjYear, "L004");
        }
        $extra = "Onchange=\"btn_submit('main');\"";
        ...
        $query = knjl084qQuery::GetLeftList($model);
        ...
        View::toHTML($model, "knjl084qForm1.html", $arg); 
    }
}
