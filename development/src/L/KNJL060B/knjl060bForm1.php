...
class knjl060bForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl060bindex.php", "", "main");
        ...
        $query = knjl060bQuery::getNameMst("L003", $model->examyear, ""); //1:中学は表示しない
        ...
        $query = knjl060bQuery::getNameMst("L004", $model->examyear, "");
        ...
        View::toHTML($model, "knjl060bForm1.html", $arg);
    }
}
