...
class knjl414mForm1
{
    public function main(&$model)
    {
        ...
        $query = knjl414mQuery::getSchoolKind($model);
        makeCmb($objForm, $arg, $db, $query, "SCHOOL_KIND", $model->schoolKind, $extra, 1);

        //試験コンボ
        $extra = "";
        $query = knjl414mQuery::getExamId($model);
        ...
        //HTML出力終了
        $arg["start"]  = $objForm->get_start("main", "POST", "knjl414mindex.php", "", "main");
        $arg["finish"] = $objForm->get_finish();
        View::toHTML($model, "knjl414mForm1.html", $arg);
    }
}
