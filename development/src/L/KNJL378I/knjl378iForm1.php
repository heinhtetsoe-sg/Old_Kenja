...
class knjl378iForm1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("csv", "POST", "knjl378iindex.php", "", "csv");
        ...
        $query = knjl378iQuery::getNameMst("L003", $model->field["APPLICANTDIV"]);
        $extra = "onChange=\"btn_submit('main')\"";
        
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1, "");

        //入試区分
        $query = knjl378iQuery::getEntexamTestDivMst($model->field["APPLICANTDIV"]);
        $extra = "onChange=\"btn_submit('main')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL378I");
        ...
        View::toHTML($model, "knjl378iForm1.html", $arg);
    }
}
