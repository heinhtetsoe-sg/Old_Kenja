...
class knjl317uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl317uForm1", "POST", "knjl317uindex.php", "", "knjl317uForm1");
        ...
        //入試制度コンボ
        $query = knjl317uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl317u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl317uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl317u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL317U");
        ...
        View::toHTML($model, "knjl317uForm1.html", $arg);
    }
}
//makeCmb
