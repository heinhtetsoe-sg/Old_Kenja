...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].RESALT1.checked == true) {
        if (document.forms[0].ORIHOUR.disabled == false && document.forms[0].ORIHOUR.value == '' || document.forms[0].ORIMINUTE.disabled == false && document.forms[0].ORIMINUTE.value == '') {
            alert('{rval MSG301}\n( 帳票種類、時間 )');
            return;
        }
    }
...
function disAbled(obj) {
    if (obj.name == "RESALT") {
        ...
        if (document.forms[0].APPLICANTDIV.value == "1" && document.forms[0].TESTDIV.value == "1") {
            document.forms[0].ORIDATE.disabled     = true;
            document.forms[0].ORIHOUR.disabled     = true;
            document.forms[0].ORIMINUTE.disabled   = true;
        }
    }
    if (obj.name == "ALLFLG") {
        if (obj.value == 1) {
