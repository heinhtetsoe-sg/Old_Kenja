...
class knjl014pForm1
{
    public function main(&$model)
    {
        ...
        /******************/
        //入試制度
        $query = knjl014pQuery::getNameMst($model->ObjYear, "L003");
        $extra = "onchange=\"return btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分
        $namecd1 = ($model->field["APPLICANTDIV"] == "2") ? "L004" : "L024";
        $query = knjl014pQuery::getNameMst($model->ObjYear, $namecd1);
        $extra = "onchange=\"return btn_submit('main');\"";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl014pindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl014pForm1.html", $arg);
    }
}
