function btn_submit(cmd, zip, gzip, zadd, gadd) 
{
    ...
    if (cmd == 'disp_clear' || cmd == 'showdiv') {
        for (i = 0; i < document.forms[0].elements.length; i++) {
            if (document.forms[0].elements[i].type == 'select-one' || document.forms[0].elements[i].type == 'text' || document.forms[0].elements[i].type == 'textarea' || document.forms[0].elements[i].type == 'checkbox') {
                if (document.forms[0].elements[i].name == 'APPLICANTDIV' || document.forms[0].elements[i].name == 'TESTDIV' || document.forms[0].elements[i].name == 'SEX') {
                    // 入試制度はクリアしない
...
function disabledCommon(div, val) {
    ...
    if (div == 'general_flg') {
        if (document.forms[0].GENERAL_FLG.checked) {
            document.forms[0].GENERAL_TESTDIV.disabled = false;
        } else {
            document.forms[0].GENERAL_TESTDIV.disabled = true;
        }
    }
}
