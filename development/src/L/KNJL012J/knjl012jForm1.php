...
class knjl012jForm1
{
    function main(&$model)
    {
        $db = Query::dbCheckOut();
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl012jindex.php", "", "main");
...
//        $arg["YEAR"] = CTRL_YEAR;
        ...
        //出願区分
        $opt = array();
        $result = $db->query(knjl012jQuery::GetName("L004",$model->ObjYear));
        ...
        View::toHTML($model, "knjl012jForm1.html", $arg);
    }
}
?>
