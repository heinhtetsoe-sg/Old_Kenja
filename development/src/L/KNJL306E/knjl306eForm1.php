...
class knjl306eForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl306eForm1", "POST", "knjl306eindex.php", "", "knjl306eForm1");
        ...
        //入試制度コンボ
        $query = knjl306eQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl306e')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL306E");
        ...
        View::toHTML($model, "knjl306eForm1.html", $arg);
    }
}
//makeCmb
