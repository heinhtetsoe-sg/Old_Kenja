...
class knjl343wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl343windex.php", "", "main");
        ...
        $model->schoolcd = $db->getOne(knjl343wQuery::getSchoolInfo($model));

        //報告表示
        $query = knjl343wQuery::getReport($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL343W");
        ...
        View::toHTML($model, "knjl343wForm1.html", $arg);
    }
}
?>
