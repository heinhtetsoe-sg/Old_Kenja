...
class knjl760hForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("csv", "POST", "knjl760hindex.php", "", "csv");
        ...
        View::toHTML($model, "knjl760hForm1.html", $arg);
    }
}
