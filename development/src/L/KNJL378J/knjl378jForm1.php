...
class knjl378jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl378jForm1", "POST", "knjl378jindex.php", "", "knjl378jForm1");
    ...
    View::toHTML($model, "knjl378jForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJL378J"));
