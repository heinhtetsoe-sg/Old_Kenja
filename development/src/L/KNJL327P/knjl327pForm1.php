...
class knjl327pForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl327pForm1", "POST", "knjl327pindex.php", "", "knjl327pForm1");
        ...
        //入試制度コンボボックス
        $query = knjl327pQuery::getNameMst($model->ObjYear, "L003");
        $extra = " onchange=\"return btn_submit('knjl327p');\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1);

        //入試区分コンボボックス
        $namecd1 = ($model->field["APPLICANTDIV"] == "1") ? "L024" : "L004";
        $query = knjl327pQuery::getNameMst($model->ObjYear, $namecd1);
        $extra = " onChange=\"return btn_submit('knjl327ptestdiv');\"";
        ...
        if ($model->cmd == '' || $model->cmd == 'knjl327ptestdiv') {
        ...
        $arg["data"]["ORIDATE"] = View::popUpCalendarAlp($objForm, "ORIDATE", $model->field["ORIDATE"], $reDisabled, "");

        //オリエンテーション時間
        $extra = "style=\"text-align:right\" onblur=\"return to_Integer(this);\"" .$reDisabled;
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL327P");
        ...
        View::toHTML($model, "knjl327pForm1.html", $arg); 
    }
}
