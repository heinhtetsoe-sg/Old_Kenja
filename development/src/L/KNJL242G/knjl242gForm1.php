...
class knjl242gForm1
{
    function main(&$model) {
        ...
        $arg["start"]   = $objForm->get_start("knjl242gForm1", "POST", "knjl242gindex.php", "", "knjl242gForm1");
        ...
        //入試制度コンボ
        $extra = "onChange=\"return btn_submit('knjl242g');\" tabindex=-1";
        $query = knjl242gQuery::getNameMst("L003", $model->year);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL242G");
        ...
        View::toHTML($model, "knjl242gForm1.html", $arg); 
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    //クラス一覧
    $row1 = array();
    $result = $db->query(knjl242gQuery::getGradeHrclass($model));
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
