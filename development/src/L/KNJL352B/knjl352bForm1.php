...
class knjl352bForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl352bForm1", "POST", "knjl352bindex.php", "", "knjl352bForm1");
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl352bQuery::getNameMst($model->ObjYear, "L003"));
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL352B");
        ...
        View::toHTML($model, "knjl352bForm1.html", $arg); 
