...
class knjl329Form1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl329Form1", "POST", "knjl329index.php", "", "knjl329Form1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl329Query::get_apct_div("L003",$model->ObjYear));	/* NO001 */
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl329');\"",
	...
	$defoult     = 1 ;
	$db = Query::dbCheckOut();
	$result = $db->query(knjl329Query::get_test_div($model->ObjYear));	/* NO001 */
	...
	View::toHTML($model, "knjl329Form1.html", $arg); 
	}
}
?>
