...
class knjl016rForm1
{
    public function main(&$model)
    {
        ...
        //入試制度
        $query = knjl016rQuery::getNameMst($model, "L003", $model->fixApplicantDiv); //中学のみ
        $extra = " onchange=\"return btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "");

        //入試区分
        $setNameCd1 = ($model->field["APPLICANTDIV"] == '2') ? 'L024': 'L004';
        $query = knjl016rQuery::getNameMst($model, $setNameCd1);
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl016rindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl016rForm1.html", $arg);
    }
}
//makeCmb
