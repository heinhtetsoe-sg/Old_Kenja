...
class knjl344uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl344uForm1", "POST", "knjl344uindex.php", "", "knjl344uForm1");
        ...
        //入試制度コンボ
        $query = knjl344uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl344u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl344uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl344u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL344U");
        ...
        View::toHTML($model, "knjl344uForm1.html", $arg);
    }
}
//makeCmb
