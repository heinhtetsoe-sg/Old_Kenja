...
class knjl377jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl377jForm1", "POST", "knjl377jindex.php", "", "knjl377jForm1");
    ...
    View::toHTML($model, "knjl377jForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJL377J"));
