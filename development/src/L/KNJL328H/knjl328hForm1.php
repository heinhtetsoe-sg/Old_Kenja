...
class knjl328hForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl328hForm1", "POST", "knjl328hindex.php", "", "knjl328hForm1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl328hQuery::get_apct_div("L003",$model->ObjYear));	
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl328h');\"",
    ...
    if($model->field["APDIV"] == "1"){
	    $result = $db->query(knjl328hQuery::get_test_div("L004",$model->ObjYear,$model->field["APDIV"]));
	...
	View::toHTML($model, "knjl328hForm1.html", $arg); 
	}
}
?>
