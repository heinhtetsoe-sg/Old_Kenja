...
class knjl301bForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl301bForm1", "POST", "knjl301bindex.php", "", "knjl301bForm1");
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl301bQuery::getNameMst($model->ObjYear, "L003"));
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl301bQuery::getNameMst($model->ObjYear, "L004"));
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            $opt[] = array('label' => $row["LABEL"],
                           'value' => $row["VALUE"]);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL301B");
        ...
        View::toHTML($model, "knjl301bForm1.html", $arg); 
