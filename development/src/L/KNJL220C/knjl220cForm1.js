...
function Setflg(obj) {
    ...
    document.forms[0].HID_PRE_TESTDIV.value = document.forms[0].PRE_TESTDIV.options[document.forms[0].PRE_TESTDIV.selectedIndex].value;
    document.forms[0].PRE_TESTDIV.disabled = true;
