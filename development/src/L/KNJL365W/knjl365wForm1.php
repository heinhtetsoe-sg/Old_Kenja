...
class knjl365wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl365windex.php", "", "main");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL365W");
        ...
        View::toHTML($model, "knjl365wForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjl365wQuery::getSchoolData($model);
