...
class knjl084pForm1 {
    ...
    function main(&$model) {
        ...
        $arg["start"] = $objForm->get_start("sel", "POST", "knjl084pindex.php", "", "sel");
        ...
        //入試制度
        $query = knjl084pQuery::getNameMst($model->ObjYear, "L003");
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分
        $namecd1 = ($model->applicantdiv == "2") ? "L004" : "L024";
        $query = knjl084pQuery::getNameMst($model->ObjYear, $namecd1);
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "TESTDIV", $model->testdiv, $extra, 1);

        //リストタイトル用
        $arg["LEFT_TITLE"]  = "入学手続者一覧";
        $arg["RIGHT_TITLE"] = "手続き済者一覧";

        //入学手続者・手続き済者一覧
        $opt_left = $opt_right = array();
        $query = knjl084pQuery::GetLeftList($model);
        ...
        View::toHTML($model, "knjl084pForm1.html", $arg); 
    }
}
