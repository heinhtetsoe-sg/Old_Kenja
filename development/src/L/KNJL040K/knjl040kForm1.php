...
class knjl040kForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl040kForm1", "POST", "knjl040kindex.php", "", "knjl040kForm1");
    $db = Query::dbCheckOut();
    ...
    $opt = array();
    $value_flg = false;
    $query = knjl040kQuery::getSpecialReasonDiv($model);
    ...
    //中高判別フラグを作成する
    $jhflg = 0;
    $row = $db->getOne(knjl040kQuery::GetJorH());
    if ($row == 1){
        $jhflg = 1;
    }else {
        $jhflg = 2;
    ...
    View::toHTML($model, "knjl040kForm1.html", $arg); 
    }
}
?>
