...
class knjl080sForm1
{
    function main(&$model) {
        ...
        //入試制度
        $opt = array();
        $result = $db->query(knjl080sQuery::GetName("L003",$model->ObjYear));
        ...
        $result = $db->query(knjl080sQuery::GetLeftList($model));
        ...
        //合格者一覧
        $opt_right = array();
        $result = $db->query(knjl080sQuery::GetRightList($model));
        ...
        $arg["start"]   = $objForm->get_start("sel", "POST", "knjl080sindex.php", "", "sel");

        $arg["finish"]  = $objForm->get_finish();

        View::toHTML($model, "knjl080sForm1.html", $arg);
    }
}
