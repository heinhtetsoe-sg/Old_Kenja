...
class knjl324Form1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl324Form1", "POST", "knjl324index.php", "", "knjl324Form1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl324Query::get_apct_div("L003",$model->ObjYear));	/* NO001 */
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl324');\"",
	...
	$defoult     = 1 ;
	$db = Query::dbCheckOut();
	$result = $db->query(knjl324Query::get_test_div($model->ObjYear));	/* NO001 */
	...
	View::toHTML($model, "knjl324Form1.html", $arg); 
	}
}
?>
