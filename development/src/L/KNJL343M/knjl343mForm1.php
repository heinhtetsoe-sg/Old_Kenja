...
class knjl343mForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl343mForm1", "POST", "knjl343mindex.php", "", "knjl343mForm1");
        ...
        $model->field["PRINT_RANGE"] = ($model->field["PRINT_RANGE"] == "") ? "2" : $model->field["PRINT_RANGE"];
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL343M");
        ...
        View::toHTML($model, "knjl343mForm1.html", $arg);
    }
}
?>
