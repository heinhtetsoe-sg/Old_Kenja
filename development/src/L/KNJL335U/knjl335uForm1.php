...
class knjl335uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl335uForm1", "POST", "knjl335uindex.php", "", "knjl335uForm1");
        ...
        //入試制度コンボ
        $query = knjl335uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl335u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl335uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl335u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL335U");
        ...
        View::toHTML($model, "knjl335uForm1.html", $arg);
    }
}
//makeCmb
