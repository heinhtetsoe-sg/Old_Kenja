...
class knjl132rForm1
{
    function main(&$model) {
        ...
        $arg["start"]   = $objForm->get_start("knjl132rForm1", "POST", "knjl132rindex.php", "", "knjl132rForm1");
        ...
        //入試制度コンボ
        $extra = "onChange=\"return btn_submit('knjl132r');\" tabindex=-1";
        $query = knjl132rQuery::getNameMst("L003", $model->year, $model->fixApplicantDiv);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL132R");
        ...
        View::toHTML($model, "knjl132rForm1.html", $arg); 
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    //クラス一覧
    $row1 = array();
    $result = $db->query(knjl132rQuery::getGradeHrclass($model));
    while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
