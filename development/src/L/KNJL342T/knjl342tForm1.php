...
class knjl342tForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl342tForm1", "POST", "knjl342tindex.php", "", "knjl342tForm1");
        ...
        //入試制度
        $query = knjl342tQuery::getApplicantdiv($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL342T");
        ...
        View::toHTML($model, "knjl342tForm1.html", $arg);
    }
}
//コンボ作成
