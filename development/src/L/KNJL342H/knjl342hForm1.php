...
class knjl342hForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl342hForm1", "POST", "knjl342hindex.php", "", "knjl342hForm1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl342hQuery::get_apct_div("L003",$model->ObjYear));
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl342h');\"",
	...
	View::toHTML($model, "knjl342hForm1.html", $arg); 
	}
}
?>
