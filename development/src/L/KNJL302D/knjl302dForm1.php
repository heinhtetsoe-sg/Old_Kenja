...
class knjl302dForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl302dForm1", "POST", "knjl302dindex.php", "", "knjl302dForm1");
        ...
        //入試区分
        $query = knjl302dQuery::getNameMst($model->examyear, "L004");
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL302D");
        ...
        View::toHTML($model, "knjl302dForm1.html", $arg);
    }
}
