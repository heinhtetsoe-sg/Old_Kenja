function btn_submit(cmd)
{
    ...
    if(cmd == 'end') {
        if ((document.forms[0].APPLICANTDIV.disabled) || (document.forms[0].TESTDIV.disabled) || (document.forms[0].TESTSUBCLASSCD.disabled) || (document.forms[0].EXAMHALLCD.disabled)) {
