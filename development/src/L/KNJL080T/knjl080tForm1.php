...
class knjl080tForm1
{
    function main(&$model) {
        ...
        //入試制度
        $opt = array();
        $result = $db->query(knjl080tQuery::GetName("L003",$model->ObjYear));
        ...
        $result = $db->query(knjl080tQuery::GetLeftList($model));
        ...
        //合格者一覧
        $opt_right = array();
        $result = $db->query(knjl080tQuery::GetRightList($model));
        ...
        $arg["start"]   = $objForm->get_start("sel", "POST", "knjl080tindex.php", "", "sel");

        $arg["finish"]  = $objForm->get_finish();

        View::toHTML($model, "knjl080tForm1.html", $arg);
    }
}
