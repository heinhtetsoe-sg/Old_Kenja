...
class knjl316uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl316uForm1", "POST", "knjl316uindex.php", "", "knjl316uForm1");
        ...
        //入試制度コンボ
        $query = knjl316uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl316u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl316uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl316u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL316U");
        ...
        View::toHTML($model, "knjl316uForm1.html", $arg);
    }
}
//makeCmb
