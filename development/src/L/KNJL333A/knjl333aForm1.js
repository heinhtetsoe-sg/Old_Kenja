...
function newwin(SERVLET_URL) {
    ...
    if (document.forms[0].DOC_TYPE.value == "1" || document.forms[0].DOC_TYPE.value == "2") {
    ...
    if (document.forms[0].DOC_TYPE.value == "3" || document.forms[0].DOC_TYPE.value == "4" || document.forms[0].DOC_TYPE.value == "5") {
