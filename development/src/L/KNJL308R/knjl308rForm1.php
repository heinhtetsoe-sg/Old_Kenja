...
class knjl308rForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl308rForm1", "POST", "knjl308rindex.php", "", "knjl308rForm1");
        ...
        $opt = array();
        $value_flg = false;
        $result = $db->query(knjl308rQuery::getNameMst($model, $model->ObjYear, "L003"));
        ...
        $extra = " onchange=\"return btn_submit('knjl308r');\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL308R");
        ...
        View::toHTML($model, "knjl308rForm1.html", $arg); 
