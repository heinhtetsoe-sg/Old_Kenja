...
class knjl374iForm1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("csv", "POST", "knjl374iindex.php", "", "csv");
        ...
        //入試制度
        $query = knjl374iQuery::getNameMst("L003", "1");
        ...
        //入試区分
        $query = knjl374iQuery::getEntexamTestDivMst($model->field["APPLICANTDIV"]);
        $extra = "onChange=\"btn_submit('main')\"";
        ...
        $extra = array("id=\"DISP1\" onClick=\"return btn_submit('knjl374i')\"", "id=\"DISP2\" onClick=\"return btn_submit('knjl374i')\"", "id=\"DISP3\" onClick=\"return btn_submit('knjl374i')\"");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL374I");
        ...
        View::toHTML($model, "knjl374iForm1.html", $arg);
    }
}
