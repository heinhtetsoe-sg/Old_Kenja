...
class knjl441mForm1
{
    public function main(&$model)
    {
        ...
        $query = knjl441mQuery::getSchoolKind($model);
        ...
        //HTML出力終了
        $arg["start"]  = $objForm->get_start("main", "POST", "knjl441mindex.php", "", "main");
        $arg["finish"] = $objForm->get_finish();
        View::toHTML($model, "knjl441mForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    ...
    $query = knjl441mQuery::getApplicant($model);
    $result = $db->query($query);
