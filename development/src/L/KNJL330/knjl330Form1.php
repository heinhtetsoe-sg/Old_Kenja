...
class knjl330Form1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl330Form1", "POST", "knjl330index.php", "", "knjl330Form1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl330Query::get_apct_div("L003",$model->ObjYear));	/* NO001 */
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl330');\"",
	...
	$defoult     = 1 ;
	$db = Query::dbCheckOut();
	$result = $db->query(knjl330Query::get_test_div("L004",$model->ObjYear));
	...
	View::toHTML($model, "knjl330Form1.html", $arg); 
	}
}
?>
