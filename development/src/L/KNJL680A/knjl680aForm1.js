function btn_submit(cmd) {
    if (cmd == "exec"){
        if (document.forms[0].CLASS_SELECTED.length == 0) {
            if (!(document.forms[0].SCHOOLNAME.value == "bunkyo" && document.forms[0].OUTPUTDIV[2].checked && document.forms[0].OUTPUTDIV3TEMPL.checked)) {
                alert('{rval MSG916}');
                return;
            }
        }
        ...
        attribute3.value = "";
        attribute4 = document.forms[0].SELECTED_DATA_LABEL;
        attribute4.value = "";
        sep = "";
        ...
        for (var i = 0; i < document.forms[0].CLASS_SELECTED.length; i++) {
            ...
            attribute4.value = attribute4.value + sep + document.forms[0].CLASS_SELECTED.options[i].label;
            sep = ",";
        }
    }
