...
class knjl304uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl304uForm1", "POST", "knjl304uindex.php", "", "knjl304uForm1");
        ...
        //入試制度コンボ
        $query = knjl304uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl304u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl304uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl304u')\"";
        ...
        //会場コンボ
        $query = knjl304uQuery::getHallData($model);
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, $model->field["EXAMHALLCD"], "EXAMHALLCD", $extra, 1, "TOP", "");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL304U");
        ...
        View::toHTML($model, "knjl304uForm1.html", $arg);
    }
}
//makeCmb
