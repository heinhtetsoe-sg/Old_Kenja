...
class knjl301sForm1 {
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl301sForm1", "POST", "knjl301sindex.php", "", "knjl301sForm1");
        ...
        //入試制度
        $query = knjl301sQuery::getApplicantdiv($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL301S");
        ...
        View::toHTML($model, "knjl301sForm1.html", $arg);
    }
}
