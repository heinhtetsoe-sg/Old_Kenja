...
class knjl506gForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl506gForm1", "POST", "knjl506gindex.php", "", "knjl506gForm1");
        ...
        //入試制度
        $extra = "";
        $query = knjl506gQuery::getNameMst($model->ObjYear, "L003");
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボボックス
        $extra = "";
        $query = knjl506gQuery::getNameMst($model->ObjYear, "L004");
        ...
        View::toHTML($model, "knjl506gForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL506G");
