...
class knjl370jForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl370jForm1", "POST", "knjl370jindex.php", "", "knjl370jForm1");
    ...
    $result = $db->query(knjl370jQuery::get_test_div("L004",$model->ObjYear));
    ...
    if($default_flg){
        ...
        $opt_test_dv[] = array("label" => "　　　",  "value" => "0");
    }
	...
	View::toHTML($model, "knjl370jForm1.html", $arg); 
	}
}
?>
