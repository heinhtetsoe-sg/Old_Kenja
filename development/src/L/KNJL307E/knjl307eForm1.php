...
class knjl307eForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl307eForm1", "POST", "knjl307eindex.php", "", "knjl307eForm1");
        ...
        //入試制度コンボ
        $query = knjl307eQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl307e')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl307eQuery::getNameMst($model->examyear, "L065");
        $extra = "onChange=\"return btn_submit('knjl307e')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL307E");
        ...
        View::toHTML($model, "knjl307eForm1.html", $arg);
    }
}
//makeCmb
