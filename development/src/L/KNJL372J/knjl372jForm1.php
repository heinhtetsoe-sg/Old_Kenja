...
class knjl372jForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl372jForm1", "POST", "knjl372jindex.php", "", "knjl372jForm1");
    ...
    $result = $db->query(knjl372jQuery::get_test_div("L004",$model->ObjYear));
	...
	View::toHTML($model, "knjl372jForm1.html", $arg); 
	}
}
?>
