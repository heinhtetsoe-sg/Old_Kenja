...
class knjl312uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl312uForm1", "POST", "knjl312uindex.php", "", "knjl312uForm1");
        ...
        //入試制度コンボ
        $query = knjl312uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl312u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl312uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl312u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL312U");
        ...
        View::toHTML($model, "knjl312uForm1.html", $arg);
    }
}
//makeCmb
