...
class knjl309eForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl309eForm1", "POST", "knjl309eindex.php", "", "knjl309eForm1");
        ...
        //入試制度
        $query = knjl309eQuery::getNameMst($model->examyear, "L003");
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, $model->applicantdiv, "APPLICANTDIV", $extra, 1);

        //入試日程
        $query = knjl309eQuery::getNameMst($model->examyear, "L065", "1");
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL309E");
        ...
        View::toHTML($model, "knjl309eForm1.html", $arg);
    }
}
