...
class knjl304dForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl304dForm1", "POST", "knjl304dindex.php", "", "knjl304dForm1");
        ...
        //入試区分
        $query = knjl304dQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl304d')\"";
        makeCmb($objForm, $arg, $db, $query, $model->testdiv, "TESTDIV", $extra, 1);

        //会場一覧リストToリスト
        $opt = array();
        $query = knjl304dQuery::getHallData($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL304D");
        ...
        View::toHTML($model, "knjl304dForm1.html", $arg);
    }
}
