...
class knjl343uForm1 {
    function main(&$model) {
        $objForm = new form;
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl343uForm1", "POST", "knjl343uindex.php", "", "knjl343uForm1");
        ...
        //入試制度コンボ
        $query = knjl343uQuery::getNameMst($model->examyear, "L003");
        $extra = "onChange=\"return btn_submit('knjl343u')\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "TOP", "");

        //入試区分
        $query = knjl343uQuery::getNameMst($model->examyear, "L004");
        $extra = "onChange=\"return btn_submit('knjl343u')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL343U");
        ...
        View::toHTML($model, "knjl343uForm1.html", $arg);
    }
}
//makeCmb
