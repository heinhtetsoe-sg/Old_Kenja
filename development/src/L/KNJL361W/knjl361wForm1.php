...
class knjl361wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl361windex.php", "", "main");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL361W");
        ...
        View::toHTML($model, "knjl361wForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjl361wQuery::getSchoolData($model);
