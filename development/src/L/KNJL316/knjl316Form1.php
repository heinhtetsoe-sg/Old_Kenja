...
class knjl316Form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl316Form1", "POST", "knjl316index.php", "", "knjl316Form1");
        ...
        //入試制度コンボの設定
        $opt_apdv_typ = array();
        $result = $db->query(knjl316Query::getApctDiv("L003", $model->ObjYear));
        ...
        View::toHTML($model, "knjl316Form1.html", $arg);
    }
}
?>
