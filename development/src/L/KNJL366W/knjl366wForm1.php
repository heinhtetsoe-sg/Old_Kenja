...
class knjl366wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl366windex.php", "", "main");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL366W");
        ...
        View::toHTML($model, "knjl366wForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjl366wQuery::getSchoolData($model);
