...
class knjl302hForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl302hForm1", "POST", "knjl302hindex.php", "", "knjl302hForm1");
	...
	$db = Query::dbCheckOut();
	$opt_apdv_typ = array();
	$result = $db->query(knjl302hQuery::get_apct_div("L003",$model->ObjYear));	
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl302h');\"",
    ...
    if($model->field["APDIV"] == "1"){
	    $result = $db->query(knjl302hQuery::get_test_div("L004",$model->ObjYear));	
	...
	View::toHTML($model, "knjl302hForm1.html", $arg); 
	}
}
