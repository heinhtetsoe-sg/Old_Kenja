...
class knjl062iForm1
{
    function main(&$model) {
        ...
        //入試制度
        $query = knjl062iQuery::getApplicantDivMst();
        ...
        //入試区分
        $query = knjl062iQuery::getEntexamTestDivMst($model->field["APPLICANTDIV"]);
        // $extra = "onChange=\"btn_submit('main')\"";
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("csv", "POST", "knjl062iindex.php", "", "csv");
        //フォーム終わり
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl062iForm1.html", $arg);
    }
}
