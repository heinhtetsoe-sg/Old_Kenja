...
class knjl342sForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl342sForm1", "POST", "knjl342sindex.php", "", "knjl342sForm1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL342S");
        ...
        View::toHTML($model, "knjl342sForm1.html", $arg);
    }
}
//コンボ作成
