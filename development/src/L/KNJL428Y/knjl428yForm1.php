...
class knjl428yForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl428yForm1", "POST", "knjl428yindex.php", "", "knjl428yForm1");
        ...
        //入試制度コンボボックス
        $extra = "onchange=\"return btn_submit('knjl428y');\"";
        $query = knjl428yQuery::getNameMst("L003", $model->ObjYear);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボボックス
        $model->field["TESTDIV"] = ($model->field["APPLICANTDIV"] == $model->field["APP_HOLD"]) ? $model->field["TESTDIV"] : "";
        $query = knjl428yQuery::getNameMst("L004", $model->ObjYear);
        ...
        View::toHTML($model, "knjl428yForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL428Y");
