...
class knjl080uForm1 {
    ...
    function main(&$model) {
        ...
        //入試制度
        $query = knjl080uQuery::getNameMst($model->ObjYear, "L003");
        $extra = "Onchange=\"btn_submit('main');\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分
        $query = knjl080uQuery::getNameMst($model->ObjYear, "L004");
        $extra = "Onchange=\"btn_submit('main');\"";
        ...
        $query = knjl080uQuery::getLeftRightList($model);
        ...
        $arg["start"] = $objForm->get_start("sel", "POST", "knjl080uindex.php", "", "sel");
        $arg["finish"] = $objForm->get_finish();

        View::toHTML($model, "knjl080uForm1.html", $arg); 
    }
}
