...
class knjl014wForm1
{
    public function main(&$model)
    {
        ...
        //権限チェック
        $adminFlg = knjl014wQuery::getAdminFlg();
        ...
        /******************/
        //入試制度
        $query = knjl014wQuery::getNameMst($model->ObjYear, "L003");
        ...
        $opt[] = array('label' => "3:得点",     'value' => "3");
        $opt[] = array('label' => "4:開示資料", 'value' => "4");
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl014windex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl014wForm1.html", $arg);
    }
}
