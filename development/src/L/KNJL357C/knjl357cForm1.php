...
class knjl357cForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl357cForm1", "POST", "knjl357cindex.php", "", "knjl357cForm1");
        ...
        //入試制度コンボの設定
        $query = knjl357cQuery::getApctDiv("L003", $model->ObjYear);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボの設定
        $query = knjl357cQuery::getTestDiv("L004", $model->ObjYear);
        ...
        $click = " onClick=\"return btn_submit('knjl357c');\"";
        ...
        View::toHTML($model, "knjl357cForm1.html", $arg); 
	}
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL357C");
