...
class knjl375jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl375jForm1", "POST", "knjl375jindex.php", "", "knjl375jForm1");
    ...
    View::toHTML($model, "knjl375jForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model)
{
    ...
    $objForm->ae(createHiddenAe("PRGID", "KNJL375J"));
