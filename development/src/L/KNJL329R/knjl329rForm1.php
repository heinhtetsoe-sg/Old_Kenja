...
class knjl329rForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl329rForm1", "POST", "knjl329rindex.php", "", "knjl329rForm1");
        ...
        //extra
        $extra = " onChange=\"return btn_submit('knjl329r');\"";

        //入試制度コンボの設定
        $query = knjl329rQuery::getApctDiv($model, "L003", $model->ObjYear);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボの設定
        if ($model->field["APPLICANTDIV"] == "2") {
            $query = knjl329rQuery::getTestDiv("L024", $model->ObjYear);
        } else {
            $query = knjl329rQuery::getTestDiv("L004", $model->ObjYear);
        }
        ...
        $extra = array("id=\"FINSCHOOLDIV1\" onClick=\"return btn_submit('knjl329r')\"", "id=\"FINSCHOOLDIV2\" onClick=\"return btn_submit('knjl329r')\"", "id=\"FINSCHOOLDIV3\" onClick=\"return btn_submit('knjl329r')\"", "id=\"FINSCHOOLDIV4\" onClick=\"return btn_submit('knjl329r')\"");
        ...
        /**********/
        //一覧リスト取得
        $result = $db->query(knjl329rQuery::getList($model));
        $row1 = array();
        ...
        View::toHTML($model, "knjl329rForm1.html", $arg); 
    }
}
//コンボ作成
