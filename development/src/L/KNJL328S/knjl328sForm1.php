...
class knjl328sForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl328sForm1", "POST", "knjl328sindex.php", "", "knjl328sForm1");
        ...
        //入試制度
        $query = knjl328sQuery::getApplicantdiv($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL328S");
        ...
        View::toHTML($model, "knjl328sForm1.html", $arg);
    }
}
//コンボ作成
