...
class knjl362wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl362windex.php", "", "main");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL362W");
        ...
        View::toHTML($model, "knjl362wForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjl362wQuery::getSchoolData($model);
