...
class knjl141rForm1
{
    public function main(&$model)
    {
        ...
        //コンボ作成
        $query = knjl141rQuery::getGoukaku($model);
        $extra = "";
        ...
        //DB切断
        Query::dbCheckIn($db);
        $arg["start"]  = $objForm->get_start("main", "POST", "knjl141rindex.php", "", "main");
        $arg["finish"] = $objForm->get_finish();

        View::toHTML($model, "knjl141rForm1.html", $arg);
    }
}
...
function makeCmb(&$objForm, &$arg, $db, $query, $value, $name, $extra, $size, $blank = "")
{
    ...
    if ($name === 'GOUKAKU') {
        $opt[] = array("label" => 'すべて', "value" => '9:999:9999');
    }
