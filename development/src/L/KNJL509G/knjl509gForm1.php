...
class knjl509gForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl509gForm1", "POST", "knjl509gindex.php", "", "knjl509gForm1");
        ...
        View::toHTML($model, "knjl509gForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL509G");
