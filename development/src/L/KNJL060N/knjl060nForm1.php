...
class knjl060nForm1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl060nindex.php", "", "main");
        ...
        $query = knjl060nQuery::getNameMst("L003", $model->examyear, ""); //1:中学は表示しない
        ...
        $query = knjl060nQuery::getNameMst("L004", $model->examyear, "");
        ...
        View::toHTML($model, "knjl060nForm1.html", $arg);
    }
}
