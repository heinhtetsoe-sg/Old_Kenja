...
class knjl330gForm1
{
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl330gForm1", "POST", "knjl330gindex.php", "", "knjl330gForm1");
        ...
        //入試制度
        $extra = "";
        $query = knjl330gQuery::getNameMst($model->ObjYear, "L003");
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1);

        //入試区分コンボボックス
        $extra = "";
        $query = knjl330gQuery::getNameMst($model->ObjYear, "L004");
        ...
        View::toHTML($model, "knjl330gForm1.html", $arg); 
    }
}
...
function makeHidden(&$objForm, $model) {
    knjCreateHidden($objForm, "PRGID", "KNJL330G");
