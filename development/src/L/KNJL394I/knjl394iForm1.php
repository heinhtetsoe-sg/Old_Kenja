...
class knjl394iForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl394iindex.php", "", "main");
        ...
        $query = knjl394iQuery::getNameMst($model->examyear, "L003", $model->applicantdiv);
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->applicantdiv, $extra, 1);

        //入試区分コンボボックス
        $extra = "";
        $query = knjl394iQuery::getTestDiv($model);
        ...
        View::toHTML($model, "knjl394iForm1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJL394I");
