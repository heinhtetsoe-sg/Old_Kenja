...
class knjl300jForm1
{
    ...
    $objForm = new form;
    //フォーム作成
    $arg["start"]   = $objForm->get_start("knjl300jForm1", "POST", "knjl300jindex.php", "", "knjl300jForm1");
    ...
    $result = $db->query(knjl300jQuery::get_test_div("L004",$model->ObjYear));
    ...
    $objForm->ae( array("type"       => "select",
                        ...
                        "extrahtml"  => "onChange=\"return btn_submit('knjl300j');\"",
                        "options"    => $opt_test_dv));
    ...
    //試験会場選択コンボボックスを作成する
    $db = Query::dbCheckOut();
    $result = $db->query(knjl300jQuery::get_hall_data($model->field["TESTDV"], $model->field["EXAM_TYPE"]));
    ...
    View::toHTML($model, "knjl300jForm1.html", $arg); 
    }
}
?>
