...
class knjl022eForm1 {
    ...
    function main(&$model) {
        ...
        //入試制度
        $query = knjl022eQuery::getNameMst($model, "L003", '');
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1, "BLANK");

        //入試区分
        $query = knjl022eQuery::getNameMst($model, "L004", '1');
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl022eindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl022eForm1.html", $arg);
    }
}
//makeCmb
