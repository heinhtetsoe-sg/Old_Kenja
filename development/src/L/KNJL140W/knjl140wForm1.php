...
class knjl140wForm1
{
    public function main(&$model)
    {
        ...
        //権限チェック
        $adminFlg = knjl140wQuery::getAdminFlg();
        ...
        //コンボ作成
        $query = knjl140wQuery::getGoukaku($model);
        $extra = "";
        ...
        //DB切断
        Query::dbCheckIn($db);
        $arg["start"]  = $objForm->get_start("main", "POST", "knjl140windex.php", "", "main");
        $arg["finish"] = $objForm->get_finish();

        View::toHTML($model, "knjl140wForm1.html", $arg);
    }
}
/********************************************** ここから下関数 ****************************************************/
//////////////
