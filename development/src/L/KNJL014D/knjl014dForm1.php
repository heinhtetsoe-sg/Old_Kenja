...
class knjl014dForm1
{
    public function main(&$model)
    {
        ...
        /******************/
        //入試区分
        $query = knjl014dQuery::getNameMst($model->ObjYear, "L004");
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl014dindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl014dForm1.html", $arg);
    }
}
