...
class knjl341wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl341windex.php", "", "main");
        ...
        $radioArray = knjCreateRadio($objForm, "CSV_PRG", 1, $extra, $opt, get_count($opt));
        foreach($radioArray as $key => $val) $arg["data"][$key] = $val;

        //V_SCHOOL_MSTから学校コードを取得
        $model->schoolcd = $db->getOne(knjl341wQuery::getSchoolInfo($model));

        //報告表示
        $query = knjl341wQuery::getReport($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL341W");
        ...
        View::toHTML($model, "knjl341wForm1.html", $arg);
    }
}
?>
