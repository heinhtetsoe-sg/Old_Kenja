...
class knjl329pForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl329pForm1", "POST", "knjl329pindex.php", "", "knjl329pForm1");
        ...
        //入試制度コンボボックス
        $query = knjl329pQuery::getNameMst($model->ObjYear, "L003");
        $extra = " onchange=\"return btn_submit('knjl329p');\"";
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1);

        //入試区分コンボボックス
        $namecd1 = ($model->field["APPLICANTDIV"] == "1") ? "L024" : "L004";
        $query = knjl329pQuery::getNameMst($model->ObjYear, $namecd1);
        $extra = " onchange=\"return btn_submit('knjl329p');\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL329P");
        ...
        View::toHTML($model, "knjl329pForm1.html", $arg); 
    }
}
