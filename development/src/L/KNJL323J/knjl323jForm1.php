...
class knjl323jForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl323jForm1", "POST", "knjl323jindex.php", "", "knjl323jForm1");
    ...
    $result = $db->query(knjl323jQuery::get_test_div("L004",$model->ObjYear));
	...
	View::toHTML($model, "knjl323jForm1.html", $arg); 
	}
}
?>
