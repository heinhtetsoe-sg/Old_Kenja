...
class knjl324hForm1
{
	...
	$objForm = new form;
	//フォーム作成
	$arg["start"]   = $objForm->get_start("knjl324hForm1", "POST", "knjl324hindex.php", "", "knjl324hForm1");
	...
	$opt_apdv_typ = array();
	$db = Query::dbCheckOut();
	$result = $db->query(knjl324hQuery::get_apct_div("L003",$model->ObjYear));	
	...
	$objForm->ae( array("type"       => "select",
						...
						"extrahtml"  => " onChange=\"return btn_submit('knjl324h');\"",
    ...
    if($model->field["APDIV"] == "1"){
	    $result = $db->query(knjl324hQuery::get_test_div("L004",$model->ObjYear,$model->field["APDIV"]));	
	...
	View::toHTML($model, "knjl324hForm1.html", $arg); 
	}
}
?>
