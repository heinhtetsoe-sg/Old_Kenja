...
class knjl375mForm1 {
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl375mForm1", "POST", "knjl375mindex.php", "", "knjl375mForm1");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL375M");
        ...
        View::toHTML($model, "knjl375mForm1.html", $arg);
    }
}
//コンボ作成
