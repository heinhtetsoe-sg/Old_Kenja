...
class knjl352Form1
{
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjl352Form1", "POST", "knjl352index.php", "", "knjl352Form1");
        ...
        //入試制度コンボ
        $query = knjl352Query::GetName($model->ObjYear, "L003");
        $extra = "";
        ...
        $arg["button"]["csv_print"] = knjCreateBtn($objForm, "csv_print", "ＣＳＶ出力", $extra);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL352");
        ...
        View::toHTML($model, "knjl352Form1.html", $arg); 
    }
}
//makeCmb
