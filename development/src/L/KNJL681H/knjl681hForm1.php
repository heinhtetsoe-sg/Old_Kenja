...
class knjl681hForm1
{
    public function main(&$model)
    {
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL681H");
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl681hindex.php", "", "main");

        //フォーム終わり
        $arg["finish"] = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl681hForm1.html", $arg);
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    ...
    $leftCnt = $rightCnt = 0;
    $query = knjl681hQuery::getBaseDatData($model);
