...
class knjl371mForm1 {
    function main(&$model){
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("knjl371mForm1", "POST", "knjl371mindex.php", "", "knjl371mForm1");
        ...
        //入試制度
        $query = knjl371mQuery::getApplicantdiv($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL371M");
        ...
        View::toHTML($model, "knjl371mForm1.html", $arg);
    }
}
