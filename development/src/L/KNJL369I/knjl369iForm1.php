...
class knjl369iForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjl369iForm1", "POST", "knjl369iindex.php", "", "knjl369iForm1");
        ...
        //入試制度コンボ
        $extra = " onchange=\"return btn_submit('knjl369i');\"";
        $query = knjl369iQuery::getNameMst($model->ObjYear, "L003");
        makeCmb($objForm, $arg, $db, $query, $model->field["APPLICANTDIV"], "APPLICANTDIV", $extra, 1);

        //入試区分コンボ
        $extra = "";
        $query = knjl369iQuery::getEntexamTestDivMst($model->ObjYear, $model->field["APPLICANTDIV"]);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL369I");
        ...
        View::toHTML($model, "knjl369iForm1.html", $arg); 
    }
}
