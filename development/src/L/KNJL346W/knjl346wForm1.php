...
class knjl346wForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjl346windex.php", "", "main");
        ...
        $radioArray = knjCreateRadio($objForm, "CSV_PRG", 6, $extra, $opt, get_count($opt));
        ...
        $model->schoolcd = $db->getOne(knjl346wQuery::getSchoolInfo($model));

        //報告表示
        $query = knjl346wQuery::getReport($model);
        ...
        knjCreateHidden($objForm, "PRGID", "KNJL346W");
        ...
        View::toHTML($model, "knjl346wForm1.html", $arg);
    }
}
?>
