...
class knjl516hForm1 {
    ...
    function main(&$model) {
        ...
        //学校種別
        $query = knjl516hQuery::getNameMst($model->year, "L003");
        $extra = " onChange=\"btn_submit('main')\"";
        makeCmb($objForm, $arg, $db, $query, "APPLICANTDIV", $model->field["APPLICANTDIV"], $extra, 1, "");

        //入試判別
        $query = knjl516hQuery::getDistinctId($model);
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjl516hindex.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjl516hForm1.html", $arg);
    }
}
