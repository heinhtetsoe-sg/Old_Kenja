...
class knjl030dForm1 {
    ...
    function main(&$model) {
        ...
        //受験種別（入試区分）
        $query = knjl030dQuery::getNameMst($model->examyear, "L004");
        ...
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
            ...
            $row["EXAMHALL_NAME"] = View::alink("#",htmlspecialchars($row["EXAMHALL_NAME"]),
                            "onclick=\"loadwindow('knjl030dindex.php?cmd=edit&mode=update&examhallcd=".$row["EXAMHALLCD"] ."',event.clientX + function () {var scrollX = document.documentElement.scrollLeft || document.body.scrollLeft;return scrollX;}(), event.clientY + function () {var scrollY = document.documentElement.scrollTop || document.body.scrollTop;return scrollY;}(),370,170);\"");
        ...
        View::toHTML($model, "knjl030dForm1.html", $arg); 
    }
}
//コンボ作成
