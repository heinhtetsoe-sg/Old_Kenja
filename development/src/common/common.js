...
function toInteger(checkString, id){
    var newString = "";
    var count = 0;
    for (i = 0; i < checkString.length; i++) {
        ch = checkString.substring(i, i+1);
    ...
    return ShowDialog(newString,checkString,"数字", id);
}
...
function ShowDialog(newString, checkString, STR ,id){
