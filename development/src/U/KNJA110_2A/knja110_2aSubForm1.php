...
class knja110_2aSubForm1 {
    function main(&$model) {
        $objForm = new form;
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knja110_2aSubForm1", "POST", "knja110_2aindex.php", "", "knja110_2aSubForm1");
        ...
        $query = knja110_2aQuery::get_last_expiredate($model, $model->schregno);
        $last_expiredate = $db->getOne($query);

        $query = knja110_2aQuery::get_ent_date($model->schregno);
        ...
        View::toHTML($model, "knja110_2aSubForm1.html", $arg);
    }
}
?>
