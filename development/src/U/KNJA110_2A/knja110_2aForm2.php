...
class knja110_2aForm2
{
    function main(&$model)
    {
        ...
        //保護者履歴入力ボタン
        $link = REQUESTROOT."/U/KNJA110_2A/knja110_2aindex.php?cmd=rireki&SCHREGNO=".$model->schregno;
        $extra = "onclick=\"Page_jumper('$link', 1);\"";
        $arg["button"]["btn_rireki"] = knjCreateBtn($objForm, "btn_rireki", "保護者履歴修正", $extra);

        //保証人履歴入力ボタン
        $link = REQUESTROOT."/U/KNJA110_2A/knja110_2aindex.php?cmd=rireki2&SCHREGNO=".$model->schregno;
        ...
        $row1 = $db->getRow(knja110_2aQuery::getRow_Address($model->schregno,$model->issuedate),DB_FETCHMODE_ASSOC);
...
/********************************************************************************/
        ...
        $query = knja110_2aQuery::get_name_mst();
...
/********************************************************************************/
        ...
        //保護者基礎データの更新
//        $link = REQUESTROOT."/U/KNJA110_2A/knja110_2aindex.php?cmd=guardian_hist_dat_kousin&SCHREGNO=".$model->schregno;
...
//        $arg["button"]["GUARDIAN_HIST_DAT_KOUSIN"] = knjCreateBtn($objForm, "GUARDIAN_HIST_DAT_KOUSIN", "保護者基礎データの更新", $extra);
        ...
        View::toHTML($model, "knja110_2aForm2.html", $arg);
    }
}
?>
