function btn_submit(cmd) {
    ...
    for (var i = 0; i < document.forms[0].SORT_SELECTED.length; i++) {
        ...
        attribute4.value = attribute4.value + sep + document.forms[0].SORT_SELECTED.options[i].value;
        sep = ",";
    }
...
function AllClearList(OptionList, TitleName)
{
        ...
        ClearList(attribute,attribute);
        attribute = document.forms[0].SORT_NAME;
        ClearList(attribute,attribute);
        attribute = document.forms[0].SORT_SELECTED;
        ClearList(attribute,attribute);
}
