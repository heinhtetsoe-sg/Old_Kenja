...
class knjj210aForm1
{
    function main(&$model) {
        ...
        $arg["start"]   = $objForm->get_start("knjj210aForm1", "POST", "knjj210aindex.php", "", "knjj210aForm1");
        $db = Query::dbCheckOut();

        $arg["data"]["YEAR"] = $model->control["年度"];

        //makeCmb2
        $query = knjj210aQuery::getSchoolKind($model);
        $extra = "onChange=\"btn_submit('knjj210a')\"";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJJ210A");
        ...
        View::toHTML($model, "knjj210aForm1.html", $arg); 
    }
}
...
function makeListToList(&$objForm, &$arg, $db, $model)
{
    //クラス一覧
    $row1 = array();
    $result = $db->query(knjj210aQuery::getGradeHrclass($model));
