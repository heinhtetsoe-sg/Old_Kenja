...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].fareyear.length==0 && document.forms[0].faremaster.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].fareyear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].fareyear.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].fareyear,document.forms[0].fareyear);
    ClearList(document.forms[0].faremaster,document.forms[0].faremaster);
}
