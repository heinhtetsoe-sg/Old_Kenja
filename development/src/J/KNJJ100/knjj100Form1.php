...
class knjj100Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjj100Form1", "POST", "knjj100index.php", "", "knjj100Form1");
        ...
        //クラス一覧リスト作成する
        $query = knjj100Query::getHr_Class_alp($model, $model->control["年度"], $model->control["学期"], AUTHORITY, STAFFCD, "1");
        ...
        //対象学期
        $query = knjj100Query::getJ004($model);
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJJ100");
        ...
        View::toHTML($model, "knjj100Form1.html", $arg);
    }
}
//makeCmb
