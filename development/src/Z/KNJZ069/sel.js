...
function setFirstData() {
    var attribute1 = document.forms[0].right_list;
...
function temp_clear()
{
    ClearList(document.forms[0].left_list,document.forms[0].left_list);
    ClearList(document.forms[0].right_list,document.forms[0].right_list);
}
