...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].majoryear.length==0 && document.forms[0].majormaster.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].majoryear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].majoryear.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].majoryear,document.forms[0].majoryear);
