...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].textbookyear.length==0 && document.forms[0].textbookmaster.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].textbookyear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].textbookyear.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].textbookyear,document.forms[0].textbookyear);
    ClearList(document.forms[0].textbookmaster,document.forms[0].textbookmaster);
}
