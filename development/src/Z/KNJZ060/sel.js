...
function setFirstData() {
    var attribute1 = document.forms[0].classmaster;
...
function move1(side) {
    ...
    for (var i = 0; i < attribute2.length; i++) {
        ...
        tempaa[y] = String(attribute2.options[i].value).substr(3, 4) + "" + String(attribute2.options[i].value).substr(0, 2) + "," + y;
    ...
    for (var i = 0; i < attribute1.length; i++) {
        if (attribute1.options[i].selected) {
            ...
            tempaa[y] = String(attribute1.options[i].value).substr(3, 4) + "" + String(attribute1.options[i].value).substr(0, 2) + "," + y;
...
function moves(sides) {
    ...
    for (var i = 0; i < attribute6.length; i++) {
        ...
        tempaa[z] = String(attribute6.options[i].value).substr(3, 4) + "" + String(attribute6.options[i].value).substr(0, 2) + "," + z;
    ...
    for (var i = 0; i < attribute5.length; i++) {
        ...
        tempaa[z] = String(attribute5.options[i].value).substr(3, 4) + "" + String(attribute5.options[i].value).substr(0, 2) + "," + z;
