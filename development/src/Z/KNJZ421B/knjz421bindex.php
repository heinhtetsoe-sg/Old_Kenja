...
require_once('knjz421bModel.inc');
require_once('knjz421bQuery.inc');

class knjz421bController extends Controller
{
    public $ModelClassName = "knjz421bModel";
    public $ProgramID      = "KNJZ421B";
    public function main()
    {
        ...
        while (true) {
            switch (trim($sessionInstance->cmd)) {
                ...
                case "":
                    //分割フレーム作成
                    $args["left_src"] = "knjz421bindex.php?cmd=list";
                    $args["right_src"] = "knjz421bindex.php?cmd=edit";
                    $args["cols"] = "30%,70%";
                    View::frame($args);
                    exit;
                default:
...
$knjz421bCtl = new knjz421bController();
