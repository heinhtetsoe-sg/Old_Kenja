...
class knjz525form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjz525index.php", "", "main");
        ...
        if ($model->cmd != "kakutei" && !isset($model->warning)) {
            $Row = array();
            $maxDataDiv = "";
            $query = knjz525Query::getChallengedAssessmentStatusGrowupDat($model, CTRL_YEAR);
        ...
        View::toHTML($model, "knjz525Form1.html", $arg);
    }
}
?>
