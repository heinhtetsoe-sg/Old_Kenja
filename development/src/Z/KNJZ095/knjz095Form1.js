...
function doSubmit() {
    ...
    var val;
    var i;
    if (document.forms[0].partner_school_year.length==0 && document.forms[0].partner_school_master.length==0) {
        alert('データは存在していません。');
        return false;
    }
    ...
    sep = "";
    val = "";
    len = document.forms[0].partner_school_year.length;
    for (i = 0; i < len; i++)
    {
        val += sep + document.forms[0].partner_school_year.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].partner_school_year,document.forms[0].partner_school_year);
    ClearList(document.forms[0].partner_school_master,document.forms[0].partner_school_master);
}
