...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].stationyear.length==0 && document.forms[0].stationmaster.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].stationyear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].stationyear.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].stationyear,document.forms[0].stationyear);
    ClearList(document.forms[0].stationmaster,document.forms[0].stationmaster);
}
