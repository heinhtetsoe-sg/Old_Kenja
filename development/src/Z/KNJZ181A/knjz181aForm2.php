...
class knjz181aForm2 {
    function main(&$model) {
        ...
        /* ヘッダ */
        /**********/
        $arg["sepa"]["TEST_NAME"]   = $db->getOne(knjz181aQuery::getTestName($model));
        $arg["sepa"]["DIV_NAME"]    = $div_name;
        $arg["sepa"]["GRADE_NAME"]  = $db->getOne(knjz181aQuery::getGradeName($model));
        ...
        View::toHTML($model, "knjz181aForm2.html", $arg);
    }
}
/********************************************** 以下関数 **********************************************/
//リスト作成
function makeList(&$objForm, &$arg, $db, $model) {
    ...
    $query = knjz181aQuery::getListInquiry($model);
