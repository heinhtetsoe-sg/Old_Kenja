...
class knjz286aForm1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("sel", "POST", "knjz286aindex.php", "", "sel");
        ...
        $flg = "";
        $opt = array();
        $result = $db->query(knjz286aQuery::selectYearQuery());
        ...
        //教務主任等年度一覧取得
        $opt_left = array();
        $result = $db->query(knjz286aQuery::selectQuery($model));
        while ($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
        ...
        //教務主任等一覧取得
        $opt_right = array();
        $result = $db->query(knjz286aQuery::selectPositionQuery($model));
        while($row = $result->fetchRow(DB_FETCHMODE_ASSOC)) {
        ...
        /****************/
        //extra
        $link = REQUESTROOT."/Z/KNJZ286_2A/knjz286_2aindex.php?mode=1";
        ...
        $link = REQUESTROOT."/Z/KNJZ286_POSITION_REFLECTION/knjz286_position_reflectionindex.php";
        ...
        $arg["button"] = array("BTN_MASTER" => knjCreateBtn($objForm, "btn_master", "教務主任等マスタ", $extra_mst),
                               ...
                               "BTN_END"    => knjCreateBtn($objForm, "btn_end", "終 了", $extra_end)."&nbsp;&nbsp;".
                                               knjCreateBtn($objForm, "btn_torikomi", "教育委員会教務主任等取込", $extra_torikomi));
