...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].sectionyear.length==0 && document.forms[0].sectionmaster.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].sectionyear.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].sectionyear.options[i].value;
        sep = ",";
    }
