function btn_submit(cmd) {
    ...
    if (cmd == "grade") {
        result = confirm('保存されていないデータは破棄されます。\nよろしいですか？');
        if (result == false) {
            document.forms[0].GRADE.value = document.forms[0].PRE_GRADE.value;
            document.forms[0].MAJORCD.value = document.forms[0].PRE_MAJORCD.value;
            ...
            document.forms[0].cmd.value = 'knjz235v';
        }
    } else {
        attribute3 = document.forms[0].selectdata;
        attribute3.value = "";
