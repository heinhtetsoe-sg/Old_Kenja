...
function doSubmit() {
    ...
    attribute3.value = "";
    sep = "";
    if (document.forms[0].EXPENSE_MS.length==0 && document.forms[0].EXPENSE_S.length==0) {
        alert('{rval MSG916}');
        return false;
    }
    for (var i = 0; i < document.forms[0].EXPENSE_MS.length; i++)
    {
        attribute3.value = attribute3.value + sep + document.forms[0].EXPENSE_MS.options[i].value;
        sep = ",";
    }
...
function temp_clear()
{
    ClearList(document.forms[0].EXPENSE_MS,document.forms[0].EXPENSE_MS);
    ClearList(document.forms[0].EXPENSE_S,document.forms[0].EXPENSE_S);
}
