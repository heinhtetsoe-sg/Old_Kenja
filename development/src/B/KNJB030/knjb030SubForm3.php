...
class knjb030SubForm3
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knjb030index.php", "", "subform3");
        ...
        //SQL文発行
        //使用施設一覧取得
        $query = knjb030Query::selectQuerySubForm3($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb030SubForm3.html", $arg);
    }
}
?>