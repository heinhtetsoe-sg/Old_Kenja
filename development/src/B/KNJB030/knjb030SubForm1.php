...
class knjb030SubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjb030index.php", "", "subform1");
        ...
        //SQL文発行
        //組略称（学年・組）取得
        $query = knjb030Query::selectQuerySubForm1($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb030SubForm1.html", $arg);
    }
}
?>