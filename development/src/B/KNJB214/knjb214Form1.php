...
class knjb214Form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjb214Form1", "POST", "knjb214index.php", "", "knjb214Form1");
        ...
        View::toHTML($model, "knjb214Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJB214");
