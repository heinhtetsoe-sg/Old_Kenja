...
class knjb0032Form1 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("knjb0032Form1", "POST", "knjb0032index.php", "", "knjb0032Form1");
        ...
        View::toHTML($model, "knjb0032Form1.html", $arg);
    }
}
...
function makeHidden(&$objForm, $model) {
    ...
    knjCreateHidden($objForm, "PRGID", "KNJB0032");
