...
class knjb3050SubForm2
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjb3050SubForm2", "POST", "knjb3050index.php", "", "knjb3050SubForm2");
        ...
        $query=knjb3050Query::getSemesterRange($model);
        ...
        View::toHTML($model, "knjb3050SubForm2.html", $arg);
    }
}
