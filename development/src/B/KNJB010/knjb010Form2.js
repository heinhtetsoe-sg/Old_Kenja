...
function doSubmit() {
   ...
   {
       attribute3.value = attribute3.value + sep + document.forms[0].left_chaircd.options[i].value;
       sep = ",";
   }

   if (document.forms[0].left_class.length==0 && document.forms[0].right_class.length==0) {
       alert('{rval MSG916}');
       return false;
   }
   sep="";
   ...
   {
       attribute4.value = attribute4.value + sep + document.forms[0].left_class.options[i].value;
       sep = ",";
   }
