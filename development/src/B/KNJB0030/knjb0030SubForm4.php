...
class knjb0030SubForm4
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform4", "POST", "knjb0030index.php", "", "subform4");
        ...
        //SQL文発行
        //教科書一覧取得
        $query = knjb0030Query::selectQuerySubForm4($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0030SubForm4.html", $arg);
    }
}
