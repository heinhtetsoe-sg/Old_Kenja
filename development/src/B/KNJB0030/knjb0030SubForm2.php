...
class knjb0030SubForm2
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform2", "POST", "knjb0030index.php", "", "subform2");
        ...
        $check = $db->getOne(knjb0030Query::getStaffClass($model, $subclass));
        $staff = $db->getCol(knjb0030Query::getStaffClass($model, $subclass, "1"));

        $query = knjb0030Query::selectQuerySubForm2($model->term, $staff, $subclass);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0030SubForm2.html", $arg);
    }
}
