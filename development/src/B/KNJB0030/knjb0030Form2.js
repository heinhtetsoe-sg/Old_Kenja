function btn_submit(cmd) {
    ...
    if (cmd == "subform1") {
        ...
        loadwindow(
            "knjb0030index.php?cmd=subform1&param=" + param,
            0,
            0,
            350,
            400
    ...
    if (cmd == "subform2") {
        if (document.forms[0].SUBCLASSCD.value == "") {
            ...
            loadwindow(
                "knjb0030index.php?cmd=subform2&param=" +
                    param +
                    "&param2=" +
                    param2 +
                    "&subclass=" +
    ...
    if (cmd == "subform3") {
        ...
        loadwindow(
            "knjb0030index.php?cmd=subform3&param=" + param,
            0,
            0,
            350,
            400
    ...
    if (cmd == "subform4") {
        ...
        loadwindow(
            "knjb0030index.php?cmd=subform4&param=" + param,
            0,
            0,
            350,
            400
