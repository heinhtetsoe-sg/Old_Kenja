...
class knjb1215Form2 {
    ...
    function main(&$model) {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("edit", "POST", "knjb1215index.php", "", "edit");
        ...
        //科目名取得
        $arg["SUBCLASSNAME"] = $db->getOne(knjb1215Query::getSubclassName($model));

        //教科書一覧
        $query = knjb1215Query::getRow($model);
        ...
        if (VARS::get("cmd") != "edit"){
            $arg["reload"]  = "parent.left_frame.location.href='knjb1215index.php?cmd=list';";
        }
        ...
        View::toHTML($model, "knjb1215Form2.html", $arg); 
    }
}
