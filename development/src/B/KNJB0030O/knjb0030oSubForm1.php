...
class knjb0030oSubForm1
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform1", "POST", "knjb0030oindex.php", "", "subform1");
        ...
        //SQL文発行
        //組略称（学年・組）取得
        $query = knjb0030oQuery::selectQuerySubForm1($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0030oSubForm1.html", $arg);
    }
}
?>
