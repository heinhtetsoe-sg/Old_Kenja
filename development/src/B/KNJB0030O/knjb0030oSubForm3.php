...
class knjb0030oSubForm3
{
    function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knjb0030oindex.php", "", "subform3");
        ...
        //SQL文発行
        //使用施設一覧取得
        $query = knjb0030oQuery::selectQuerySubForm3($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0030oSubForm3.html", $arg);
    }
}
?>
