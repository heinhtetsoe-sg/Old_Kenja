...
*/
    ...
    parent.document.forms[0]["STAFFCD" + "-" + counter].value = Ch_val;
    parent.document.forms[0]["CHARGEDIV" + "-" + counter].value = Ch_val1;
    parent.document.forms[0]["STAFFNAME_SHOW1" + "-" + counter].value = Ch_txt1;
    parent.document.forms[0]["STAFFNAME_SHOW" + "-" + counter].value = Ch_txt;
    parent.document.forms[0]["STF_CHARGE" + "-" + counter].value = Ch_val2;
