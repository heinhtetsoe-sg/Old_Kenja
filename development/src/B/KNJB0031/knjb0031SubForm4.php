...
class knjb0031SubForm4
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform4", "POST", "knjb0031index.php", "", "subform4");
        ...
        //SQL文発行
        //教科書一覧取得
        $query = knjb0031Query::selectQuerySubForm4($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0031SubForm4.html", $arg);
    }
}
