...
class knjb0031SubForm3
{
    public function main(&$model)
    {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("subform3", "POST", "knjb0031index.php", "", "subform3");
        ...
        //SQL文発行
        //使用施設一覧取得
        $query = knjb0031Query::selectQuerySubForm3($model->term);
...
//            $row["backcolor"] = "#ffffff";
        ...
        View::toHTML($model, "knjb0031SubForm3.html", $arg);
    }
}
