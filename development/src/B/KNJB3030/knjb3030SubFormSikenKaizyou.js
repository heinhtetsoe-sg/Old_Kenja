...
function btn_submit(datacnt) {
    ...
    top.main_frame.right_frame.document.forms[0].SIKENKAIZYOUFACCD.value = Ch_val;
    top.main_frame.right_frame.document.forms[0].SIKENKAIZYOUFACILITYABBV.value = Ch_txt;
