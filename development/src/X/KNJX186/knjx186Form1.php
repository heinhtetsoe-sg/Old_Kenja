...
class knjx186Form1
{
    public function main(&$model)
    {
        ...
        $securityCnt = $db->getOne(knjx186Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $query = knjx186query::getYearSeme();
        ...
        //複式クラスコンボボックス
        $query = knjx186query::getGhrCd($model);
        $extra = "";
        makeCmb($objForm, $arg, $db, $query, "GHR_CD", $model->field["GHR_CD"], $extra, 1, "");
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX186");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx186index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx186Form1.html", $arg);
    }
}
//makeCmb
