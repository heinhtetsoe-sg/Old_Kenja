...
class knjxjob_search {
    function main(&$model) {
        $objForm = new form;
        $arg["start"]   = $objForm->get_start("knjxjob_search", "POST", "knjxjob_searchindex.php", "", "knjxjob_search");
        $db = Query::dbCheckOut();
        ...
        $query = knjxjob_searchQuery::getSchoolList($model);
        $opt = array();
        ...
        View::toHTML($model, "knjxjob_search.html", $arg);
    }
}
