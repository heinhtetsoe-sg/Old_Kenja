...
class knjx155Form1
{
    public function main(&$model)
    {
        ...
        //年度一覧コンボボックス
        $result     = $db->query(knjx155query::getSelectFieldSQL());
        $opt_year   = array();
        ...
        //年組一覧コンボボックス
        $result      = $db->query(knjx155query::getSelectFieldSQL2($model));
        $opt_gr_hr   = array();
        ...
        //学期コンボ
        $opt = array();
        $query = knjx155query::getSemester();
        ...
        Query::dbCheckIn($db);
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx155index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx155Form1.html", $arg);
    }
