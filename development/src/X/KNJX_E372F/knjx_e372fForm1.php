...
class knjx_e372fForm1
{
    public function main(&$model)
    {
        ...
        //年組リストを作成する
        $query = knjx_e372fQuery::getHrClass($model, CTRL_YEAR, CTRL_SEMESTER);
        $extra = "";
        ...
        //フォーム作成
        $arg["start"]  = $objForm->get_start("csv", "POST", "knjx_e372findex.php", "", "csv");
        //フォーム終わり
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx_e372fForm1.html", $arg);
    }
}
