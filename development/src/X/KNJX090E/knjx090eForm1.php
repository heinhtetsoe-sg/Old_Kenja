...
class knjx090eForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjx090eindex.php", "", "main");
        ...
        //年度・学期コンボ
        $query = knjx090equery::getYearSemeList();
        ...
        View::toHTML($model, "knjx090eForm1.html", $arg);
    }
}
...
function makeBtn(&$objForm, &$arg, $db, $model)
{
    ...
    if ($model->Properties["useXLS"]) {
        $model->schoolCd = $db->getOne(knjx090eQuery::getSchoolCd());
...
function makeHidden(&$objForm, $model)
{
    ...
    knjCreateHidden($objForm, "PRGID", "KNJX090E");
