...
class knjxSearch_Freshman
{
    function main(&$model) {
        ...
        $arg = array();
        //フォーム作成
        $arg["start"]   = $objForm->get_start("knjxSearch_Freshman", "POST", "knjxSearch_Freshmanindex.php", "", "knjxSearch_Freshman");
        ...
        if ($model->Properties["use_prg_schoolkind"] == "1") {
            $arg["schkind"] = "1";
            $query = knjxSearch_FreshmanQuery::getSchkind($model);
        ...
        //年組コンボ
        $query = knjxSearch_FreshmanQuery::getGradeHrClass($model);
        ...
        $arg["JAVASCRIPT"] = $js;
        View::toHTML($model, "knjxSearch_Freshman.html", $arg);
    }
}
//コンボ作成
