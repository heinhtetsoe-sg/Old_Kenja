...
class knjx183Form1 {
    function main(&$model) {
        ...
        $securityCnt = $db->getOne(knjx183Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $query = knjx183query::getYearSeme();
        ...
        //年組一覧コンボボックス
        $query = knjx183query::getGradeHrClass($model);
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX183");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx183index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx183Form1.html", $arg);
    }
}
//makeCmb
