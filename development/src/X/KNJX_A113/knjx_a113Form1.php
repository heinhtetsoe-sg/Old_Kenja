...
class knjx_a113Form1
{
    public function main(&$model)
    {
        ...
        //今年度・今学期名及びタイトルの表示
        $arg["data"]["YEAR_SEMESTER"] = CTRL_YEAR."年度"."　特待合格者データＣＳＶ入出力";
        ...
        //学年一覧コンボボックス
        $extra = "";
        $query = knjx_a113query::getGrade($model);
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx_a113index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx_a113Form1.html", $arg);
    }
}
