...
class knjx180Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx180index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx180Query::getSecurityHigh($model));
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $result     = $db->query(knjx180query::getSelectFieldSQL());
        $opt_year   = array();
        ...
        //年組一覧コンボボックス
        $result      = $db->query(knjx180query::getSelectFieldSQL2($model));
        $opt_gr_hr   = array();
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx180Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX180");
        ...
        View::toHTML($model, "knjx180Form1.html", $arg);
    }
}
