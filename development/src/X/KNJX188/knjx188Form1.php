...
class knjx188Form1 {
    function main(&$model) {
        ...
        $securityCnt = $db->getOne(knjx188Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $query = knjx188query::getYearSeme();
        ...
        //年組一覧コンボボックス
        $query = knjx188query::getGradeHrClass($model);
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX188");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx188index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx188Form1.html", $arg);
    }
}
//makeCmb
