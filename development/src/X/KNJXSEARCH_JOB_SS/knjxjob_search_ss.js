...
function apply_school(obj)
{
    ...
    if (job_list.value) {
        ...
        var jobtype_sscd     = job_list.value.split('|')[3];
        var jobtype_sname    = job_list.value.split('|')[4];
    } else {
        var jobtype_lcd      = "";
        var jobtype_mcd      = "";
        var jobtype_scd      = "";
    ...
    var p_jobtype_sscd   = eval("parent.document.forms[0].JOBTYPE_SSCD" + document.forms[0].target_number.value);
    ...
    p_jobtype_sscd.value = jobtype_sscd;
