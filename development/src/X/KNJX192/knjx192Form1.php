...
class knjx192Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx192index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx192Query::getSecurityHigh($model));
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $result     = $db->query(knjx192query::getSelectFieldSQL($model));
        $opt_year   = array();
        ...
        //年組一覧コンボボックス
        $result      = $db->query(knjx192query::getSelectFieldSQL2($model));
        $opt_gr_hr   = array();
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx192Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX192");
        ...
        View::toHTML($model, "knjx192Form1.html", $arg);
    }
}
?>
