...
class knjx192oForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjx192oindex.php", "", "main");
        ...
        //年度一覧コンボボックス
        $result     = $db->query(knjx192oquery::getSelectFieldSQL());
        $opt_year   = array();
        ...
        //年組一覧コンボボックス
        $result      = $db->query(knjx192oquery::getSelectFieldSQL2($model));   
        $opt_gr_hr   = array();
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx192oQuery::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX192O");
        ...
        View::toHTML($model, "knjx192oForm1.html", $arg);
    }
}
?>
