...
class knjx187Form1
{
    public function main(&$model)
    {
        ...
        $securityCnt = $db->getOne(knjx187Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $query = knjx187query::getYearSeme();
        ...
        //年組一覧コンボボックス
        $query = knjx187query::getGradeHrClass($model);
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX187");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx187index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx187Form1.html", $arg);
    }
}
//makeCmb
