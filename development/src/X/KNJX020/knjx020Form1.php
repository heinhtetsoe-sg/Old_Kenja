...
class knjx020Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx020index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx020Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        $arg["data"]["SCHREGNO_FROM"] = knjCreateTextBox($objForm, $model->field["SCHREGNO_FROM"], "SCHREGNO_FROM", 10, 8, $extra);
        $arg["data"]["SCHREGNO_TO"] = knjCreateTextBox($objForm, $model->field["SCHREGNO_TO"], "SCHREGNO_TO", 10, 8, $extra);

        //実行ボタン
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx020Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX020");
        ...
        View::toHTML($model, "knjx020Form1.html", $arg);
    }
}
