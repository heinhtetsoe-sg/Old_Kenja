...
class knjx_e372cForm1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjx_e372cindex.php", "", "main");
        ...
        //年組一覧コンボボックス
        $extra = "";
        $query = knjx_e372cQuery::getGradeHrClass($model);
        ...
        View::toHTML($model, "knjx_e372cForm1.html", $arg);
    }
}
