...
class knjx_h211Form1
{
    public function main(&$model)
    {
        ...
        //今年度・今学期名及びタイトルの表示
        $arg["data"]["YEAR_SEMESTER"] = CTRL_YEAR."年度"."　寮生名簿データＣＳＶ入出力";
        ...
        //学年一覧コンボボックス
        $extra = "";
        $query = knjx_h211query::getGrade($model);
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx_h211index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx_h211Form1.html", $arg);
    }
}
