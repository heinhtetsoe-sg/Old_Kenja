...
class knjx020bForm1
{
    function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx020bindex.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx020bQuery::getSecurityHigh());
        //セキュリティーチェック
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx020bQuery::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX020B");
        ...
        View::toHTML($model, "knjx020bForm1.html", $arg);
    }
}
?>
