...
class knjx170Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"] = $objForm->get_start("main", "POST", "knjx170index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx170Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度コンボ
        $result = $db->query(knjx170query::getSelectYear());
        $opt_year = array();
        $opt_year[] = array("label" => "",  "value" => "");
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx170Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX170");
        ...
        View::toHTML($model, "knjx170Form1.html", $arg);
    }
}
