...
class knjx010Form1
{
    public function main(&$model)
    {
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx010index.php", "", "main");
        ...
        $securityCnt = $db->getOne(knjx010Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        $result     = $db->query(knjx010query::getMasterSQL("staff_mst", "ORDER BY STAFFCD"));
        ...
        if ($model->Properties["useXLS"]) {
            $model->schoolCd = $db->getOne(knjx010Query::getSchoolCd());
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX010");
        ...
        View::toHTML($model, "knjx010Form1.html", $arg);
    }
}
