...
class knjx185Form1 {
    function main(&$model) {
        ...
        $securityCnt = $db->getOne(knjx185Query::getSecurityHigh());
        //セキュリティーチェック
        ...
        //年度一覧コンボボックス
        $query = knjx185query::getYearSeme();
        ...
        //年組一覧コンボボックス
        $query = knjx185query::getGradeHrClass($model);
        $extra = "";
        ...
        knjCreateHidden($objForm, "PRGID", "KNJX185");
        ...
        //フォーム作成
        $arg["start"]   = $objForm->get_start("main", "POST", "knjx185index.php", "", "main");
        $arg["finish"]  = $objForm->get_finish();

        //テンプレートのHTMLを読み込んでデータを$arg経由で渡す。
        View::toHTML($model, "knjx185Form1.html", $arg);
    }
}
//makeCmb
