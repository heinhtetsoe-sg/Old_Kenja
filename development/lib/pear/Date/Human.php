...
class Date_Human
{
    ...
    function gregorianToHuman($day=0, $month=0, $year=0) 
    {
         ...
         * 28 days in a month...
         */
        $humanMonthOfYear = floor((int)$dayofyear / 28);
        /**
        ...
        if ($humanMonthOfYear == 0) {
            ...
            $humanDayOfMonth = ((int)$dayofyear) % 28;
        }
        /**
         * Day of the week is modulus 7
         */
        $humanDayOfWeek = (int)$dayofyear % 7;
        /**
         ...
         */
        $humanWeekOfMonth = ceil((int)$humanDayOfMonth / 7);
        $humanWeekOfYear = ceil((int)$dayofyear / 7);
        /**
