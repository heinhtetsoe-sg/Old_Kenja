...
/*******************************************************************
/*PHP�p�f�o�b�O�v���O�����i�ǉ��� H21.05.11 kurata)
/*******************************************************************
/*
/*(���̃f�o�b�O�i�ϐ��\���j�v���O�����̗��_)
/*   �@�ϐ����z��̏ꍇ�ɂ����̊K�w���Ƃɉ��������Ă��邩�킩��
/*   �A�Ƃɂ������₷��
/*   �Brequire�����Ȃ��悤�ɂ���Ε\������Ȃ��Ȃ�
/*
/*(�g����)
/*   �@�g�������v���O�����œǂݍ��܂��邽�߂Ɏ��s��
/*
/*       require_once('../../common/dBug.php');
/*
/*     �̂P�s�����Ă���
/*�A���g���������ϐ��̈ʒu�̒����̍s������� 
/*        
...
class dBug {
	...
	function getVariableName() {
		...
		for($i=get_count($arrBacktrace)-1; $i>=0; $i--) {
		...
		if(isset($arrFile)) {
			...
			$code = $arrLines[((int)$arrFile["line"]-1)];
	...
	function varIsDBResource($var,$db="mysql") {
		...
		$this->makeTableHeader("resource",$db." result",(int)$numfields+1);
		echo "<tr><td class=\"dBug_resourceKey\">&nbsp;</td>";
		for($i=0;$i<$numfields;$i++) {
			$field_header = "";
			for($j=0; $j<get_count($arrFields); $j++) {
