/*
 * $Id: 4546db4ac1a1f306e2fae5404cb3d83cf9a53264 $
 *
 * 作成日: 2012/10/18
 * 作成者: maesiro
 *
 ...
 * 受講料・諸経費の各種帳票
 */
public class KNJMP801 {

    private static final Log log = LogFactory.getLog(KNJMP801.class);
    ...
    private void printMain1(final DB2UDB db2, final Vrw32alp svf, final String schregno) {
        ...
        svf.VrSetForm("KNJMP801_1.frm", 1);
...
//            log.debug("address sql = " + sql);
    ...
    private void printMain2(final DB2UDB db2, final Vrw32alp svf, final String schregno) {
        ...
        svf.VrSetForm("KNJMP801_2.frm", 4);
...
//        log.debug(" bank sql =" + stb.toString());
    ...
    public String getMoneyDueSql(final String schregno) {
        ...
        stb.append(" ), MONEY_DUE_M_SUM AS ( ");
        stb.append("     SELECT ");
        stb.append("         T2.YEAR, ");
        stb.append("         T2.SCHREGNO, ");
        stb.append("         T2.COLLECT_GRP_CD, ");
        stb.append("         T2.COLLECT_L_CD, ");
        stb.append("         T2.COLLECT_M_CD, ");
        stb.append("         VALUE(MONEY_DUE, 0) * VALUE(COLLECT_CNT, 0) AS MONEY_DUE ");
        stb.append("     FROM ");
        ...
        stb.append("     CASE WHEN T3.SCHREGNO IS NOT NULL THEN T3.MONEY_DUE ELSE T2.MONEY_DUE END AS MONEY_DUE, ");
        ...
        stb.append("     INNER JOIN MONEY_DUE_M_SUM T2 ON T2.YEAR = T1.YEAR ");
