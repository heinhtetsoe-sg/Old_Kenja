/*
 * $Id: e4357286f5ffefc68a4834f3b2e6772faea01ba7 $
 *
 * 作成日: 2017/01/23
 * 作成者: maesiro
 *
...
public class KNJMP717 {

    private static final Log log = LogFactory.getLog(KNJMP717.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if ("1".equals(rs.getString("IS_JUGYOURYOU"))) {
    ...
    private String sql() {
        ...
        stb.append("     COL_MM.IS_JUGYOURYOU, ");
