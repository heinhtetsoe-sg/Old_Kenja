/*
 * $Id: 8b7dff0c59109f07b66b267756301f20643ed47e $
 *
 * 作成日: 2012/02/21
 * 作成者: maesiro
 *
...
public class KNJH566B {

    private static final Log log = LogFactory.getLog(KNJH566B.class);
    ...
    private void printStudent(
        ...
        final String form = "KNJH566B.frm";
    ...
    private static class ScoreSubclass {
        ...
        public static List getScoreSubclassList(final DB2UDB db2, final Param param, final String schregno) {
            ...
            final KNJH566B.KNJE070_1 e70 = new KNJH566B.KNJE070_1(db2, definecode, schregno, param._year, param._semester, m);
            for (final Iterator it = e70._printData._studyrecData.iterator(); it.hasNext();) {
                final KNJH566B.KNJE070_1.StudyrecClass sc = (KNJH566B.KNJE070_1.StudyrecClass) it.next();
                ...
                for (final Iterator itd = sc._studyrecDatList.iterator(); itd.hasNext();) {
                    final KNJH566B.KNJE070_1.StudyrecDat sd = (KNJH566B.KNJE070_1.StudyrecDat) itd.next();
                    ...
                    for (final Iterator itg = sd._gradesList.iterator(); itg.hasNext();) {
                        final KNJH566B.KNJE070_1.Grades grades = (KNJH566B.KNJE070_1.Grades) itg.next();
    ...
    private static class KNJE070_1 {
         ...
         * <<クラスの説明>>。
         * @author yamasiro
         * @version $Id: 8b7dff0c59109f07b66b267756301f20643ed47e $
         */
