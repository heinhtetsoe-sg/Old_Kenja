...
/**
 *  学校教育システム 賢者 [入試処理] 武蔵・座席ラベル
 *
 */
public class KNJL300M {
    private boolean _hasData;
    Param _param;

    private static final Log log = LogFactory.getLog(KNJL300M.class);
        ...
        for( int ia=0 ; ia < _param._categoryName.length ; ia++ ){
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    //タックシールに印字
                    svf.VrsOutn("APPLICANTDIV"+String.valueOf(len), gyo, "入学試験");
    ...
    private String getExamnoSql(String hallCd, String receptSt, String receptEd) {
        ...
        stb.append("     AND T2.EXAMNO BETWEEN '" + receptSt + "' AND '" + receptEd + "' ");
    ...
    private class Param {
        ...
        Param(final DB2UDB db2, HttpServletRequest request) throws Exception {
            ...
            _testDiv = request.getParameter("TESTDV");
        }
    }
