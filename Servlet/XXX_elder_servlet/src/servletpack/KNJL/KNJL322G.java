/*
 * $Id: 8122399e6b806a96f58b6f61bd4ae4a7930fc132 $
 *
 * 作成日: 2016/12/16
 * 作成者: maesiro
 *
...
public class KNJL322G {

    private static final Log log = LogFactory.getLog(KNJL322G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                svf.VrsOutn("COURSE_NAME", lineCnt, course1);
    ...
    private void setTitle(final Vrw32alp svf, final String nendo) {
        svf.VrsOut("TITLE", nendo + "　" + _param._applicantdivName + "　" + _param._testdivAbbv1 + "　欠席者リスト");
    ...
    private String sql() {
        ...
        stb.append("     AND VBASE.JUDGEMENT = '4' ");
        stb.append(" ORDER BY ");
        stb.append("     VBASE.EXAMNO ");
        return stb.toString();
    }
