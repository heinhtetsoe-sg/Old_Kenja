...
public class KNJL312J {

    private static final Log log = LogFactory.getLog(KNJL312J.class);
    ...
    private void printHead(DB2UDB db2, Vrw32alp svf, PreparedStatement ps2)
	{
        ...
        try {
            ret = svf.VrSetForm("KNJL312J.frm", 4);
...
//            stb.append(                                         "W2.EXAM_TYPE = W1.EXAM_TYPE AND ");
            ...
            stb.append(                                           "W5.APPLICANTDIV = '1' AND ");
            stb.append(                                           "W5.TESTDIV = '" + param[2] + "' AND ");
            ...
            stb.append(                                          "W6.TESTDIV = '" + param[2] + "' AND ");
