/*
 * $Id: 468e2d0f4c46fbcb2e782c350a95ddf87b1cd24f $
 *
 * 作成日: 2019/01/14
 * 作成者: yamashiro
 *
...
public class KNJL131R {

    private static final Log log = LogFactory.getLog(KNJL131R.class);
    ...
    private class Param {
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            loadControlMst(db2);
            _schoolStampPath = checkFilePath(_documentRoot + "/" + _imagePath + "/SCHOOLSTAMP_J.bmp");
            _schoolLogoPath = checkFilePath(_documentRoot + "/" + _imagePath + "/SCHOOLLOGO_J.jpg");
            _schoolNamePath = checkFilePath(_documentRoot + "/" + _imagePath + "/SCHOOLNAME_J.jpg");
