/*
 * $Id: 83dd7e98aa2431cb09de125938c7e6a566e6bdc0 $
 *
 * 作成日: 2016/12/16
 * 作成者: maesiro
 *
...
public class KNJL323G {

    private static final Log log = LogFactory.getLog(KNJL323G.class);
    ...
    private void setTitle(final Vrw32alp svf, final String nendo) {
        svf.VrsOut("TITLE", nendo + "　" + _param._applicantdivName + "　" + _param._testdivAbbv1 + "　転科合格者一覧");
