// kanji=漢字
/*
 * $Id: e7436e39ac16fdd9e2b1f07dd37c3225388b1f28 $
 *
 * 作成日: 2008/01/04 16:10:26 - JST
 * 作成者: m-yama
 *
...
public class KNJL300J {

    private static final Log log = LogFactory.getLog(KNJL300J.class);
	...
	//	パラメータ（会場コード）
		try {
			stb.append("SELECT ");
			stb.append("    (SELECT NAME1 AS TEST_NAME FROM NAME_MST WHERE NAMECD1='L004' AND NAMECD2='"+param[1]+"'), ");
