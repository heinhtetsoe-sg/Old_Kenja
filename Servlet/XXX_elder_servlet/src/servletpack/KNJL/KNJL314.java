...
public class KNJL314 {

    private static final Log log = LogFactory.getLog(KNJL314.class);
...
for(int i=0 ; i<param.length ; i++) if( param[i] != null ) System.out.println("[KNJL314]param[" + i + "]=" + param[i]);
    }
