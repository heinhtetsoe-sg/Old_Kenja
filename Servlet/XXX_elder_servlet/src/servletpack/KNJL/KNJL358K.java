// kanji=漢字
/*
 * $Id: 3dd84e31f5edb2f13970378da3c2ca3afe701f05 $
 *
 * 作成日: 2006/01/05
 * 作成者: m-yama
 *
 ...
 * @author m-yama
 * @version $Id: 3dd84e31f5edb2f13970378da3c2ca3afe701f05 $
 */

public class KNJL358K {
    ...
    private static final Log log = LogFactory.getLog(KNJL358K.class);
    ...
    private void setInfluenceName(DB2UDB db2, Vrw32alp svf, String specialReasonDiv) {
        PreparedStatement ps;
        ResultSet rs;
        try {
            ps = db2.prepareStatement("SELECT NAME2 FROM NAME_MST WHERE NAMECD1 = 'L017' AND NAMECD2 = '" + specialReasonDiv + "' ");
            rs = ps.executeQuery();
            while (rs.next()) {
    ...
    /**ヘッダデータをセット*/
    private void printHeder(final DB2UDB db2, final Vrw32alp svf) {
        ...
        setInfluenceName(db2, svf, _param._specialReasonDiv);
    }
...
//      log.debug(stb);
    ...
    private String sqlLowerMeisaiGet(
        ...
        stb.append("    AND ((JUDGEMENT > '" + JudgeMent.HORYUU + "' AND JUDGEMENT <= '" + JudgeMent.SUISEN + "') OR JUDGEMENT = '" + JudgeMent.PASS4 + "') ");
        ...
        stb.append("    AND ((JUDGEMENT > '" + JudgeMent.HORYUU + "' AND JUDGEMENT <= '" + JudgeMent.ADDPASS + "') OR JUDGEMENT = '" + JudgeMent.PASS4 + "') ");
