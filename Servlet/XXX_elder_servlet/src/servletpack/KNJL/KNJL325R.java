/*
 * $Id: 4be51fa297803da2429e34a50442bb0b796c49be $
 *
 * 作成日: 2013/10/10
 * 作成者: maesiro
 *
 ...
 *  学校教育システム 賢者 [入試管理]
 *
 *                  ＜ＫＮＪＬ３２５Ｒ＞  不合格者、欠席者リスト
 **/
public class KNJL325R {

    private static final Log log = LogFactory.getLog(KNJL325R.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        final String form = "KNJL325R.frm";
        final int maxLine = 50;

        final List list = ReceptDat.load(db2, _param);
        ...
        for (int pi = 0; pi < pageList.size(); pi++) {
            ...
            svf.VrsOut("TITLE", KenjaProperties.gengou(Integer.parseInt(_param._entexamyear)) + "年度　" + _param._testdivName + "得点付き欠席不合格者一覧"); // タイトル
    ...
    private static class ReceptDat {
                ...
                while (rs.next()) {
                    ...
                    if (null == getReceptDat(list, examno)) {
                        ...
                        final ReceptDat receptdat = new ReceptDat(receptno, examno, examCoursemark1, examCoursemark2, examCoursemark3, examCoursemark4, name, sex, sexName, fsCd, finschoolName,
                                sucCoursecode, sucCoursemark, naidakuCoursemark, sub, kasantenAll, total4, totalRank4, juken, interviewValue);
                        list.add(receptdat);
                    }
        ...
        public static String sql(final Param param) {
            ...
            stb.append("     CASE WHEN T10.INTERVIEW_VALUE = 'C' THEN 'C' END AS INTERVIEW_VALUE, ");
            ...
            stb.append("     LEFT JOIN ENTEXAM_WISHDIV_MST T6 ON T5.ENTEXAMYEAR = BASE.ENTEXAMYEAR ");
            ...
            stb.append("     INNER JOIN NAME_MST NML013 ON NML013.NAMECD1 = 'L013' ");
            ...
            stb.append("     AND VALUE(NML013.NAMESPARE1, '') <> '1' "); // 不合格者
            stb.append(" ORDER BY ");
            stb.append("     T3.EXAMCOURSECD, T1.EXAMNO ");
            return stb.toString();
        }
    }
