...
public class KNJL311 {

    private static final Log log = LogFactory.getLog(KNJL311.class);
    ...
    private void printHead(DB2UDB db2, Vrw32alp svf, PreparedStatement ps1, PreparedStatement ps2)
	{
        ...
        try {
            ret = svf.VrSetForm("KNJL311.frm", 1);
        } catch( Exception ex ){
    ...
    private void printsvfMeibo(Vrw32alp svf, ResultSet rs)
	{
		...
		try{
            ...
            ret = svf.VrsOut( "SEX",       ( rs.getString("SEXNAME")   != null )? rs.getString("SEXNAME")   : ""  ); //性別
	 		ret = svf.VrsOut( "SCHOOLNAME",( rs.getString("FS_NAME")   != null )? rs.getString("FS_NAME")  : ""  ); //出身学校
