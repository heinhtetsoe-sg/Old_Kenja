// kanji=漢字
/*
 * $Id: 4912a5646c59c97905a0c989e2d8dc02734b6ef3 $
 *
 * 作成日: 2014/06/11 17:49:25 - JST
 * 作成者: m-yama
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: 4912a5646c59c97905a0c989e2d8dc02734b6ef3 $
 */
public class KNJL413_A {

    private static final Log log = LogFactory.getLog("KNJL413_A.class");
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) throws SQLException, UnsupportedEncodingException {
        ...
        for (final Iterator iter = printList.iterator(); iter.hasNext();) {
            ...
            if (!StringUtils.isBlank(recruitData._name)) {
                svf.VrsOutn("NAME" + gyou + "_1",retu , recruitData._name + "　様");  //名称
            }
