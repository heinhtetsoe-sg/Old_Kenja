/*
 * $Id: edc6b6aa368b5fe7e58733cd2badfc4ded5c5a40 $
 *
 * 作成日: 2016/12/21
 * 作成者: maesiro
 *
...
public class KNJL344G {

    private static final Log log = LogFactory.getLog(KNJL344G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                svf.VrsOutn("PASS_COURSE_NAME", lineCnt, sucCourse);
    ...
    private void setTitle(final Vrw32alp svf, final String nendo) {
        svf.VrsOut("TITLE", nendo + "　中学校別成績リスト");
    ...
    private String sql() {
        ...
        stb.append("          AND VBASE.SINZOKU_ZOKUGARA = H201_2.NAMECD2 ");
