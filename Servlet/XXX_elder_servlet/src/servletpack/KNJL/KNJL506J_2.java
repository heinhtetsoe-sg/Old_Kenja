/*
 * $Id: c7320800ff4727255018c1b0c0d8b276996fe5bc $
 *
 * 作成日: 2015/09/08
 * 作成者: nakamoto
 *
 ...
 *                  ＜ＫＮＪＬ３００Ｎ＞  座席ラベル
 **/
public class KNJL506J_2 {

    private static final Log log = LogFactory.getLog(KNJL506J_2.class);
    ...
    private String sql() {
        ...
        stb.append(" ORDER BY ");
        if ("1".equals(_param._sort2)) {
            if ("1".equals(_param._subsort)) {
                stb.append(" VALUE(TOTAL2,0) DESC, ");
            }else {
                stb.append(" VALUE(TOTAL4,0) DESC, ");
            }
        }
        stb.append("     RECEPTNO ");
        return stb.toString();
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        if ("1".equals(_param._applicantdiv)) {
            svf.VrSetForm("KNJL506J_2_1.frm", 1);
        } else {
            svf.VrSetForm("KNJL506J_2_2.frm", 1);
        }
    ...
    private void setTitle(final DB2UDB db2, final Vrw32alp svf) {
        ...
        String sort2Name = "1".equals(_param._sort2) ? " (成績順)" : " (受験番号順)";
        svf.VrsOut("TITLE", setYear + "度 " + _param._applicantdivName + " " + _param._testdivName + " 成績一覧表" + sort2Name);
        //DATE
    ...
    private static class Param {
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            _sort2 = request.getParameter("SORT2");
            _subsort = request.getParameter("SUBSORT");
