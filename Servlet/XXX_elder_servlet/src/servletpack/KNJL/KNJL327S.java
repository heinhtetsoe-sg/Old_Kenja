// kanji=漢字
/*
 * $Id: baf99a0a0f9040ceadc7b311f338f393229ea0ec $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: baf99a0a0f9040ceadc7b311f338f393229ea0ec $
 */
public class KNJL327S {

    private static final Log log = LogFactory.getLog("KNJL327S.class");

    private boolean _hasData;
    private static final String FORMNAME = "KNJL327S.frm";
    ...
    private void setKoteiKoumoku(final Vrw32alp svf) {
        ...
        svf.VrsOut("MAIN1", "　上記の者は、" + warekiYear + "度宮城県高等学校入学者");
