/*
 * $Id: cd04931e7b4ed2d91781add5ad255c4bbba93ec5 $
 *
 * 作成日: 2018/12/18
 * 作成者: matsushima
 *
...
public class KNJL501G {

    private static final Log log = LogFactory.getLog(KNJL501G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                aftCd = StringUtils.defaultString(aftCd);
                ...
                svf.VrsOutn("BIRTHDAY", lineCnt, KNJ_EditDate.h_format_JP(db2, birthday));
