/*
 * $Id: 21be92d9cfcdb167a96abbd46cd7cc1fc86f4b02 $
 *
 * 作成日: 2016/12/22
 * 作成者: maesiro
 *
...
public class KNJL335G {

    private static final Log log = LogFactory.getLog(KNJL335G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                final String houkoku = rs.getString("REMARK1");
    ...
    private void setTitle(final Vrw32alp svf, final String nendo, final String shName) {
        svf.VrsOut("TITLE", nendo + "　" + _param._applicantdivName + "　" + _param._testdivAbbv1 + "　監督者情報(" + shName + ")");
    ...
    private String sql() {
        ...
        stb.append("     AND VBASE.REMARK1 IS NOT NULL ");
