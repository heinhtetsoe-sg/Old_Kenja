// kanji=漢字
/*
 * $Id: e83b829d0203335b4dde66f7e09e4fac903fde3f $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: e83b829d0203335b4dde66f7e09e4fac903fde3f $
 */
public class KNJL365 {
    private static final Log log = LogFactory.getLog(KNJL365.class);
    ...
    private String getPrintDataSql() {
        ...
        sql.append("   AND T1.SPECIAL_REASON_DIV IN (SELECT NAMECD2 FROM NAME_MST WHERE NAMECD1 = 'L017' AND NAMESPARE1 = '1') ");
