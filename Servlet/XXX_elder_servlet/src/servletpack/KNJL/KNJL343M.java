// kanji=漢字
/*
 * $Id: 7b459d5e598966e2411b2d3ced014699f91561c5 $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: 7b459d5e598966e2411b2d3ced014699f91561c5 $
 */
public class KNJL343M {

    private static final Log log = LogFactory.getLog("KNJL343M.class");

    private boolean _hasData;
    private static final String FORMNAME = "KNJL343M.frm";
    ...
    private void setKoteiKoumoku(final Vrw32alp svf) {
        final String dateYM = KNJ_EditDate.h_format_JP_M(_param._date);
        final String date = KNJ_EditDate.setDateFormat(dateYM, _param._year);
        svf.VrsOut("DATE", date + "    日");
