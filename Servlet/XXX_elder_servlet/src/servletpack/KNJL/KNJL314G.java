/*
 * $Id: f8fb97d521aef15ef969f3fc31468d515627a3c5 $
 *
 * 作成日: 2016/12/14
 * 作成者: maesiro
 *
...
public class KNJL314G {

    private static final Log log = LogFactory.getLog(KNJL314G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        svf.VrSetForm("KNJL314G.frm", 1);

        final String nendo = KenjaProperties.gengou(Integer.parseInt(_param._entexamyear)) + "年度 ";
        svf.VrsOut("TITLE", nendo + "　" + _param._applicantdivName + "　" + _param._testdivAbbv1 + "　面接表");
