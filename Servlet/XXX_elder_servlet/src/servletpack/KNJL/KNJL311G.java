/*
 * $Id: 5589971d89f61d514df4277673dd399f192d98fa $
 *
 * 作成日: 2016/12/14
 * 作成者: maesiro
 *
...
public class KNJL311G {

    private static final Log log = LogFactory.getLog(KNJL311G.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        svf.VrSetForm("KNJL311G.frm", 1);

        final String nendo = KenjaProperties.gengou(Integer.parseInt(_param._entexamyear)) + "年度 ";
        svf.VrsOut("TITLE", nendo + "　" + _param._applicantdivName + "　" + _param._testdivAbbv1 + "　出願確認リスト");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                svf.VrsOutn("COURSE1", lineCnt, course1);
                ...
                final String kanaField = getMS932Bytecount(nameKana) > 30 ? "3" : getMS932Bytecount(nameKana) > 20 ? "2" : "1";
                svf.VrsOutn("KANA" + kanaField, lineCnt, nameKana);
                svf.VrsOutn("SEX", lineCnt, sex);
                svf.VrsOutn("COURSE2", lineCnt, course2);
