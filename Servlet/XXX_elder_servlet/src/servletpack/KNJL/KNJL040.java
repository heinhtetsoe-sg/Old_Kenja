// kanji=漢字
/*
 * $Id: aaf5baf34f1afbbde8445673c43e6bc533e84267 $
 *
 ...
 */
public class KNJL040
{
    private static final Log log = LogFactory.getLog(KNJL040.class);
...
private abstract class CourseStatistics_Base
{
    ...
    String preStatSub( Map paramap )
    {
        ...
        try {
            ...
            stb.append("                    AND E1.SPECIAL_REASON_DIV IN (SELECT NAMECD2 FROM NAME_MST WHERE NAMECD1 = 'L017' AND NAMESPARE1 = '1') ");
            stb.append("           ) ");
            stb.append(")  ");
