/*
 * $Id: 97793f7d939ea3f4a5648f63f6c8328c46b0ad49 $
 *
 * 作成日: 2017/11/20
 * 作成者: tawada
 *
...
public class KNJL342W {

    private static final Log log = LogFactory.getLog(KNJL342W.class);
    ...
    public void svf_out(
        ...
        try {
            ...
            if ("1".equals(_param._csvDiv)) {
                ...
                printMain(db2, svf, testDiv, "前期選抜", "");
                printMain(db2, svf, testDiv, "前期選抜", "1");
            } else {
                String testDiv = "5";
                printMain(db2, svf, testDiv, "後期選抜", "");
                printMain(db2, svf, testDiv, "後期選抜", "1");
                testDiv = "6";
                printMain(db2, svf, testDiv, "再募集", "");
            }
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf, final String testDiv, final String divName, final String testDiv2) {
        svf.VrSetForm("KNJL342W.frm", 4);
        final Map printMap = getMap(db2, testDiv, testDiv2);
        int printLine = 1;

        setTitle(svf, divName, testDiv2);//タイトル
    ...
    private void setTitle(final Vrw32alp svf, final String divName, final String testDiv2) {
    ...
    private Map getMap(final DB2UDB db2, final String testDiv, final String testDiv2) {
        final Map retMap = new TreeMap();
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            final String sql = getSql(testDiv, testDiv2);
            log.debug(" sql =" + sql);
    ...
    private String getSql(final String testDiv, final String testDiv2) {
        ...
        stb.append("                 FROM ");
        stb.append("                     ENTEXAM_COURSE_MST V1 ");
        stb.append("                     INNER JOIN V_COURSE_MAJOR_MST V2 ON V1.ENTEXAMYEAR = V2.YEAR ");
        ...
        stb.append("                 FROM ");
        stb.append("                     V_ENTEXAM_APPLICANTBASE_DAT V1 ");
        stb.append("                 WHERE ");
        stb.append("                         V1.ENTEXAMYEAR  = '" + _param._entExamYear + "' ");
        ...
        stb.append("                 FROM ");
        stb.append("                     V_ENTEXAM_APPLICANTBASE_DAT V1 ");
        stb.append("                     JOIN ENTEXAM_SCORE_DAT E1 ON V1.ENTEXAMYEAR = E1.ENTEXAMYEAR ");
        ...
        private List getCouseMajorList(final DB2UDB db2) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    final String cmName = rs.getString("CM_NAME");

                    final PrintCmData PrintCmData = new PrintCmData(cmCd, cmName);
