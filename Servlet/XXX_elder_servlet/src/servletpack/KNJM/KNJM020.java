// kanji=漢字
/*
 * $Id: ce09b8c3aad7fc2eb6ad980060b2cb03fe077db3 $
 *
...
public class KNJM020 {

    private static final Log log = LogFactory.getLog(KNJM020.class);
...
//          if (nonedata) svf.VrEndRecord();
    ...
    private String preStat(String param[])
    {
        ...
        try {
            ...
            stb.append("    w1.GRADE||w1.HR_CLASS in " +param[3] );
            stb.append(") ");
