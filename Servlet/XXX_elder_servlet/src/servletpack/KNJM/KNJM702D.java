 ...
 * @version $Id$
 */
public class KNJM702D {

    private static final Log log = LogFactory.getLog("KNJM702D.class");

    private boolean _hasData;

    private static final String FORMNAME = "KNJM702D.frm";
    ...
    public void svf_out(
        ...
        try {
            ...
            if ("csv".equals(_param._cmd)) {
                outputCsv(db2, request, response);
            } else {
                svf = new Vrw32alp();
    ...
    private void outPutData(final Vrw32alp svf, final HrClass hrClass) {
        ...
        for (final Iterator iter = hrClass._studentList.iterator(); iter.hasNext();) {
            ...
            svf.VrsOutn("ATTENDNO", lineCnt, student._attendNo);  //出席番号
            svf.VrsOutn("SCHREGNO", lineCnt, student._schregNo);  //学籍番号
            svf.VrsOutn("NAME", lineCnt, student._name);  //氏名
            final String setCreditBorder = null != student._creditBorder ? student._creditBorder.toBigInteger().toString() : "";
            svf.VrsOutn("SP_TIME", lineCnt, setCreditBorder);  //特活時数
...
//            }
            final String ttlCre = null != student._totalCredit ? student._totalCredit.toBigInteger().toString() : "";
            svf.VrsOutn("TOTAL_CREDIT_TIME", lineCnt, ttlCre);
    ...
    private void outputCsv(final DB2UDB db2, final HttpServletRequest request, final HttpServletResponse response) throws SQLException {
        ...
        CsvUtils.outputLines(log, response, title + ".csv", lines, csvParam);
    }
...
//            }
            final String ttlCre = null != student._totalCredit ? student._totalCredit.toBigInteger().toString() : "";
            studentLine.add("0.0".equals(ttlCre) ? "" : ttlCre);
    ...
    private class Student {
        ...
        public void setNowCredit(final DB2UDB db2) throws SQLException {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    _totalCreditTimeNow = rs.getBigDecimal("SPACTTIME");
        ...
        private String getNowCredit() {
            final StringBuffer stb = new StringBuffer();
            stb.append(" SELECT ");
            stb.append("   SUM(VALUE(T2.SPECIALACTIVITYTIME, 0)) AS SPACTTIME ");
            stb.append(" FROM ");
        ...
        public void setLastCredit(final DB2UDB db2) throws SQLException {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    _totalCreditTimeLast = rs.getBigDecimal("SPACTTIME");
        ...
        public String getCreditBorder() {
            final StringBuffer stb = new StringBuffer();
            stb.append(" SELECT ");
            stb.append("     T1.BASE_REMARK2 AS CREDIT_BORDER ");
            stb.append(" FROM ");
