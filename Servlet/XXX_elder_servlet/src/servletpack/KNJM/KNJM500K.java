...
/*
 * $Id: a32165b51e2542e2252b5daa709b1f41edadec82 $
 *
 * 作成日: 2020/06/09
 * 作成者: matsushima
 *
...
public class KNJM500K {

    private static final Log log = LogFactory.getLog(KNJM500K.class);
...
//    private static final String HYOTEI_TESTCD = "9990009";
    ...
    private void printSvfMain(final DB2UDB db2, final Vrw32alp svf, final Student student) {
        final String form = "KNJM500K.frm";
...
//            final StringBuffer divStrT5 = divStr("T5.", sdivs);
            ...
            stb.append("     FROM V_RECORD_SCORE_HIST_DAT T1 ");
            ...
            stb.append("     LEFT JOIN RECORD_SCORE_HIST_DAT L2 ");
