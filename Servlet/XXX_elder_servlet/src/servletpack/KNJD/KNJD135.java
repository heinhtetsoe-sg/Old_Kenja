// kanji=漢字
/*
 * $Id: 1b7a3a4865d37bf78989e5b685af9b3130d10abd $
 *
 * 作成日: 2010/06/30 17:57:35 - JST
 * 作成者: m-yama
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: 1b7a3a4865d37bf78989e5b685af9b3130d10abd $
 */
public class KNJD135 {

    private static final Log log = LogFactory.getLog("KNJD135.class");

    private boolean _hasData;
    private static final String FORMNAME = "KNJD135.frm";
    ...
    private class HrClass {
        ...
        private String getStudentSql() {
            ...
            if (_param._isSapporo) {
            	stb.append("     AND T1.COURSECODE IN('1851', '1852', '1853') ");
            }
            stb.append(" ORDER BY ");
            stb.append("     T1.ATTENDNO ");
    ...
    private class Param {
        ...
        private final boolean _isSapporo;
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            _isSapporo = "sapporo".equals(z010Name1);
        }
        ...
        private String getPrintDate(final DB2UDB db2) throws SQLException {
            ...
            try {
                ...
                db2.commit();
                retStr = KNJ_EditDate.h_format_JP(db2, arr_ctrl_date[0]) + arr_ctrl_date[1] + "時" + arr_ctrl_date[2] + "分";
            } finally {
                db2.commit();
            }
            return retStr;
