 ...
 *
 *    2010/04/17 o-naka KNJD128Aを元に新規作成
 */
...
public class KNJD128B {

    private static final Log log = LogFactory.getLog(KNJD128B.class);
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        final String form = "1".equals(param[21]) ? "KNJD128B_P.frm" : "KNJD128B.frm";
    ...
    private void printSvfOutTotal( Vrw32alp svf, int total[][] )
    {
        try {
            ...
            String fname[] = { "TOTAL1_1", 
                               "TOTAL1_2", "TOTAL_AVERAGE1",
                               "TOTAL2_1", 
                               "TOTAL2_2", "TOTAL_AVERAGE2",
                               "TOTAL3_1", 
                               "TOTAL3_2", "TOTAL_AVERAGE3",
                               "TOTAL_AVERAGE4" };
