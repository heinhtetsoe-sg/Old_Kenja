...
public class KNJD124T {

    private static final Log log = LogFactory.getLog(KNJD124T.class);
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        if ("1".equals(param[20])) {
            svf.VrSetForm("KNJD124T_P.frm", 4);
        } else {
            svf.VrSetForm("KNJD124T.frm", 4);
        }
    ...
    private String getTestField(String test) {
        ...
        if ("30201".equals(test)) return "TESTNAME3_1";
        return "DUMMY";
    }
    ...
    private boolean printSvfOutMeisai( Vrw32alp svf, ResultSet rs, String param[], int total[][], Map attendmap ){
        ...
        try {
            ...
            printSvfOutDetal( svf, "GRADING3_1", (rs.getString("SEM3_TERM_VALUE_DI") != null) ? rs.getString("SEM3_TERM_VALUE_DI") : rs.getString("SEM3_TERM_VALUE"), null );
            printSvfOutDetal( svf, "AVERAGE3",   (rs.getString("SEM3_VALUE_DI") != null) ? rs.getString("SEM3_VALUE_DI") : rs.getString("SEM3_VALUE"),      null );
            ...
            accumMeisai( total, i++, rs.getString("SEM3_TERM_VALUE") );
    ...
    private void printSvfOutTotal( Vrw32alp svf, int total[][] )
    {
        try {
            ...
            String fname[] = { "TOTAL1_1", "TOTAL_GRADING1_1", 
                               ...
                               "TOTAL3_1", "TOTAL_GRADING3_1", "TOTAL_AVERAGE3",
                               "TOTAL_AVERAGE4" };
