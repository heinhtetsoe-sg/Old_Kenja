/*
 * $Id: 38cee8d61f576d9b4a8b4497b5725cdf9bd02876 $
 *
 * 作成日: 2017/11/15
 * 作成者: maesiro
 *
...
public class KNJD175A {

    private static final Log log = LogFactory.getLog(KNJD175A.class);
    ...
    private void printStudent(final DB2UDB db2, final Vrw32alp svf, final List viewClassList, final Student student) {
        final String form = "KNJD175A.frm";
    ...
    private void printShoken(final Vrw32alp svf, final Student student) {
        ...
        if (null != hReportRemarkDat) {
            //統合的な学習
            //内容
            String tsac_datsz = StringUtils.defaultString((String)_param._totalStudyTime_DataSizeMap.get(CLASSCD_TOTALSTDY + "TOTALSTUDYACT"), "11*11");
            ...
            //観点
            String tsav_datsz = StringUtils.defaultString((String)_param._totalStudyTime_DataSizeMap.get(CLASSCD_TOTALSTDY + "REMARK1"), "8*11");
            ...
            //評価
            String tsae_datsz = StringUtils.defaultString((String)_param._totalStudyTime_DataSizeMap.get(CLASSCD_TOTALSTDY + "TOTALSTUDYTIME"), "34*11");
            ...
            //道徳
            //内容
            String ts2a_datsz = StringUtils.defaultString((String)_param._totalStudyTime_DataSizeMap.get(CLASSCD_MORAL + "TOTALSTUDYACT"), "20*11");
            ...
            svfVrsOutnRepeat(svf, "MORAL_CONTENT", KNJ_EditKinsoku.getTokenList(hReportRemarkDat._ta2_totalstudyact, size2N.getKeta(), size2N._gyo));

            //評価
            String ts2v_datsz = StringUtils.defaultString((String)_param._totalStudyTime_DataSizeMap.get(CLASSCD_MORAL + "TOTALSTUDYTIME"), "34*11");
            ...
            svfVrsOutnRepeat(svf, "MORAL_EVAL", KNJ_EditKinsoku.getTokenList(hReportRemarkDat._ta2_totalstudytime, size2R.getKeta(), size2R._gyo));
...
//                final String specialactremark,
                ...
                for (final Iterator it = studentList.iterator(); it.hasNext();) {
                    ...
                    while (rs.next()) {
                        if ("".equals(semester) || !semester.equals(rs.getString("SEMESTER"))) {
                            if (!"".equals(semester)) {
                                final HReportRemarkDat hReportRemarkDat = new HReportRemarkDat(semester, ta1_totalstudytime, ta1_totalstudyact, ta1_remark1, ta2_totalstudytime, ta2_totalstudyact);
        ...
        private static String getHReportRemarkSql(final Param param) {
            ...
            stb.append(" WHERE ");
            stb.append("  T1.YEAR = '" + param._year + "' ");
//            stb.append("  and T1.CURRICULUM_CD = '3' ");  //固定 <-固定しないで取得することになった。
            stb.append("  and T1.SCHREGNO = ? ");
            if (!param._isLastSemester) {
                stb.append("     AND (T1.SEMESTER <= '" + param._gakki + "') ");
            }
