 ...
 *
 *    2011/04/25 o-naka KNJD128Eを元に新規作成
 */
...
public class KNJD128D {

    private static final Log log = LogFactory.getLog(KNJD128D.class);
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        final String form = "1".equals(param[21]) ? "KNJD128D_P.frm" : "KNJD128D.frm";
    ...
    private boolean printSvfOutMeisai( Vrw32alp svf, ResultSet rs, String param[], int total[][], Map attendmap, int linex ){
        ...
        try {
            ...
            printSvfOutDetal( svf, "POINT2_3" + fieldNo,   rs.getString("SEM2_TERM2_SCORE"), getTestAttend( rs.getString("SEM2_TERM2_ATTEND"), attendmap ) );
    ...
    String prestatementRecord(String param[],int pdiv) {
        ...
        try {
            ...
            stb.append(            "SEM2_INTR_VALUE_DI, SEM2_TERM_VALUE_DI, SEM2_TERM2_VALUE_DI, SEM2_VALUE_DI, ");
            ...
            stb.append(        "SEM2_INTR_ATTEND, SEM2_TERM_ATTEND, SEM2_TERM2_ATTEND, ");
            stb.append(        "SEM1_INTR_VALUE_DI, SEM1_TERM_VALUE_DI, SEM1_VALUE_DI, ");
            stb.append(        "SEM2_INTR_VALUE_DI, SEM2_TERM_VALUE_DI, SEM2_TERM2_VALUE_DI, SEM2_VALUE_DI, ");
            if ("1".equals(param[21])) {
