 ...
 *
 *	2010/10/29 nakamoto 新規作成 KNJD123Sを元に作成
 */
...
public class KNJD122S {

    private static final Log log = LogFactory.getLog(KNJD122S.class);
	...
	private void setHead(DB2UDB db2,Vrw32alp svf,String param[]){
        ...
        final String form = "1".equals(param[21]) ? "KNJD122S_P.frm" : "KNJD122S.frm";
	...
	private boolean printSvfOutMeisai( Vrw32alp svf, ResultSet rs, String param[], int total[][], Map attendmap ){
		...
		try {
            ...
            printSvfOutDetal( svf, "GRADING2_3", (rs.getString("SEM2_TERM2_VALUE_DI") != null) ? rs.getString("SEM2_TERM2_VALUE_DI") : rs.getString("SEM2_TERM2_VALUE"), null );                             //後期期末2評価
            ...
            accumMeisai( total, i++, rs.getString("SEM2_TERM2_VALUE") );
