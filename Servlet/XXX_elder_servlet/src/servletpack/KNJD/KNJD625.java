// kanji=漢字
/*
 * $Id: 7e520308f8d86b9af0697db60c3af5a8b2ddb7e0 $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: 7e520308f8d86b9af0697db60c3af5a8b2ddb7e0 $
 */
public class KNJD625 {
    private static final Log log = LogFactory.getLog(KNJD625.class);
...
//                            log.debug(printData);
    ...
    private String getPrintData(final String subclassCd) {
        ...
        stb.append("     INNER JOIN RECORD_RANK_CHAIR_DAT L1 ON T1.YEAR = L1.YEAR ");
        ...
        stb.append("     LEFT JOIN CHAIR_DAT L2 ON T1.YEAR = L2.YEAR ");
