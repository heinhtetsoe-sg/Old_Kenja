// kanji=漢字
/*
 * $Id: 501ca2e701e3b5f2c4115924ecb6e7327b471a9d $
 *
 * 作成日: 2006/06/20
 * 作成者: yamasiro
 *
...
public class KNJD151T extends KNJD151 {

    private static final Log log = LogFactory.getLog(KNJD151T.class);

    private static final String FORM_FILE = "KNJD151_3.frm";
    private static final String FORM_FILE2 = "KNJD151_4.frm";
    ...
    protected List setRecordList(final Map paramap) {
        ...
        if (1 < s) {
            ...
            list.add(setRecordFieldListDetail("SEM2_TERM2_CHAIRCD","SEM2_TERM2_SCORE","SEM2_TERM2_VALUE","SEM2_TERM2_VALUE_DI","2-0202"));  // ２学期中間テスト
