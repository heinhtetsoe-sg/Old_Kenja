// kanji=漢字
/*
 * $Id: 4837a89cfbbdcca28977c5c418aa928253811c07 $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: 4837a89cfbbdcca28977c5c418aa928253811c07 $
 */
public class KNJD192F {

    private static final Log log = LogFactory.getLog(KNJD192F.class);
...
//        final String rankName1 = _param.getRankName1();
//        svf.VrsOutn("AVG_NAME", fieldNo, rankName1);
//        svf.VrsOutn("RANK_NAME", fieldNo, rankName1);
...
//            }
//        } finally {
//            DbUtils.closeQuietly(null, ps, assessLevelRs);
//            db2.commit();
//        }
//
//        // コースの評定段階値
