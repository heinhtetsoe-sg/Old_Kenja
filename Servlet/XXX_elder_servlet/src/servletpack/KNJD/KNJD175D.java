/*
 * $Id: 047950e216e566d890168d4e57b9f44713f4e573 $
 *
 * 作成日: 2019/12/20
 * 作成者: yamashiro
 *
...
public class KNJD175D {

    private static final Log log = LogFactory.getLog(KNJD175D.class);
    ...
    private void printStudent(final DB2UDB db2, final Vrw32alp svf, final List viewClassList, final Student student) {
        final String form = "KNJD175D.frm";
    ...
    private void printAttendance(final Vrw32alp svf, final Student student) {
        final String[] seme = {_param._gakki, SEMEALL};
    	...
    	if(student._hReportRemarkDatMap.containsKey(_param._gakki)) {
            ...
            if(map.containsKey("2")) {
                ...
                if (null != hReportRemarkDat) {
                    ...
                    //評価
                    String ts2e_datsz = StringUtils.defaultString(_param.getRecordTotalstudytimeItemSize(db2, "2", _param._columnName2), "64*10");
                    final String[] spl4 = StringUtils.split(ts2e_datsz, "*");
                    ...
                    svfVrsOutnRepeat(svf, "MORAL_EVAL", KNJ_EditKinsoku.getTokenList(hReportRemarkDat._moraEval, size2R.getKeta(), size2R._gyo));
                }
            }
    	}
    }
    ...
    private static class HReportRemarkDat {
                ...
                for (final Iterator it = studentList.iterator(); it.hasNext();) {
                    ...
                    while (rs.next()) {
                        if ("".equals(semester) || !semester.equals(rs.getString("SEMESTER")) || !remark2.equals(rs.getString("REMARK2")) ) {
                            if (!"".equals(semester)) {
                                final HReportRemarkDat hReportRemarkDat = new HReportRemarkDat(semester, remark2, ta1_totalstudytime, ta1_totalstudyact, ta1_remark1, moralEval);
                                Map map = new HashMap();
                            ...
                            moralEval = rs.getString("MORAL_EVAL");
                        } else {
                            semester = rs.getString("SEMESTER");
                            remark2 = rs.getString("REMARK2");
                            ...
                            moralEval = moralEval + sep + rs.getString("MORAL_EVAL");
                        }
        ...
        private static String getHReportRemarkSql(final DB2UDB db2, final Param param) {
            final StringBuffer stb = new StringBuffer();
            final String moralColumnName = (param._columnName2 != null) ? param._columnName2 : "TOTALSTUDYACT"; //「道徳」の参照カラム名を取得(無ければデフォルト)
            ...
            stb.append("  T3." + moralColumnName + " as MORAL_EVAL ");
            stb.append(" FROM ");
            stb.append("  COMMON T1 ");
            stb.append("  LEFT JOIN GETDOUTOKU T3 ");
            stb.append("     ON T3.YEAR = T1.YEAR ");
            stb.append("    AND T3.SEMESTER = T1.SEMESTER ");
            stb.append("    AND (    ( T3.REMARK2  = '1' AND T3.CLASSCD =  '" + param._classCd1 + "' ) ");
            stb.append("          OR ( T3.REMARK2  = '2' AND T3.CLASSCD =  '" + param._classCd2 + "' ) ");
            stb.append("        ) ");
    ...
    private static class Param {
    	...
    	final String _classCd1;
    	final String _classCd2;
    	final String _columnName1;
    	final String _columnName2;
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            //総額・道徳の一番若い教科CDを取得
            _classCd1 = getRecordTotalstudytimeItemClassCd(db2, "1"); //総合的な学習の時間のCLASSCD
            _classCd2 = getRecordTotalstudytimeItemClassCd(db2, "2"); //道徳のCLASSCD

            //データを保持するカラム名
            _columnName1 = getRecordTotalstudytimeItemColumn(db2, "1", _classCd1);
            _columnName2 = getRecordTotalstudytimeItemColumn(db2, "2", _classCd2);
        ...
        private String getRecordTotalstudytimeItemClassCd(DB2UDB db2, final String remark2) {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    final String minClassCd = StringUtils.defaultString(rs.getString("CLASSCD"));
                    classCd = minClassCd;
                }
            } catch (Exception ex) {
        ...
        //RECORD_TOTALSTUDYTIME_DATのCOLUMNNAME取得
        private String getRecordTotalstudytimeItemColumn(DB2UDB db2, final String remark2, final String classCd) {
            String rtnStr = null;
            PreparedStatement ps = null;
            ResultSet rs = null;
            ...
            try {
                ...
                stb.append("   RECORD_TOTALSTUDYTIME_ITEM_MST ");
                stb.append(" WHERE ");
                stb.append("   CLASSCD 			= '" + classCd + "' ");
                stb.append("   AND SCHOOL_KIND 	= '" + _schoolkind + "' ");
                stb.append("   AND SHOW_FLG 	= '1' ");
                stb.append("   AND REMARK2 		= '" + remark2 + "' ");
                stb.append("   AND COLUMNNAME IN ( "); //テーブルに実在するカラム名かチェック
                stb.append("     SELECT ");
                stb.append("       COLUMN_NAME ");
                stb.append("     FROM ");
                stb.append("       SYSIBM.COLUMNS ");
                stb.append("     WHERE ");
                stb.append("       TABLE_NAME = 'RECORD_TOTALSTUDYTIME_DAT' ");
                stb.append("   ) ");
