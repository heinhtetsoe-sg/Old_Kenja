 ...
 *
 *    2010/04/17 o-naka KNJD128Cを元に新規作成
 */
...
public class KNJD128 {

    private static final Log log = LogFactory.getLog(KNJD128.class);
                     ...
                     throws ServletException, IOException
    {
        ...
        try {
            ...
            param[15] = request.getParameter("TESTCD2"); //19900 or 19901
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        ret = svf.VrSetForm("KNJD128.frm", 4);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (null != param[15] && !"".equals(param[15])) {
                    if ("19901".equals(param[15])) {
                        svf.VrsOut("VALUENAME1" , "７月");
                        svf.VrsOut("VALUENAME2" , "評価");
                    } else if ("29901".equals(param[15])) {
                        svf.VrsOut("VALUENAME1" , "12月");
                        svf.VrsOut("VALUENAME2" , "評価");
                    } else {
                        svf.VrsOut("VALUENAME1" , "評価");
                        svf.VrsOut("VALUENAME2" , "");
                    }
                }
            }
            rs.close();
    ...
    private boolean printSvfOutMeisai( Vrw32alp svf, ResultSet rs, String param[], int total[][], Map attendmap, int linex ){
        ...
        try {
            ...
            printSvfOutDetal( svf, "AVERAGE1" + fieldNo,   (rs.getString("SEM_VALUE_DI") != null) ? rs.getString("SEM_VALUE_DI") : rs.getString("SEM_VALUE"),      null );
    ...
    String prestatementRecord(String param[],int pdiv) {
        ...
        try {
            ...
            //評価
            stb.append("             ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '" + param[15] + "' THEN VALUE END) as SEM_VALUE ");
            //出欠
            stb.append("             ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '" + param[15] + "' THEN VALUE_DI END) as SEM_VALUE_DI ");
            ...
            stb.append("        OR  SEMESTER || TESTKINDCD || TESTITEMCD = '" + param[15] + "') ");
