 ...
 *
 *    2015/01/28 o-naka KNJD129Aを元に新規作成
 */
...
public class KNJD129C {

    private static final Log log = LogFactory.getLog(KNJD129C.class);
                     ...
                     throws ServletException, IOException
    {
        ...
        try {
            ...
            param[19] = request.getParameter("useCurriculumcd"); //プロパティ(教育課程コード)(1:教育課程対応)
            param[20] = request.getParameter("useVirus"); // プロパティ：伝染病
            param[21] = request.getParameter("useKoudome"); // プロパティ：公停
            param[22] = request.getParameter("useProvFlg"); // プロパティ：仮評定の追加対応
        } catch( Exception ex ) {
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        final String form = "1".equals(param[22]) ? "KNJD129C_P.frm" : "KNJD129C.frm";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                svf.VrsOut(getSemeField(seme) , semeName);
    ...
    private String getSemeField(String seme) {
        if ("1".equals(seme)) return "TYPE_A_NAME";
        if ("2".equals(seme)) return "TYPE_B_NAME";
        if ("3".equals(seme)) return "TYPE_C_NAME";
        if ("9".equals(seme)) return "TYPE_D_NAME";
        return "DUMMY";
    }
    ...
    private String getTestField(String test) {
        ...
        if ("30101".equals(test)) return "TESTNAME3_1";
    ...
    private String getTestName(String param[]) {
        ...
        try {
            ...
            stb.append("     rtrim(ltrim(substr(T2.TESTITEMNAME,1,15))) as TESTITEMNAME, ");
    ...
    private boolean printSvfOutMeisai( Vrw32alp svf, ResultSet rs, String param[], int total[][], Map attendmap, int linex ){
        ...
        try {
            ...
            printSvfOutDetal( svf, "POINT1_1" + fieldNo,   rs.getString("SEM1_INTR_SCORE"), getTestAttend( rs.getString("SEM1_INTR_ATTEND"), attendmap ) );
            printSvfOutDetal( svf, "POINT1_2" + fieldNo,   rs.getString("SEM1_TERM_SCORE"), getTestAttend( rs.getString("SEM1_TERM_ATTEND"), attendmap ) );
            printSvfOutDetal( svf, "AVERAGE1" + fieldNo,   (rs.getString("SEM1_VALUE_DI") != null) ? rs.getString("SEM1_VALUE_DI") : rs.getString("SEM1_VALUE"),      null );

            printSvfOutDetal( svf, "POINT2_1" + fieldNo,   rs.getString("SEM2_INTR_SCORE"), getTestAttend( rs.getString("SEM2_INTR_ATTEND"), attendmap ) );
            printSvfOutDetal( svf, "POINT2_2" + fieldNo,   rs.getString("SEM2_TERM_SCORE"), getTestAttend( rs.getString("SEM2_TERM_ATTEND"), attendmap ) );
            printSvfOutDetal( svf, "AVERAGE2" + fieldNo,   (rs.getString("SEM2_VALUE_DI") != null) ? rs.getString("SEM2_VALUE_DI") : rs.getString("SEM2_VALUE"),      null );

            printSvfOutDetal( svf, "POINT3_2" + fieldNo,   rs.getString("SEM3_TERM_SCORE"), getTestAttend( rs.getString("SEM3_TERM_ATTEND"), attendmap ) );
            printSvfOutDetal( svf, "AVERAGE3" + fieldNo,   (rs.getString("SEM3_VALUE_DI") != null) ? rs.getString("SEM3_VALUE_DI") : rs.getString("SEM3_VALUE"),      null );

            printSvfOutDetal( svf, "POINT4" + fieldNo,     rs.getString("GRAD_SCORE"),      null );//学年成績
            if ("1".equals(param[22])) {
                printSvfOutDetal( svf, "PROV_FLG" + fieldNo,   rs.getString("PROV_FLG"), null);
            }
            printSvfOutDetal( svf, "AVERAGE4" + fieldNo,   (rs.getString("GRAD_VALUE_DI") != null) ? rs.getString("GRAD_VALUE_DI") : rs.getString("GRAD_VALUE"),      null );
            ...
            if( rs.getString("ABSENT_S1") != null  &&  !"0".equals(rs.getString("ABSENT_S1"))  &&  !"0.0".equals(rs.getString("ABSENT_S1")) )
                printSvfOutDetal( svf, "TYPE_A" + fieldNo, null, rs.getString("ABSENT_S1") );

            if( rs.getString("ABSENT_S2") != null  &&  !"0".equals(rs.getString("ABSENT_S2"))  &&  !"0.0".equals(rs.getString("ABSENT_S2")) )
                printSvfOutDetal( svf, "TYPE_B" + fieldNo, null, rs.getString("ABSENT_S2") );

            if( rs.getString("ABSENT_S3") != null  &&  !"0".equals(rs.getString("ABSENT_S3"))  &&  !"0.0".equals(rs.getString("ABSENT_S3")) )
                printSvfOutDetal( svf, "TYPE_C" + fieldNo, null, rs.getString("ABSENT_S3") );

            if( rs.getString("ABSENT_S9") != null  &&  !"0".equals(rs.getString("ABSENT_S9"))  &&  !"0.0".equals(rs.getString("ABSENT_S9")) )
                printSvfOutDetal( svf, "TYPE_D" + fieldNo, null, rs.getString("ABSENT_S9") );
            ...
            accumMeisai( total, i++, rs.getString("SEM3_VALUE") );
    ...
    String prestatementRecord(String param[],int pdiv) {
        ...
        try {
            ...
            stb.append("     SELECT  YEAR ,SUBCLASSCD ,SCHREGNO ");
            if ("1".equals(param[19])) {
            ...
            stb.append("             ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD||SCORE_DIV = '1990100' THEN SCORE END) as SEM1_SCORE ");
            stb.append("             ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD||SCORE_DIV = '2990100' THEN SCORE END) as SEM2_SCORE ");
            stb.append("             ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD||SCORE_DIV = '3990100' THEN SCORE END) as SEM3_SCORE ");
            ...
            //教育課程対応
            if ("1".equals(param[19])) {
                stb.append("     GROUP BY YEAR ,CLASSCD, SCHOOL_KIND, CURRICULUM_CD, SUBCLASSCD ,SCHREGNO ");
            } else {
                stb.append("     GROUP BY YEAR ,SUBCLASSCD ,SCHREGNO ");
            }
            stb.append("     ) ");
            ...
            stb.append(            "SEM1_VALUE_DI, ");
            stb.append(            "SEM2_VALUE_DI, ");
            stb.append(            "SEM3_VALUE_DI, ");
            stb.append(            "GRAD_VALUE_DI, ");
            stb.append(            "COMP_CREDIT, GET_CREDIT, ");
            stb.append(            "SEM1_SCORE, SEM2_SCORE, SEM3_SCORE, ");
            ...
            stb.append("     SELECT SCHREGNO ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '10101' THEN SCORE_PASS END) AS SEM1_INTR_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '10201' THEN SCORE_PASS END) AS SEM1_TERM_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '20101' THEN SCORE_PASS END) AS SEM2_INTR_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '20201' THEN SCORE_PASS END) AS SEM2_TERM_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '30101' THEN SCORE_PASS END) AS SEM3_INTR_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '30201' THEN SCORE_PASS END) AS SEM3_TERM_SCORE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '19900' THEN SCORE_PASS END) as SEM1_VALUE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '29900' THEN SCORE_PASS END) as SEM2_VALUE_PASS ");
            stb.append("           ,min(CASE WHEN SEMESTER||TESTKINDCD||TESTITEMCD = '39900' THEN SCORE_PASS END) as SEM3_VALUE_PASS ");
            stb.append("     FROM   SUPP_EXA_DAT ");
            stb.append("     WHERE  YEAR = '" + param[0] + "' ");
            //教育課程対応
            if ("1".equals(param[19])) {
                stb.append("   AND  CLASSCD || '-' || SCHOOL_KIND || '-' || CURRICULUM_CD || '-' || SUBCLASSCD = '" + param[3] + "' ");
            ...
            stb.append("       AND  SCORE_FLG  = '2' ");
            stb.append("     GROUP BY SCHREGNO ");
            stb.append("     ) ");

            //学校マスタの各フラグを参照
            String strLesson = "VALUE(LESSON,0) - VALUE(OFFDAYS,0) - VALUE(ABROAD,0) - VALUE(SUSPEND,0) - VALUE(MOURNING,0)";
            if ("true".equals(param[20])) strLesson += " - VALUE(VIRUS,0) ";
            if ("true".equals(param[21])) strLesson += " - VALUE(KOUDOME,0) "; 
            ...
            } else if( "1".equals(_knjSchoolMst._absentCov) ){
                //学期でペナルティ欠課を算出
                stb.append(        "VALUE(SUM(ABSENT1),0) + VALUE(SUM(LATE_EARLY),0) / " + _knjSchoolMst._absentCovLate + " AS ABSENT2, ");
                stb.append(        "MOD(VALUE(SUM(LATE_EARLY),0) , " + _knjSchoolMst._absentCovLate + ") AS LATE_EARLY ");
            } else{
                //通年の場合、ペナルティ欠課なし。各学期の欠課数は欠時数と同じ。
                //5:通年でペナルティ欠課を算出・・・例．余りを一捨二入
                //4:通年でペナルティ欠課を算出（小数点あり）
                //2:通年でペナルティ欠課を算出
                //0:ペナルティ欠課なしの場合
            ...
            stb.append(        "T2.NAME, ");
            stb.append(        "CASE WHEN SEM1_INTR_SCORE_PASS IS NOT NULL THEN SEM1_INTR_SCORE_PASS ELSE SEM1_INTR_SCORE END AS SEM1_INTR_SCORE, ");
            stb.append(        "CASE WHEN SEM1_TERM_SCORE_PASS IS NOT NULL THEN SEM1_TERM_SCORE_PASS ELSE SEM1_TERM_SCORE END AS SEM1_TERM_SCORE, ");
            stb.append(        "CASE WHEN SEM1_VALUE_PASS IS NOT NULL THEN SEM1_VALUE_PASS ELSE SEM1_VALUE END AS SEM1_VALUE, ");
            stb.append(        "CASE WHEN SEM2_INTR_SCORE_PASS IS NOT NULL THEN SEM2_INTR_SCORE_PASS ELSE SEM2_INTR_SCORE END AS SEM2_INTR_SCORE, ");
            stb.append(        "CASE WHEN SEM2_TERM_SCORE_PASS IS NOT NULL THEN SEM2_TERM_SCORE_PASS ELSE SEM2_TERM_SCORE END AS SEM2_TERM_SCORE, ");
            stb.append(        "CASE WHEN SEM2_VALUE_PASS IS NOT NULL THEN SEM2_VALUE_PASS ELSE SEM2_VALUE END AS SEM2_VALUE, ");
            stb.append(        "CASE WHEN SEM3_INTR_SCORE_PASS IS NOT NULL THEN SEM3_INTR_SCORE_PASS ELSE SEM3_INTR_SCORE END AS SEM3_INTR_SCORE, ");
            stb.append(        "CASE WHEN SEM3_TERM_SCORE_PASS IS NOT NULL THEN SEM3_TERM_SCORE_PASS ELSE SEM3_TERM_SCORE END AS SEM3_TERM_SCORE, ");
            stb.append(        "CASE WHEN SEM3_VALUE_PASS IS NOT NULL THEN SEM3_VALUE_PASS ELSE SEM3_VALUE END AS SEM3_VALUE, ");
            stb.append(        "SEM1_INTR_ATTEND, SEM1_TERM_ATTEND, ");
            stb.append(        "SEM2_INTR_ATTEND, SEM2_TERM_ATTEND, ");
            stb.append(        "SEM3_INTR_ATTEND, SEM3_TERM_ATTEND, ");
            if ("1".equals(param[22])) {
            ...
            stb.append(        "S1.ABSENT2 AS ABSENT_S1, ");
            stb.append(        "S2.ABSENT2 AS ABSENT_S2, ");
            stb.append(        "S3.ABSENT2 AS ABSENT_S3, ");
            stb.append(        "S9.ABSENT2 AS ABSENT_S9, ");

            stb.append(        "VALUE(S9.LESSON,0) AS LESSON, ");
            stb.append(        "S9.ABSENT, S9.ABSENT2 ");
            // 累積情報の遅刻・早退欄のフラグ(1なら遅刻・早退回数、1以外なら欠課換算後の余り)
            if ("1".equals(param[13])) {
                stb.append(   ",VALUE(S9.LATE_EARLY2,0) AS LATE_EARLY ");
            } else {
                stb.append(   ",VALUE(S9.LATE_EARLY,0)  AS LATE_EARLY ");
            }
            
            stb.append("FROM    SCHNO T2 ");
            stb.append(        "LEFT JOIN RECORD T1 ON T1.SCHREGNO = T2.SCHREGNO ");
            stb.append(        "LEFT JOIN ATTEND_S S1 ON S1.SCHREGNO = T2.SCHREGNO AND S1.SEMESTER = '1' ");
            stb.append(        "LEFT JOIN ATTEND_S S2 ON S2.SCHREGNO = T2.SCHREGNO AND S2.SEMESTER = '2' ");
            stb.append(        "LEFT JOIN ATTEND_S S3 ON S3.SCHREGNO = T2.SCHREGNO AND S3.SEMESTER = '3' ");
            stb.append(        "LEFT JOIN ATTEND_S9 S9 ON S9.SCHREGNO = T2.SCHREGNO ");
            stb.append(        "LEFT JOIN SUPP_EXA T4 ON T4.SCHREGNO = T2.SCHREGNO ");
            /* 仮評定情報 */
            //仮評定フラグ対応
            if ("1".equals(param[22])) {
    ...
    String prestatementHeadCredit(String param[])
    {
        ...
        try {
            ...
            stb.append("     T1.CLASSCD = '"+param[3].substring(0,2)+"' AND ");
            //教育課程対応
            if ("1".equals(param[19])) {
