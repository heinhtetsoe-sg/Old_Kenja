// kanji=漢字
/*
 * $Id: 0a4de534344593a97423cbbb519ecc34e34def19 $
 *
 * 作成日: 2007/05/14
 * 作成者: nakamoto
 *
 ...
 * @author nakamoto
 * @version $Id: 0a4de534344593a97423cbbb519ecc34e34def19 $
 */
public class KNJD653 {
    private static final Log log = LogFactory.getLog(KNJD653.class);
    ...
    private boolean printMain(
        ...
        for (final Iterator it = hrInfo.getStudents().iterator(); it.hasNext();) {
            ...
            if (null == current || current.size() >= formMaxLine) {
...
//    }
    ...
    void printHRInfo(
        ...
        final int COUNT_LINE = formMaxLine + 1;
        final int TOTAL_LINE = formMaxLine + 2;
        final int AVG_LINE = formMaxLine + 3;
        if (null != hrInfo._hrScore3Average) {
            final String idx = "1";
            svf.VrsOutn("TOTAL" + idx, COUNT_LINE, hrInfo._hrScore3Count);  // 人数
            svf.VrsOutn("TOTAL" + idx, TOTAL_LINE, hrInfo._hrScore3Total);  //総合点合計
            svf.VrsOutn("TOTAL" + idx, AVG_LINE, hrInfo._hrScore3Average);  //総合点平均
            svf.VrsOutn("AVERAGE" + idx, COUNT_LINE, hrInfo._hrAvg3Count);  // 人数
            svf.VrsOutn("AVERAGE" + idx, TOTAL_LINE, hrInfo._hrAvg3Total);  //平均点合計
            svf.VrsOutn("AVERAGE" + idx, AVG_LINE, hrInfo._hrAvg3Average);  //平均点平均
            log.debug("SCORE3 = " + hrInfo._hrScore3Average + ", AVERAGE3 = " + hrInfo._hrAvg3Average);
        }
        if (null != hrInfo._hrScore5Average) {
            final String idx = "2";
            svf.VrsOutn("TOTAL" + idx, COUNT_LINE, hrInfo._hrScore5Count);  // 人数
            svf.VrsOutn("TOTAL" + idx, TOTAL_LINE, hrInfo._hrScore5Total);  //総合点合計
            svf.VrsOutn("TOTAL" + idx, AVG_LINE, hrInfo._hrScore5Average);  //総合点平均
            svf.VrsOutn("AVERAGE" + idx, COUNT_LINE, hrInfo._hrAvg5Count);  // 人数
            svf.VrsOutn("AVERAGE" + idx, TOTAL_LINE, hrInfo._hrAvg5Total);  //平均点合計
            svf.VrsOutn("AVERAGE" + idx, AVG_LINE, hrInfo._hrAvg5Average);  //平均点平均
            log.debug("SCORE5 = " + hrInfo._hrScore5Average + ", AVERAGE5 = " + hrInfo._hrAvg5Average);
        }
        if (null != hrInfo._hrScore9Average) {
            final String idx = "3";
            svf.VrsOutn("TOTAL" + idx, COUNT_LINE, hrInfo._hrScore9Count);  // 人数
            svf.VrsOutn("TOTAL" + idx, TOTAL_LINE, hrInfo._hrScore9Total);  //総合点合計
            svf.VrsOutn("TOTAL" + idx, AVG_LINE, hrInfo._hrScore9Average);  //総合点平均
            svf.VrsOutn("AVERAGE" + idx, COUNT_LINE, hrInfo._hrAvg9Count);  // 人数
            svf.VrsOutn("AVERAGE" + idx, TOTAL_LINE, hrInfo._hrAvg9Total);  //平均点合計
            svf.VrsOutn("AVERAGE" + idx, AVG_LINE, hrInfo._hrAvg9Average);  //平均点平均
            log.debug("SCORE9 = " + hrInfo._hrScore9Average + ", AVERAGE9 = " + hrInfo._hrAvg9Average);
        }
    }
...
//        stb.append(" MAJOR_DEVIATION_RANK ");
    ...
    private class HRInfo implements Comparable {
        ...
        private String _hrScore3Total;
        private String _hrScore3Count;
        private String _hrScore3Average;
        private String _hrAvg3Total;
        private String _hrAvg3Count;
        private String _hrAvg3Average;
        private String _hrScore5Total;
        private String _hrScore5Count;
        private String _hrScore5Average;
        private String _hrAvg5Total;
        private String _hrAvg5Count;
        private String _hrAvg5Average;
        private String _hrScore9Total;
        private String _hrScore9Count;
        private String _hrScore9Average;
        private String _hrAvg9Total;
        private String _hrAvg9Count;
        private String _hrAvg9Average;
...
//            log.debug("RANK:" + _ranking);
        ...
        private void loadScoreDetail(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String subclassCd = rs.getString("SUBCLASSCD") != null && rs.getString("SUBCLASSCD").length() > 1 ? rs.getString("SUBCLASSCD").substring(1) : "";
        ...
        private void setHrAverage() {
            ...
            if (0 < count3) {
                ...
                _hrScore3Count = String.valueOf(count3);
                _hrScore3Total = String.valueOf(score3);
                _hrScore3Average = decimalScore.setScale(1, BigDecimal.ROUND_HALF_UP).toString();

                final double doubleAvg = avg3 / count3;
                BigDecimal decimalAvg = new BigDecimal(doubleAvg);
                _hrAvg3Count = String.valueOf(count3);
                _hrAvg3Total = new BigDecimal(avg3).setScale(0, BigDecimal.ROUND_HALF_UP).toString();
                _hrAvg3Average = decimalAvg.setScale(1, BigDecimal.ROUND_HALF_UP).toString();
            }                
            if (0 < count5) {
                final double doubleScore = (double) score5 / count5;
                BigDecimal decimalScore = new BigDecimal(doubleScore);
                _hrScore5Count = String.valueOf(count5);
                _hrScore5Total = String.valueOf(score5);
                _hrScore5Average = decimalScore.setScale(1, BigDecimal.ROUND_HALF_UP).toString();

                final double doubleAvg = avg5 / count5;
                BigDecimal decimalAvg = new BigDecimal(doubleAvg);
                _hrAvg5Count = String.valueOf(count5);
                _hrAvg5Total = new BigDecimal(avg5).setScale(0, BigDecimal.ROUND_HALF_UP).toString();
                _hrAvg5Average = decimalAvg.setScale(1, BigDecimal.ROUND_HALF_UP).toString();
            }                
            if (0 < count9) {
                final double doubleScore = (double) score9 / count9;
                BigDecimal decimalScore = new BigDecimal(doubleScore);
                _hrScore9Count = String.valueOf(count9);
                _hrScore9Total = String.valueOf(score9);
                _hrScore9Average = decimalScore.setScale(1, BigDecimal.ROUND_HALF_UP).toString();

                final double doubleAvg = avg9 / count9;
                BigDecimal decimalAvg = new BigDecimal(doubleAvg);
                _hrAvg9Count = String.valueOf(count9);
                _hrAvg9Total = new BigDecimal(avg9).setScale(0, BigDecimal.ROUND_HALF_UP).toString();
                _hrAvg9Average = decimalAvg.setScale(1, BigDecimal.ROUND_HALF_UP).toString();
            }                
        }
...
//        private String _scoreFailCnt;  // 欠点者数
        ...
        SubClass(
            ...
            _classcode = "1".equals(_param._useCurriculumcd) ? subclasscode.substring(5, 7) : subclasscode.substring(1, 3);
...
//                    if (scoreValue.getScoreAsInt() <= _param.getFailValue()) countFail++;
    ...
    private class Param {
        ...
        public String getFormFile() {
            return "1".equals(_subclassMax) ? "KNJD653_1.frm" : "KNJD653_2.frm";
        }
