// kanji=漢字
/*
 * $Id: 7fbc27cc5654e5b990bd38634b3b3360a643dcb3 $
 *
...
/**
 * @version $Id: 7fbc27cc5654e5b990bd38634b3b3360a643dcb3 $
 */
public class KNJD107A {
    ...
    private static final Log log = LogFactory.getLog(KNJD107A.class);
    ...
    public void printPage1(final Vrw32alp svf, final List studentList, final Map classcdSubclasscdMap) {
        final String form = "KNJD107A_1.frm";
    ...
    public void printPage2(final Vrw32alp svf, final List studentList, final Map classcdSubclasscdMap) {
        final String form = "KNJD107A_2.frm";
        svf.VrSetForm(form, 4);
    ...
    private static class Student {
        ...
        public static void setScore(final DB2UDB db2, final Param param, final List students) {
            final String sql1 = " SELECT * FROM RECORD_RANK_DAT WHERE SEMESTER = '" + SEMEALL + "' AND TESTKINDCD || TESTITEMCD = '" + _9900 + "' AND SCHREGNO = ? AND SUBCLASSCD <> '" + SUBCLASSALL3 + "' AND SUBCLASSCD <> '" + SUBCLASSALL5 + "' ";
            final String sql2 = " SELECT * FROM RECORD_RANK_V_DAT WHERE SEMESTER = '" + SEMEALL + "' AND TESTKINDCD || TESTITEMCD = '" + _9900 + "' AND SCHREGNO = ? AND SUBCLASSCD <> '" + SUBCLASSALL3 + "' AND SUBCLASSCD <> '" + SUBCLASSALL5 + "' ";
