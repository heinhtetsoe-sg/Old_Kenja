// kanji=漢字
/*
 * $Id: 2ccf9edfa5ca0a53f70f8e519c0e75e9a287bf41 $
 *
 ...
 * 通知表(熊本)。
 * @author m-yama
 * @version $Id: 2ccf9edfa5ca0a53f70f8e519c0e75e9a287bf41 $
 */
public class KNJD177D extends KNJD177FormAbstract {

    private static final String SUBCLASSALL = "999999";

    private static final Log log = LogFactory.getLog(KNJD177D.class);

    /**
     * コンストラクタ。
     * @param param
     */
    public KNJD177D(final HttpServletResponse response, final Param param) throws Exception {
...
//                    _svf.VrsOut("CLASS_GRAD_RANK", testScore._classRank);
//                    _svf.VrsOut("CLASS_GRAD_RANK_TOTAL", testScore._classCnt);
//                }
                if (!"3".equals(semester)) {
