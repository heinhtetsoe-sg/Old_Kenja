 ...
 *
 *    2011/07/12 o-naka KNJD128(1.3)を元に新規作成
 */
...
public class KNJD128_2 {

    private static final Log log = LogFactory.getLog(KNJD128_2.class);
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        ret = svf.VrSetForm("KNJD128_2.frm", 4);
