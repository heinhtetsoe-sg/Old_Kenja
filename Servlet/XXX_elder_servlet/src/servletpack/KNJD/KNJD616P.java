// kanji=漢字
/*
 * $Id: 52b0ca2d537ec1ebb5a8e28b4ffd0414e6731a1b $
 *
 * 作成日: 2018/10/29
 * 作成者: yogi
 *
 ...
 * @author nakamoto
 * @version $Id: 52b0ca2d537ec1ebb5a8e28b4ffd0414e6731a1b $
 */
public class KNJD616P {
    private static final Log log = LogFactory.getLog(KNJD616P.class);
        ...
        private void setHrTotal(final Param param) {
            ...
            for (final Iterator itS = _students.iterator(); itS.hasNext();) {
                ...
                if (null != student._attendInfo) {
                    ...
                    arrj = setMaxMin(arrj[0], arrj[1], student._attendInfo._mLesson);
                }
            ...
            if (0 < arrj[0]) {
                _HrMLesson = String.valueOf(arrj[0]);
            }
...
//        }
        ...
        private static void printAttendInfo(final DB2UDB db2, final Vrw32alp svf, final Param param, final Student student, final AttendInfo attendInfo, final int line) {
            ...
            String remark = "";
            remark += student._transInfo.toString(db2);  // 備考
            //異常値を表示する
            ...
            private static boolean print(
                ...
                for (int p = 0, pages = subclassListList.size(); p < pages; p++) {
                    ...
                    for (final Iterator it = stulist.iterator(); it.hasNext();) {
                        ...
                        if (p == pages - 1) {
                            printStudentTotal(db2, svf, param, student, divSet);
                        }
                    }
            ...
            private static void printHeader(
                ...
                if ("1".equals(param._semester) && (param._testKindCd.startsWith("01") || param._testKindCd.startsWith("02")) // 1学期中間,期末
                 || "2".equals(param._semester) && (param._testKindCd.startsWith("01") || param._testKindCd.startsWith("02")) // 2学期中間,期末
                    ...
                    svf.VrsOut("ATTEND_DAY", hrInfo._HrMLesson);
                }
                if (param._isPrintKaikin) {
...
//            }
            ...
            private static void printStudentTotal(
                ...
                final int line = gnumToLine(param, student._gnum);
                printAttendInfo(db2, svf, param, student, student._attendInfo, line);
            }
...
//            }
    ...
    protected Param createParam(final HttpServletRequest request, final DB2UDB db2) {
        log.fatal("$Revision: 63137 $ $Date: 2018-10-30 18:34:53 +0900 (火, 30 10 2018) $"); // CVSキーワードの取り扱いに注意
    ...
    private static class Param {
        ...
        private static String getDbPrginfoProperties(final DB2UDB db2, final String propName) {
            return KnjDbUtils.getOne(KnjDbUtils.query(db2, " SELECT VALUE FROM PRGINFO_PROPERTIES WHERE PROGRAMID = 'KNJD616P' AND NAME = '" + propName + "' "));
        }
        ...
        private void createKnjd065Obj(
            ...
            if (SCORE_DIV_01.equals(scoreDiv)) {
                ...
                _title = _semesterName + " " + _testItem._testitemname + " 欠課時数チェック一覧表";
        ...
        private void setPrintKaikin(final DB2UDB db2) {
            if (Integer.parseInt(_semester) < 3) {
                return;
            }
            _isPrintKaikin = true;
            PreparedStatement ps = null;
