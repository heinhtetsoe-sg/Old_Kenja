// kanji=漢字
/*
 * $Id: b7e5e4ff39e699fb035b41e6976c1963d63f7736 $
 *
 * 作成日: 2009/06/15
 * 作成者: maesiro
 *
...
/**
 * 学校教育システム 賢者 [成績管理] KNJD231T 成績不振者一覧
 */

public class KNJD231T {

    private static final Log log = LogFactory.getLog(KNJD231T.class);
    ...
    private void printHeader(final Vrw32alp svf, final int page, final int maxPage) {
        ...
        svf.VrsOut("SEMESTER", _param.getTestItemName());
    ...
    private List createDataList(final DB2UDB db2) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                final Student student = findStudent(studentList, schregno, hrClass, attendNo, name);
                final String subClassCd = rs.getString("SUBCLASSCD");
                final String credit = rs.getString("CREDITS");
                
                final String value = (rs.getString("VALUE") == null) ? "(" + rs.getString("VALUE_DI") + ")" : rs.getString("VALUE");
                String gradeValue = "";
                ...
                final SubClass subClass = new SubClass(subClassCd, credit, value, gradeValue);
     ...
     */
    private final Student findStudent(final List list, final String schregno, final String hrClass, final String attendNo, final String name) {
    ...
    private String sqlData() {
        final String value = _param.getTargetValueField();
        ...
        stb.append("    " + value + "_DI AS VALUE_DI,");
        stb.append("    " + value + " AS VALUE,");
        stb.append("    T1.GRAD_VALUE_DI,");
        ...
        stb.append("    LEFT JOIN CREDIT_MST T3 ON");
        ...
        stb.append("    AND ( " + value + " = 1 OR " + value + " = 0 OR (" + value + " IS NULL AND " + value + "_DI IS NOT NULL))");
    ...
    Param createParam(final HttpServletRequest req) {
        ...
        return new Param(year, semester, testKindCd, grade, hrClasses, loginDate, attendDate, useTestitemMstCountflgNew, useCurriculumcd, useVirus, useKoudome);
    }
    ...
    private class Student {
        ...
        public List getOutputDataList() {
            ...
            for (Iterator it = _subClassDataMap.keySet().iterator(); it.hasNext();) {
                ...
                rtn.add(new OutputData(hrClassAttendNo, name, _schregno, subClass));
                first = false;
            }
    ...
    private class SubClass {
        ...
        public String toString() {
            return "[" + _param.getSubClassAbbv(_cd) + "(" + _cd + ") 単位 = " + _credit + " 評価 = " + _value + " 評定 = " + _gradValue + " 欠課 = " + _absent + "]";
        }
    }
    ...
    private class OutputData {
        ...
        public void output(final Vrw32alp svf, final int column, final int row) {
            ...
            svf.VrsOutn("CREDIT_" + column, row, _subClass._credit);
            svf.VrsOutn("VALUE_" + column, row, _subClass._value);
