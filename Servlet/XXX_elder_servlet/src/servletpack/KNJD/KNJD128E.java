/**
 *
 *    学校教育システム 賢者 [成績管理] 成績伝票（考査：１学期２回、２学期２回）
 *
 *    2011/04/25 o-naka KNJD128Bを元に新規作成
 */
...
public class KNJD128E {

    private static final Log log = LogFactory.getLog(KNJD128E.class);
    ...
    private void setHead(DB2UDB db2,Vrw32alp svf,String param[]) {
        ...
        final String form = "1".equals(param[21]) ? "KNJD128E_P.frm" : "KNJD128E.frm";
