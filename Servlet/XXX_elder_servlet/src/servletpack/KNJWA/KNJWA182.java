// kanji=漢字
/*
 * $Id: a9610321339f4059e405b09b90eb58877e78135a $
 *
 ...
 * 受領書（指導要録）
 * @author nakada
 * @version $Id: a9610321339f4059e405b09b90eb58877e78135a $
 */
public class KNJWA182 {
    /* pkg */static final Log log = LogFactory.getLog(KNJWA182.class);

    private static final String FORM_FILE = "KNJWA182.frm";
...
//    private static final String STAFF_CD = "0001";
    ...
    private void printApplicant(Student student) throws SQLException {
        ...
        /* 作成日 */
        _form._svf.VrsOut("DATE", getJDate(_param._certifIssueDat._issueDate));
        /* 学校名 */
    ...
    private class Param {
        ...
        private final String _output;              // 1:受領書（指導要録）印刷
        ...
        public void load(DB2UDB db2) throws SQLException, Exception {
            ...
            _finHighschoolMst = createFinHighschoolMst(db2, _certifIssueDat._certifDetailEachtypeDat._remark1, _certifIssueDat._certifDetailEachtypeDat._remark5);
    ...
    private Param createParam(final HttpServletRequest request) {
        ...
        final String certif = request.getParameter("JYURYOU");
        final String output = request.getParameter("CHECK_JYURYOU");
    ...
    private FinHighschoolMst createFinHighschoolMst(final DB2UDB db2, final String schoolCd, final String schoolDiv)
    throws SQLException {
    PreparedStatement ps = null;
    ResultSet rs = null;

    ps = db2.prepareStatement(sqlFinHighschoolMst(schoolCd, schoolDiv));
    rs = ps.executeQuery();
    while (rs.next()) {
        final String name = rs.getString("name");
...
private String sqlFinHighschoolMst(final String schoolCd, final String schoolDiv) {
    final String tableName = "H".equals(schoolDiv) ? "FIN_HIGH_SCHOOL_MST" : "FIN_JUNIOR_HIGHSCHOOL_MST";
    return " select"
            + "    NAME as name,"
            + "    ZIPCD as zipcd,"
            + "    ADDR1 as add1,"
