// kanji=漢字
/*
 * $Id: e798334907520d76611e4ad8a562d66f6d799446 $
 *
 */
...
/*
 *  学校教育システム 賢者 [事務管理] 皆勤賞・精勤賞 幼稚園用
 */

public class KNJG102A {

    private static final Log log = LogFactory.getLog(KNJG102A.class);
    ...
    public void svf_out (
        ...
        log.debug(" $Id: e798334907520d76611e4ad8a562d66f6d799446 $ ");
    ...
    private boolean isTarget(final Student student, final Param param) {
        ...
        boolean isTargetKesseki = da._sick <= param._kaikinKesseki;
        boolean isKaikinTarget = isTargetKesseki;
        boolean isTarget = isKaikinTarget;
        if ("2".equals(param._kaikinsya)) {
            if (isKaikinTarget) {
                isTarget = false;
            } else {
                isTargetKesseki = da._sick <= param._seikinKesseki;
                isTarget = isTargetKesseki;
            }
        }
    ...
    private static class Param {
        ...
        Param(final HttpServletRequest request, final DB2UDB db2) {
            ...
            _seikinKesseki = defval(request.getParameter("SEIKIN_KESSEKI"), 5);
