// kanji=漢字
/*
 * $Id: e3be87d5fa3b79643cbde152e1ddb53bea3f97e7 $
 *
 ...
 * <<クラスの説明>>。
 * @author nakamoto
 * @version $Id: e3be87d5fa3b79643cbde152e1ddb53bea3f97e7 $
 */
public class KNJX_H110A extends AbstractXls {

    private static final Log log = LogFactory.getLog("KNJX_H110A.class");
    ...
    protected String getSql() {
        ...
        if ("1".equals(_param._useCurriculumcd)) {
            stb.append("         AND L1.CLASSCD = T3.CLASSCD AND L1.SCHOOL_KIND = T3.SCHOOL_KIND AND L1.CURRICULUM_CD = T3.CURRICULUM_CD ");
        }
