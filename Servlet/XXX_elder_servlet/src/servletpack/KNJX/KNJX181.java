// kanji=漢字
/*
 * $Id: 41579ffcf26c0643605b81560b787b715ed5c29c $
 *
 ...
 * <<クラスの説明>>。
 * @author nakamoto
 * @version $Id: 41579ffcf26c0643605b81560b787b715ed5c29c $
 */
public class KNJX181 extends AbstractXls {

    private static final Log log = LogFactory.getLog("KNJX181.class");
    ...
    protected List getHeadData() {
        ...
        retList.add("総合学習活動");
        retList.add("総合学習評価");
        if ("tokyoto".equals(_param._getname)) {
            retList.add("奉仕活動");
            retList.add("奉仕評価");
            retList.add("備考");
        }
    ...
    protected String getSql() {
        ...
        if ("tokyoto".equals(_param._getname)) {
            ...
            stb.append("     T3.TOTALSTUDYACT2, ");
            stb.append("     T3.TOTALSTUDYVAL2, ");
            stb.append("     T3.CREDITREMARK ");
        } else {
            stb.append("     T3.TOTALSTUDYACT, ");
            stb.append("     T3.TOTALSTUDYVAL ");
        }
    ...
    private class Param {
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            _getname = request.getParameter("GETNAME");
        }
