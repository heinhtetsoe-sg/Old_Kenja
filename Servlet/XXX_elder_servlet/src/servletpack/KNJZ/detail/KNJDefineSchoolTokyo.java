...
public class KNJDefineSchoolTokyo extends KNJDefineSchool implements KNJDefineSchool.DefineSchoolHolder {

    private static final Log log = LogFactory.getLog(KNJDefineSchoolTokyo.class);

//    //public int school_Distinc;            //学校による設定区分 0:kenja(hiroshima) 1:kindai  04/07/28ADD
//    public String schoolmark = "TOK";
...
//    public int absencehighgrade[][] = null;
	...
	public void setSchoolCode( DB2UDB db2, String year )
	{
		try{
            ...
            if (0 == absent_cov_late) {
                log.warn("欠課数換算遅刻数がゼロまたは null なので、換算なし(ゼロ)として扱います。");
