...
public class KNJZ340 implements KNJ_ClassCode {

    private static Log log = LogFactory.getLog(KNJZ340.class);
                     ...
                     throws ServletException, IOException
    {
        ...
        svf.VrSetForm("KNJZ340.frm", 4);        //SuperVisualFormadeで設計したレイアウト定義態の設定
    ...
    public void set_detail(String param[])
    {
        try {
            ...
            sql.append(           "LEFT JOIN DUTYSHARE_MST T2 ON (T2.DUTYSHARECD = T1.DUTYSHARECD) ");
