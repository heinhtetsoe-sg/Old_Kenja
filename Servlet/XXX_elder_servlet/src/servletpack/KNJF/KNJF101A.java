// kanji=漢字
/*
 * $Id: e1af20a6ffd6cbc0468abf5ebad5550e5455f953 $
 *
 ...
 * <<クラスの説明>>。
 * @author m-yama
 * @version $Id: e1af20a6ffd6cbc0468abf5ebad5550e5455f953 $
 */
public class KNJF101A {

    private static final Log log = LogFactory.getLog("KNJF101A.class");
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) throws SQLException {
        ...
        svf.VrsOut("PERIOD", _param.changePrintDateGengou(db2, _param._sDate) + "〜" + _param.changePrintDateGengou(db2, _param._eDate));
        String befType = "";
        String befClass = "";
        for (final Iterator itPrint = printData.iterator(); itPrint.hasNext();) {
            ...
            svf.VrsOut("VISIT_DATE", _param.changePrintDateGengou(db2, student._nurseoffVisitrecDat._visitDate));
            ...
            svf.VrsOut("NENDO", KNJ_EditDate.h_format_JP_N(db2, student._nurseoffVisitrecDat._visitDate));
            ...
            svf.VrsOut("TYPE", student._nurseoffVisitrecDat._typeName);
            svf.VrsOut("VISIT_REASON1", student._nurseoffVisitrecDat._visitReasonName1);
            svf.VrsOut("TREATMENT1", student._nurseoffVisitrecDat._treatmentName1);
            if("fukuiken".equals(_param._schoolName)){
                final String noteField = getMS932Bytecount(student._nurseoffVisitrecDat._specialNote) > 118 ? "2" : "";
                svf.VrsOut("SPECIAL_NOTE" + noteField , student._nurseoffVisitrecDat._specialNote);
            }else {
                svf.VrsOut("SPECIAL_NOTE" , student._nurseoffVisitrecDat._specialNote);
            }
    ...
    private List getPritnData(DB2UDB db2) throws SQLException {
        ...
        try {
            ...
            while (rsNurs.next()) {
                ...
                final String specialNote = rsNurs.getString("SPECIAL_NOTE");
    ...
    private String getNurseOffSql() {
        ...
        if ("1".equals(_param._useSchool_KindField) && !StringUtils.isBlank(_param._setSchoolKind)) {
            stb.append(" INNER JOIN SCHREG_REGD_GDAT T2 ON T2.YEAR = T1.YEAR AND T2.GRADE = T1.GRADE ");
            stb.append("   AND T2.SCHOOL_KIND = '" + _param._setSchoolKind + "' ");
        }
        stb.append("     WHERE ");
        ...
        if (_param._campusDiv != null) {
            ...
            stb.append("                              ENM1.* ");
            stb.append("                          FROM ");
            stb.append("                              NAME_MST ENM1, ");
            stb.append("                              (SELECT ");
            stb.append("                                   * ");
            stb.append("                               FROM ");
            stb.append("                                   NAME_MST ENM2 ");
            stb.append("                               WHERE ");
            stb.append("                                   ENM2.NAMECD1 = 'Z043' ");
            stb.append("                                   AND ENM2.NAMECD2 = '" + _param._campusDiv + "' ");
            stb.append("                               ) ENM3 ");
            stb.append("                          WHERE ");
            stb.append("                              ENM1.NAMECD1 = ENM3.NAMESPARE1 ");
            stb.append("                              AND ENM1.NAMESPARE1 = ENM3.NAMESPARE2 ");
            stb.append("                         ) E1 ");
            stb.append("                     WHERE ");
    ...
    private class Param {
        ...
        Param(final DB2UDB db2, final HttpServletRequest request) throws SQLException {
            ...
            _setSchoolKind = null != _SCHKIND && !"".equals(_SCHKIND) ? _SCHKIND : _SCHOOLKIND;
            ...
            if ("1".equals(request.getParameter("use_select_nurseoffice"))) {
            ...
            if (null != _sortSelected) {
                for (int i = 0; i < _sortSelected.length; i++) {
                    ...
                    if (_sortSelected[i].equals("TYPE")) {
                        sortName = "(CASE WHEN I1.TYPE = '5' THEN 3 WHEN I1.TYPE >= '3' THEN INT(I1.TYPE) + 1 ELSE INT(I1.TYPE) END)";
                    } else if (_sortSelected[i].equals("SCHREGNO")) {
