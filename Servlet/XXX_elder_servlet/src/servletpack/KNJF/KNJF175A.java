/*
 * $Id: 3fe848509e3283fc99e0e1aa98fc8ebff11d0753 $
 *
 * 作成日: 2017/03/30
 * 作成者: maesiro
 *
...
public class KNJF175A {

    private static final Log log = LogFactory.getLog(KNJF175A.class);
    ...
    private String getDateSql() {
        ...
        stb.append("     DATE ");
        stb.append(" FROM ");
        stb.append("     NURSEOFF_DIARY_CAMPUS_DAT ");
        stb.append(" WHERE ");
        stb.append("     CAMPUS_DIV = '" + _param._campusDiv + "' ");
        stb.append("     AND DATE BETWEEN '" + _param._diaryDateFrom + "' AND '" + _param._diaryDateTo + "' ");
        ...
        if ("1".equals(_param._use_prg_schoolkind)) {
            ...
            stb.append("                                                  NAME_MST ");
            stb.append("                                              WHERE ");
            stb.append("                                                  NAMECD1 = 'Z043' ");
            stb.append("                                                  AND NAMECD2 = '" + _param._campusDiv + "' ");
            stb.append("                                              ) T2 ");
            stb.append("                                         WHERE ");
            stb.append("                                             T1.NAMECD1 = T2.NAMESPARE1 ");
            stb.append("                                             AND T1.NAMESPARE1 = '" + _param._SCHOOL_KIND + "' ");
            stb.append("                                        ) E1 ");
            stb.append("                                    WHERE ");
            stb.append("                                        T1.COURSECD = E1.NAMESPARE2 ");
            stb.append("                                        AND T1.MAJORCD = E1.NAMESPARE3 ");
            stb.append("                       ) ");
    ...
    private void printDiary(final Vrw32alp svf, final Date date) {
        ...
        final int lineCnt = null != _param._useFormNameF175 && !"".equals(_param._useFormNameF175) ? 15 : 10;
    ...
    private void printVisitrec(final Vrw32alp svf, final Date date) {
        ...
        for (final Iterator iter = date._visitrecList.iterator(); iter.hasNext();) {
            ...
            svf.VrsOutn(getFieldName("PROCESS", visitrec._reason), gyo,  visitrec._reason);
    ...
    private void printStamp(final Vrw32alp svf) {
        for (Iterator iterator = _param._stampData.keySet().iterator(); iterator.hasNext();) {
            ...
            if (_param._printStamp01 && "1".equals(stampData._seq)) {
            	final String stmpstr = !"".equals(stampData._stampName) ? stampData._stampName : _param._remark6StampNo;
                svf.VrsOut("STAFFBTM_1", _param.getStampImageFile(stmpstr));
            }
            if (_param._printStamp02 && "2".equals(stampData._seq)) {
            	final String stmpstr = !"".equals(stampData._stampName) ? stampData._stampName : _param._remark7StampNo;
                svf.VrsOut("STAFFBTM_2", _param.getStampImageFile(stmpstr));
            }
            if (_param._printStamp03 && "3".equals(stampData._seq)) {
            	final String stmpstr = !"".equals(stampData._stampName) ? stampData._stampName : _param._remark8StampNo;
                svf.VrsOut("STAFFBTM_3", _param.getStampImageFile(stmpstr));
            }
        }
    ...
    //  校時名称
        ...
        try {
            ...
            if (definecode != null && definecode.usefromtoperiod) {
                ...
                stb.append("                                                WHERE ");
                stb.append("                                                   NAMECD1 = 'Z043' ");
                stb.append("                                                   AND NAMECD2 = '" + campusDiv + "' ");
                stb.append("                                              ) T2 ");
                stb.append("                                          WHERE ");
                stb.append("                                              T1.NAMECD1 = T2.NAMESPARE1 ");
                stb.append("                                              AND T1.NAMESPARE1 = '" + schoolKind + "' ");
                stb.append("                                         ) E1 ");
                stb.append("                                     WHERE ");
                stb.append("                                         W3.COURSECD = E1.NAMESPARE2 ");
                stb.append("                                         AND W3.MAJORCD = E1.NAMESPARE3 ");
                stb.append("                        ) ");
    ...
    private String getAttendSemesSql(
        ...
        stb.append("                    ) E1 ");
        stb.append("                WHERE ");
        stb.append("                    W1.COURSECD = E1.NAMESPARE2 ");
        stb.append("                    AND W1.MAJORCD = E1.NAMESPARE3 ");
        stb.append("    ) ");
    ...
    public static String getNurseoffAttendDat(final Param param, final String date) {
        ...
        stb.append("     T1.* ");
        stb.append(" FROM ");
        stb.append("     NURSEOFF_ATTEND_CAMPUS_DAT T1 ");
        ...
        stb.append(" WHERE ");
        stb.append("     CAMPUS_DIV = '" + param._campusDiv + "' ");
        stb.append("     AND DATE = '" + date + "' ");
        stb.append(" ) ");
        stb.append(" SELECT ");
        stb.append("     T1.GRADE ");
    ...
    private class Param {
        ...
        private final String _campusDiv;
        ...
        Param(final HttpServletRequest request, final DB2UDB db2) throws Exception {
            ...
            _campusDiv = request.getParameter("CAMPUS_DIV");
...
log.debug(rs.getString("TITLE") + " = " + stampNo);
        ...
        private String getStampData() {
            ...
            stb.append("     AND PROGRAMID   = 'KNJF175A' ");
            return stb.toString();
        }
        ...
        private void setPeriodIn(final DB2UDB db2) throws SQLException, ParseException {
            try {
                ...
                _periodInState = getPeiodValue(db2, _definecode, _year, _semester, _semester, _campusDiv, _SCHOOL_KIND);
    ...
    private class Date {
        ...
        private String getDiarySql() {
            ...
            stb.append("     T1.DIARY ");
            stb.append(" FROM ");
            stb.append("     NURSEOFF_DIARY_CAMPUS_DAT T1 ");
            stb.append("     LEFT JOIN NAME_MST A006 ON A006.NAMECD1 = 'A006' ");
            stb.append("                            AND A006.NAMECD2 = T1.WEATHER ");
            stb.append(" WHERE ");
            stb.append("     T1.CAMPUS_DIV = '" + _param._campusDiv + "' ");
            stb.append("     AND T1.DATE = '" + _date + "' ");
            if ("1".equals(_param._use_prg_schoolkind)) {
        ...
        private String getVisitrecSql() {
            ...
            stb.append("          WHEN T1.TYPE = '3' OR T1.TYPE = '4' THEN F202.NAME1 ");
