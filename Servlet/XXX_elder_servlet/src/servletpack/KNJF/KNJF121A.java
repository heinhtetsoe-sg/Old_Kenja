// kanji=漢字
/*
 * $Id: 2c2adb6f1fe339488bcd2f368dcb23bcdaae2cfc $
 *
 ...
 * <<クラスの説明>>。
 * @author nakamoto
 * @version $Id: 2c2adb6f1fe339488bcd2f368dcb23bcdaae2cfc $
 */
public class KNJF121A {

    private static final Log log = LogFactory.getLog("KNJF121A.class");
    ...
    private String getDataCntSql(final String division) {
        ...
        stb.append("         month(T1.VISIT_DATE) AS DAYCD, ");
        stb.append("         T2.GRADE, ");
        stb.append("         T3.SEX ");
        stb.append("     FROM ");
        ...
        stb.append("         value(DAYCD, 99) as DAYCD, ");
    ...
    private class DataCnt {
        ...
        private int getRetuNo() {
            ...
            if ("99".equals(_daycd)) {
                return 13;
            } else if (Integer.parseInt(_daycd) < 4) {
                return Integer.parseInt(_daycd) + 9;
            } else {
                return Integer.parseInt(_daycd) - 3;
            }
        }
    ...
    private class Param {
        ...
        private String printYM(final String date) {
            if (null == date) {
                return "";
            }
            if (_isSeireki) {
                return date.substring(0, 4) + "年" + KNJ_EditDate.h_format_S(date, "M月");
            } else {
                return KNJ_EditDate.h_format_JP_M(date);
            }
        }

        private String printKikan() {
            return printYM(_sDate) + " \uFF5E " + printYM(_eDate);
        }
