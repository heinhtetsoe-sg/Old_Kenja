/*
 * $Id: f428cd26e24aa79d10404d3e4641eb88ec14fef1 $
 *
 * 作成日: 2015/08/14
 * 作成者: maesiro
 *
...
public class KNJF321 {

    private static final Log log = LogFactory.getLog(KNJF321.class);
    ...
    private void printMain(final DB2UDB db2, final Vrw32alp svf) {
        ...
        try {
            final String mainSql = mainSql();
            log.debug(" sql =" + mainSql);
            ...
            while (rs.next()) {
                ...
                svf.VrsOut("EXE_PLACE6", "1".equals(rs.getString("REMARK0_6")) ? "○" : "");
                svf.VrsOut("EXE_ETC", null != rs.getString("REMARK0_7") ? rs.getString("REMARK0_7") : "");
                ...
                svf.VrsOut("ITEM3_1", "1".equals(rs.getString("REMARK3_2")) ? "○" : "");
                svf.VrsOut("ITEM3_2", "1".equals(rs.getString("REMARK3_3")) ? "○" : "");
                svf.VrsOut("ITEM3_3", "1".equals(rs.getString("REMARK3_4")) ? "○" : "");
                svf.VrsOut("ITEM3_4", "1".equals(rs.getString("REMARK3_5")) ? "○" : "");
                svf.VrsOut("ITEM_ETC3", null != rs.getString("REMARK3_6") ? rs.getString("REMARK3_6") : "");
                ...
                svf.VrsOut("ITEM_ETC4", null != rs.getString("REMARK4_5") ? rs.getString("REMARK4_5") : "");
                ...
                svf.VrsOut("ITEM6_4", "1".equals(rs.getString("REMARK6_5")) ? "○" : "");
                svf.VrsOut("ITEM_ETC6", null != rs.getString("REMARK6_6") ? rs.getString("REMARK6_6") : "");

                svf.VrsOut("ITEM7", "1".equals(rs.getString("REMARK7_1")) ? "○" : "");

                svf.VrsOut("ITEM8", "1".equals(rs.getString("REMARK8_1")) ? "○" : "");

                svf.VrsOut("ITEM9", "1".equals(rs.getString("REMARK9_1")) ? "○" : "");
                svf.VrsOut("ITEM9_1", "1".equals(rs.getString("REMARK9_2")) ? "○" : "");
    ...
    private String mainSql() {
        ...
        stb.append("     L7.REMARK1 AS REMARK7_1, ");
        stb.append("     L7.REMARK2 AS REMARK7_2, ");
        stb.append("     L7.REMARK3 AS REMARK7_3, ");
        stb.append("     L7.REMARK4 AS REMARK7_4, ");
        stb.append("     L7.REMARK5 AS REMARK7_5, ");
        stb.append("     L7.REMARK6 AS REMARK7_6, ");
        stb.append("     L8.REMARK1 AS REMARK8_1, ");
        stb.append("     L8.REMARK2 AS REMARK8_2, ");
        stb.append("     L8.REMARK3 AS REMARK8_3, ");
        stb.append("     L8.REMARK4 AS REMARK8_4, ");
        stb.append("     L8.REMARK5 AS REMARK8_5, ");
        stb.append("     L8.REMARK6 AS REMARK8_6, ");
        stb.append("     L9.REMARK1 AS REMARK9_1, ");
        stb.append("     L9.REMARK2 AS REMARK9_2, ");
        stb.append("     L9.REMARK3 AS REMARK9_3, ");
        stb.append("     L9.REMARK4 AS REMARK9_4, ");
        stb.append("     L9.REMARK5 AS REMARK9_5, ");
        stb.append("     L9.REMARK6 AS REMARK9_6, ");
        ...
        stb.append("     LEFT JOIN MEDICAL_WORK_RECORD_DETAIL_DAT L7 ON T1.WORK_DATE = L7.WORK_DATE ");
        stb.append("          AND T1.STAFFCD = L7.STAFFCD ");
        stb.append("          AND T1.WORK_DIV = L7.WORK_DIV ");
        stb.append("          AND L7.SEQ = '007' ");
        stb.append("     LEFT JOIN MEDICAL_WORK_RECORD_DETAIL_DAT L8 ON T1.WORK_DATE = L8.WORK_DATE ");
        stb.append("          AND T1.STAFFCD = L8.STAFFCD ");
        stb.append("          AND T1.WORK_DIV = L8.WORK_DIV ");
        stb.append("          AND L8.SEQ = '008' ");
        stb.append("     LEFT JOIN MEDICAL_WORK_RECORD_DETAIL_DAT L9 ON T1.WORK_DATE = L9.WORK_DATE ");
        stb.append("          AND T1.STAFFCD = L9.STAFFCD ");
        stb.append("          AND T1.WORK_DIV = L9.WORK_DIV ");
        stb.append("          AND L9.SEQ = '009' ");
