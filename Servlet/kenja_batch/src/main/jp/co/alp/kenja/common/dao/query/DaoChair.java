// kanji=漢字
/*
 * $Id: DaoChair.java 74553 2020-05-27 04:44:53Z maeshiro $
 *
 ...
 * CLASSCD                        SYSIBM    VARCHAR                   2     0 はい
 * SCHOOL_KIND                    SYSIBM    VARCHAR                   2     0 はい
 * CURRICULUM_CD                  SYSIBM    VARCHAR                   2     0 はい
 * SUBCLASSCD                     SYSIBM    VARCHAR                   6     0 はい
 * CHAIRNAME                      SYSIBM    VARCHAR                  30     0 はい
 * CHAIRABBV                      SYSIBM    VARCHAR                  30     0 はい
 ...
 * 講座を読み込む。
 * @author tamura
 * @version $Id: DaoChair.java 74553 2020-05-27 04:44:53Z maeshiro $
 */
public final class DaoChair extends AbstractDaoLoader<Chair> {
    /** テーブル名 */
    public static final String TABLE_NAME = "CHAIR_DAT";

    /** log */
    private static final Log log = LogFactory.getLog(DaoChair.class);
    private static final AbstractDaoLoader<Chair> INSTANCE = new DaoChair();
