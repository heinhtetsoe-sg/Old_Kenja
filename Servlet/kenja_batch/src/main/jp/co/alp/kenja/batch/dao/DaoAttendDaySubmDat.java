// kanji=漢字
/*
 * $Id: DaoAttendDaySubmDat.java 74552 2020-05-27 04:41:22Z maeshiro $
 *
...
/**
 * 日々出欠中分類データを取得する。
 * @version $Id: DaoAttendDaySubmDat.java 74552 2020-05-27 04:41:22Z maeshiro $
 */
public final class DaoAttendDaySubmDat extends AbstractDaoLoader<AccumulateAttendDayDat> {
    /** テーブル名 */
    public static final String TABLE_NAME = "ATTEND_DAY_SUBM_DAT";
    /*pkg*/static final Log log = LogFactory.getLog(DaoAttendDaySubmDat.class);
     ...
     */
    public DaoAttendDaySubmDat(final Term term, final Map<Student, AccumulateAttendDayDat> schregnoAttendDayDat) {
        super(log);
        _term = term;
    ...
    check:
        {
            ...
            final String submCd = MapUtils.getString(map, "submCd");
            ...
            aadd.addDayDatSubm(date, kintai, sublCd, submCd);
            rtn = aadd;
