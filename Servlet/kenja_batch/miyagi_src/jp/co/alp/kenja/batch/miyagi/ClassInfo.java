// kanji=漢字
/*
 * $Id: ClassInfo.java 56574 2017-10-22 11:21:06Z maeshiro $
 *
 ...
 * クラス情報テーブル。
 * @author takaesu
 * @version $Id: ClassInfo.java 56574 2017-10-22 11:21:06Z maeshiro $
 */
public class ClassInfo {
    /*pkg*/static final Log log = LogFactory.getLog(ClassInfo.class);

    protected final Param _param;

    public ClassInfo(final Param param, final Database knj, final Database vqs, final String title) throws SQLException {
        _param = param;
    ...
    private String getALLMatchCntSql(final Data data) {
        ...
        stb.append("     AND grade      = '" + data._grade + "' ");
        stb.append("     AND class_code = '" + data._class_code + "' ");
        stb.append("     AND class_name = '" + data._class_name + "' ");
        if (null != data._abbreviated_name) {
            stb.append("     AND abbreviated_name = '" + data._abbreviated_name + "' ");
        } else {
            stb.append("     AND abbreviated_name IS NULL ");
        }
    ...
    private String getInsertSql(final Data data, final String id) {
        ...
        stb.append(" INSERT INTO k_class_info ( ");
        stb.append("     id, ");
        stb.append("     year, ");
        stb.append("     schoolcd, ");
        ...
        stb.append("     class_name, ");
        if (null != data._abbreviated_name) {
            stb.append("     abbreviated_name, ");
        }
        stb.append("     updated) ");
        stb.append(" VALUES ( ");
        stb.append("      " + id + ", ");
        ...
        stb.append("     '" + data._class_name + "', ");
        if (null != data._abbreviated_name) {
            stb.append("     '" + data._abbreviated_name + "', ");
        }
    ...
    private String getDataSql() {
        ...
        //組名称２を名称と略称にセット
        stb.append("     T1.HR_CLASS_NAME2 AS CLASS_NAME, ");
        stb.append("     T1.HR_CLASS_NAME2 AS ABBREVIATED_NAME ");
        stb.append(" FROM ");
...
//        stb.append("     LEFT JOIN SCHREG_REGD_GDAT L1 ON L1.YEAR = T1.YEAR AND L1.GRADE = T1.GRADE ");
        ...
        stb.append("     AND T1.HR_CLASS_NAME2 IS NOT NULL ");
        stb.append(" ORDER BY ");
        stb.append("     T1.GRADE, ");
    ...
    private class Data {
        ...
        final String _abbreviated_name;
        ...
        public String toString() {
            return _grade + "/" + _class_code + "/" + _class_name;
        }
    }
} // ClassInfo
