// kanji=漢字
/*
 * $Id: UpdateUpdate.java 56574 2017-10-22 11:21:06Z maeshiro $
 *
 ...
 *
 * @author m-yamashiro
 * @version $Id: UpdateUpdate.java 56574 2017-10-22 11:21:06Z maeshiro $
 */
public class UpdateUpdate {
    /* pkg */static final Log log = LogFactory.getLog(UpdateUpdate.class);

    protected final Param _param;

    public UpdateUpdate(final Param param, final Database knj, final String title) throws SQLException {
        _param = param;
