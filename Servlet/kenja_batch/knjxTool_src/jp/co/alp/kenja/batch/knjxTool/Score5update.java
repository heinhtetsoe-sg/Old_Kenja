// kanji=漢字
/*
 * $Id: Score5update.java 56574 2017-10-22 11:21:06Z maeshiro $
 *
 ...
 *
 * @author m-yamashiro
 * @version $Id: Score5update.java 56574 2017-10-22 11:21:06Z maeshiro $
 */
public class Score5update {
    /* pkg */static final Log log = LogFactory.getLog(Score5update.class);

    protected final Param _param;

    public Score5update(final Param param, final Database knj, final String title) throws SQLException {
        _param = param;
    ...
    private void saveData(final Database knj, final NameMst nameMst) throws SQLException {
        ...
        if ("P".equals(nameMst._name1)) {
            whereSql1 = " WHERE BUMONCD = '1' AND NENDO = '" + _param._year + "' AND TEST_CATEGORYCD = '5' ";
            whereSql2 = " AND T2.GRADE BETWEEN  '" + nameMst._name2 + "' AND '" + nameMst._name3 + "' AND T1.YEAR = '" + _param._year + "' ";
        }
        if ("J".equals(nameMst._name1)) {
            whereSql1 = " WHERE BUMONCD = '2' AND NENDO = '" + _param._year + "' AND TEST_CATEGORYCD = '5' ";
            whereSql2 = " AND T2.GRADE BETWEEN  '" + nameMst._name2 + "' AND '" + nameMst._name3 + "' AND T1.YEAR = '" + _param._year + "' ";
        }
        if ("H".equals(nameMst._name1)) {
            whereSql1 = " WHERE (BUMONCD = '3' OR BUMONCD = '4') AND NENDO = '" + _param._year + "' AND TEST_CATEGORYCD = '5' ";
            whereSql2 = " AND T2.GRADE BETWEEN  '" + nameMst._name2 + "' AND '" + nameMst._name3 + "' AND T1.YEAR = '" + _param._year + "' ";
        }
    ...
    private String getInsertSql(final String whereSql2) {
        ...
        stb.append("     '5' as TEST_CATEGORYCD, ");
        stb.append("     'センター自己採点' as TESTCATEGORYNAME, ");
        stb.append("     NULL as SEMESTER, ");
        stb.append("     T1.CENTERCD || '00', ");
        stb.append("     'センター自己採点' as TESTITEMNAME, ");
        stb.append("     NULL as CLASSCD, ");
        stb.append("     NULL as CLASSNAME, ");
        stb.append("     NULL as CLASSSORT, ");
        stb.append("     T1.CENTER_SUBCLASS_CD, ");
        ...
        stb.append("      ");
        stb.append(" FROM ");
        stb.append("     MOCK_CENTER_RANK_RANGE_DAT T1  ");
        ...
        stb.append("     LEFT JOIN MOCK_CENTER_DAT T3 on T1.CENTERCD = T3.CENTERCD and T1.YEAR = T2.YEAR and T1.SCHREGNO = T3.SCHREGNO ");
        stb.append("     LEFT JOIN MOCK_CENTER_SUBCLASS_MST T4 on T1.CENTER_SUBCLASS_CD = T4.CENTER_SUBCLASS_CD and T1.YEAR = T4.YEAR ");
