...
# kanji=漢字
# ---------------------------------------
# $Id: knjxTool.sh 56574 2017-10-22 11:21:06Z maeshiro $
# 甲府　レポートツール用データ作成
# 使用例:
#     ./knjxTool.sh //172.31.120.21:50000/koufudb db2inst1 db2kenja 2016-06-03
# ---------------------------------------

# 設定
MAINCLASS=jp.co.alp.kenja.batch.knjxTool.Main
JAVA_HOME=/opt/IBM/WebSphere/AppServer/java
KENJA_HOME=/usr/local/kofu_hi
...
CLASSPATH=$CLASSPATH:/usr/local/kofu_hi/src/batch/knjxTool.jar
