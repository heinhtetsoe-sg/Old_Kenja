// kanji=漢字
/*
 * $Id: KnjCompRegistDat.java 56574 2017-10-22 11:21:06Z maeshiro $
 *
 ...
 * COMP_REGIST_DATを作る。
 * @author takaesu
 * @version $Id: KnjCompRegistDat.java 56574 2017-10-22 11:21:06Z maeshiro $
 */
public class KnjCompRegistDat extends AbstractKnj {
    /*pkg*/static final Log log = LogFactory.getLog(KnjCompRegistDat.class);

    public static final String ICASS_TABLE = "SEITO_RISHU_KAMOKU";

    public KnjCompRegistDat() {
        super();
    }
