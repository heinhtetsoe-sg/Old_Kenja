// kanji=漢字
/*
 * $Id: KnjAnotherSchoolGetcreditsDat3.java 56574 2017-10-22 11:21:06Z maeshiro $
 *
 ...
 * @author takaesu
 * @version $Id: KnjAnotherSchoolGetcreditsDat3.java 56574 2017-10-22 11:21:06Z maeshiro $
 */
public class KnjAnotherSchoolGetcreditsDat3 extends AbstractKnj {
    /*pkg*/static final Log log = LogFactory.getLog(KnjAnotherSchoolGetcreditsDat3.class);
    ...
    public KnjAnotherSchoolGetcreditsDat3() {
        super();
    }
    ...
    private String getSql(final int strSep, final int endSep) {
        ...
        stb.append(" WHERE  ");
        stb.append("     VALUE(T1.TANI_SHUTOKU_SHUDAN_CODE, '') IN ('12')  ");
        ...
        stb.append(" ), MK AS (  ");
        stb.append(" SELECT  ");
        stb.append("     CAST(ROW_NUMBER() OVER() AS INTEGER) + 100 AS COUN,   ");
        stb.append("     T1.SHIGANSHA_RENBAN,  ");
        stb.append("     T1.KYOKA_NAME,  ");
        stb.append("     T1.KAMOKU_NAME,  ");
        stb.append("     T1.SHUTOKU_NENDO,  ");
        stb.append("     '0' GET_METHOD,  ");
