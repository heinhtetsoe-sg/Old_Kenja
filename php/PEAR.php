...
class PEAR
{
    ...
    */
    ...
    function expectError($code = '*')
    {
        ...
        return get_count($this->_expected_errors);
    }
    ...
    function _checkDelExpect($error_code)
    {
        ...
        foreach ($this->_expected_errors as $key => $error_array) {
            ...
            if (0 == get_count($this->_expected_errors[$key])) {
    ...
    {
        $deleted = false;
        if ((is_array($error_code) && (0 != get_count($error_code)))) {
                         ...
                         $skipmsg = false)
    {
        ...
        if (
            ...
            get_count($object->_expected_errors) > 0 &&
            get_count($exp = end($object->_expected_errors))
        ) {
            if ($exp[0] === "*" ||
