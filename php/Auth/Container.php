...
class Auth_Container
{
    ...
    {
        $this->log('Auth_Container::verifyPassword() called.{'.$cryptType.'}', AUTH_LOG_DEBUG);
        switch ($cryptType) {
            case "crypt" :
        ...
        $this->log('Hash Hash{'.$hashpass.'}', AUTH_LOG_DEBUG);
                return ((string)$hashpass === (string)$password2);
    ...
    function getUser($username)
    {
        ...
        for ($i=0; $c = get_count($users), $i<$c; $i++) {
