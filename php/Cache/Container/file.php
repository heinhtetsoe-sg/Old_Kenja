...
// +----------------------------------------------------------------------+
//
// $Id: file.php,v 1.16.2.3 2001/11/13 01:26:40 ssb Exp $
...
* @version  $Id: file.php,v 1.16.2.3 2001/11/13 01:26:40 ssb Exp $
*/
class Cache_Container_file extends Cache_Container {
    ...
    */
    ...
    function garbageCollection($maxlifetime=100) {
