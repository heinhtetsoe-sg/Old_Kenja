    ...
    function uninstallPackage(&$pkg)
    {
        ...
        foreach ($data['dependencies'][$channel][$package] as $dep) {
            ...
            if ($found) {
                ...
                if (!get_count($data['packages'][$depchannel][$depname])) {
                    unset($data['packages'][$depchannel][$depname]);
                    if (!get_count($data['packages'][$depchannel])) {
        ...
        if (!get_count($data['dependencies'][$channel])) {
            unset($data['dependencies'][$channel]);
        }

        if (!get_count($data['dependencies'])) {
            unset($data['dependencies']);
        }

        if (!get_count($data['packages'])) {
            unset($data['packages']);
        }
