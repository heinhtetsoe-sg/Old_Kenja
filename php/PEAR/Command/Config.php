...
',
    ...
    {
        $args_cnt = is_array($params) ? get_count($params) : 0;
        switch ($args_cnt) {
            case 1:
                $config_key = $params[0];
                $layer = null;
    ...
    function doConfigSet($command, $options, $params)
    {
        ...
        // $param[2] -> the layer
        $failmsg = '';
        if (get_count($params) < 2 || get_count($params) > 3) {
    ...
    function doConfigHelp($command, $options, $params)
    {
        ...
        $data['caption']  = "Config help" . ((get_count($params) == 1) ? " for $params[0]" : '');
