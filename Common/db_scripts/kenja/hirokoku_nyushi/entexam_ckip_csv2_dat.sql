-- kanji=漢字
-- $Id: entexam_ckip_csv2_dat.sql 64588 2019-01-15 02:13:08Z tawada $
...
drop table ENTEXAM_CKIP_CSV2_DAT

create table ENTEXAM_CKIP_CSV2_DAT ( \
...
alter table ENTEXAM_CKIP_CSV2_DAT add constraint PK_EXAM_CKIP_CSV primary key (LOGIN_ID, ENTEXAMYEAR, APPLICANTDIV, TESTDIV, TESTDIV1, EXAMNO)
