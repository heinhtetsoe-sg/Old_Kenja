-- $Id: kojin_idou_wkdat.sql 74435 2020-05-20 07:59:16Z yamashiro $

DROP TABLE KOJIN_IDOU_WKDAT
CREATE TABLE KOJIN_IDOU_WKDAT( \
...
ALTER TABLE KOJIN_IDOU_WKDAT ADD CONSTRAINT PK_K_IDOU_WKDAT PRIMARY KEY (KOJIN_NO, IDOU_DIV, SHINSEI_DATE, SHINSEI_YEAR, SHUUGAKU_NO, SEQ)