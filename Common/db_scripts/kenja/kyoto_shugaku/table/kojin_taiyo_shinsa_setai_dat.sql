-- $Id: kojin_taiyo_shinsa_setai_dat.sql 74435 2020-05-20 07:59:16Z yamashiro $

DROP TABLE KOJIN_TAIYO_SHINSA_SETAI_DAT
CREATE TABLE KOJIN_TAIYO_SHINSA_SETAI_DAT( \
...
ALTER TABLE KOJIN_TAIYO_SHINSA_SETAI_DAT ADD CONSTRAINT PK_K_T_SHI_SETAI_D PRIMARY KEY (KOJIN_NO, SHINSEI_YEAR, SHIKIN_SHOUSAI_DIV, ISSUEDATE, KEKKA_DIV, SETAI_SEQ, SEQ)