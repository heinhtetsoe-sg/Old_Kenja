-- $Id: rep-kojin_taiyo_setai_dat.sql 74435 2020-05-20 07:59:16Z yamashiro $

DROP TABLE KOJIN_TAIYO_SETAI_DAT_OLD
RENAME TABLE KOJIN_TAIYO_SETAI_DAT TO KOJIN_TAIYO_SETAI_DAT_OLD
...
INSERT INTO KOJIN_TAIYO_SETAI_DAT \
    SELECT \
        KOJIN_NO        , \
        SHINSEI_YEAR    , \
        01, \
