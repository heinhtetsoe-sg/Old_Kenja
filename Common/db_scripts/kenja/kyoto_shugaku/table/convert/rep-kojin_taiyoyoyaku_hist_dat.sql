-- $Id: rep-kojin_taiyoyoyaku_hist_dat.sql 74435 2020-05-20 07:59:16Z yamashiro $

DROP TABLE KOJIN_TAIYOYOYAKU_HIST_DAT_OLD
RENAME TABLE KOJIN_TAIYOYOYAKU_HIST_DAT TO KOJIN_TAIYOYOYAKU_HIST_DAT_OLD
...
INSERT INTO KOJIN_TAIYOYOYAKU_HIST_DAT \
    SELECT \
        KOJIN_NO            , \
        SHINSEI_YEAR        , \
        SHIKIN_SHOUSAI_DIV  , \
        ...
        UPDATED \
    FROM \
        KOJIN_TAIYOYOYAKU_HIST_DAT_OLD
