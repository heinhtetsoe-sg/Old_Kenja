-- kanji=漢字
-- $Id: rep-bank_result_tmp_data2.sql 56577 2017-10-22 11:35:50Z maeshiro $
...
drop table BANK_RESULT_TMP_DATA2_OLD
create table BANK_RESULT_TMP_DATA2_OLD like BANK_RESULT_TMP_DATA2
insert into BANK_RESULT_TMP_DATA2_OLD select * from BANK_RESULT_TMP_DATA2

drop table BANK_RESULT_TMP_DATA2

create table BANK_RESULT_TMP_DATA2 \
( \
...
alter table BANK_RESULT_TMP_DATA2 \
add constraint PK_BANK_RES_TMP2 \
primary key \
(FILE_LINE_NUMBER)

insert into BANK_RESULT_TMP_DATA2 \
( \
    select \
        FILE_LINE_NUMBER, \
        PROCESS1_UPDATED, \
