-- kanji=漢字
-- $Id: rep-bank_result_tmp_data3.sql 56577 2017-10-22 11:35:50Z maeshiro $
...
drop table BANK_RESULT_TMP_DATA3_OLD
create table BANK_RESULT_TMP_DATA3_OLD like BANK_RESULT_TMP_DATA3
insert into BANK_RESULT_TMP_DATA3_OLD select * from BANK_RESULT_TMP_DATA3

drop table BANK_RESULT_TMP_DATA3

create table BANK_RESULT_TMP_DATA3 \
( \
...
alter table BANK_RESULT_TMP_DATA3 \
add constraint PK_BANK_RES_TMP3 \
primary key \
(FILE_LINE_NUMBER)

insert into BANK_RESULT_TMP_DATA3 \
( \
    select \
        FILE_LINE_NUMBER, \
        PROCESS1_UPDATED, \
