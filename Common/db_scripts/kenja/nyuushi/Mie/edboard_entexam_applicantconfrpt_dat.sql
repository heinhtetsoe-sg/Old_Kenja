-- $Id: 6780c3142e522fae84132132b19fe7fb6f10fff2 $

drop table EDBOARD_ENTEXAM_APPLICANTCONFRPT_DAT
...
alter table EDBOARD_ENTEXAM_APPLICANTCONFRPT_DAT add constraint \
PK_ED_EE_APCNRPT primary key (EDBOARD_SCHOOLCD, ENTEXAMYEAR, APPLICANTDIV, EXAMNO)
