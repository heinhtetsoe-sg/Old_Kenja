-- $Id: rep-entexam_applicantbase_dat.sql 70654 2019-11-13 02:28:50Z nakamoto $
...
CREATE TABLE ENTEXAM_APPLICANTBASE_DAT( \
    ...
    GENERAL_FLG2         VARCHAR(1), \
    GENERAL_FLG3         VARCHAR(1), \
...
INSERT INTO ENTEXAM_APPLICANTBASE_DAT \
    SELECT \
        ...
        GENERAL_FLG, \
        GENERAL_FLG2, \
        CAST(null as varchar(1)) AS GENERAL_FLG3, \
        SPORTS_FLG, \
        DORMITORY_FLG, \
        RECOM_ITEM1, \
        RECOM_ITEM2, \
