...
DROP TABLE MEDEXAM_DISEASE_ADDITION2_DAT

CREATE TABLE MEDEXAM_DISEASE_ADDITION2_DAT \
...
alter table MEDEXAM_DISEASE_ADDITION2_DAT add constraint PK_MEDEXAM_D_A2_D primary key (EDBOARD_SCHOOLCD, YEAR, ADDITION_DATE, GRADE, HR_CLASS)
