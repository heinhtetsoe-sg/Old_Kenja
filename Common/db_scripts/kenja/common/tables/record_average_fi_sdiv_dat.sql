-- kanji=漢字
-- $Id: 8e6fee212155aa445750b8269ab69f3375e1a3fb $

DROP   TABLE RECORD_AVERAGE_FI_SDIV_DAT
CREATE TABLE RECORD_AVERAGE_FI_SDIV_DAT ( \
...
ALTER TABLE RECORD_AVERAGE_FI_SDIV_DAT ADD CONSTRAINT PK_REC_AVG_FI_SD \
