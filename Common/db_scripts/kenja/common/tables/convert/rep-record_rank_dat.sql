-- $Id: cf869d79fe72c4cd676832f63b539223f6b14291 $

DROP TABLE RECORD_RANK_DAT_OLD
RENAME TABLE RECORD_RANK_DAT TO RECORD_RANK_DAT_OLD
CREATE TABLE RECORD_RANK_DAT( \
...
ALTER TABLE RECORD_RANK_DAT ADD CONSTRAINT PK_RECORD_RANK_DAT PRIMARY KEY (YEAR,SEMESTER,TESTKINDCD,TESTITEMCD,CLASSCD,SCHOOL_KIND,CURRICULUM_CD,SUBCLASSCD,SCHREGNO)