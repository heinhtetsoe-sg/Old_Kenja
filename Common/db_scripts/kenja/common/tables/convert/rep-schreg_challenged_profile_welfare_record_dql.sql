...
create table SCHREG_CHALLENGED_PROFILE_WELFARE_RECORD_DAT( \
    ...
    SUPPLY_DATE              DATE         , \
    CENTERCD                 VARCHAR(5)   , \
    SERVICE_CENTER_TEXT      VARCHAR(310) , \
...
alter table SCHREG_CHALLENGED_PROFILE_WELFARE_RECORD_DAT add constraint SCH_CHA_P_W_R_D primary key (SCHREGNO,RECORD_DATE,RECORD_DIV,RECORD_NO,RECORD_SEQ)
