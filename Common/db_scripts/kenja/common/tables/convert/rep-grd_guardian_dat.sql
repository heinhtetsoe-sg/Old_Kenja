-- $Id: b520eeda16838177420900cc2c03aa9db36fb7ba $

DROP TABLE GRD_GUARDIAN_DAT_OLD
RENAME TABLE GRD_GUARDIAN_DAT TO GRD_GUARDIAN_DAT_OLD
CREATE TABLE GRD_GUARDIAN_DAT( \
...
ALTER TABLE GRD_GUARDIAN_DAT ADD CONSTRAINT PK_GRD_GUARDIAN PRIMARY KEY (SCHREGNO)

INSERT INTO GRD_GUARDIAN_DAT \
    SELECT \
        SCHREGNO, \
        RELATIONSHIP, \
        GUARD_NAME, \
