-- $Id: 2a61366a2fd8608ab2d505e0d2c52f29b4559a73 $

DROP TABLE GUARDIAN2_DAT_OLD
RENAME TABLE GUARDIAN2_DAT TO GUARDIAN2_DAT_OLD
CREATE TABLE GUARDIAN2_DAT( \
...
ALTER TABLE GUARDIAN2_DAT ADD CONSTRAINT PK_GUARDIAN2_DAT PRIMARY KEY (SCHREGNO)