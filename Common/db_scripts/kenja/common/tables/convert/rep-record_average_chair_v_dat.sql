-- kanji=漢字
-- $Id: 7aeb9ba7b3b54f115b1d22c0ce4e2e966c64152a $
...
DROP TABLE RECORD_AVERAGE_CHAIR_V_DAT_OLD
RENAME TABLE RECORD_AVERAGE_CHAIR_V_DAT TO RECORD_AVERAGE_CHAIR_V_DAT_OLD
...
insert into RECORD_AVERAGE_CHAIR_V_DAT \
SELECT \
    YEAR, \
    SEMESTER, \
    TESTKINDCD, \
    ...
    UPDATED \
FROM \
RECORD_AVERAGE_CHAIR_V_DAT_OLD
