-- $Id: e9003596c78e34b53f7b7eaa60027c36a1a09302 $

drop table GRD_BASE_COMEBACK_MST_OLD
create table GRD_BASE_COMEBACK_MST_OLD like GRD_BASE_COMEBACK_MST
insert into GRD_BASE_COMEBACK_MST_OLD select * from GRD_BASE_COMEBACK_MST

DROP TABLE GRD_BASE_COMEBACK_MST
CREATE TABLE GRD_BASE_COMEBACK_MST( \
...
ALTER TABLE GRD_BASE_COMEBACK_MST ADD CONSTRAINT PK_GRD_BASE_COME PRIMARY KEY (SCHREGNO, COMEBACK_DATE)

INSERT INTO GRD_BASE_COMEBACK_MST \
    SELECT \
        * \
    FROM \
        GRD_BASE_COMEBACK_MST_OLD
