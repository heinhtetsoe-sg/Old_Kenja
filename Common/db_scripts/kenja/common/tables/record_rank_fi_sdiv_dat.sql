-- kanji=漢字
-- $Id: 1b3f44a4a2b5ce90310a9b91a898ad38772a7de6 $

DROP TABLE RECORD_RANK_FI_SDIV_DAT
CREATE TABLE RECORD_RANK_FI_SDIV_DAT( \
...
ALTER TABLE RECORD_RANK_FI_SDIV_DAT ADD CONSTRAINT PK_REC_RNK_FI_SD PRIMARY KEY (YEAR,SEMESTER,TESTKINDCD,TESTITEMCD,SCORE_DIV,CLASSCD,SCHOOL_KIND,CURRICULUM_CD,SUBCLASSCD,SCHREGNO)