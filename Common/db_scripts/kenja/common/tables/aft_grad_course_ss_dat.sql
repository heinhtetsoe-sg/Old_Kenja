-- kanji=漢字
-- $Id: d7b1b58afc756d960d2e0f459c54f823ea286b1c $

DROP TABLE AFT_GRAD_COURSE_SS_DAT
CREATE TABLE AFT_GRAD_COURSE_SS_DAT( \
...
ALTER TABLE AFT_GRAD_COURSE_SS_DAT ADD CONSTRAINT PK_AFT_GRAD_COURSE_SS PRIMARY KEY (YEAR,SEQ)