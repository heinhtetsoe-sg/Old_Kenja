-- kanji=漢字
-- $Id: levy_request_seisan_dat.sql 56577 2017-10-22 11:35:50Z maeshiro $
...
alter table LEVY_REQUEST_SEISAN_DAT add constraint PK_LEVY_SEISAN_D primary key (YEAR, SEISAN_L_CD, SEISAN_M_CD, REQUEST_NO)
